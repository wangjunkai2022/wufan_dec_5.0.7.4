...
# direct methods
.method constructor <init>(Landroidx/concurrent/futures/AbstractResolvableFuture;Ld1/a;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    iput-object p2, p0, Landroidx/concurrent/futures/AbstractResolvableFuture$SetFuture;->future:Ld1/a;
...
.method public run()V
    ...
    .line 2
    :cond_0
    iget-object v0, p0, Landroidx/concurrent/futures/AbstractResolvableFuture$SetFuture;->future:Ld1/a;

    invoke-static {v0}, Landroidx/concurrent/futures/AbstractResolvableFuture;->getFutureValue(Ld1/a;)Ljava/lang/Object;
