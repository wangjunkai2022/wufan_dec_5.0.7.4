.class Lcom/join/mgps/adapter/SearchGameListAdapter$b;
.super Lw1/p;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/join/mgps/adapter/SearchGameListAdapter;->E(Lcom/join/mgps/base/BaseViewHolder;Lcom/join/mgps/adapter/SearchGameListAdapter$i;)V
.end annotation
...
.method constructor <init>(Lcom/join/mgps/adapter/SearchGameListAdapter;Lcom/join/mgps/dto/GInfoBean;Lcom/join/mgps/dto/CommonGameInfoBean;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/join/mgps/adapter/SearchGameListAdapter$b;->d:Lcom/join/mgps/adapter/SearchGameListAdapter;

    iput-object p2, p0, Lcom/join/mgps/adapter/SearchGameListAdapter$b;->b:Lcom/join/mgps/dto/GInfoBean;

    iput-object p3, p0, Lcom/join/mgps/adapter/SearchGameListAdapter$b;->c:Lcom/join/mgps/dto/CommonGameInfoBean;
...
.method public varargs onClickBlank(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lcom/join/mgps/adapter/SearchGameListAdapter$b;->d:Lcom/join/mgps/adapter/SearchGameListAdapter;
    ...
    iget-object p1, p0, Lcom/join/mgps/adapter/SearchGameListAdapter$b;->b:Lcom/join/mgps/dto/GInfoBean;
    ...
    iget-object p1, p0, Lcom/join/mgps/adapter/SearchGameListAdapter$b;->c:Lcom/join/mgps/dto/CommonGameInfoBean;
    ...
    iget-object p2, p0, Lcom/join/mgps/adapter/SearchGameListAdapter$b;->c:Lcom/join/mgps/dto/CommonGameInfoBean;
...
.method public onClickCover()V
    ...
    iget-object v1, p0, Lcom/join/mgps/adapter/SearchGameListAdapter$b;->d:Lcom/join/mgps/adapter/SearchGameListAdapter;
    ...
    iget-object v2, p0, Lcom/join/mgps/adapter/SearchGameListAdapter$b;->b:Lcom/join/mgps/dto/GInfoBean;

    invoke-virtual {v2}, Lcom/join/mgps/dto/GInfoBean;->getId()Ljava/lang/String;

    move-result-object v2

    iget-object v3, p0, Lcom/join/mgps/adapter/SearchGameListAdapter$b;->b:Lcom/join/mgps/dto/GInfoBean;

    invoke-virtual {v3}, Lcom/join/mgps/dto/GInfoBean;->getGame_info_tpl_type()Ljava/lang/String;

    move-result-object v3

    iget-object v4, p0, Lcom/join/mgps/adapter/SearchGameListAdapter$b;->b:Lcom/join/mgps/dto/GInfoBean;

    invoke-virtual {v4}, Lcom/join/mgps/dto/GInfoBean;->getSp_tpl_two_position()I

    move-result v4

    iget-object v5, p0, Lcom/join/mgps/adapter/SearchGameListAdapter$b;->c:Lcom/join/mgps/dto/CommonGameInfoBean;

    invoke-virtual {v5}, Lcom/join/mgps/dto/DownloadPointBase;->get_from_type()I

    move-result v5

    iget-object v6, p0, Lcom/join/mgps/adapter/SearchGameListAdapter$b;->c:Lcom/join/mgps/dto/CommonGameInfoBean;

    invoke-virtual {v6}, Lcom/join/mgps/dto/DownloadPointBase;->getReMarks()Ljava/lang/String;

    move-result-object v6

    iget-object v7, p0, Lcom/join/mgps/adapter/SearchGameListAdapter$b;->d:Lcom/join/mgps/adapter/SearchGameListAdapter;

    invoke-virtual {v7}, Lcom/join/mgps/adapter/SearchGameListAdapter;->O()Ljava/lang/String;

    move-result-object v7

    iget-object v8, p0, Lcom/join/mgps/adapter/SearchGameListAdapter$b;->d:Lcom/join/mgps/adapter/SearchGameListAdapter;

    invoke-virtual {v8}, Lcom/join/mgps/adapter/SearchGameListAdapter;->O()Ljava/lang/String;

    move-result-object v8

    iget-object v9, p0, Lcom/join/mgps/adapter/SearchGameListAdapter$b;->d:Lcom/join/mgps/adapter/SearchGameListAdapter;

    iget-object v10, p0, Lcom/join/mgps/adapter/SearchGameListAdapter$b;->c:Lcom/join/mgps/dto/CommonGameInfoBean;
