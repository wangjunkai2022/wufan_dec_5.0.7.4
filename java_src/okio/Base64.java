...
public final class Base64 {
    ...
    public static final String encodeBase64(@NotNull byte[] encodeBase64, @NotNull byte[] map) {
        ...
        while (i4 < length) {
            int i6 = i4 + 1;
            byte b5 = encodeBase64[i4];
            int i7 = i6 + 1;
            byte b6 = encodeBase64[i6];
            int i8 = i7 + 1;
            byte b7 = encodeBase64[i7];
            int i9 = i5 + 1;
            bArr[i5] = map[(b5 & 255) >> 2];
            int i10 = i9 + 1;
            bArr[i9] = map[((b5 & 3) << 4) | ((b6 & 255) >> 4)];
            int i11 = i10 + 1;
            bArr[i10] = map[((b6 & 15) << 2) | ((b7 & 255) >> 6)];
            i5 = i11 + 1;
            bArr[i11] = map[b7 & Utf8.REPLACEMENT_BYTE];
            i4 = i8;
        }
        ...
        if (length2 == 1) {
            ...
            int i14 = i4 + 1;
            byte b10 = encodeBase64[i4];
            byte b11 = encodeBase64[i14];
            int i15 = i5 + 1;
            bArr[i5] = map[(b10 & 255) >> 2];
            int i16 = i15 + 1;
            bArr[i15] = map[((b10 & 3) << 4) | ((b11 & 255) >> 4)];
            bArr[i16] = map[(b11 & 15) << 2];
            bArr[i16 + 1] = (byte) 61;
        }
