    ...
    */
    ...
    public long readHexadecimalUnsignedLong() {
        ...
        while (true) {
            ...
            b5 = this.bufferField.getByte(i4);
    ...
    public int readUtf8CodePoint() {
        require(1L);
        byte b5 = this.bufferField.getByte(0L);
        if ((b5 & 224) == 192) {
            require(2L);
        } else if ((b5 & 240) == 224) {
            require(3L);
    ...
    public String readUtf8LineStrict(long j4) {
        if (j4 >= 0) {
            ...
            if (j5 < Long.MAX_VALUE && request(j5) && this.bufferField.getByte(j5 - 1) == ((byte) 13) && request(1 + j5) && this.bufferField.getByte(j5) == b5) {
    ...
    public long indexOf(byte b5, long j4, long j5) {
        ...
        if (!this.closed) {
            ...
            while (j4 < j5) {
                long indexOf = this.bufferField.indexOf(b5, j4, j5);
                if (indexOf != -1) {
                    return indexOf;
                }
                long size = this.bufferField.size();
