...
public interface BufferedSource extends Source, ReadableByteChannel {
    ...
    long indexOf(byte b5, long j4) throws IOException;

    long indexOf(byte b5, long j4, long j5) throws IOException;
