...
public final class SegmentedByteString extends ByteString {
    ...
    public byte[] toByteArray() {
        ...
        while (i4 < length) {
            ...
            int i8 = getDirectory$okio()[i4];
            int i9 = i8 - i5;
            ArraysKt___ArraysJvmKt.copyInto(getSegments$okio()[i4], bArr, i6, i7, i7 + i9);
            i6 += i9;
            i4++;
            i5 = i8;
        }
