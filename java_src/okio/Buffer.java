...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    /* compiled from: Buffer.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\t\n\u0002\b\u0006\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0012\n\u0002\b\b\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u001d\u0010\u001eJ\u0006\u0010\u0003\u001a\u00020\u0002J\u000e\u0010\u0006\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004J\u000e\u0010\b\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0004J\u000e\u0010\n\u001a\u00020\u00042\u0006\u0010\t\u001a\u00020\u0002J\b\u0010\f\u001a\u00020\u000bH\u0016R\u0018\u0010\u000e\u001a\u0004\u0018\u00010\r8\u0006@\u0006X\u0087\u000e¢\u0006\u0006\n\u0004\b\u000e\u0010\u000fR\u0016\u0010\u0011\u001a\u00020\u00108\u0006@\u0006X\u0087\u000e¢\u0006\u0006\n\u0004\b\u0011\u0010\u0012R\u0018\u0010\u0014\u001a\u0004\u0018\u00010\u00138\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0014\u0010\u0015R\u0016\u0010\u0005\u001a\u00020\u00048\u0006@\u0006X\u0087\u000e¢\u0006\u0006\n\u0004\b\u0005\u0010\u0016R\u0018\u0010\u0018\u001a\u0004\u0018\u00010\u00178\u0006@\u0006X\u0087\u000e¢\u0006\u0006\n\u0004\b\u0018\u0010\u0019R\u0016\u0010\u001a\u001a\u00020\u00028\u0006@\u0006X\u0087\u000e¢\u0006\u0006\n\u0004\b\u001a\u0010\u001bR\u0016\u0010\u001c\u001a\u00020\u00028\u0006@\u0006X\u0087\u000e¢\u0006\u0006\n\u0004\b\u001c\u0010\u001b¨\u0006\u001f"}, d2 = {"Lokio/Buffer$UnsafeCursor;", "Ljava/io/Closeable;", "", "next", "", "offset", "seek", "newSize", "resizeBuffer", "minByteCount", "expandBuffer", "", "close", "Lokio/Buffer;", "buffer", "Lokio/Buffer;", "", "readWrite", "Z", "Lokio/Segment;", "segment", "Lokio/Segment;", "J", "", "data", "[B", "start", "I", "end", "<init>", "()V", "okio"}, k = 1, mv = {1, 4, 0})
    ...
    public final byte m1536deprecated_getByte(long j4) {
        return getByte(j4);
    }
    ...
    public final long m1537deprecated_size() {
        return this.size;
    }
    ...
    */
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        if (size() != 0) {
            ...
            throw new EOFException("size < " + i5 + ": " + size() + " (to read code point prefixed 0x" + Util.toHexString(b5) + ')');
        }
        throw new EOFException();
    }
    ...
    public String readUtf8LineStrict(long j4) throws EOFException {
        if (j4 >= 0) {
            ...
            if (j5 < size() && getByte(j5 - 1) == ((byte) 13) && getByte(j5) == b5) {
    ...
    public Buffer writeDecimalLong(long j4) {
        ...
        } else if (j4 >= com.join.mgps.data.c.f49010a) {
    ...
    private final void readFrom(InputStream inputStream, long j4, boolean z4) throws IOException {
        while (true) {
            if (j4 <= 0 && !z4) {
                return;
            }
    ...
    public Buffer write(@NotNull byte[] source, int i4, int i5) {
        ...
        while (i4 < i6) {
            ...
            int i7 = i4 + min;
            ArraysKt.copyInto(source, writableSegment$okio.data, writableSegment$okio.limit, i4, i7);
            writableSegment$okio.limit += min;
            i4 = i7;
        }
                    ...
                    if (size() - j5 < j5) {
                        ...
                        while (size < size3) {
                            ...
                            for (int i4 = (int) ((segment.pos + j5) - j7); i4 < min; i4++) {
                                if (bArr[i4] == b5 && BufferKt.rangeEquals(segment, i4 + 1, internalArray$okio, 1, size2)) {
                        ...
                        while (j6 < size5) {
                            ...
                            for (int i5 = (int) ((segment.pos + j5) - j6); i5 < min2; i5++) {
                                if (bArr2[i5] == b6 && BufferKt.rangeEquals(segment, i5 + 1, internalArray$okio2, 1, size4)) {
