...
public final class FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1<T> implements e<T> {
    ...
    final /* synthetic */ e f70602b;

    /* renamed from: c  reason: collision with root package name */
    final /* synthetic */ Function2 f70603c;
    ...
    public static final class AnonymousClass2<T> implements f, SuspendFunction {
        ...
        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ f f70607b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ Function2 f70608c;

        /* compiled from: Emitters.kt */
        @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1$2", f = "Transform.kt", i = {0, 0}, l = {Opcodes.XOR_INT_LIT8, Opcodes.XOR_INT_LIT8}, m = "emit", n = {"value", "$this$filterNot_u24lambda_u2d1"}, s = {"L$0", "L$1"})
        ...
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                this.f70609b = obj;
                this.f70610c |= Integer.MIN_VALUE;
        ...
        public final Object a(Object obj, @NotNull Continuation continuation) {
            ...
            InlineMarker.mark(5);
            f fVar = this.f70607b;
            if (!((Boolean) this.f70608c.invoke(obj, continuation)).booleanValue()) {
                InlineMarker.mark(0);
        ...
        */
        public final java.lang.Object emit(T r7, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
            ...
            L13:
                ...
                r0.<init>(r8)
            L18:
                java.lang.Object r8 = r0.f70609b
            ...
            L2c:
                ...
                throw r7
            L34:
                java.lang.Object r7 = r0.f70613f
                kotlinx.coroutines.flow.f r7 = (kotlinx.coroutines.flow.f) r7
                java.lang.Object r2 = r0.f70612e
                kotlin.ResultKt.throwOnFailure(r8)
                goto L56
            L3e:
                kotlin.ResultKt.throwOnFailure(r8)
                kotlinx.coroutines.flow.f r8 = r6.f70607b
                kotlin.jvm.functions.Function2 r2 = r6.f70608c
                r0.f70612e = r7
                r0.f70613f = r8
                r0.f70610c = r4
    ...
    public FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1(e eVar, Function2 function2) {
        this.f70602b = eVar;
        this.f70603c = function2;
    }
    ...
    public Object a(@NotNull f fVar, @NotNull Continuation continuation) {
        ...
        Object a5 = this.f70602b.a(new AnonymousClass2(fVar, this.f70603c), continuation);
    ...
    public Object g(@NotNull f fVar, @NotNull Continuation continuation) {
        ...
        new ContinuationImpl(continuation) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1.1
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                this.f70604b = obj;
                this.f70605c |= Integer.MIN_VALUE;
                return FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1.this.a(null, this);
            }
        };
        InlineMarker.mark(5);
        e eVar = this.f70602b;
        AnonymousClass2 anonymousClass2 = new AnonymousClass2(fVar, this.f70603c);
        InlineMarker.mark(0);
