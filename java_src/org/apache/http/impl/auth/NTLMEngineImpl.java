...
public final class NTLMEngineImpl implements NTLMEngine {
    ...
    public static class MD4 {
        ...
        byte[] getOutput() {
            int i4 = (int) (this.count & 63);
            int i5 = i4 < 56 ? 56 - i4 : 120 - i4;
            byte[] bArr = new byte[i5 + 8];
            bArr[0] = Byte.MIN_VALUE;
            for (int i6 = 0; i6 < 8; i6++) {
                bArr[i5 + i6] = (byte) ((this.count * 8) >>> (i6 * 8));
            }
            update(bArr);
    ...
    public static class Type1Message extends NTLMMessage {
        ...
        Type1Message(String str, String str2) throws NTLMEngineException {
            try {
                ...
                throw new NTLMEngineException("Unicode unsupported: " + e5.getMessage(), e5);
            }
        }
    ...
    public static class Type3Message extends NTLMMessage {
        ...
        Type3Message(String str, String str2, String str3, String str4, byte[] bArr, int i4, String str5, byte[] bArr2) throws NTLMEngineException {
            ...
            if (convertHost != null) {
                try {
                    ...
                    throw new NTLMEngineException("Unicode not supported: " + e5.getMessage(), e5);
                }
            } else {
                bytes = null;
            }
        ...
        String getResponse() {
            ...
            addULong((i9 & 4) | (i9 & 128) | (i9 & 512) | (524288 & i9) | NTLMEngineImpl.FLAG_REQUEST_VERSION | (32768 & i9) | (i9 & 32) | (i9 & 16) | (NTLMEngineImpl.FLAG_REQUEST_128BIT_KEY_EXCH & i9) | (Integer.MIN_VALUE & i9) | (1073741824 & i9) | (8388608 & i9) | (i9 & 1));
            addUShort(261);
            addULong(2600);
            addUShort(3840);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static Key createDESKey(byte[] bArr, int i4) {
    ...
    public static byte[] lmHash(String str) throws NTLMEngineException {
        try {
            byte[] bytes = str.toUpperCase(Locale.ENGLISH).getBytes(a.f4994b);
            byte[] bArr = new byte[14];
            System.arraycopy(bytes, 0, bArr, 0, Math.min(bytes.length, 14));
            Key createDESKey = createDESKey(bArr, 0);
            Key createDESKey2 = createDESKey(bArr, 7);
            byte[] bytes2 = "KGS!@#$%".getBytes(a.f4994b);
    ...
    private static void oddParity(byte[] bArr) {
        for (int i4 = 0; i4 < bArr.length; i4++) {
            byte b5 = bArr[i4];
            if ((((b5 >>> 1) ^ ((((((b5 >>> 7) ^ (b5 >>> 6)) ^ (b5 >>> 5)) ^ (b5 >>> 4)) ^ (b5 >>> 3)) ^ (b5 >>> 2))) & 1) == 0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static byte[] readSecurityBuffer(byte[] bArr, int i4) throws NTLMEngineException {
        int readUShort = readUShort(bArr, i4);
        int readULong = readULong(bArr, i4 + 4);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static int readULong(byte[] bArr, int i4) throws NTLMEngineException {
        if (bArr.length >= i4 + 4) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static int readUShort(byte[] bArr, int i4) throws NTLMEngineException {
        if (bArr.length >= i4 + 2) {
    ...
    static int rotintlft(int i4, int i5) {
    ...
    private static String stripDotSuffix(String str) {
        ...
        int indexOf = str.indexOf(h0.f27805a);
        return indexOf != -1 ? str.substring(0, indexOf) : str;
    }

    static void writeULong(byte[] bArr, int i4, int i5) {
        bArr[i5] = (byte) (i4 & 255);
    ...
    String getType3Message(String str, String str2, String str3, String str4, byte[] bArr, int i4, String str5, byte[] bArr2) throws NTLMEngineException {
        return new Type3Message(str4, str3, str, str2, bArr, i4, str5, bArr2).getResponse();
    }
    ...
    public static class NTLMMessage {
        ...
        protected void addByte(byte b5) {
            ...
            int i4 = this.currentOutputPosition;
            bArr[i4] = b5;
            this.currentOutputPosition = i4 + 1;
        }
        ...
        protected void addULong(int i4) {
            addByte((byte) (i4 & 255));
            addByte((byte) ((i4 >> 8) & 255));
            addByte((byte) ((i4 >> 16) & 255));
            addByte((byte) ((i4 >> 24) & 255));
        }

        protected void addUShort(int i4) {
            addByte((byte) (i4 & 255));
            addByte((byte) ((i4 >> 8) & 255));
        }
        ...
        protected void prepareResponse(int i4, int i5) {
            this.messageContents = new byte[i4];
            this.currentOutputPosition = 0;
            addBytes(NTLMEngineImpl.SIGNATURE);
            addULong(i5);
        }

        protected byte readByte(int i4) throws NTLMEngineException {
            byte[] bArr = this.messageContents;
            if (bArr.length >= i4 + 1) {
                return bArr[i4];
            }
        ...
        protected void readBytes(byte[] bArr, int i4) throws NTLMEngineException {
            byte[] bArr2 = this.messageContents;
        ...
        protected byte[] readSecurityBuffer(int i4) throws NTLMEngineException {
            return NTLMEngineImpl.readSecurityBuffer(this.messageContents, i4);
        }

        protected int readULong(int i4) throws NTLMEngineException {
            return NTLMEngineImpl.readULong(this.messageContents, i4);
        }

        protected int readUShort(int i4) throws NTLMEngineException {
            return NTLMEngineImpl.readUShort(this.messageContents, i4);
        }

        NTLMMessage(String str, int i4) throws NTLMEngineException {
            this.messageContents = null;
            this.currentOutputPosition = 0;
            ...
            if (decode.length >= NTLMEngineImpl.SIGNATURE.length) {
                ...
                throw new NTLMEngineException("NTLM type " + Integer.toString(i4) + " message expected - instead got type " + Integer.toString(readULong));
            }
    ...
    protected static class CipherGen {
        ...
        public byte[] getTimestamp() {
            if (this.timestamp == null) {
                long currentTimeMillis = (System.currentTimeMillis() + 11644473600000L) * c.f49010a;
