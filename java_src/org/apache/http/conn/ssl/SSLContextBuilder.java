            ...
            if (trustStrategy != null) {
                for (int i4 = 0; i4 < trustManagers.length; i4++) {
                    ...
                    if (trustManager instanceof X509TrustManager) {
                        trustManagers[i4] = new TrustManagerDelegate((X509TrustManager) trustManager, trustStrategy);
                    }
                }
            }
        ...
        if (keyManagers != null) {
            if (privateKeyStrategy != null) {
                for (int i4 = 0; i4 < keyManagers.length; i4++) {
                    KeyManager keyManager = keyManagers[i4];
                    if (keyManager instanceof X509KeyManager) {
                        keyManagers[i4] = new KeyManagerDelegate((X509KeyManager) keyManager, privateKeyStrategy);
                    }
                }
            }
