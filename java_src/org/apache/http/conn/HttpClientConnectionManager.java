...
public interface HttpClientConnectionManager {
    ...
    void connect(HttpClientConnection httpClientConnection, HttpRoute httpRoute, int i4, HttpContext httpContext) throws IOException;

    void releaseConnection(HttpClientConnection httpClientConnection, Object obj, long j4, TimeUnit timeUnit);
