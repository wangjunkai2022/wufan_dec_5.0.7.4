...
final class LifecycleCoroutineScope$launchWhenResumed$1 extends SuspendLambda implements Function2<q0, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(q0 q0Var, Continuation<? super Unit> continuation) {
        return ((LifecycleCoroutineScope$launchWhenResumed$1) create(q0Var, continuation)).invokeSuspend(Unit.INSTANCE);
    }
