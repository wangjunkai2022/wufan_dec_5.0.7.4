...
public class ViewModelProvider {
    ...
    public /* synthetic */ ViewModelProvider(ViewModelStore viewModelStore, Factory factory, CreationExtras creationExtras, int i4, DefaultConstructorMarker defaultConstructorMarker) {
