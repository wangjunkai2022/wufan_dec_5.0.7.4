...
public final class LifecycleCoroutineScopeImpl$register$1 extends SuspendLambda implements Function2<q0, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(q0 q0Var, Continuation<? super Unit> continuation) {
        return ((LifecycleCoroutineScopeImpl$register$1) create(q0Var, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            if (this.this$0.getLifecycle$lifecycle_runtime_ktx_release().getCurrentState().compareTo(Lifecycle.State.INITIALIZED) < 0) {
                e2.i(q0Var.getCoroutineContext(), null, 1, null);
            } else {
