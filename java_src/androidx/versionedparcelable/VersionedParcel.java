...
public abstract class VersionedParcel {
    ...
    private <T, S extends Collection<T>> S readCollection(S s4) {
        int readInt = readInt();
        if (readInt < 0) {
            return null;
        }
        if (readInt != 0) {
            ...
            if (readInt2 == 1) {
                while (readInt > 0) {
                    s4.add(readVersionedParcelable());
                    readInt--;
                }
            } else if (readInt2 == 2) {
                while (readInt > 0) {
    ...
    public boolean readBoolean(boolean z4, int i4) {
        return !readField(i4) ? z4 : readBoolean();
    }
    ...
    public byte readByte(byte b5, int i4) {
        return !readField(i4) ? b5 : (byte) (readInt() & 255);
    }
    ...
    public double readDouble(double d5, int i4) {
        return !readField(i4) ? d5 : readDouble();
    }
    ...
    public float readFloat(float f5, int i4) {
        return !readField(i4) ? f5 : readFloat();
    }
    ...
    public <T extends Parcelable> T readParcelable(T t4, int i4) {
        return !readField(i4) ? t4 : (T) readParcelable();
    }
    ...
    public <T extends VersionedParcelable> T readVersionedParcelable(T t4, int i4) {
        return !readField(i4) ? t4 : (T) readVersionedParcelable();
    }
    ...
    public void writeBoolean(boolean z4, int i4) {
        setOutputField(i4);
        writeBoolean(z4);
    }
    ...
    public void writeByte(byte b5, int i4) {
        setOutputField(i4);
        writeInt(b5);
    }
    ...
    public void writeDouble(double d5, int i4) {
        setOutputField(i4);
        writeDouble(d5);
    }
    ...
    public void writeFloat(float f5, int i4) {
        setOutputField(i4);
        writeFloat(f5);
    }
    ...
    protected <T extends VersionedParcelable> void writeToParcel(T t4, VersionedParcel versionedParcel) {
        try {
