...
public class LruCache<K, V> {
    ...
    private int safeSizeOf(K k4, V v2) {
        int sizeOf = sizeOf(k4, v2);
        if (sizeOf >= 0) {
            return sizeOf;
        }
        throw new IllegalStateException("Negative size: " + k4 + SimpleComparison.EQUAL_TO_OPERATION + v2);
    }
    ...
    protected void entryRemoved(boolean z4, @NonNull K k4, @NonNull V v2, @Nullable V v4) {
    }
    ...
    @Nullable
    public final V put(@NonNull K k4, @NonNull V v2) {
        V put;
        if (k4 != null && v2 != null) {
            synchronized (this) {
                this.putCount++;
                this.size += safeSizeOf(k4, v2);
                put = this.map.put(k4, v2);
                if (put != null) {
                    this.size -= safeSizeOf(k4, put);
                }
            }
            if (put != null) {
                entryRemoved(false, k4, put, v2);
            }
            trimToSize(this.maxSize);
            return put;
        }
    ...
    protected int sizeOf(@NonNull K k4, @NonNull V v2) {
        return 1;
    }
