...
public final class LruCacheKt$lruCache$4<K, V> extends LruCache<K, V> {
    ...
    public LruCacheKt$lruCache$4(Function2 function2, Function1 function1, Function4 function4, int i4, int i5) {
        super(i5);
    ...
    protected V create(@NotNull K k4) {
        return (V) this.$create.invoke(k4);
    }

    @Override // androidx.collection.LruCache
    protected void entryRemoved(boolean z4, @NotNull K k4, @NotNull V v2, @Nullable V v4) {
        this.$onEntryRemoved.invoke(Boolean.valueOf(z4), k4, v2, v4);
    }

    @Override // androidx.collection.LruCache
    protected int sizeOf(@NotNull K k4, @NotNull V v2) {
        return ((Number) this.$sizeOf.invoke(k4, v2)).intValue();
    }
}
