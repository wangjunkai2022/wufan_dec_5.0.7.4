...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    */
    ...
    private boolean scrollAndFocus(int i4, int i5, int i6) {
        ...
        boolean z4 = false;
        boolean z5 = i4 == 33;
        View findFocusableViewInBounds = findFocusableViewInBounds(z5, i5, i6);
        if (findFocusableViewInBounds == null) {
            findFocusableViewInBounds = this;
        }
        if (i5 < scrollY || i6 > i7) {
            doScrollY(z5 ? i5 - scrollY : i6 - i7);
            z4 = true;
        }
    ...
    private boolean scrollToChildRect(Rect rect, boolean z4) {
        ...
        boolean z5 = computeScrollDeltaToGetChildRectOnScreen != 0;
        if (z5) {
            if (z4) {
                scrollBy(0, computeScrollDeltaToGetChildRectOnScreen);
            } else {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (!this.mEdgeGlowTop.isFinished()) {
            ...
            if (i5 < 21 || Api21Impl.getClipToPadding(this)) {
        ...
        if (i6 < 21 || Api21Impl.getClipToPadding(this)) {
    ...
    @Override // android.view.ViewGroup
    protected void measureChild(@NonNull View view, int i4, int i5) {
    ...
    */
    ...
    void smoothScrollTo(int i4, int i5, boolean z4) {
        smoothScrollTo(i4, i5, 250, z4);
    }
    ...
    void smoothScrollTo(int i4, int i5, int i6, boolean z4) {
