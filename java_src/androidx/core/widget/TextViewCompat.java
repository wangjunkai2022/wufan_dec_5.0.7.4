...
public final class TextViewCompat {
    ...
    public static class Api17Impl {
        ...
        @DoNotInline
        static void setCompoundDrawablesRelativeWithIntrinsicBounds(TextView textView, int i4, int i5, int i6, int i7) {
    ...
    public static Drawable[] getCompoundDrawablesRelative(@NonNull TextView textView) {
        ...
        if (i4 >= 17) {
            boolean z4 = Api17Impl.getLayoutDirection(textView) == 1;
    ...
    public static void setAutoSizeTextTypeUniformWithConfiguration(@NonNull TextView textView, int i4, int i5, int i6, int i7) throws IllegalArgumentException {
        if (Build.VERSION.SDK_INT >= 27) {
            Api26Impl.setAutoSizeTextTypeUniformWithConfiguration(textView, i4, i5, i6, i7);
    ...
    public static void setFirstBaselineToTopHeight(@NonNull TextView textView, @IntRange(from = 0) @Px int i4) {
        ...
        if (i6 >= 16 && !Api16Impl.getIncludeFontPadding(textView)) {
    ...
    public static void setCompoundDrawablesRelativeWithIntrinsicBounds(@NonNull TextView textView, @DrawableRes int i4, @DrawableRes int i5, @DrawableRes int i6, @DrawableRes int i7) {
        ...
        if (i8 >= 18) {
            Api17Impl.setCompoundDrawablesRelativeWithIntrinsicBounds(textView, i4, i5, i6, i7);
        } else if (i8 >= 17) {
            boolean z4 = Api17Impl.getLayoutDirection(textView) == 1;
            int i9 = z4 ? i6 : i4;
            if (!z4) {
            ...
            textView.setCompoundDrawablesWithIntrinsicBounds(i9, i5, i4, i7);
        } else {
