...
public class BuildCompat {
    ...
    public static boolean isAtLeastS() {
        ...
        return i4 >= 31 || (i4 >= 30 && isAtLeastPreReleaseCodename("S", Build.VERSION.CODENAME));
    }
    ...
    public static boolean isAtLeastSv2() {
        int i4 = Build.VERSION.SDK_INT;
        return i4 >= 32 || (i4 >= 31 && isAtLeastPreReleaseCodename("Sv2", Build.VERSION.CODENAME));
    }
    ...
    public static boolean isAtLeastT() {
        int i4 = Build.VERSION.SDK_INT;
        return i4 >= 33 || (i4 >= 32 && isAtLeastPreReleaseCodename("Tiramisu", Build.VERSION.CODENAME));
    }
