...
public class WindowInsetsCompat {
    ...
    public static class BuilderImpl {
        ...
        void setInsets(int i4, @NonNull Insets insets) {
        ...
        void setInsetsIgnoringVisibility(int i4, @NonNull Insets insets) {
            if (i4 == 8) {
        ...
        void setVisible(int i4, boolean z4) {
        }
    ...
    private static class BuilderImpl30 extends BuilderImpl29 {
        ...
        void setInsets(int i4, @NonNull Insets insets) {
            this.mPlatBuilder.setInsets(TypeImpl30.toPlatformType(i4), insets.toPlatformInsets());
        }

        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        void setInsetsIgnoringVisibility(int i4, @NonNull Insets insets) {
            this.mPlatBuilder.setInsetsIgnoringVisibility(TypeImpl30.toPlatformType(i4), insets.toPlatformInsets());
        }

        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        void setVisible(int i4, boolean z4) {
            this.mPlatBuilder.setVisible(TypeImpl30.toPlatformType(i4), z4);
        }
    ...
    public static class Impl {
        ...
        @NonNull
        Insets getInsets(int i4) {
            return Insets.NONE;
        }

        @NonNull
        Insets getInsetsIgnoringVisibility(int i4) {
            if ((i4 & 8) == 0) {
                return Insets.NONE;
            }
    ...
    public static class Impl20 extends Impl {
        ...
        @Override // androidx.core.view.WindowInsetsCompat.Impl
        @NonNull
        public Insets getInsets(int i4) {
            return getInsets(i4, false);
        }

        @NonNull
        protected Insets getInsetsForType(int i4, boolean z4) {
            Insets stableInsets;
            int i5;
            ...
            if (i4 == 2) {
                ...
                return Insets.of(systemWindowInsets.left, 0, systemWindowInsets.right, i6);
            } else if (i4 != 8) {
                if (i4 != 16) {
                    if (i4 != 32) {
                        if (i4 != 64) {
                ...
                if (insets != null && !insets.equals(Insets.NONE) && (i5 = this.mRootViewVisibleInsets.bottom) > rootStableInsets2.bottom) {
        ...
        @Override // androidx.core.view.WindowInsetsCompat.Impl
        @NonNull
        public Insets getInsetsIgnoringVisibility(int i4) {
        ...
        protected boolean isTypeVisible(int i4) {
            if (i4 != 1 && i4 != 2) {
                if (i4 == 4) {
                    return false;
                }
            ...
            return !getInsetsForType(i4, false).equals(Insets.NONE);
        }
        ...
        @NonNull
        @SuppressLint({"WrongConstant"})
        private Insets getInsets(int i4, boolean z4) {
            Insets insets = Insets.NONE;
            for (int i5 = 1; i5 <= 256; i5 <<= 1) {
                if ((i4 & i5) != 0) {
                    insets = Insets.max(insets, getInsetsForType(i5, z4));
                }
            }
            return insets;
        }
    ...
    private static class Impl30 extends Impl29 {
        ...
        @NonNull
        public Insets getInsets(int i4) {
            return Insets.toCompatInsets(this.mPlatformInsets.getInsets(TypeImpl30.toPlatformType(i4)));
        }

        @Override // androidx.core.view.WindowInsetsCompat.Impl20, androidx.core.view.WindowInsetsCompat.Impl
        @NonNull
        public Insets getInsetsIgnoringVisibility(int i4) {
            return Insets.toCompatInsets(this.mPlatformInsets.getInsetsIgnoringVisibility(TypeImpl30.toPlatformType(i4)));
        }

        @Override // androidx.core.view.WindowInsetsCompat.Impl20, androidx.core.view.WindowInsetsCompat.Impl
        public boolean isVisible(int i4) {
            return this.mPlatformInsets.isVisible(TypeImpl30.toPlatformType(i4));
        }
    ...
    private static final class TypeImpl30 {
        ...
        static int toPlatformType(int i4) {
            int statusBars;
            int i5 = 0;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Insets insetInsets(@NonNull Insets insets, int i4, int i5, int i6, int i7) {
    ...
    @NonNull
    public Insets getInsets(int i4) {
        return this.mImpl.getInsets(i4);
    }

    @NonNull
    public Insets getInsetsIgnoringVisibility(int i4) {
        return this.mImpl.getInsetsIgnoringVisibility(i4);
    }
    ...
    public boolean isVisible(int i4) {
        return this.mImpl.isVisible(i4);
    }
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setInsets(int i4, @NonNull Insets insets) {
            this.mImpl.setInsets(i4, insets);
            return this;
        }

        @NonNull
        public Builder setInsetsIgnoringVisibility(int i4, @NonNull Insets insets) {
            this.mImpl.setInsetsIgnoringVisibility(i4, insets);
            return this;
        }
        ...
        @NonNull
        public Builder setVisible(int i4, boolean z4) {
