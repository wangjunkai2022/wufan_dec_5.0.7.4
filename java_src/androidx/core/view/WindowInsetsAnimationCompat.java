...
public final class WindowInsetsAnimationCompat {
    ...
    public static class Impl {
        ...
        Impl(int i4, @Nullable Interpolator interpolator, long j4) {
            this.mTypeMask = i4;
    ...
    public static class Impl21 extends Impl {
        ...
        @NonNull
        static BoundsCompat computeAnimationBounds(@NonNull WindowInsetsCompat windowInsetsCompat, @NonNull WindowInsetsCompat windowInsetsCompat2, int i4) {
        ...
        static void dispatchOnStart(View view, WindowInsetsAnimationCompat windowInsetsAnimationCompat, BoundsCompat boundsCompat) {
            ...
            if (view instanceof ViewGroup) {
                ViewGroup viewGroup = (ViewGroup) view;
                for (int i4 = 0; i4 < viewGroup.getChildCount(); i4++) {
                    dispatchOnStart(viewGroup.getChildAt(i4), windowInsetsAnimationCompat, boundsCompat);
                }
            }
        }
        ...
        @SuppressLint({"WrongConstant"})
        static WindowInsetsCompat interpolateInsets(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, float f5, int i4) {
            ...
            for (int i5 = 1; i5 <= 256; i5 <<= 1) {
                if ((i4 & i5) == 0) {
                    ...
                    float f6 = 1.0f - f5;
                    double d5 = (insets.left - insets2.left) * f6;
                    Double.isNaN(d5);
                    int i6 = (int) (d5 + 0.5d);
                    double d6 = (insets.top - insets2.top) * f6;
                    Double.isNaN(d6);
                    double d7 = (insets.right - insets2.right) * f6;
                    Double.isNaN(d7);
                    int i7 = (int) (d7 + 0.5d);
                    double d8 = (insets.bottom - insets2.bottom) * f6;
                    Double.isNaN(d8);
                    builder.setInsets(i5, WindowInsetsCompat.insetInsets(insets, i6, (int) (d6 + 0.5d), i7, (int) (d8 + 0.5d)));
                }
            }
    ...
    public WindowInsetsAnimationCompat(int i4, @Nullable Interpolator interpolator, long j4) {
        ...
        if (i5 >= 30) {
            this.mImpl = new Impl30(i4, interpolator, j4);
        } else if (i5 >= 21) {
            this.mImpl = new Impl21(i4, interpolator, j4);
        } else {
            this.mImpl = new Impl(0, interpolator, j4);
        }
    }
