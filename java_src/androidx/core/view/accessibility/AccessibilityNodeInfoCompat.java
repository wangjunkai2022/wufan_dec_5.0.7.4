...
public class AccessibilityNodeInfoCompat {
    ...
    public static class RangeInfoCompat {
        ...
        public static RangeInfoCompat obtain(int i4, float f5, float f6, float f7) {
            if (Build.VERSION.SDK_INT >= 19) {
                return new RangeInfoCompat(AccessibilityNodeInfo.RangeInfo.obtain(i4, f5, f6, f7));
            }
    ...
    public static class CollectionInfoCompat {
        ...
        public static CollectionInfoCompat obtain(int i4, int i5, boolean z4, int i6) {
            int i7 = Build.VERSION.SDK_INT;
            if (i7 >= 21) {
                return new CollectionInfoCompat(AccessibilityNodeInfo.CollectionInfo.obtain(i4, i5, z4, i6));
            }
            if (i7 >= 19) {
                return new CollectionInfoCompat(AccessibilityNodeInfo.CollectionInfo.obtain(i4, i5, z4));
            }
        ...
        public static CollectionInfoCompat obtain(int i4, int i5, boolean z4) {
            if (Build.VERSION.SDK_INT >= 19) {
                return new CollectionInfoCompat(AccessibilityNodeInfo.CollectionInfo.obtain(i4, i5, z4));
            }
            return new CollectionInfoCompat(null);
    ...
    public static class CollectionItemInfoCompat {
        ...
        public static CollectionItemInfoCompat obtain(int i4, int i5, int i6, int i7, boolean z4, boolean z5) {
            int i8 = Build.VERSION.SDK_INT;
            if (i8 >= 21) {
                return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(i4, i5, i6, i7, z4, z5));
            }
            if (i8 >= 19) {
                return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(i4, i5, i6, i7, z4));
            }
        ...
        public static CollectionItemInfoCompat obtain(int i4, int i5, int i6, int i7, boolean z4) {
            if (Build.VERSION.SDK_INT >= 19) {
                return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(i4, i5, i6, i7, z4));
            }
            return new CollectionItemInfoCompat(null);
