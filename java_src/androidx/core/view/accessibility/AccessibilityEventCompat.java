...
public final class AccessibilityEventCompat {
    ...
    static class Api16Impl {
        ...
        @DoNotInline
        static void setAction(AccessibilityEvent accessibilityEvent, int i4) {
            accessibilityEvent.setAction(i4);
        }

        @DoNotInline
        static void setMovementGranularity(AccessibilityEvent accessibilityEvent, int i4) {
    ...
    public static void setAction(@NonNull AccessibilityEvent accessibilityEvent, int i4) {
        if (Build.VERSION.SDK_INT >= 16) {
            Api16Impl.setAction(accessibilityEvent, i4);
        }
    }

    public static void setContentChangeTypes(@NonNull AccessibilityEvent accessibilityEvent, int i4) {
        if (Build.VERSION.SDK_INT >= 19) {
            Api19Impl.setContentChangeTypes(accessibilityEvent, i4);
        }
    }

    public static void setMovementGranularity(@NonNull AccessibilityEvent accessibilityEvent, int i4) {
        if (Build.VERSION.SDK_INT >= 16) {
            Api16Impl.setMovementGranularity(accessibilityEvent, i4);
        }
    }
}
