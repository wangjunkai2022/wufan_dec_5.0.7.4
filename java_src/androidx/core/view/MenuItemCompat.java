...
public final class MenuItemCompat {
    ...
    static class Api26Impl {
        ...
        @DoNotInline
        static MenuItem setAlphabeticShortcut(MenuItem menuItem, char c5, int i4) {
            return menuItem.setAlphabeticShortcut(c5, i4);
        }
        ...
        @DoNotInline
        static MenuItem setNumericShortcut(MenuItem menuItem, char c5, int i4) {
            return menuItem.setNumericShortcut(c5, i4);
        }

        @DoNotInline
        static MenuItem setShortcut(MenuItem menuItem, char c5, char c6, int i4, int i5) {
            return menuItem.setShortcut(c5, c6, i4, i5);
        }
    ...
    public static void setAlphabeticShortcut(@NonNull MenuItem menuItem, char c5, int i4) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setAlphabeticShortcut(c5, i4);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setAlphabeticShortcut(menuItem, c5, i4);
        }
    }
    ...
    public static void setNumericShortcut(@NonNull MenuItem menuItem, char c5, int i4) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setNumericShortcut(c5, i4);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setNumericShortcut(menuItem, c5, i4);
        }
    }
    ...
    public static void setShortcut(@NonNull MenuItem menuItem, char c5, char c6, int i4, int i5) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setShortcut(c5, c6, i4, i5);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setShortcut(menuItem, c5, c6, i4, i5);
        }
    }
