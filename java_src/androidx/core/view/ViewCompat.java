...
public class ViewCompat {
    ...
    public static abstract class AccessibilityViewProperty<T> {
        ...
        abstract void frameworkSet(View view, T t4);
        ...
        boolean shouldUpdate(T t4, T t5) {
            return !t5.equals(t4);
        }
    ...
    public static class Api16Impl {
        ...
        @DoNotInline
        static void setHasTransientState(View view, boolean z4) {
        ...
        @DoNotInline
        static void postInvalidateOnAnimation(View view, int i4, int i5, int i6, int i7) {
    ...
    static class Api17Impl {
        ...
        @DoNotInline
        static void setPaddingRelative(View view, int i4, int i5, int i6, int i7) {
    ...
    public static class Api21Impl {
        ...
        @DoNotInline
        static boolean dispatchNestedPreScroll(View view, int i4, int i5, int[] iArr, int[] iArr2) {
            return view.dispatchNestedPreScroll(i4, i5, iArr, iArr2);
        }

        @DoNotInline
        static boolean dispatchNestedScroll(View view, int i4, int i5, int i6, int i7, int[] iArr) {
    ...
    private static class Api23Impl {
        ...
        @DoNotInline
        static void setScrollIndicators(@NonNull View view, int i4, int i5) {
    ...
    public static boolean dispatchNestedFling(@NonNull View view, float f5, float f6, boolean z4) {
        ...
        if (view instanceof NestedScrollingChild) {
            return ((NestedScrollingChild) view).dispatchNestedFling(f5, f6, z4);
        }
        return false;
    }
    ...
    public static boolean dispatchNestedPreFling(@NonNull View view, float f5, float f6) {
        ...
        if (view instanceof NestedScrollingChild) {
            return ((NestedScrollingChild) view).dispatchNestedPreFling(f5, f6);
        }
        return false;
    }
    ...
    public static boolean dispatchNestedPreScroll(@NonNull View view, int i4, int i5, @Nullable int[] iArr, @Nullable int[] iArr2) {
        if (Build.VERSION.SDK_INT >= 21) {
            return Api21Impl.dispatchNestedPreScroll(view, i4, i5, iArr, iArr2);
        }
        if (view instanceof NestedScrollingChild) {
    ...
    public static boolean dispatchNestedScroll(@NonNull View view, int i4, int i5, int i6, int i7, @Nullable int[] iArr) {
        if (Build.VERSION.SDK_INT >= 21) {
            return Api21Impl.dispatchNestedScroll(view, i4, i5, i6, i7, iArr);
        }
        if (view instanceof NestedScrollingChild) {
    ...
    public static void setBackgroundTintList(@NonNull View view, @Nullable ColorStateList colorStateList) {
        ...
        if (i4 >= 21) {
            ...
            if (i4 == 21) {
                ...
                boolean z4 = (Api21Impl.getBackgroundTintList(view) == null && Api21Impl.getBackgroundTintMode(view) == null) ? false : true;
    ...
    public static void setHasTransientState(@NonNull View view, boolean z4) {
        if (Build.VERSION.SDK_INT >= 16) {
            Api16Impl.setHasTransientState(view, z4);
        }
    }
    ...
    public static void setNestedScrollingEnabled(@NonNull View view, boolean z4) {
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            ((NestedScrollingChild) view).setNestedScrollingEnabled(z4);
        }
    }
    ...
    public static void setOnReceiveContentListener(@NonNull View view, @Nullable String[] strArr, @Nullable OnReceiveContentListener onReceiveContentListener) {
        ...
        if (strArr != null) {
            ...
            while (true) {
                if (i4 >= length) {
                    break;
                } else if (strArr[i4].startsWith(WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD)) {
                    z4 = true;
                    break;
                } else {
                    i4++;
    ...
    public static void setPaddingRelative(@NonNull View view, @Px int i4, @Px int i5, @Px int i6, @Px int i7) {
        if (Build.VERSION.SDK_INT >= 17) {
            Api17Impl.setPaddingRelative(view, i4, i5, i6, i7);
        } else {
    ...
    public static void setScrollIndicators(@NonNull View view, int i4, int i5) {
        if (Build.VERSION.SDK_INT >= 23) {
            Api23Impl.setScrollIndicators(view, i4, i5);
        }
    }
    ...
    public static void postInvalidateOnAnimation(@NonNull View view, int i4, int i5, int i6, int i7) {
        if (Build.VERSION.SDK_INT >= 16) {
            Api16Impl.postInvalidateOnAnimation(view, i4, i5, i6, i7);
        } else {
