...
public final class PointerIconCompat {
    ...
    @NonNull
    public static PointerIconCompat getSystemIcon(@NonNull Context context, int i4) {
        if (Build.VERSION.SDK_INT >= 24) {
            return new PointerIconCompat(Api24Impl.getSystemIcon(context, i4));
        }
        return new PointerIconCompat(null);
    }

    @NonNull
    public static PointerIconCompat load(@NonNull Resources resources, int i4) {
        if (Build.VERSION.SDK_INT >= 24) {
            return new PointerIconCompat(Api24Impl.load(resources, i4));
        }
        return new PointerIconCompat(null);
    }
