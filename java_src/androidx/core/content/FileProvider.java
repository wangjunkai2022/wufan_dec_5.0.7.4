...
public class FileProvider extends ContentProvider {
    ...
    private static final File DEVICE_ROOT = new File(e.F0);
    @GuardedBy("sCache")
        ...
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                if (entry != null) {
                    ...
                    return new Uri.Builder().scheme("content").authority(this.mAuthority).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(substring, e.F0)).build();
                }
    ...
    @VisibleForTesting
    static XmlResourceParser getFileProviderPathsMetaData(Context context, String str, @Nullable ProviderInfo providerInfo, int i4) {
    ...
    private static PathStrategy getPathStrategy(Context context, String str, int i4) {
        ...
        synchronized (hashMap) {
            ...
            if (pathStrategy == null) {
                try {
                    try {
                        pathStrategy = parsePathStrategy(context, str, i4);
    ...
    private static PathStrategy parsePathStrategy(Context context, String str, int i4) throws IOException, XmlPullParserException {
    ...
    protected FileProvider(@XmlRes int i4) {
        this.mResourceId = i4;
    }
