...
public final class PermissionChecker {
    ...
    public static int checkPermission(@NonNull Context context, @NonNull String str, int i4, int i5, @Nullable String str2) {
        ...
        if (Process.myUid() == i5 && ObjectsCompat.equals(context.getPackageName(), str2)) {
            noteProxyOpNoThrow = AppOpsManagerCompat.checkOrNoteProxyOp(context, i5, permissionToOp, str2);
        } else {
