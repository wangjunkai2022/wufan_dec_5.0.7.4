...
public final class ResourcesCompat {
    ...
    static class Api15Impl {
        ...
        @DoNotInline
        static Drawable getDrawableForDensity(Resources resources, int i4, int i5) {
    ...
    static class Api21Impl {
        ...
        @DoNotInline
        static Drawable getDrawable(Resources resources, int i4, Resources.Theme theme) {
            return resources.getDrawable(i4, theme);
        }

        @DoNotInline
        static Drawable getDrawableForDensity(Resources resources, int i4, int i5, Resources.Theme theme) {
    ...
    public static class Api23Impl {
        ...
        @DoNotInline
        static int getColor(Resources resources, int i4, Resources.Theme theme) {
            return resources.getColor(i4, theme);
        }

        @NonNull
        @DoNotInline
        static ColorStateList getColorStateList(@NonNull Resources resources, @ColorRes int i4, @Nullable Resources.Theme theme) {
    ...
    static class Api29Impl {
        ...
        @DoNotInline
        static float getFloat(@NonNull Resources resources, @DimenRes int i4) {
        ...
        public final void callbackFailAsync(final int i4, @Nullable Handler handler) {
            getHandler(handler).post(new Runnable() { // from class: androidx.core.content.res.a
                ...
                public final void run() {
                    ResourcesCompat.FontCallback.this.lambda$callbackFailAsync$1(i4);
                }
            });
        }
    ...
    private static void addColorStateListToCache(@NonNull ColorStateListCacheKey colorStateListCacheKey, @ColorRes int i4, @NonNull ColorStateList colorStateList, @Nullable Resources.Theme theme) {
        synchronized (sColorStateCacheLock) {
            ...
            sparseArray.append(i4, new ColorStateListCacheEntry(colorStateList, colorStateListCacheKey.mResources.getConfiguration(), theme));
        }
    }
    ...
    @Nullable
    private static ColorStateList getCachedColorStateList(@NonNull ColorStateListCacheKey colorStateListCacheKey, @ColorRes int i4) {
    ...
    public static Typeface getCachedFont(@NonNull Context context, @FontRes int i4) throws Resources.NotFoundException {
        ...
        return loadFont(context, i4, new TypedValue(), 0, null, null, false, true);
    }
    ...
    public static int getColor(@NonNull Resources resources, @ColorRes int i4, @Nullable Resources.Theme theme) throws Resources.NotFoundException {
        if (Build.VERSION.SDK_INT >= 23) {
            return Api23Impl.getColor(resources, i4, theme);
        }
    ...
    public static ColorStateList getColorStateList(@NonNull Resources resources, @ColorRes int i4, @Nullable Resources.Theme theme) throws Resources.NotFoundException {
        ...
        ColorStateList cachedColorStateList = getCachedColorStateList(colorStateListCacheKey, i4);
        if (cachedColorStateList != null) {
            return cachedColorStateList;
        }
        ColorStateList inflateColorStateList = inflateColorStateList(resources, i4, theme);
        if (inflateColorStateList != null) {
            addColorStateListToCache(colorStateListCacheKey, i4, inflateColorStateList, theme);
            return inflateColorStateList;
        } else if (Build.VERSION.SDK_INT >= 23) {
            return Api23Impl.getColorStateList(resources, i4, theme);
        } else {
    ...
    public static Drawable getDrawable(@NonNull Resources resources, @DrawableRes int i4, @Nullable Resources.Theme theme) throws Resources.NotFoundException {
        if (Build.VERSION.SDK_INT >= 21) {
            return Api21Impl.getDrawable(resources, i4, theme);
        }
    ...
    public static Drawable getDrawableForDensity(@NonNull Resources resources, @DrawableRes int i4, int i5, @Nullable Resources.Theme theme) throws Resources.NotFoundException {
        ...
        if (i6 >= 21) {
            return Api21Impl.getDrawableForDensity(resources, i4, i5, theme);
        }
        if (i6 >= 15) {
            return Api15Impl.getDrawableForDensity(resources, i4, i5);
        }
        return resources.getDrawable(i4);
    }
    ...
    public static float getFloat(@NonNull Resources resources, @DimenRes int i4) {
        if (Build.VERSION.SDK_INT >= 29) {
            return Api29Impl.getFloat(resources, i4);
        }
    ...
    public static Typeface getFont(@NonNull Context context, @FontRes int i4) throws Resources.NotFoundException {
        ...
        return loadFont(context, i4, new TypedValue(), 0, null, null, false, false);
    }
    ...
    @Nullable
    private static ColorStateList inflateColorStateList(Resources resources, int i4, @Nullable Resources.Theme theme) {
        if (isColorInt(resources, i4)) {
            return null;
        }
        try {
            return ColorStateListInflaterCompat.createFromXml(resources, resources.getXml(i4), theme);
        } catch (Exception unused) {
            return null;
        }
    }

    private static boolean isColorInt(@NonNull Resources resources, @ColorRes int i4) {
        TypedValue typedValue = getTypedValue();
        resources.getValue(i4, typedValue, true);
    ...
    private static Typeface loadFont(@NonNull Context context, int i4, @NonNull TypedValue typedValue, int i5, @Nullable FontCallback fontCallback, @Nullable Handler handler, boolean z4, boolean z5) {
        Resources resources = context.getResources();
        resources.getValue(i4, typedValue, true);
        Typeface loadFont = loadFont(context, resources, typedValue, i4, i5, fontCallback, handler, z4, z5);
    ...
    public static void getFont(@NonNull Context context, @FontRes int i4, @NonNull FontCallback fontCallback, @Nullable Handler handler) throws Resources.NotFoundException {
        ...
        if (context.isRestricted()) {
            ...
            loadFont(context, i4, new TypedValue(), 0, fontCallback, handler, false, false);
        }
    }
    ...
    */
    ...
    public static Typeface getFont(@NonNull Context context, @FontRes int i4, @NonNull TypedValue typedValue, int i5, @Nullable FontCallback fontCallback) throws Resources.NotFoundException {
        ...
        return loadFont(context, i4, typedValue, i5, fontCallback, null, true, false);
    }
}
