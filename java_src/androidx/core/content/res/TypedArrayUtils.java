...
public class TypedArrayUtils {
    ...
    public static boolean getNamedBoolean(@NonNull TypedArray typedArray, @NonNull XmlPullParser xmlPullParser, @NonNull String str, @StyleableRes int i4, boolean z4) {
        return !hasAttribute(xmlPullParser, str) ? z4 : typedArray.getBoolean(i4, z4);
    }
    ...
    public static float getNamedFloat(@NonNull TypedArray typedArray, @NonNull XmlPullParser xmlPullParser, @NonNull String str, @StyleableRes int i4, float f5) {
        return !hasAttribute(xmlPullParser, str) ? f5 : typedArray.getFloat(i4, f5);
    }
