...
public class FontResourcesParserCompat {
    ...
    public static final class FontFileResourceEntry {
        ...
        public FontFileResourceEntry(@NonNull String str, int i4, boolean z4, @Nullable String str2, int i5, int i6) {
            this.mFileName = str;
            this.mWeight = i4;
            this.mItalic = z4;
    ...
    private static FontFileResourceEntry readFont(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        ...
        return new FontFileResourceEntry(string2, i5, z4, string, i9, resourceId);
    }
    ...
    public static final class ProviderResourceEntry implements FamilyResourceEntry {
        ...
        public ProviderResourceEntry(@NonNull FontRequest fontRequest, int i4, int i5, @Nullable String str) {
