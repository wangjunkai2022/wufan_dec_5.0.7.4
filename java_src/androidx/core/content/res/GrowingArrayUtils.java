...
final class GrowingArrayUtils {
    ...
    public static <T> T[] append(T[] tArr, int i4, T t4) {
        if (i4 + 1 > tArr.length) {
    ...
    public static <T> T[] insert(T[] tArr, int i4, int i5, T t4) {
        if (i4 + 1 <= tArr.length) {
    ...
    public static boolean[] append(boolean[] zArr, int i4, boolean z4) {
        if (i4 + 1 > zArr.length) {
    ...
    public static boolean[] insert(boolean[] zArr, int i4, int i5, boolean z4) {
        if (i4 + 1 <= zArr.length) {
