...
public class ContextCompat {
    ...
    public static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            if (i4 >= 17) {
                ...
                hashMap.put(UserManager.class, aw.f63382m);
            }
            if (i4 >= 16) {
            ...
            hashMap.put(AccountManager.class, GrantCredentialsPermissionActivity.f67535g);
            ...
            hashMap.put(SensorManager.class, bm.ac);
    ...
    public static Drawable getDrawable(@NonNull Context context, @DrawableRes int i4) {
        ...
        synchronized (sLock) {
            ...
            context.getResources().getValue(i4, sTempValue, true);
            i5 = sTempValue.resourceId;
        }
