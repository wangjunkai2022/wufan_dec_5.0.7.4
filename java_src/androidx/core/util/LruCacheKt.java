...
public final class LruCacheKt {
    @NotNull
    public static final <K, V> LruCache<K, V> lruCache(int i4, @NotNull Function2<? super K, ? super V, Integer> sizeOf, @NotNull Function1<? super K, ? extends V> create, @NotNull Function4<? super Boolean, ? super K, ? super V, ? super V, Unit> onEntryRemoved) {
    ...
    public static /* synthetic */ LruCache lruCache$default(int i4, Function2 sizeOf, Function1 create, Function4 onEntryRemoved, int i5, Object obj) {
        if ((i5 & 2) != 0) {
            sizeOf = new Function2<K, V, Integer>() { // from class: androidx.core.util.LruCacheKt$lruCache$1
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // kotlin.jvm.functions.Function2
                @NotNull
                public final Integer invoke(@NotNull K k4, @NotNull V v2) {
                    Intrinsics.checkNotNullParameter(k4, "<anonymous parameter 0>");
        ...
        if ((i5 & 4) != 0) {
            create = new Function1<K, V>() { // from class: androidx.core.util.LruCacheKt$lruCache$2
                ...
                @Nullable
                public final V invoke(@NotNull K it2) {
        ...
        if ((i5 & 8) != 0) {
            onEntryRemoved = new Function4<Boolean, K, V, V, Unit>() { // from class: androidx.core.util.LruCacheKt$lruCache$3
                ...
                public final void invoke(boolean z4, @NotNull K k4, @NotNull V v2, @Nullable V v4) {
                    Intrinsics.checkNotNullParameter(k4, "<anonymous parameter 1>");
