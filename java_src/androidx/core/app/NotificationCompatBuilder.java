...
public class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    public NotificationCompatBuilder(NotificationCompat.Builder builder) {
        ...
        if (i6 >= 19 && i6 < 21 && (combineLists = combineLists(getPeople(builder.mPersonList), builder.mPeople)) != null && !combineLists.isEmpty()) {
        ...
        if (i8 >= 23 && (icon = builder.mSmallIcon) != null) {
        ...
        if (i9 >= 31 && (i4 = builder.mFgsDeferBehavior) != 0) {
    ...
    public Notification build() {
        ...
        if (i4 >= 16 && style != null && (extras = NotificationCompat.getExtras(buildInternal)) != null) {
