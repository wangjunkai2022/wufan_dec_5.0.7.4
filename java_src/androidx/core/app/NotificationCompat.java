...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            private Builder(@Nullable IconCompat iconCompat, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @NonNull Bundle bundle, @Nullable RemoteInput[] remoteInputArr, boolean z4, int i4, boolean z5, boolean z6, boolean z7) {
        ...
        public Action(int i4, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @Nullable Bundle bundle, @Nullable RemoteInput[] remoteInputArr, @Nullable RemoteInput[] remoteInputArr2, boolean z4, int i5, boolean z5, boolean z6, boolean z7) {
            this(i4 != 0 ? IconCompat.createWithResource(null, "", i4) : null, charSequence, pendingIntent, bundle, remoteInputArr, remoteInputArr2, z4, i5, z5, z6, z7);
        }
    ...
    public static final class BubbleMetadata {
        ...
        public static final class Builder {
            ...
            @NonNull
            private Builder setFlag(int i4, boolean z4) {
                if (z4) {
                    this.mFlags = i4 | this.mFlags;
                } else {
                    this.mFlags = (i4 ^ (-1)) & this.mFlags;
    ...
    public static abstract class Style {
        ...
        */
        ...
        private Bitmap createColoredBitmap(@NonNull IconCompat iconCompat, int i4, int i5) {
    ...
    static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        if (i7 >= 24) {
            z4 = action.getExtras().getBoolean("android.support.allowGeneratedReplies") || action.getAllowGeneratedReplies();
        } else {
        ...
        if (i7 >= 23) {
            if (action.getIcon() == null && (i5 = action.icon) != 0) {
                return new Action(i5, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z5, i8, z6, isContextual, isAuthenticationRequired);
            }
            return new Action(action.getIcon() != null ? IconCompat.createFromIconOrNullIfZeroResId(action.getIcon()) : null, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z5, i8, z6, isContextual, isAuthenticationRequired);
        }
        return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z5, i8, z6, isContextual, isAuthenticationRequired);
    }
    ...
    public static List<Person> getPeople(@NonNull Notification notification) {
        ...
        } else if (i4 >= 19 && (stringArray = notification.extras.getStringArray(EXTRA_PEOPLE)) != null && stringArray.length != 0) {
            for (String str : stringArray) {
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (i4 >= 16) {
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
                boolean z4 = this.mConversationTitle != null || hasMessagesWithoutSender();
                for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                    Message message3 = this.mMessages.get(size);
                    CharSequence makeMessageLine = z4 ? makeMessageLine(message3) : message3.getText();
