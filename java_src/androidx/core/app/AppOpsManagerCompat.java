...
public final class AppOpsManagerCompat {
    ...
    static class Api19Impl {
        ...
        @DoNotInline
        static int noteOp(AppOpsManager appOpsManager, String str, int i4, String str2) {
            return appOpsManager.noteOp(str, i4, str2);
        }

        @DoNotInline
        static int noteOpNoThrow(AppOpsManager appOpsManager, String str, int i4, String str2) {
    ...
    static class Api29Impl {
        ...
        @DoNotInline
        static int checkOpNoThrow(@Nullable AppOpsManager appOpsManager, @NonNull String str, int i4, @NonNull String str2) {
    ...
    public static int checkOrNoteProxyOp(@NonNull Context context, int i4, @NonNull String str, @NonNull String str2) {
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            return checkOpNoThrow != 0 ? checkOpNoThrow : Api29Impl.checkOpNoThrow(systemService, str, i4, Api29Impl.getOpPackageName(context));
        }
    ...
    public static int noteOp(@NonNull Context context, @NonNull String str, int i4, @NonNull String str2) {
        if (Build.VERSION.SDK_INT >= 19) {
            return Api19Impl.noteOp((AppOpsManager) context.getSystemService("appops"), str, i4, str2);
        }
        return 1;
    }
    ...
    public static int noteOpNoThrow(@NonNull Context context, @NonNull String str, int i4, @NonNull String str2) {
        if (Build.VERSION.SDK_INT >= 19) {
            return Api19Impl.noteOpNoThrow((AppOpsManager) context.getSystemService("appops"), str, i4, str2);
        }
        return 1;
    }
