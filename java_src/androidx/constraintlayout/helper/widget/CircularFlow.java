...
public class CircularFlow extends VirtualLayout {
    ...
    private void setAngles(String idList) {
        ...
        while (true) {
            ...
            if (indexOf == -1) {
                addAngle(idList.substring(i4).trim());
                return;
            } else {
                addAngle(idList.substring(i4, indexOf).trim());
                i4 = indexOf + 1;
            }
        }
    }
    ...
    private void setRadius(String idList) {
        ...
        while (true) {
            int indexOf = idList.indexOf(44, i4);
            if (indexOf == -1) {
                addRadius(idList.substring(i4).trim());
                return;
            } else {
                addRadius(idList.substring(i4, indexOf).trim());
                i4 = indexOf + 1;
            }
        }
    }
