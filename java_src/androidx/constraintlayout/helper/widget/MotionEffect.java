        ...
        if (attrs != null) {
            ...
            for (int i4 = 0; i4 < indexCount; i4++) {
                ...
                if (index == R.styleable.MotionEffect_motionEffect_start) {
                    int i5 = obtainStyledAttributes.getInt(index, this.motionEffectStart);
                    this.motionEffectStart = i5;
                    this.motionEffectStart = Math.max(Math.min(i5, 99), 0);
                } else if (index == R.styleable.MotionEffect_motionEffect_end) {
                    int i6 = obtainStyledAttributes.getInt(index, this.motionEffectEnd);
                    this.motionEffectEnd = i6;
                    this.motionEffectEnd = Math.max(Math.min(i6, 99), 0);
            ...
            int i7 = this.motionEffectStart;
            int i8 = this.motionEffectEnd;
            if (i7 == i8) {
                if (i7 > 0) {
                    this.motionEffectStart = i7 - 1;
                } else {
                    this.motionEffectEnd = i8 + 1;
                }
            }
