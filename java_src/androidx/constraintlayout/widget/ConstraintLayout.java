...
public class ConstraintLayout extends ViewGroup {
        ...
        public final void measure(ConstraintWidget widget, BasicMeasure.Measure measure) {
            ...
            if (widget.getVisibility() == 8 && !widget.isInPlaceholder()) {
                ...
                if (i11 == 1) {
                    ...
                    makeMeasureSpec = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i10, -2);
                } else if (i11 == 3) {
                    makeMeasureSpec = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i10 + widget.getHorizontalMargin(), -1);
                } else if (i11 != 4) {
                    makeMeasureSpec = 0;
                } else {
                    makeMeasureSpec = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i10, -2);
                    boolean z4 = widget.mMatchConstraintDefaultWidth == 1;
                    ...
                    if (i12 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i12 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                        if (measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z4 || (z4 && (view.getMeasuredHeight() == widget.getHeight())) || (view instanceof Placeholder) || widget.isResolvedHorizontally()) {
                ...
                if (i13 == 1) {
                    ...
                    makeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i9 + widget.getVerticalMargin(), -1);
                } else if (i13 != 4) {
                    makeMeasureSpec2 = 0;
                } else {
                    makeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i9, -2);
                    boolean z5 = widget.mMatchConstraintDefaultHeight == 1;
                    ...
                    if (i14 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i14 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                        if (measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z5 || (z5 && (view.getMeasuredWidth() == widget.getWidth())) || (view instanceof Placeholder) || widget.isResolvedVertically()) {
                ...
                if (i15 != BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS && i15 != BasicMeasure.Measure.USE_GIVEN_DIMENSIONS && z6 && widget.mMatchConstraintDefaultWidth == 0 && z7 && widget.mMatchConstraintDefaultHeight == 0) {
                    i6 = -1;
                    i5 = 0;
                    baseline = 0;
                    max = 0;
                    ...
                    int i16 = widget.mMatchConstraintMinWidth;
                    max = i16 > 0 ? Math.max(i16, measuredWidth) : measuredWidth;
                    int i17 = widget.mMatchConstraintMaxWidth;
                    if (i17 > 0) {
                        max = Math.min(i17, max);
                    }
                    int i18 = widget.mMatchConstraintMinHeight;
                    if (i18 > 0) {
                    ...
                    int i19 = widget.mMatchConstraintMaxHeight;
                    if (i19 > 0) {
                        i5 = Math.min(i19, i5);
                    }
                    if (!Optimizer.enabled(ConstraintLayout.this.mOptimizationLevel, 1)) {
                        if (z10 && z8) {
                            max = (int) ((i5 * widget.mDimensionRatio) + 0.5f);
                        } else if (z11 && z9) {
                            i5 = (int) ((max / widget.mDimensionRatio) + 0.5f);
                        }
                    }
                ...
                measure.measuredNeedsSolverPass = (max == measure.horizontalDimension && i5 == measure.verticalDimension) ? false : true;
    ...
    public void applyConstraintsFromLayoutParams(boolean isInEditMode, View child, ConstraintWidget widget, LayoutParams layoutParams, SparseArray<ConstraintWidget> idToWidget) {
        ...
        if (layoutParams.isGuideline) {
            ...
            if (Build.VERSION.SDK_INT < 17) {
                ...
                f6 = layoutParams.guidePercent;
            }
            if (f6 != -1.0f) {
                guideline.setGuidePercent(f6);
                return;
            } else if (i8 != -1) {
        ...
        if (Build.VERSION.SDK_INT < 17) {
            ...
            float f8 = layoutParams.horizontalBias;
            if (i10 == -1 && i16 == -1) {
        ...
        if (i24 != -1) {
            ...
            if (i10 != -1) {
                ...
                if (constraintWidget6 != null) {
                    ...
                    widget.immediateConnect(type, constraintWidget6, type, ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, i14);
                }
            } else if (i11 != -1 && (constraintWidget = idToWidget.get(i11)) != null) {
                widget.immediateConnect(ConstraintAnchor.Type.LEFT, constraintWidget, ConstraintAnchor.Type.RIGHT, ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, i14);
            }
            if (i5 != -1) {
                ConstraintWidget constraintWidget7 = idToWidget.get(i5);
                if (constraintWidget7 != null) {
                    widget.immediateConnect(ConstraintAnchor.Type.RIGHT, constraintWidget7, ConstraintAnchor.Type.LEFT, ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin, i4);
                }
            } else if (i6 != -1 && (constraintWidget2 = idToWidget.get(i6)) != null) {
                ConstraintAnchor.Type type2 = ConstraintAnchor.Type.RIGHT;
                widget.immediateConnect(type2, constraintWidget2, type2, ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin, i4);
            }
            ...
            if (f5 >= 0.0f) {
                widget.setHorizontalBiasPercent(f5);
            }
            float f9 = layoutParams.verticalBias;
            if (f9 >= 0.0f) {
                widget.setVerticalBiasPercent(f9);
            }
        }
        if (isInEditMode && ((i7 = layoutParams.editorAbsoluteX) != -1 || layoutParams.editorAbsoluteY != -1)) {
            widget.setOrigin(i7, layoutParams.editorAbsoluteY);
        }
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            if ((childAt.getVisibility() != 8 || layoutParams.isGuideline || layoutParams.isHelper || layoutParams.isVirtualGroup || isInEditMode) && !layoutParams.isInPlaceholder) {
                ...
                childAt.layout(x4, y2, width, height);
                if ((childAt instanceof Placeholder) && (content = ((Placeholder) childAt).getContent()) != null) {
                    content.setVisibility(0);
                    content.layout(x4, y2, width, height);
                }
            }
        }
        int size = this.mConstraintHelpers.size();
    ...
    public void resolveSystem(ConstraintWidgetContainer layout, int optimizationLevel, int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.mMeasurer.captureLayoutInfo(widthMeasureSpec, heightMeasureSpec, max2, max3, paddingWidth, i4);
        if (Build.VERSION.SDK_INT >= 17) {
        ...
        int i6 = size2 - i4;
        setSelfDimensionBehaviour(layout, mode, i5, mode2, i6);
        layout.measure(optimizationLevel, mode, i5, mode2, i6, this.mLastMeasureWidth, this.mLastMeasureHeight, max, max2);
    }
    ...
    protected void setSelfDimensionBehaviour(ConstraintWidgetContainer layout, int widthMode, int widthSize, int heightMode, int heightSize) {
        ...
        if (widthMode == Integer.MIN_VALUE) {
            ...
            widthSize = Math.min(this.mMaxWidth - i5, widthSize);
            dimensionBehaviour = dimensionBehaviour2;
        }
        ...
        layout.setX(0);
        layout.setY(0);
        layout.setMaxWidth(this.mMaxWidth - i5);
        ...
        layout.setMinWidth(this.mMinWidth - i5);
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        */
        ...
        public LayoutParams(Context c5, AttributeSet attrs) {
            ...
            this.widget = new ConstraintWidget();
            this.helped = false;
            TypedArray obtainStyledAttributes = c5.obtainStyledAttributes(attrs, R.styleable.ConstraintLayout_Layout);
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i4 = 0; i4 < indexCount; i4++) {
                int index = obtainStyledAttributes.getIndex(i4);
