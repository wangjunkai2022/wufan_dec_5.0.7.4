...
public class ConstraintLayoutStates {
    ...
    public boolean needsToChange(int id, float width, float height) {
        ...
        return (i5 == -1 || !valueAt.mVariants.get(i5).match(width, height)) && this.mCurrentConstraintNumber != valueAt.findMatch(width, height);
    }
    ...
    public void updateConstraints(int id, float width, float height) {
        ...
        if (i6 == id) {
            ...
            if ((i7 == -1 || !state.mVariants.get(i7).match(width, height)) && this.mCurrentConstraintNumber != (findMatch = state.findMatch(width, height))) {
                if (findMatch == -1) {
                ...
                if (findMatch == -1) {
                    ...
                    i5 = state.mVariants.get(findMatch).mConstraintID;
                }
