...
public class DesignTool implements ProxyInterface {
    ...
    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public float getKeyFramePosition(Object view, int type, float x4, float y2) {
        MotionController motionController;
        if ((view instanceof View) && (motionController = this.mMotionLayout.mFrameArrayList.get((View) view)) != null) {
            return motionController.getKeyFrameParameter(type, x4, y2);
        }
        return 0.0f;
    }
    ...
    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public Object getKeyframeAtLocation(Object viewObject, float x4, float y2) {
        MotionController motionController;
        View view = (View) viewObject;
        MotionLayout motionLayout = this.mMotionLayout;
        if (motionLayout.mScene == null) {
        ...
        return motionController.getPositionKeyframe(viewGroup.getWidth(), viewGroup.getHeight(), x4, y2);
    }

    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public Boolean getPositionKeyframe(Object keyFrame, Object view, float x4, float y2, String[] attribute, float[] value) {
        if (keyFrame instanceof KeyPositionBase) {
            View view2 = (View) view;
            this.mMotionLayout.mFrameArrayList.get(view2).positionKeyframe(view2, (KeyPositionBase) keyFrame, x4, y2, attribute, value);
    ...
    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public boolean setKeyFramePosition(Object view, int position, int type, float x4, float y2) {
        if (view instanceof View) {
            ...
            if (motionLayout.mScene != null) {
                ...
                if (motionController != null) {
                    View view2 = (View) view;
                    if (motionLayout2.mScene.hasKeyFramePosition(view2, i4)) {
                        float keyFrameParameter = motionController.getKeyFrameParameter(2, x4, y2);
                        float keyFrameParameter2 = motionController.getKeyFrameParameter(5, x4, y2);
                        this.mMotionLayout.mScene.setKeyframe(view2, i4, "motion:percentX", Float.valueOf(keyFrameParameter));
                        this.mMotionLayout.mScene.setKeyframe(view2, i4, "motion:percentY", Float.valueOf(keyFrameParameter2));
                        this.mMotionLayout.rebuildScene();
                        this.mMotionLayout.evaluate(true);
    ...
    public void setState(String id) {
        ...
        int lookUpConstraintId = motionLayout.lookUpConstraintId(id);
