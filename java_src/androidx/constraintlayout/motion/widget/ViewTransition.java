...
public class ViewTransition {
    ...
    public static class Animate {
        ...
        void mutateForward() {
            ...
            double d5 = nanoTime - this.mLastRender;
            Double.isNaN(d5);
            float f6 = f5 + (((float) (d5 * 1.0E-6d)) * this.mDpositionDt);
            this.mPosition = f6;
            if (f6 >= 1.0f) {
                this.mPosition = 1.0f;
            }
        ...
        public void reactTo(int action, float x4, float y2) {
            if (action == 1) {
                if (this.reverse) {
                    return;
                }
                ...
                if (this.mTempRec.contains((int) x4, (int) y2) || this.reverse) {
                    return;
                }
                reverse(true);
            }
        ...
        void reverse(boolean dir) {
            int i4;
            this.reverse = dir;
            if (dir && (i4 = this.mUpDuration) != -1) {
                this.mDpositionDt = i4 == 0 ? Float.MAX_VALUE : 1.0f / i4;
            }
            this.mVtController.invalidate();
    ...
    public void applyTransition(ViewTransitionController controller, MotionLayout layout, int fromId, ConstraintSet current, final View... views) {
        ...
        int i4 = this.mViewTransitionMode;
        if (i4 == 2) {
            applyIndependentTransition(controller, layout, views[0]);
            return;
        }
        if (i4 == 1) {
            for (int i5 : layout.getConstraintSetIds()) {
                if (i5 != fromId) {
                    ConstraintSet constraintSet = layout.getConstraintSet(i5);
                    for (View view : views) {
        ...
        layout.updateState(i6, current);
        layout.setState(i6, -1, -1);
        MotionScene.Transition transition = new MotionScene.Transition(-1, layout.mScene, i6, fromId);
    ...
    public boolean checkTags(View view) {
        int i4 = this.mIfTagSet;
        boolean z4 = i4 == -1 || view.getTag(i4) != null;
        int i5 = this.mIfTagNotSet;
    ...
    Interpolator getInterpolator(Context context) {
        int i4 = this.mDefaultInterpolator;
        if (i4 != -2) {
            if (i4 == -1) {
    ...
    public boolean supports(int action) {
        int i4 = this.mOnStateTransition;
        return i4 == 1 ? action == 0 : i4 == 2 ? action == 1 : i4 == 3 && action == 0;
    }
