...
public class MotionLabel extends View implements FloatLayout {
    ...
    private void adjustTexture(float l4, float t4, float r4, float b5) {
        if (this.mTextShaderMatrix == null) {
            return;
        }
        this.mFloatWidth = r4 - l4;
        this.mFloatHeight = b5 - t4;
        updateShaderMatrix();
    }

    private float getHorizontalOffset() {
        float f5 = Float.isNaN(this.mBaseTextSize) ? 1.0f : this.mTextSize / this.mBaseTextSize;
        TextPaint textPaint = this.mPaint;
        String str = this.mText;
        return (((((Float.isNaN(this.mFloatWidth) ? getMeasuredWidth() : this.mFloatWidth) - getPaddingLeft()) - getPaddingRight()) - (f5 * textPaint.measureText(str, 0, str.length()))) * (this.mTextPanX + 1.0f)) / 2.0f;
    }
    ...
    private float getVerticalOffset() {
        ...
        return (((measuredHeight - ((f6 - f7) * f5)) * (1.0f - this.mTextPanY)) / 2.0f) - (f5 * f7);
    }
    ...
    Bitmap blur(Bitmap bitmapOriginal, int factor) {
        ...
        for (int i4 = 0; i4 < factor && width >= 32 && height >= 32; i4++) {
            width /= 2;
            height /= 2;
    ...
    public void layout(int l4, int t4, int r4, int b5) {
        super.layout(l4, t4, r4, b5);
    ...
    public void setRoundPercent(float round) {
        boolean z4 = this.mRoundPercent != round;
    ...
    public void layout(float l4, float t4, float r4, float b5) {
        int i4 = (int) (l4 + 0.5f);
        this.mDeltaLeft = l4 - i4;
        int i5 = (int) (r4 + 0.5f);
        int i6 = i5 - i4;
        int i7 = (int) (b5 + 0.5f);
        int i8 = (int) (0.5f + t4);
