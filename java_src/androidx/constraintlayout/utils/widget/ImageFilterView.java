...
public class ImageFilterView extends AppCompatImageView {
    ...
    public static class ImageMatrix {
        ...
        private void saturation(float saturationStrength) {
            float f5 = 1.0f - saturationStrength;
            float f6 = 0.2999f * f5;
            float f7 = 0.587f * f5;
            float f8 = f5 * 0.114f;
            float[] fArr = this.f72m;
        ...
        private void warmth(float warmth) {
            ...
            float f7 = (5000.0f / warmth) / 100.0f;
            if (f7 > 66.0f) {
                double d5 = f7 - 60.0f;
        ...
        public void updateMatrix(ImageView view) {
            ...
            if (f5 != 1.0f) {
                saturation(f5);
                this.mColorMatrix.set(this.f72m);
                z4 = true;
            } else {
                z4 = false;
            }
            ...
            if (f7 != 1.0f) {
                warmth(f7);
                this.mTmpColorMatrix.set(this.f72m);
                this.mColorMatrix.postConcat(this.mTmpColorMatrix);
                z4 = true;
            }
    ...
    private void setMatrix() {
        ...
        float f5 = Float.isNaN(this.mPanX) ? 0.0f : this.mPanX;
