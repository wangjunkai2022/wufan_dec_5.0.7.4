...
public class CLContainer extends CLElement {
    ...
    public CLElement getOrNull(int i4) {
        if (i4 < 0 || i4 >= this.mElements.size()) {
            return null;
        }
        return this.mElements.get(i4);
    }

    public CLElement get(int i4) throws CLParsingException {
        if (i4 >= 0 && i4 < this.mElements.size()) {
            return this.mElements.get(i4);
        }
    ...
    public CLArray getArray(int i4) throws CLParsingException {
        CLElement cLElement = get(i4);
        if (cLElement instanceof CLArray) {
            return (CLArray) cLElement;
        }
    ...
    public CLObject getObject(int i4) throws CLParsingException {
        CLElement cLElement = get(i4);
        if (cLElement instanceof CLObject) {
            return (CLObject) cLElement;
        }
    ...
    public String getString(int i4) throws CLParsingException {
        CLElement cLElement = get(i4);
        if (cLElement instanceof CLString) {
            return cLElement.content();
        }
