...
public class State {
    ...
    public void apply(ConstraintWidgetContainer constraintWidgetContainer) {
        ...
        for (Object obj4 : this.mHelperReferences.keySet()) {
            ...
            if (helperReference2.getHelperWidget() != null) {
                Iterator<Object> it2 = helperReference2.mReferences.iterator();
                while (it2.hasNext()) {
                    helperReference2.getHelperWidget().add(this.mReferences.get(it2.next()).getConstraintWidget());
                }
    ...
    public HelperReference helper(Object obj, Helper helper) {
        ...
        if (helperReference == null) {
            int i4 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$state$State$Helper[helper.ordinal()];
            if (i4 == 1) {
