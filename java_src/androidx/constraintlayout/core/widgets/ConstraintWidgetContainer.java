    ...
    public boolean addChildrenToSolver(LinearSystem linearSystem) {
        ...
        while (this.widgetsToAdd.size() > 0) {
            ...
            if (size2 == this.widgetsToAdd.size()) {
                Iterator<ConstraintWidget> it3 = this.widgetsToAdd.iterator();
                while (it3.hasNext()) {
        ...
        if (LinearSystem.USE_DEPENDENCY_ORDERING) {
            ...
            for (int i8 = 0; i8 < size; i8++) {
                ConstraintWidget constraintWidget5 = this.mChildren.get(i8);
        ...
        if (constraintWidget.getVisibility() != 8 && !(constraintWidget instanceof Guideline) && !(constraintWidget instanceof Barrier)) {
            ...
            if (z6) {
                if (constraintWidget.mResolvedMatchConstraintDefault[0] == 4) {
                    ...
                    measure.horizontalDimension = (int) (constraintWidget.getDimensionRatio() * i7);
                }
            }
            if (z7) {
