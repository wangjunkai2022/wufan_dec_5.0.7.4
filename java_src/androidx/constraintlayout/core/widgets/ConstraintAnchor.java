...
public class ConstraintAnchor {
    ...
    public boolean connect(ConstraintAnchor constraintAnchor, int i4, int i5, boolean z4) {
        if (constraintAnchor == null) {
            reset();
            return true;
        } else if (z4 || isValidConnection(constraintAnchor)) {
    ...
    public void findDependents(int i4, ArrayList<WidgetGroup> arrayList, WidgetGroup widgetGroup) {
        HashSet<ConstraintAnchor> hashSet = this.mDependents;
        if (hashSet != null) {
            Iterator<ConstraintAnchor> it2 = hashSet.iterator();
            while (it2.hasNext()) {
                Grouping.findDependents(it2.next().mOwner, i4, arrayList, widgetGroup);
            }
        }
    }
        ...
        switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$widgets$ConstraintAnchor$Type[type2.ordinal()]) {
            ...
            case 3:
                ...
                if (constraintAnchor.getOwner() instanceof Guideline) {
                    return (z5 || type == Type.CENTER_X) ? true : true;
                }
                return z5;
            case 4:
            case 5:
                ...
                if (constraintAnchor.getOwner() instanceof Guideline) {
                    return (z6 || type == Type.CENTER_Y) ? true : true;
                }
                return z6;
            case 6:
    ...
    public boolean connect(ConstraintAnchor constraintAnchor, int i4) {
        return connect(constraintAnchor, i4, Integer.MIN_VALUE, false);
    }
}
