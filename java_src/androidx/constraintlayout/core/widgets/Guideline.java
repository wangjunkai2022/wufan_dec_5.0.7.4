...
public class Guideline extends ConstraintWidget {
    ...
    public void addToSolver(LinearSystem linearSystem, boolean z4) {
        ...
        if (this.mOrientation == 0) {
            ...
            z6 = (constraintWidget2 == null || constraintWidget2.mListDimensionBehaviors[1] != ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) ? false : false;
        }
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type type) {
        int i4 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$widgets$ConstraintAnchor$Type[type.ordinal()];
        if (i4 != 1 && i4 != 2) {
