...
public class HorizontalWidgetRun extends WidgetRun {
    ...
    private void computeInsetRatio(int[] iArr, int i4, int i5, int i6, int i7, float f5, int i8) {
        int i9 = i5 - i4;
        int i10 = i7 - i6;
        if (i8 != -1) {
            if (i8 == 0) {
                iArr[0] = (int) ((i10 * f5) + 0.5f);
                iArr[1] = i10;
                return;
            } else if (i8 != 1) {
                return;
                ...
                iArr[0] = i9;
                iArr[1] = (int) ((i9 * f5) + 0.5f);
                return;
            }
        }
        int i11 = (int) ((i10 * f5) + 0.5f);
        int i12 = (int) ((i9 / f5) + 0.5f);
        if (i11 <= i9) {
            iArr[0] = i11;
            iArr[1] = i10;
        } else if (i12 <= i10) {
