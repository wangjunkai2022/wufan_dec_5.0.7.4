...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    private void addVariable(int i4, SolverVariable solverVariable, float f5) {
    ...
    private void insertVariable(int i4, SolverVariable solverVariable, float f5) {
    ...
    public void put(SolverVariable solverVariable, float f5) {
        ...
        insertVariable(i6, solverVariable, f5);
    }
    ...
    public float use(ArrayRow arrayRow, boolean z4) {
        ...
        while (i4 < currentSize) {
            ...
            if (iArr[i5] != -1) {
                add(this.mCache.mIndexedVariables[iArr[i5]], solverVariableValues.values[i5] * f5, z4);
                i4++;
            }
            i5++;
        }
