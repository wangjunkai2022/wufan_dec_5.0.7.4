...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    private void moveSpinner(float f5) {
        ...
        int i5 = this.mOriginalOffsetTop + ((int) ((f6 * min) + (f6 * f7 * 2.0f)));
        ...
        this.mProgress.setProgressRotation((((max * 0.4f) - 0.25f) + (f7 * 2.0f)) * 0.5f);
    ...
    private Animation startAlphaAnimation(final int i4, final int i5) {
        Animation animation = new Animation() { // from class: androidx.swiperefreshlayout.widget.SwipeRefreshLayout.4
            ...
            public void applyTransformation(float f5, Transformation transformation) {
                ...
                int i6 = i4;
                circularProgressDrawable.setAlpha((int) (i6 + ((i5 - i6) * f5)));
            }
        };
    ...
    private void startDragging(float f5) {
        ...
        if (f5 - f6 <= i4 || this.mIsBeingDragged) {
            return;
        }
        this.mInitialMotionY = f6 + i4;
    ...
    void moveToStart(float f5) {
        int i4 = this.mFrom;
        setTargetOffsetTopAndBottom((i4 + ((int) ((this.mOriginalOffsetTop - i4) * f5))) - this.mCircleView.getTop());
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            startDragging(y2);
            if (this.mIsBeingDragged) {
                float f5 = (y2 - this.mInitialMotionY) * 0.5f;
                if (f5 <= 0.0f) {
                    return false;
                }
                moveSpinner(f5);
    ...
    public SwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.mAnimateToCorrectPosition = new Animation() { // from class: androidx.swiperefreshlayout.widget.SwipeRefreshLayout.6
            ...
            public void applyTransformation(float f5, Transformation transformation) {
                ...
                SwipeRefreshLayout.this.setTargetOffsetTopAndBottom((i5 + ((int) ((i4 - i5) * f5))) - swipeRefreshLayout2.mCircleView.getTop());
