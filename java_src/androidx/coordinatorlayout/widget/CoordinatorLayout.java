...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public static abstract class Behavior<V extends View> {
        ...
        public boolean onNestedFling(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, float f5, float f6, boolean z4) {
            return false;
        }
        ...
        @Deprecated
        public void onNestedPreScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, int i4, int i5, @NonNull int[] iArr) {
        }
        ...
        public void onNestedPreScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, int i4, int i5, @NonNull int[] iArr, int i6) {
            if (i6 == 0) {
                onNestedPreScroll(coordinatorLayout, v2, view, i4, i5, iArr);
            }
        }

        @Deprecated
        public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, int i4, int i5, int i6, int i7) {
        }

        @Deprecated
        public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, int i4, int i5, int i6, int i7, int i8) {
            if (i8 == 0) {
                onNestedScroll(coordinatorLayout, v2, view, i4, i5, i6, i7);
            }
        }

        @Deprecated
        public void onNestedScrollAccepted(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, @NonNull View view2, int i4) {
        }

        public void onNestedScrollAccepted(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, @NonNull View view2, int i4, int i5) {
            if (i5 == 0) {
                onNestedScrollAccepted(coordinatorLayout, v2, view, view2, i4);
            }
        }

        public boolean onRequestChildRectangleOnScreen(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull Rect rect, boolean z4) {
            return false;
        }
        ...
        @Deprecated
        public boolean onStartNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, @NonNull View view2, int i4) {
            return false;
        }
        ...
        public boolean onStartNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, @NonNull View view2, int i4, int i5) {
            if (i5 == 0) {
                return onStartNestedScroll(coordinatorLayout, v2, view, view2, i4);
            }
            return false;
        }
        ...
        public void onStopNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, int i4) {
            if (i4 == 0) {
        ...
        public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, int i4, int i5, int i6, int i7, int i8, @NonNull int[] iArr) {
            iArr[0] = iArr[0] + i6;
            iArr[1] = iArr[1] + i7;
            onNestedScroll(coordinatorLayout, v2, view, i4, i5, i6, i7, i8);
        }
    }
    ...
    private boolean performIntercept(MotionEvent motionEvent, int i4) {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            ...
            if (!(z4 || z5) || actionMasked == 0) {
                ...
                z5 = isBlockingInteractionBelow && !didBlockInteraction;
    ...
    void offsetChildToAnchor(View view, int i4) {
        ...
        if (layoutParams.mAnchorView != null) {
            ...
            z4 = (acquireTempRect3.left == acquireTempRect2.left && acquireTempRect3.top == acquireTempRect2.top) ? true : true;
    ...
    */
    ...
    final WindowInsetsCompat setWindowInsets(WindowInsetsCompat windowInsetsCompat) {
        ...
        setWillNotDraw((z5 || getBackground() != null) ? false : false);
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        boolean isBlockingInteractionBelow(CoordinatorLayout coordinatorLayout, View view) {
            boolean z4 = this.mDidBlockInteraction;
            if (z4) {
                return true;
            }
            Behavior behavior = this.mBehavior;
            boolean blocksInteractionBelow = (behavior != null ? behavior.blocksInteractionBelow(coordinatorLayout, view) : false) | z4;
        ...
        void setNestedScrollAccepted(int i4, boolean z4) {
            if (i4 == 0) {
