...
public class AnimatedStateListDrawableCompat extends StateListDrawable implements TintAwareDrawable {
    ...
    public static class AnimatedStateListState extends StateListDrawable.StateListState {
        ...
        int addTransition(int i4, int i5, @NonNull Drawable drawable, boolean z4) {
    ...
    public static class AnimationDrawableTransition extends Transition {
        ...
        AnimationDrawableTransition(AnimationDrawable animationDrawable, boolean z4, boolean z5) {
            ...
            ObjectAnimator ofInt = ObjectAnimator.ofInt(animationDrawable, ClassifyAndRankActivity_.f28639n, i4, i5);
    ...
    private static class FrameInterpolator implements TimeInterpolator {
        ...
        public float getInterpolation(float f5) {
            int i4 = (int) ((f5 * this.mTotalDuration) + 0.5f);
            int i5 = this.mFrames;
        ...
        int updateFrames(AnimationDrawable animationDrawable, boolean z4) {
            ...
            for (int i5 = 0; i5 < numberOfFrames; i5++) {
                int duration = animationDrawable.getDuration(z4 ? (numberOfFrames - i5) - 1 : i5);
                iArr2[i5] = duration;
                i4 += duration;
            }
    ...
    public <T extends Drawable & Animatable> void addTransition(int i4, int i5, @NonNull T t4, boolean z4) {
        ObjectsCompat.requireNonNull(t4);
        this.mState.addTransition(i4, i5, t4, z4);
    }
    ...
    protected boolean onStateChange(@NonNull int[] iArr) {
        ...
        boolean z4 = indexOfKeyframe != getCurrentIndex() && (selectTransition(indexOfKeyframe) || selectDrawable(indexOfKeyframe));
        Drawable current = getCurrent();
    ...
    public /* bridge */ /* synthetic */ void setTint(@ColorInt int i4) {
        super.setTint(i4);
    }
