    ...
    public static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        final void applyTheme(Resources.Theme theme) {
            if (theme != null) {
                ...
                for (int i5 = 0; i5 < i4; i5++) {
                    if (drawableArr[i5] != null && DrawableCompat.canApplyTheme(drawableArr[i5])) {
        ...
        final boolean setLayoutDirection(int i4, int i5) {
            ...
            for (int i7 = 0; i7 < i6; i7++) {
                if (drawableArr[i7] != null) {
                    boolean layoutDirection = Build.VERSION.SDK_INT >= 23 ? DrawableCompat.setLayoutDirection(drawableArr[i7], i4) : false;
                    if (i7 == i5) {
                        z4 = layoutDirection;
                    }
                }
