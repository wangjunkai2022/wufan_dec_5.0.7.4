...
public class AlertController {
    ...
    public static class RecycleListView extends ListView {
        ...
        public void setHasDecor(boolean z4, boolean z5) {
            ...
            setPadding(getPaddingLeft(), z4 ? getPaddingTop() : this.mPaddingTopNoTitle, getPaddingRight(), z5 ? getPaddingBottom() : this.mPaddingBottomNoButtons);
        }
    ...
    private void setupView() {
        ...
        boolean z6 = (resolvePanel3 == null || resolvePanel3.getVisibility() == 8) ? false : true;
        if (!z6 && resolvePanel2 != null && (findViewById2 = resolvePanel2.findViewById(R.id.textSpacerNoButtons)) != null) {
        ...
        if (!z4) {
            ...
            if (view2 != null) {
                setScrollIndicators(resolvePanel2, view2, z5 | (z6 ? 2 : 0), 3);
            }
        }
