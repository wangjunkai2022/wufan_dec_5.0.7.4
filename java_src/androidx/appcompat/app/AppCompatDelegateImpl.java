...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    static {
        ...
        sCanApplyOverrideConfiguration = i4 >= 17;
    ...
    @NonNull
    private Configuration createOverrideConfigurationForDayNight(@NonNull Context context, int i4, @Nullable Configuration configuration, boolean z4) {
        int i5;
        if (i4 == 1) {
            i5 = 16;
        } else if (i4 != 2) {
            i5 = z4 ? 0 : context.getApplicationContext().getResources().getConfiguration().uiMode & 48;
        } else {
            i5 = 32;
        }
    ...
    private boolean isActivityManifestHandlingUiMode(Context context) {
        if (!this.mActivityHandlesUiModeChecked && (this.mHost instanceof Activity)) {
            ...
            try {
                int i4 = Build.VERSION.SDK_INT;
                ActivityInfo activityInfo = packageManager.getActivityInfo(new ComponentName(context, this.mHost.getClass()), i4 >= 29 ? 269221888 : i4 >= 24 ? 786432 : 0);
    ...
    private boolean onKeyUpPanel(int i4, KeyEvent keyEvent) {
        ...
        if (z5 && (audioManager = (AudioManager) this.mContext.getApplicationContext().getSystemService("audio")) != null) {
        ...
        if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
            ...
            if (viewGroup != null && !panelFeatureState.refreshDecorView) {
                ...
                if (view != null && (layoutParams = view.getLayoutParams()) != null && layoutParams.width == -1) {
                    ...
                    WindowManager.LayoutParams layoutParams2 = new WindowManager.LayoutParams(i4, -2, panelFeatureState.f37x, panelFeatureState.f38y, 1002, 8519680, -3);
            ...
            i4 = -2;
            panelFeatureState.isHandled = false;
            WindowManager.LayoutParams layoutParams22 = new WindowManager.LayoutParams(i4, -2, panelFeatureState.f37x, panelFeatureState.f38y, 1002, 8519680, -3);
    ...
    private boolean updateForNightMode(int i4, boolean z4) {
        boolean z5 = false;
        Configuration createOverrideConfigurationForDayNight = createOverrideConfigurationForDayNight(this.mContext, i4, null, false);
        ...
        int i6 = createOverrideConfigurationForDayNight.uiMode & 48;
        boolean z6 = true;
        if (i5 != i6 && z4 && !isActivityManifestHandlingUiMode && this.mBaseContextAttached && (sCanReturnDifferentContext || this.mCreated)) {
            Object obj = this.mHost;
        ...
        if (z5 || i5 == i6) {
            ...
            updateResourcesConfigurationForNightMode(i6, isActivityManifestHandlingUiMode, null);
        }
        if (z6) {
    ...
    private void updateResourcesConfigurationForNightMode(int i4, boolean z4, @Nullable Configuration configuration) {
    ...
    protected PanelFeatureState getPanelState(int i4, boolean z4) {
        PanelFeatureState[] panelFeatureStateArr = this.mPanels;
    ...
    public boolean hasWindowFeature(int i4) {
        ...
        if (sanitizeWindowFeatureId == 1) {
            ...
            z4 = sanitizeWindowFeatureId != 109 ? false : this.mOverlayActionBar;
        } else {
            z4 = this.mHasActionBar;
        }
        return z4 || this.mWindow.hasFeature(i4);
    }
    ...
    */
    ...
    public class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        public boolean onPreparePanel(int i4, View view, Menu menu) {
            ...
            ActionBarMenuCallback actionBarMenuCallback = this.mActionBarCallback;
            z4 = (actionBarMenuCallback == null || !actionBarMenuCallback.onPreparePanel(i4)) ? false : false;
            if (!z4) {
