...
public final class Compatibility {
    ...
    public static class Api15Impl {
        ...
        @DoNotInline
        public static void getValueForDensity(@NonNull Resources resources, int i4, int i5, @NonNull TypedValue typedValue, boolean z4) {
            resources.getValueForDensity(i4, i5, typedValue, z4);
        }
    }
