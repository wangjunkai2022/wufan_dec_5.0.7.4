...
public class DropDownListView extends ListView {
    ...
    static class Api30Impl {
        ...
        static void positionSelectorForHoveredItem(DropDownListView dropDownListView, int i4, View view) {
            try {
                sPositionSelector.invoke(dropDownListView, Integer.valueOf(i4), view, Boolean.FALSE, -1, -1);
                sSetSelectedPositionInt.invoke(dropDownListView, Integer.valueOf(i4));
                sSetNextSelectedPositionInt.invoke(dropDownListView, Integer.valueOf(i4));
    ...
    private void positionSelectorLikeTouchCompat(int i4, View view, float f5, float f6) {
    ...
    private void setPressedItem(View view, int i4, float f5, float f6) {
        View childAt;
        ...
        positionSelectorLikeTouchCompat(i4, view, f5, f6);
        ...
        if (actionMasked != 9 && actionMasked != 7) {
            ...
            if (pointToPosition != -1 && pointToPosition != getSelectedItemPosition()) {
                ...
                if (childAt.isEnabled()) {
                    requestFocus();
                    if (i4 >= 30 && Api30Impl.canPositionSelectorForHoveredItem()) {
