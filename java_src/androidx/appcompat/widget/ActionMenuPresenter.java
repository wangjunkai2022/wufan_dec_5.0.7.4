...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mReserveOverflow && (z4 || i12 + i11 > i9)) {
            i9--;
        }
        int i14 = i9 - i11;
        ...
        while (i16 < i4) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                boolean z6 = (i14 > 0 || z5) && i10 > 0 && (!actionMenuPresenter.mStrictWidthLimit || i6 > 0);
                boolean z7 = z6;
                i7 = i4;
                if (z6) {
                    ...
                    z6 = z8 & (!actionMenuPresenter.mStrictWidthLimit ? i10 + i17 <= 0 : i10 < 0);
                }
                if (z6 && groupId2 != 0) {
