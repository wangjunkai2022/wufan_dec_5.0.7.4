...
public class ThemeUtils {
    ...
    static int getThemeAttrColor(@NonNull Context context, int i4, float f5) {
        int themeAttrColor = getThemeAttrColor(context, i4);
        return ColorUtils.setAlphaComponent(themeAttrColor, Math.round(Color.alpha(themeAttrColor) * f5));
    }
}
