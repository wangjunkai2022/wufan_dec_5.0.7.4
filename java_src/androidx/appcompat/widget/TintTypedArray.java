...
public class TintTypedArray {
    ...
    public float getDimension(int i4, float f5) {
        return this.mWrapped.getDimension(i4, f5);
    }
    ...
    public float getFloat(int i4, float f5) {
        return this.mWrapped.getFloat(i4, f5);
    }
    ...
    public float getFraction(int i4, int i5, int i6, float f5) {
        return this.mWrapped.getFraction(i4, i5, i6, f5);
    }
