...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    private boolean hitThumb(float f5, float f6) {
        ...
        return f5 > ((float) i7) && f5 < ((float) ((((this.mThumbWidth + i7) + rect.left) + rect.right) + i5)) && f6 > ((float) i6) && f6 < ((float) (this.mSwitchBottom + i5));
    }
    ...
    public void onMeasure(int i4, int i5) {
        ...
        if (this.mEnforceSwitchWidth) {
            i8 = Math.max(this.mSwitchMinWidth, (this.mThumbWidth * 2) + i10 + i11);
        } else {
            i8 = this.mSwitchMinWidth;
        }
