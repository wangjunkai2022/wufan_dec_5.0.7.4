...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    public static int measureChildForCells(View view, int i4, int i5, int i6, int i7) {
        ...
        layoutParams.expandable = (layoutParams.isOverflowButton || !z5) ? false : false;
        ...
        while (i19 > 0 && i12 > 0) {
            ...
            while (i30 < childCount) {
                ...
                if ((j5 & j6) == 0) {
                    ...
                    if (z9 && layoutParams3.preventEdgeOffset && i12 == 1) {
    ...
    protected boolean hasSupportDividerBeforeChildAt(int i4) {
        ...
        return (i4 <= 0 || !(childAt2 instanceof ActionMenuChildView)) ? z4 : z4 | ((ActionMenuChildView) childAt2).needsDividerBefore();
    }
    ...
    public void onLayout(boolean z4, int i4, int i5, int i6, int i7) {
        ...
        for (int i21 = 0; i21 < childCount; i21++) {
            ...
            if (childAt4.getVisibility() != 8 && !layoutParams3.isOverflowButton) {
                ...
                paddingLeft = i22 + measuredWidth4 + ((LinearLayout.LayoutParams) layoutParams3).rightMargin + max;
            }
        }
    }
