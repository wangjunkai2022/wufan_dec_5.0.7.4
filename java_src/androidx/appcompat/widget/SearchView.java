...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class Api29Impl {
        ...
        @DoNotInline
        static void setInputMethodMode(SearchAutoComplete searchAutoComplete, int i4) {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (action != 0) {
                if (action == 1 || action == 2) {
                    ...
                    if (z5 && !this.mSlopBounds.contains(x4, y2)) {
                        z6 = z5;
                        z4 = false;
                    }
                } else {
                ...
                if (this.mTargetBounds.contains(x4, y2)) {
            ...
            if (z6) {
                if (z4 && !this.mActualBounds.contains(x4, y2)) {
                    motionEvent.setLocation(this.mDelegateView.getWidth() / 2, this.mDelegateView.getHeight() / 2);
                } else {
                    Rect rect = this.mActualBounds;
                    motionEvent.setLocation(x4 - rect.left, y2 - rect.top);
                }
    ...
    private void updateSubmitButton(boolean z4) {
        this.mGoButton.setVisibility((this.mSubmitButtonEnabled && isSubmitAreaEnabled() && hasFocus() && (z4 || !this.mVoiceButtonEnabled)) ? 0 : 8);
    }
