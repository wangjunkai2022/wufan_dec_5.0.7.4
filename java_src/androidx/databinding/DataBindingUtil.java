...
public class DataBindingUtil {
    ...
    */
    ...
    public static <T extends ViewDataBinding> T inflate(@NonNull LayoutInflater layoutInflater, int i4, @Nullable ViewGroup viewGroup, boolean z4) {
        return (T) inflate(layoutInflater, i4, viewGroup, z4, sDefaultComponent);
    }
    ...
    public static <T extends ViewDataBinding> T inflate(@NonNull LayoutInflater layoutInflater, int i4, @Nullable ViewGroup viewGroup, boolean z4, @Nullable DataBindingComponent dataBindingComponent) {
