...
public class TextViewBindingAdapter {
    ...
    public static void setAutoText(TextView textView, boolean z4) {
        ...
        textView.setKeyListener(TextKeyListener.getInstance(z4, capitalize));
    }
    ...
    public static void setLineSpacingExtra(TextView textView, float f5) {
        if (Build.VERSION.SDK_INT >= 16) {
            textView.setLineSpacing(f5, textView.getLineSpacingMultiplier());
        } else {
            textView.setLineSpacing(f5, 1.0f);
        }
    }

    @BindingAdapter({"android:lineSpacingMultiplier"})
    public static void setLineSpacingMultiplier(TextView textView, float f5) {
        if (Build.VERSION.SDK_INT >= 16) {
            textView.setLineSpacing(textView.getLineSpacingExtra(), f5);
        } else {
    ...
    public static void setPassword(TextView textView, boolean z4) {
        if (z4) {
    ...
    public static void setPhoneNumber(TextView textView, boolean z4) {
        if (z4) {
    ...
    public static void setShadowDx(TextView textView, float f5) {
        if (Build.VERSION.SDK_INT >= 16) {
            int shadowColor = textView.getShadowColor();
            textView.setShadowLayer(textView.getShadowRadius(), f5, textView.getShadowDy(), shadowColor);
        }
    }

    @BindingAdapter({"android:shadowDy"})
    public static void setShadowDy(TextView textView, float f5) {
        if (Build.VERSION.SDK_INT >= 16) {
            int shadowColor = textView.getShadowColor();
            textView.setShadowLayer(textView.getShadowRadius(), textView.getShadowDx(), f5, shadowColor);
        }
    }

    @BindingAdapter({"android:shadowRadius"})
    public static void setShadowRadius(TextView textView, float f5) {
        if (Build.VERSION.SDK_INT >= 16) {
            textView.setShadowLayer(f5, textView.getShadowDx(), textView.getShadowDy(), textView.getShadowColor());
        }
    }
    ...
    public static void setTextSize(TextView textView, float f5) {
