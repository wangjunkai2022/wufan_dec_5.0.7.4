...
public class ViewBindingAdapter {
    ...
    private static int pixelsToDimensionPixelSize(float f5) {
        int i4 = (int) (0.5f + f5);
        if (i4 != 0) {
            return i4;
        }
    ...
    public static void setClickListener(View view, View.OnClickListener onClickListener, boolean z4) {
    ...
    public static void setOnClick(View view, View.OnClickListener onClickListener, boolean z4) {
        view.setOnClickListener(onClickListener);
        view.setClickable(z4);
    }
    ...
    public static void setOnLongClick(View view, View.OnLongClickListener onLongClickListener, boolean z4) {
        view.setOnLongClickListener(onLongClickListener);
        view.setLongClickable(z4);
    }

    @BindingAdapter({"android:onLongClickListener", "android:longClickable"})
    public static void setOnLongClickListener(View view, View.OnLongClickListener onLongClickListener, boolean z4) {
        view.setOnLongClickListener(onLongClickListener);
        view.setLongClickable(z4);
    }

    @BindingAdapter({"android:padding"})
    public static void setPadding(View view, float f5) {
        int pixelsToDimensionPixelSize = pixelsToDimensionPixelSize(f5);
    ...
    public static void setPaddingBottom(View view, float f5) {
        view.setPadding(view.getPaddingLeft(), view.getPaddingTop(), view.getPaddingRight(), pixelsToDimensionPixelSize(f5));
    }

    @BindingAdapter({"android:paddingEnd"})
    public static void setPaddingEnd(View view, float f5) {
        int pixelsToDimensionPixelSize = pixelsToDimensionPixelSize(f5);
    ...
    public static void setPaddingLeft(View view, float f5) {
        view.setPadding(pixelsToDimensionPixelSize(f5), view.getPaddingTop(), view.getPaddingRight(), view.getPaddingBottom());
    }

    @BindingAdapter({"android:paddingRight"})
    public static void setPaddingRight(View view, float f5) {
        view.setPadding(view.getPaddingLeft(), view.getPaddingTop(), pixelsToDimensionPixelSize(f5), view.getPaddingBottom());
    }

    @BindingAdapter({"android:paddingStart"})
    public static void setPaddingStart(View view, float f5) {
        int pixelsToDimensionPixelSize = pixelsToDimensionPixelSize(f5);
        if (Build.VERSION.SDK_INT >= 17) {
    ...
    public static void setPaddingTop(View view, float f5) {
        view.setPadding(view.getPaddingLeft(), pixelsToDimensionPixelSize(f5), view.getPaddingRight(), view.getPaddingBottom());
    }
    ...
    public static void setRequiresFadingEdge(View view, int i4) {
        boolean z4 = (i4 & 2) != 0;
        boolean z5 = (i4 & 1) != 0;
        view.setVerticalFadingEdgeEnabled(z4);
        view.setHorizontalFadingEdgeEnabled(z5);
    }
}
