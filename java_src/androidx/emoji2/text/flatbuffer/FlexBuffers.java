...
public class FlexBuffers {
    ...
    public static class Map extends Vector {
        ...
        public KeyVector keys() {
            ...
            return new KeyVector(new TypedVector(readBuf, indirect, FlexBuffers.readInt(readBuf2, i4 + i5, i5), 4));
        }
    ...
    public static class Reference {
        ...
        public String asString() {
            if (isString()) {
                ...
                return this.bb.getString(indirect2, i5 - indirect2);
            } else {
                return "";
            }
        }
    ...
    public static class Unsigned {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public static int shortToUnsignedInt(short s4) {
    ...
    public static int indirect(ReadBuf readBuf, int i4, int i5) {
        return (int) (i4 - readUInt(readBuf, i4, i5));
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int toTypedVector(int i4, int i5) {
        if (i5 != 0) {
            if (i5 != 2) {
                if (i5 != 3) {
                    if (i5 != 4) {
