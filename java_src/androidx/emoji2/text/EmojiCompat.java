...
public class EmojiCompat {
    ...
    public static class CompatInternal {
        ...
        CharSequence process(@NonNull CharSequence charSequence, @IntRange(from = 0) int i4, @IntRange(from = 0) int i5, @IntRange(from = 0) int i6, boolean z4) {
            return charSequence;
        }
    ...
    private static final class CompatInternal19 extends CompatInternal {
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        CharSequence process(@NonNull CharSequence charSequence, int i4, int i5, int i6, boolean z4) {
    ...
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = 0) int i4, @IntRange(from = 0) int i5, @IntRange(from = 0) int i6, int i7) {
        ...
        if (i7 != 1) {
            z4 = i7 != 2 ? this.mReplaceAll : false;
        } else {
            z4 = true;
        }
        return this.mHelper.process(charSequence, i4, i5, i6, z4);
    }
