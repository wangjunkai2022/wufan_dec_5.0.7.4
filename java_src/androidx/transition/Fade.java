...
public class Fade extends Visibility {
    ...
    private Animator createAnimation(final View view, float f5, float f6) {
        if (f5 == f6) {
            return null;
        }
    ...
    private static float getStartAlpha(TransitionValues transitionValues, float f5) {
        Float f6;
        return (transitionValues == null || (f6 = (Float) transitionValues.values.get(PROPNAME_TRANSITION_ALPHA)) == null) ? f5 : f6.floatValue();
    }
