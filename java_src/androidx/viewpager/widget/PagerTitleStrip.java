...
public class PagerTitleStrip extends ViewGroup {
    ...
    public class PageListener extends DataSetObserver implements ViewPager.OnPageChangeListener, ViewPager.OnAdapterChangeListener {
        ...
        public void onPageScrolled(int i4, float f5, int i5) {
            ...
            PagerTitleStrip.this.updateTextPositions(i4, f5, false);
        }
    ...
    public void setTextSize(int i4, float f5) {
        this.mPrevText.setTextSize(i4, f5);
        this.mCurrText.setTextSize(i4, f5);
        this.mNextText.setTextSize(i4, f5);
    }
    ...
    public void updateTextPositions(int i4, float f5, boolean z4) {
        ...
        int i12 = ((width - i10) - ((int) (i11 * f6))) - i9;
