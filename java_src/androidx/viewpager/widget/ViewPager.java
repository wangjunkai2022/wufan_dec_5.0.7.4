...
public class ViewPager extends ViewGroup {
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i4, ItemInfo itemInfo2) {
        ...
        if (itemInfo2 != null) {
            ...
            if (i7 < i8) {
                float f6 = itemInfo2.offset + itemInfo2.widthFactor + f5;
                int i9 = i7 + 1;
                int i10 = 0;
                while (i9 <= itemInfo.position && i10 < this.mItems.size()) {
                    ...
                    while (i9 < itemInfo4.position) {
                        f6 += this.mAdapter.getPageWidth(i9) + f5;
                        i9++;
                    }
                    itemInfo4.offset = f6;
                    f6 += itemInfo4.widthFactor + f5;
                    i9++;
                }
            } else if (i7 > i8) {
                ...
                while (true) {
                    ...
                    while (i7 > itemInfo3.position) {
                        f7 -= this.mAdapter.getPageWidth(i7) + f5;
                        i7--;
                    }
                    f7 -= itemInfo3.widthFactor + f5;
                    itemInfo3.offset = f7;
                }
            }
        }
        ...
        int i12 = i11 - 1;
        this.mFirstOffset = i11 == 0 ? f8 : -3.4028235E38f;
        int i13 = count - 1;
        this.mLastOffset = i11 == i13 ? (itemInfo.widthFactor + f8) - 1.0f : Float.MAX_VALUE;
        int i14 = i4 - 1;
        while (i14 >= 0) {
            ...
            while (true) {
                ...
                f8 -= this.mAdapter.getPageWidth(i12) + f5;
                i12--;
            }
            f8 -= itemInfo7.widthFactor + f5;
            itemInfo7.offset = f8;
            if (i6 == 0) {
        ...
        float f9 = itemInfo.offset + itemInfo.widthFactor + f5;
        ...
        while (i16 < size2) {
            ...
            while (true) {
                ...
                f9 += this.mAdapter.getPageWidth(i15) + f5;
                i15++;
            }
            if (i5 == i13) {
    ...
    private int determineTargetPage(int i4, float f5, int i5, int i6) {
        if (Math.abs(i6) <= this.mFlingDistance || Math.abs(i5) <= this.mMinimumVelocity) {
            i4 += (int) (f5 + (i4 >= this.mCurItem ? 0.4f : 0.6f));
        } else if (i5 <= 0) {
            i4++;
        }
    ...
    private void dispatchOnPageScrolled(int i4, float f5, int i5) {
        ...
        if (list != null) {
            ...
            for (int i6 = 0; i6 < size; i6++) {
                ...
                if (onPageChangeListener2 != null) {
                    onPageChangeListener2.onPageScrolled(i4, f5, i5);
                }
            }
        }
        OnPageChangeListener onPageChangeListener3 = this.mInternalPageChangeListener;
        if (onPageChangeListener3 != null) {
            onPageChangeListener3.onPageScrolled(i4, f5, i5);
        }
    }
    ...
    private boolean pageScrolled(int i4) {
        ...
        float f6 = ((i4 / f5) - infoForCurrentScrollPosition.offset) / (infoForCurrentScrollPosition.widthFactor + (i5 / f5));
        this.mCalledSuper = false;
        ...
        if (action != 3 && action != 1) {
            ...
            if (action == 0) {
                ...
                if (i4 != -1) {
                    ...
                    if (f5 != 0.0f && !isGutterDrag(this.mLastMotionX, f5) && canScroll(this, false, (int) f5, (int) x5, (int) y4)) {
                    ...
                    if (abs > i5 && abs * 0.5f > abs2) {
                        ...
                        requestParentDisallowInterceptTouchEvent(true);
                        setScrollState(1);
                        this.mLastMotionX = f5 > 0.0f ? this.mInitialMotionX + this.mTouchSlop : this.mInitialMotionX - this.mTouchSlop;
                        this.mLastMotionY = y4;
                ...
                if (!this.mIsBeingDragged) {
                    ...
                    if (findPointerIndex == -1) {
                        ...
                        if (abs > this.mTouchSlop && abs > abs2) {
                            ...
                            this.mLastMotionX = x5 - f5 > 0.0f ? f5 + this.mTouchSlop : f5 - this.mTouchSlop;
                            this.mLastMotionY = y4;
                            setScrollState(1);
                            setScrollingCacheEnabled(true);
                            ViewParent parent = getParent();
    ...
    */
    ...
    void smoothScrollTo(int i4, int i5, int i6) {
        ...
        float f5 = clientWidth;
        float f6 = i10;
        float distanceInfluenceForSnapDuration = f6 + (distanceInfluenceForSnapDuration(Math.min(1.0f, (Math.abs(i8) * 1.0f) / f5)) * f6);
        int abs2 = Math.abs(i6);
        if (abs2 > 0) {
            abs = Math.round(Math.abs(distanceInfluenceForSnapDuration / abs2) * 1000.0f) * 4;
        } else {
            abs = (int) (((Math.abs(i8) / ((f5 * this.mAdapter.getPageWidth(this.mCurItem)) + this.mPageMargin)) + 1.0f) * 100.0f);
        }
