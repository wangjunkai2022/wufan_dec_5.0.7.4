...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float f5 = height;
        canvas.drawRect(left, height - this.mIndicatorHeight, right, f5, this.mTabPaint);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0 || !this.mIgnoreTap) {
            ...
            if (action == 0) {
                ...
                if (action == 2 && (Math.abs(x4 - this.mInitialMotionX) > this.mTouchSlop || Math.abs(y2 - this.mInitialMotionY) > this.mTouchSlop)) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // androidx.viewpager.widget.PagerTitleStrip
    public void updateTextPositions(int i4, float f5, boolean z4) {
        ...
        super.updateTextPositions(i4, f5, z4);
