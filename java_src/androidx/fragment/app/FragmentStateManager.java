...
public class FragmentStateManager {
    ...
    public int computeExpectedState() {
        ...
        if (fragment3.mFromLayout) {
            if (fragment3.mInLayout) {
                ...
                i4 = this.mFragmentManagerState < 4 ? Math.min(i4, fragment3.mState) : Math.min(i4, 1);
            }
        }
    ...
    public void destroy() {
        ...
        if (z5 || this.mFragmentStore.getNonConfig().shouldDestroy(this.mFragment)) {
        ...
        try {
            ...
            while (true) {
                ...
                if (computeExpectedState == i4) {
                    ...
                    return;
                } else if (computeExpectedState > i4) {
                    switch (i4 + 1) {
                        case 0:
                            attach();
                            continue;
    ...
    public void resume() {
        ...
        if (focusedView != null && isFragmentViewChild(focusedView)) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                ...
                sb2.append(" ");
                sb2.append(requestFocus ? "succeeded" : f.f4952h);
