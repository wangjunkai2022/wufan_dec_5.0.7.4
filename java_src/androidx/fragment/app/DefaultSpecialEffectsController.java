...
class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    @NonNull
    private Map<SpecialEffectsController.Operation, Boolean> startTransitions(@NonNull List<TransitionInfo> list, @NonNull List<SpecialEffectsController.Operation> list2, final boolean z4, @Nullable final SpecialEffectsController.Operation operation, @Nullable final SpecialEffectsController.Operation operation2) {
        ...
        for (TransitionInfo transitionInfo3 : list) {
            if (!transitionInfo3.hasSharedElementTransition() || operation7 == null || operation8 == null) {
                ...
                if (arrayMap2.isEmpty()) {
                    ...
                    FragmentTransition.callSharedElementStartEnd(operation2.getFragment(), operation.getFragment(), z5, arrayMap3, true);
                    ...
                    OneShotPreDrawListener.add(getContainer(), new Runnable() { // from class: androidx.fragment.app.DefaultSpecialEffectsController.6
                        @Override // java.lang.Runnable
                        public void run() {
                            FragmentTransition.callSharedElementStartEnd(operation2.getFragment(), operation.getFragment(), z4, arrayMap4, false);
                        }
                    });
        ...
        while (it3.hasNext()) {
            ...
            if (next.isVisibilityUnchanged()) {
                ...
                boolean z7 = obj3 != null && (operation11 == operation9 || operation11 == operation10);
        ...
        for (final TransitionInfo transitionInfo4 : list) {
            if (!transitionInfo4.isVisibilityUnchanged()) {
                ...
                boolean z8 = obj3 != null && (operation13 == operation9 || operation13 == operation12);
    ...
    void executeOperations(@NonNull List<SpecialEffectsController.Operation> list, boolean z4) {
        ...
        for (final SpecialEffectsController.Operation operation4 : list) {
            ...
            arrayList.add(new AnimationInfo(operation4, cancellationSignal, z4));
            CancellationSignal cancellationSignal2 = new CancellationSignal();
            operation4.markStartedSpecialEffect(cancellationSignal2);
            boolean z5 = false;
            if (z4) {
                if (operation4 != operation) {
                    arrayList2.add(new TransitionInfo(operation4, cancellationSignal2, z4, z5));
        ...
        Map<SpecialEffectsController.Operation, Boolean> startTransitions = startTransitions(arrayList2, arrayList3, z4, operation, operation2);
