...
public class FragmentAnim {
    ...
    public static AnimationOrAnimator loadAnimation(@NonNull Context context, @NonNull Fragment fragment, boolean z4, boolean z5) {
        ...
        if (viewGroup2 == null || viewGroup2.getLayoutTransition() == null) {
            ...
            if (nextAnim == 0 && nextTransition != 0) {
                nextAnim = transitToAnimResourceId(nextTransition, z4);
            }
            if (nextAnim != 0) {
    ...
    @AnimRes
    private static int transitToAnimResourceId(int i4, boolean z4) {
        if (i4 == 4097) {
    ...
    public static class EndViewTransitionAnimation extends AnimationSet implements Runnable {
        ...
        public boolean getTransformation(long j4, @NonNull Transformation transformation, float f5) {
            this.mAnimating = true;
            if (this.mEnded) {
                return !this.mTransitionEnded;
            }
