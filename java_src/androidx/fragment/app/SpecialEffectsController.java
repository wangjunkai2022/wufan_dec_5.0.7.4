...
public abstract class SpecialEffectsController {
    ...
    abstract void executeOperations(@NonNull List<Operation> list, boolean z4);
    ...
    public static class Operation {
        ...
        final void mergeWith(@NonNull State state, @NonNull LifecycleImpact lifecycleImpact) {
            int i4 = AnonymousClass3.$SwitchMap$androidx$fragment$app$SpecialEffectsController$Operation$LifecycleImpact[lifecycleImpact.ordinal()];
            if (i4 == 1) {
                ...
                if (i4 == 3 && this.mFinalState != State.REMOVED) {
                    if (FragmentManager.isLoggingEnabled(2)) {
                        StringBuilder sb2 = new StringBuilder();
        ...
        public enum State {
            ...
            public void applyState(@NonNull View view) {
                int i4 = AnonymousClass3.$SwitchMap$androidx$fragment$app$SpecialEffectsController$Operation$State[ordinal()];
                if (i4 == 1) {
