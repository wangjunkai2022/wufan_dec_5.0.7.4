...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public void performMultiWindowModeChanged(boolean z4) {
        ...
        this.mChildFragmentManager.dispatchMultiWindowModeChanged(z4);
    }
    ...
    public void performPictureInPictureModeChanged(boolean z4) {
        ...
        this.mChildFragmentManager.dispatchPictureInPictureModeChanged(z4);
    }
    ...
    public final void requestPermissions(@NonNull String[] strArr, int i4) {
        if (this.mHost != null) {
            getParentFragmentManager().launchRequestPermissions(this, strArr, i4);
            return;
        }
    ...
    public void setAnimations(int i4, int i5, int i6, int i7) {
        ...
        ensureAnimationInfo().mEnterAnim = i4;
        ensureAnimationInfo().mExitAnim = i5;
        ensureAnimationInfo().mPopEnterAnim = i6;
        ensureAnimationInfo().mPopExitAnim = i7;
    }
    ...
    public void setHideReplaced(boolean z4) {
        ensureAnimationInfo().mIsHideReplaced = z4;
    }
    ...
    public void startIntentSenderForResult(@SuppressLint({"UnknownNullness"}) IntentSender intentSender, int i4, @Nullable Intent intent, int i5, int i6, int i7, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        if (this.mHost != null) {
            ...
            getParentFragmentManager().launchStartIntentSenderForResult(this, intentSender, i4, intent, i5, i6, i7, bundle);
            return;
        }
        throw new IllegalStateException("Fragment " + this + " not attached to Activity");
    }
    ...
    public void startActivityForResult(@SuppressLint({"UnknownNullness"}) Intent intent, int i4, @Nullable Bundle bundle) {
        if (this.mHost != null) {
            getParentFragmentManager().launchStartActivityForResult(this, intent, i4, bundle);
            return;
        }
        throw new IllegalStateException("Fragment " + this + " not attached to Activity");
    }
