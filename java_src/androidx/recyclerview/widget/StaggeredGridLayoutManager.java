...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    */
    ...
    public View onFocusSearchFailed(View view, int i4, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (z4 || (focusableViewAfter = span.getFocusableViewAfter(firstChildPosition, convertFocusDirectionToLayoutDirection)) == null || focusableViewAfter == findContainingItemView) {
    ...
    */
    ...
    public class Span {
        ...
        void cacheReferenceLineAndClear(boolean z4, int i4) {
            int startLine;
            if (z4) {
        ...
        int findOnePartiallyOrCompletelyVisibleChild(int i4, int i5, boolean z4, boolean z5, boolean z6) {
        ...
        int findOnePartiallyVisibleChild(int i4, int i5, boolean z4) {
            return findOnePartiallyOrCompletelyVisibleChild(i4, i5, false, false, z4);
        }

        int findOneVisibleChild(int i4, int i5, boolean z4) {
