...
public class ConcatAdapterController implements NestedAdapterWrapper.Callback {
    ...
    public long getItemId(int i4) {
        WrapperAndLocalPosition findWrapperAndLocalPosition = findWrapperAndLocalPosition(i4);
    ...
    public int getLocalAdapterPosition(RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter, RecyclerView.ViewHolder viewHolder, int i4) {
        ...
        int countItemsBefore = i4 - countItemsBefore(nestedAdapterWrapper);
    ...
    public int getTotalCount() {
        int i4 = 0;
        for (NestedAdapterWrapper nestedAdapterWrapper : this.mWrappers) {
            i4 += nestedAdapterWrapper.getCachedItemCount();
        }
        return i4;
    }
    ...
    public void onItemRangeMoved(@NonNull NestedAdapterWrapper nestedAdapterWrapper, int i4, int i5) {
        ...
        this.mConcatAdapter.notifyItemMoved(i4 + countItemsBefore, i5 + countItemsBefore);
    }
    ...
    public boolean addAdapter(int i4, RecyclerView.Adapter<RecyclerView.ViewHolder> adapter) {
        ...
        throw new IndexOutOfBoundsException("Index must be between 0 and " + this.mWrappers.size() + ". Given:" + i4);
    }
