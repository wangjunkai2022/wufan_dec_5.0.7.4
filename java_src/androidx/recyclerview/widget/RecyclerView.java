...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class LayoutManager {
        ...
        */
        ...
        public boolean isViewPartiallyVisible(@NonNull View view, boolean z4, boolean z5) {
            boolean z6 = this.mHorizontalBoundCheck.isViewWithinBoundFlags(view, 24579) && this.mVerticalBoundCheck.isViewWithinBoundFlags(view, 24579);
            return z4 ? z6 : !z6;
        }
    ...
    public final class Recycler {
        ...
        ViewHolder getScrapOrCachedViewForId(long j4, int i4, boolean z4) {
        ...
        ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i4, boolean z4) {
        ...
        */
        ...
        View getViewForPosition(int i4, boolean z4) {
    ...
    public class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (!(smoothScroller2 != null && smoothScroller2.isPendingInitialRun()) && z4) {
                    if (RecyclerView.this.getOverScrollMode() != 2) {
    ...
    static {
        ...
        POST_UPDATES_ON_ANIMATION = i4 >= 16;
        ALLOW_THREAD_GAP_WORK = i4 >= 21;
        FORCE_ABS_FOCUS_SEARCH_DIRECTION = i4 <= 15;
        IGNORE_DETACHED_FOCUSED_CHILD = i4 <= 15;
    ...
    private String getFullClassName(Context context, String str) {
        ...
        } else if (str.contains(h0.f27805a)) {
            return str;
        } else {
            return RecyclerView.class.getPackage().getName() + d.f68897a + str;
        }
    }
    ...
    private void nestedScrollByInternal(int i4, int i5, @Nullable MotionEvent motionEvent, int i6) {
        ...
        startNestedScroll(canScrollVertically ? canScrollHorizontally | 2 : canScrollHorizontally, i6);
        if (dispatchNestedPreScroll(canScrollHorizontally != 0 ? i4 : 0, canScrollVertically ? i5 : 0, this.mReusableIntPair, this.mScrollOffset, i6)) {
            int[] iArr2 = this.mReusableIntPair;
            i4 -= iArr2[0];
            i5 -= iArr2[1];
        }
        scrollByInternal(canScrollHorizontally != 0 ? i4 : 0, canScrollVertically ? i5 : 0, motionEvent, i6);
    ...
    private void processAdapterUpdatesAndSetAnimationFlags() {
        ...
        this.mState.mRunSimpleAnimations = this.mFirstLayoutComplete && this.mItemAnimator != null && ((z4 = this.mDataSetHasChangedAfterLayout) || z6 || this.mLayout.mRequestedSimpleAnimations) && (!z4 || this.mAdapter.hasStableIds());
        State state = this.mState;
        if (state.mRunSimpleAnimations && z6 && !this.mDataSetHasChangedAfterLayout && predictiveItemAnimationsEnabled()) {
            z5 = true;
        }
        state.mRunPredictiveAnimations = z5;
    }
    ...
    public void onAttachedToWindow() {
        ...
        if (ALLOW_THREAD_GAP_WORK) {
            ...
            if (gapWorker == null) {
                ...
                gapWorker2.mFrameIntervalNs = 1.0E9f / f5;
