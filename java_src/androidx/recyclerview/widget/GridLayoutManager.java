...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    private void guessMeasurement(float f5, int i4) {
        calculateItemBorders(Math.max(Math.round(f5 * this.mSpanCount), i4));
    }
    ...
    private void measureChild(View view, int i4, boolean z4) {
        ...
        measureChildWithDecorationsAndMargin(view, i6, i5, z4);
    }
    ...
    @Override // androidx.recyclerview.widget.LinearLayoutManager
    View findReferenceChild(RecyclerView.Recycler recycler, RecyclerView.State state, boolean z4, boolean z5) {
        int i4;
        int childCount = getChildCount();
        int i5 = -1;
        int i6 = 1;
