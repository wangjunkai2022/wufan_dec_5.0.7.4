...
public class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    private int scrollTo(float f5, float f6, int[] iArr, int i4, int i5, int i6) {
    ...
    boolean isPointInsideVerticalThumb(float f5, float f6) {
        if (!isLayoutRTL() ? f5 >= this.mRecyclerViewWidth - this.mVerticalThumbWidth : f5 <= this.mVerticalThumbWidth) {
    ...
    void updateScrollPosition(int i4, int i5) {
        ...
        boolean z4 = computeHorizontalScrollRange - i7 > 0 && i7 >= this.mScrollbarMinimumRange;
        ...
        if (z5) {
            float f5 = i6;
            this.mVerticalThumbCenterY = (int) ((f5 * (i5 + (f5 / 2.0f))) / computeVerticalScrollRange);
            this.mVerticalThumbHeight = Math.min(i6, (i6 * i6) / computeVerticalScrollRange);
        }
        if (this.mNeedHorizontalScrollbar) {
            float f6 = i7;
            this.mHorizontalThumbCenterX = (int) ((f6 * (i4 + (f6 / 2.0f))) / computeHorizontalScrollRange);
