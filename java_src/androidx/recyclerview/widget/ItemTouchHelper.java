...
public class ItemTouchHelper extends RecyclerView.ItemDecoration implements RecyclerView.OnChildAttachStateChangeListener {
    ...
    public static abstract class Callback {
        ...
        public void onChildDraw(@NonNull Canvas canvas, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float f5, float f6, int i4, boolean z4) {
            ItemTouchUIUtilImpl.INSTANCE.onDraw(canvas, recyclerView, viewHolder.itemView, f5, f6, i4, z4);
        }

        public void onChildDrawOver(@NonNull Canvas canvas, @NonNull RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float f5, float f6, int i4, boolean z4) {
            ItemTouchUIUtilImpl.INSTANCE.onDrawOver(canvas, recyclerView, viewHolder.itemView, f5, f6, i4, z4);
        }

        void onDraw(Canvas canvas, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, List<RecoverAnimation> list, int i4, float f5, float f6) {
            int size = list.size();
            ...
            if (viewHolder != null) {
                ...
                onChildDraw(canvas, recyclerView, viewHolder, f5, f6, i4, true);
                canvas.restoreToCount(save2);
            }
        }

        void onDrawOver(Canvas canvas, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, List<RecoverAnimation> list, int i4, float f5, float f6) {
            int size = list.size();
            boolean z4 = false;
            for (int i5 = 0; i5 < size; i5++) {
                RecoverAnimation recoverAnimation = list.get(i5);
            ...
            if (viewHolder != null) {
                int save2 = canvas.save();
                onChildDrawOver(canvas, recyclerView, viewHolder, f5, f6, i4, true);
                canvas.restoreToCount(save2);
            }
    ...
    public static class RecoverAnimation implements Animator.AnimatorListener {
        ...
        RecoverAnimation(RecyclerView.ViewHolder viewHolder, int i4, int i5, float f5, float f6, float f7, float f8) {
    ...
    void checkSelectForSwipe(int i4, MotionEvent motionEvent, int i5) {
        ...
        float f6 = y2 - this.mInitialTouchY;
    ...
    View findChildView(MotionEvent motionEvent) {
        ...
        if (viewHolder != null) {
            ...
            if (hitTest(view, x4, y2, this.mSelectedStartX + this.mDx, this.mSelectedStartY + this.mDy)) {
                return view;
            }
        }
        for (int size = this.mRecoverAnimations.size() - 1; size >= 0; size--) {
            ...
            if (hitTest(view2, x4, y2, recoverAnimation.mX, recoverAnimation.mY)) {
                return view2;
            }
        }
        return this.mRecyclerView.findChildViewUnder(x4, y2);
    }
