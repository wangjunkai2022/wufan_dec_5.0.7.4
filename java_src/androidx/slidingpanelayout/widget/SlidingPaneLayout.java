...
public class SlidingPaneLayout extends ViewGroup {
    ...
    private void dimChildView(View view, float f5, int i4) {
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        if (f5 > 0.0f && i4 != 0) {
    ...
    */
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (!this.mCanSlide || (this.mIsUnableToDrag && actionMasked != 0)) {
            ...
            if (actionMasked == 0) {
                ...
                if (this.mDragHelper.isViewUnder(this.mSlideableView, (int) x4, (int) y2) && isDimmed(this.mSlideableView)) {
                    z4 = true;
    ...
    protected void onMeasure(int i4, int i5) {
            ...
            while (i18 < childCount) {
                ...
                if (childAt2.getVisibility() != i7) {
                    ...
                    if (childAt2.getVisibility() != i7) {
                        ...
                        if (z5 && childAt2 != this.mSlideableView) {
                            ...
                            if (z5) {
                                ...
                                i8 = i17;
                                childAt2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth2 + ((int) ((layoutParams2.weight * Math.max(0, i12)) / f6)), 1073741824), makeMeasureSpec);
                                i18++;
                                i17 = i8;
                                i7 = 8;
                            }
        ...
        this.mCanSlide = z5;
        if (this.mDragHelper.getViewDragState() == 0 || z5) {
            return;
        }
        this.mDragHelper.abort();
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1 && isDimmed(this.mSlideableView)) {
                ...
                float f6 = y2 - this.mInitialMotionY;
                int touchSlop = this.mDragHelper.getTouchSlop();
                if ((f5 * f5) + (f6 * f6) < touchSlop * touchSlop && this.mDragHelper.isViewUnder(this.mSlideableView, (int) x4, (int) y2)) {
    ...
    boolean smoothSlideTo(float f5, int i4) {
        int paddingLeft;
        if (this.mCanSlide) {
            boolean isLayoutRtlSupport = isLayoutRtlSupport();
            LayoutParams layoutParams = (LayoutParams) this.mSlideableView.getLayoutParams();
    ...
    public SlidingPaneLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
        ...
        this.mOverhangSize = (int) ((32.0f * f5) + 0.5f);
