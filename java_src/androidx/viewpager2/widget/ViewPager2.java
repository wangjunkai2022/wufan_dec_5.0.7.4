...
public final class ViewPager2 extends ViewGroup {
    ...
    public void requestTransform() {
        ...
        double d5 = i4;
        Double.isNaN(d5);
        float f5 = (float) (relativeScrollPosition - d5);
        this.mPageTransformerAdapter.onPageScrolled(i4, f5, Math.round(getPageSize() * f5));
    }
    ...
    void setCurrentItemInternal(int i4, boolean z4) {
        ...
        if (adapter == null) {
            ...
            if (Math.abs(d6 - d5) > 3.0d) {
                this.mRecyclerView.scrollToPosition(d6 > d5 ? min - 3 : min + 3);
                RecyclerView recyclerView = this.mRecyclerView;
