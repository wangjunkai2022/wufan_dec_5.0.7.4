...
public final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    private void dispatchScrolled(int i4, float f5, int i5) {
    ...
    public double getRelativeScrollPosition() {
        ...
        ScrollEventValues scrollEventValues = this.mScrollValues;
        double d5 = scrollEventValues.mPosition;
        double d6 = scrollEventValues.mOffset;
        Double.isNaN(d5);
        Double.isNaN(d6);
        return d5 + d6;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void notifyProgrammaticScroll(int i4, boolean z4) {
        this.mAdapterState = z4 ? 2 : 3;
        this.mFakeDragging = false;
        boolean z5 = this.mTarget != i4;
        this.mTarget = i4;
        dispatchStateChanged(2);
        if (z5) {
            dispatchSelected(i4);
