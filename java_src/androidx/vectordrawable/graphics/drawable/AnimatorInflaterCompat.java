...
public class AnimatorInflaterCompat {
        ...
        public PathParser.PathDataNode[] evaluate(float f5, PathParser.PathDataNode[] pathDataNodeArr, PathParser.PathDataNode[] pathDataNodeArr2) {
            if (PathParser.canMorph(pathDataNodeArr, pathDataNodeArr2)) {
                ...
                for (int i4 = 0; i4 < pathDataNodeArr.length; i4++) {
                    this.mNodeArray[i4].interpolatePathDataNode(pathDataNodeArr[i4], pathDataNodeArr2[i4], f5);
                }
    ...
    private static void distributeKeyframes(Keyframe[] keyframeArr, float f5, int i4, int i5) {
        float f6 = f5 / ((i5 - i4) + 2);
        while (i4 <= i5) {
            keyframeArr[i4].setFraction(keyframeArr[i4 - 1].getFraction() + f6);
            i4++;
        }
    }
    ...
    private static PropertyValuesHolder getPVH(TypedArray typedArray, int i4, int i5, int i6, String str) {
        ...
        int i11 = z5 ? peekValue2.type : 0;
        if (i4 == 4) {
            i4 = ((z4 && isColorType(i10)) || (z5 && isColorType(i11))) ? 3 : 0;
        }
        boolean z6 = i4 == 0;
        ...
        if (z6) {
            if (z4) {
                ...
                if (z5) {
                    if (i11 == 5) {
                        f7 = typedArray.getDimension(i6, 0.0f);
                    } else {
                        f7 = typedArray.getFloat(i6, 0.0f);
                    }
    ...
    private static int inferValueTypeFromValues(TypedArray typedArray, int i4, int i5) {
        ...
        boolean z5 = peekValue2 != null;
        return ((z4 && isColorType(i6)) || (z5 && isColorType(z5 ? peekValue2.type : 0))) ? 3 : 0;
    }
    ...
    private static Keyframe loadKeyframe(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i4, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        TypedValue peekNamedValue = TypedArrayUtils.peekNamedValue(obtainAttributes, xmlPullParser, "value", 0);
        boolean z4 = peekNamedValue != null;
        if (i4 == 4) {
            i4 = (z4 && isColorType(peekNamedValue.type)) ? 3 : 0;
        }
        if (z4) {
            if (i4 != 0) {
    ...
    private static void setupObjectAnimator(ValueAnimator valueAnimator, TypedArray typedArray, int i4, float f5, XmlPullParser xmlPullParser) {
    ...
    */
    ...
    public static Animator loadAnimator(Context context, Resources resources, Resources.Theme theme, @AnimatorRes int i4, float f5) throws Resources.NotFoundException {
