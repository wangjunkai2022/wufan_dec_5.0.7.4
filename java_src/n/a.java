...
public final class a extends SQLiteOpenHelper {
    ...
    private static final String f71673c = "msp.db";

    /* renamed from: d  reason: collision with root package name */
    private static final int f71674d = 1;

    /* renamed from: b  reason: collision with root package name */
    private WeakReference<Context> f71675b;

    public a(Context context) {
        super(context, f71673c, (SQLiteDatabase.CursorFactory) null, 1);
        this.f71675b = new WeakReference<>(context);
    }
    ...
    */
    private java.util.List<java.lang.String> a() {
        ...
        L10:
            ...
            if (r4 != 0) goto L10
            java.lang.ref.WeakReference<android.content.Context> r4 = r6.f71675b     // Catch: java.lang.Throwable -> L40 java.lang.Exception -> L42
    ...
    private void g(SQLiteDatabase sQLiteDatabase, String str, String str2, String str3, String str4) {
        String a5 = com.alipay.sdk.encrypt.b.a(1, str3, com.alipay.sdk.util.b.h(this.f71675b.get()));
        String u4 = u(str, str2);
        sQLiteDatabase.execSQL("insert into tb_tid (name, tid, key_tid, dt) values (?, ?, ?, datetime('now', 'localtime'))", new Object[]{u4, a5, str4});
        Cursor rawQuery = sQLiteDatabase.rawQuery("select name from tb_tid where tid!='' order by dt asc", null);
        if (rawQuery.getCount() <= 14) {
            rawQuery.close();
            return;
    ...
    private static boolean k(SQLiteDatabase sQLiteDatabase, String str, String str2) {
        ...
        Cursor cursor = null;
        try {
            cursor = sQLiteDatabase.rawQuery("select count(*) from tb_tid where name=?", new String[]{u(str, str2)});
    ...
    private void p(SQLiteDatabase sQLiteDatabase, String str, String str2, String str3, String str4) {
        sQLiteDatabase.execSQL("update tb_tid set tid=?, key_tid=?, dt=datetime('now', 'localtime') where name=?", new Object[]{com.alipay.sdk.encrypt.b.a(1, str3, com.alipay.sdk.util.b.h(this.f71675b.get())), str4, u(str, str2)});
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private long t(java.lang.String r7, java.lang.String r8) {
        /*
            r6 = this;
            ...
            java.lang.String r7 = u(r7, r8)     // Catch: java.lang.Exception -> L42 java.lang.Throwable -> L44
            r8 = 0
        ...
        L68:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: n.a.t(java.lang.String, java.lang.String):long");
    }
    ...
    public final void j(String str, String str2, String str3, String str4) {
        ...
        try {
            if (k(writableDatabase, str, str2)) {
                p(writableDatabase, str, str2, str3, str4);
            } else {
                String a5 = com.alipay.sdk.encrypt.b.a(1, str3, com.alipay.sdk.util.b.h(this.f71675b.get()));
                String u4 = u(str, str2);
                writableDatabase.execSQL("insert into tb_tid (name, tid, key_tid, dt) values (?, ?, ?, datetime('now', 'localtime'))", new Object[]{u4, a5, str4});
    ...
    */
    public final java.lang.String l(java.lang.String r5, java.lang.String r6) {
        /*
            ...
            java.lang.String r5 = u(r5, r6)     // Catch: java.lang.Throwable -> L31 java.lang.Exception -> L33
            r6 = 0
        ...
        L58:
            ...
            if (r5 != 0) goto L6f
            java.lang.ref.WeakReference<android.content.Context> r5 = r4.f71675b
        ...
        L6f:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: n.a.l(java.lang.String, java.lang.String):java.lang.String");
    }
    ...
    */
    public final java.lang.String r(java.lang.String r5, java.lang.String r6) {
        ...
        L58:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: n.a.r(java.lang.String, java.lang.String):java.lang.String");
    }
}
