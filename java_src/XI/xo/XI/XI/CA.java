...
public class CA {
    ...
    public static kM XI(Cursor cursor) {
        ...
        if (columnIndex >= 0) {
            kMVar.f20XI = cursor.getString(columnIndex);
        }
    ...
    */
    public final java.lang.String XI(android.content.Context r14, XI.xo.XI.XI.XI r15) {
        ...
        L1f:
            ...
            java.lang.String r0 = r2.f20XI     // Catch: java.lang.Throwable -> L7e java.lang.Exception -> L81
            ...
            r15.f19XI = r3     // Catch: java.lang.Throwable -> L7e java.lang.Exception -> L81
