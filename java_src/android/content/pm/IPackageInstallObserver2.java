...
public interface IPackageInstallObserver2 extends IInterface {
    ...
    public static class Default implements IPackageInstallObserver2 {
        ...
        public void onPackageInstalled(String str, int i4, String str2, Bundle bundle) throws RemoteException {
        }
            ...
            public void onPackageInstalled(String str, int i4, String str2, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(2, obtain, obtain2, 0) && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().onPackageInstalled(str, i4, str2, bundle);
                    } else {
    ...
    void onPackageInstalled(String str, int i4, String str2, Bundle bundle) throws RemoteException;
