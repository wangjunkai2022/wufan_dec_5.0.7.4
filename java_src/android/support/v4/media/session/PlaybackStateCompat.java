...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final class Builder {
        ...
        public Builder setState(int i4, long j4, float f5) {
            return setState(i4, j4, f5, SystemClock.elapsedRealtime());
        }
        ...
        public Builder setState(int i4, long j4, float f5, long j5) {
            this.mState = i4;
            this.mPosition = j4;
            this.mUpdateTime = j5;
            this.mRate = f5;
