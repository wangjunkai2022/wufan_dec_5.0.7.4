...
public class HashedWheelTimer implements Timer {
    ...
    public static final class HashedWheelTimeout implements Timeout {
        private static final AtomicIntegerFieldUpdater<HashedWheelTimeout> STATE_UPDATER = AtomicIntegerFieldUpdater.newUpdater(HashedWheelTimeout.class, NoticeTopAnimActivityDialog_.f36148o);
            ...
            if (compareAndSetState(0, 2)) {
                try {
                    ...
                    if (internalLogger.isWarnEnabled()) {
                        internalLogger.warn("An exception was thrown by " + TimerTask.class.getSimpleName() + d.f68897a, th);
                    }
                }
            }
        }
    ...
    public HashedWheelTimer(ThreadFactory threadFactory, long j4, TimeUnit timeUnit, int i4, boolean z4) {
        this(threadFactory, j4, timeUnit, i4, z4, -1L);
    }

    public HashedWheelTimer(ThreadFactory threadFactory, long j4, TimeUnit timeUnit, int i4, boolean z4, long j5) {
        ...
        ObjectUtil.checkNotNull(timeUnit, "unit");
        ObjectUtil.checkPositive(j4, "tickDuration");
        ObjectUtil.checkPositive(i4, "ticksPerWheel");
        ...
        if (nanos < Long.MAX_VALUE / createWheel.length) {
            ...
            if (nanos < j6) {
                logger.warn("Configured tickDuration {} smaller then {}, using 1ms.", Long.valueOf(j4), Long.valueOf(j6));
            ...
            this.leak = (z4 || !newThread.isDaemon()) ? leakDetector.track(this) : resourceLeakTracker;
