...
public final class NetUtil {
    ...
    */
    ...
    private static boolean isValidIPv4Mapped(byte[] bArr, int i4, int i5, int i6) {
        boolean z4 = i6 + i5 >= 14;
        return i4 <= 12 && i4 >= 2 && (!z4 || i5 < 12) && isValidIPv4MappedSeparators(bArr[i4 + (-1)], bArr[i4 + (-2)], z4) && PlatformDependent.isZero(bArr, 0, i4 + (-3));
    }
    ...
    private static boolean isValidIpV4Address0(CharSequence charSequence, int i4, int i5) {
        ...
        int indexOf3;
        int i8 = i5 - i4;
        return i8 <= 15 && i8 >= 7 && (indexOf = AsciiString.indexOf(charSequence, d.f68897a, i4 + 1)) > 0 && isValidIpV4Word(charSequence, i4, indexOf) && (indexOf2 = AsciiString.indexOf(charSequence, d.f68897a, (i6 = indexOf + 2))) > 0 && isValidIpV4Word(charSequence, i6 - 1, indexOf2) && (indexOf3 = AsciiString.indexOf(charSequence, d.f68897a, (i7 = indexOf2 + 2))) > 0 && isValidIpV4Word(charSequence, i7 - 1, indexOf3) && isValidIpV4Word(charSequence, indexOf3 + 1, i5);
    }
    ...
    private static StringBuilder newSocketAddressStringBuilder(String str, String str2, boolean z4) {
    ...
    public static Inet6Address getByName(CharSequence charSequence, boolean z4) {
        byte[] iPv6ByName = getIPv6ByName(charSequence, z4);
        if (iPv6ByName == null) {
            return null;
        }
        try {
    ...
    public static String toAddressString(InetAddress inetAddress, boolean z4) {
        if (inetAddress instanceof Inet4Address) {
            return inetAddress.getHostAddress();
        }
        if (inetAddress instanceof Inet6Address) {
            return toAddressString(inetAddress.getAddress(), 0, z4);
        }
    ...
    private static String toAddressString(byte[] bArr, int i4, boolean z4) {
        int i5;
        int i6;
        int[] iArr = new int[8];
        int i7 = i4 + 8;
    ...
    private static boolean isValidIpV4Address(AsciiString asciiString, int i4, int i5) {
        ...
        int indexOf3;
        int i8 = i5 - i4;
        return i8 <= 15 && i8 >= 7 && (indexOf = asciiString.indexOf(d.f68897a, i4 + 1)) > 0 && isValidIpV4Word(asciiString, i4, indexOf) && (indexOf2 = asciiString.indexOf(d.f68897a, (i6 = indexOf + 2))) > 0 && isValidIpV4Word(asciiString, i6 - 1, indexOf2) && (indexOf3 = asciiString.indexOf(d.f68897a, (i7 = indexOf2 + 2))) > 0 && isValidIpV4Word(asciiString, i7 - 1, indexOf3) && isValidIpV4Word(asciiString, indexOf3 + 1, i5);
    }
}
