...
public final class PlatformDependent0 {
        ...
        if (explicitNoUnsafeCause0 != null) {
            ...
            if (unsafe != null) {
                Object doPrivileged2 = AccessController.doPrivileged(new PrivilegedAction<Object>() { // from class: io.netty.util.internal.PlatformDependent0.2
                    ...
                    public Object run() {
                        try {
                            Class<?> cls = Unsafe.this.getClass();
                ...
                Object doPrivileged3 = AccessController.doPrivileged(new PrivilegedAction<Object>() { // from class: io.netty.util.internal.PlatformDependent0.3
                    ...
                    public Object run() {
                        try {
                            ...
                            if (Unsafe.this.getLong(allocateDirect, Unsafe.this.objectFieldOffset(declaredField)) == 0) {
                                return null;
                            }
        ...
        if (unsafe == null) {
            ...
            try {
                ...
                if (doPrivileged5 instanceof Boolean) {
                    ...
                    logger.debug("java.nio.Bits.unaligned: available, {}", Boolean.valueOf(z4));
                } else {
                ...
                if (javaVersion() >= 9) {
                    ...
                    if (doPrivileged6 instanceof Throwable) {
                        ...
                        Object e5 = AccessController.doPrivileged(new PrivilegedAction<Object>() { // from class: io.netty.util.internal.PlatformDependent0.7
                            @Override // java.security.PrivilegedAction
                            public Object run() {
                                try {
                        ...
                        if (e5 instanceof Method) {
                            try {
                                Method method3 = (Method) e5;
    ...
    private static Throwable explicitNoUnsafeCause0() {
        boolean z4 = SystemPropertyUtil.getBoolean("io.netty.noUnsafe", false);
        InternalLogger internalLogger = logger;
        internalLogger.debug("-Dio.netty.noUnsafe: {}", Boolean.valueOf(z4));
        if (z4) {
    ...
    public static int hashCodeAsciiCompute(long j4, int i4) {
        return (i4 * HASH_CODE_C1) + (hashCodeAsciiSanitize((int) j4) * HASH_CODE_C2) + ((int) ((j4 & 2242545357458243584L) >>> 32));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int hashCodeAsciiSanitize(byte b5) {
        return b5 & 31;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int hashCodeAsciiSanitize(short s4) {
        return s4 & 7967;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void putShort(long j4, short s4) {
        UNSAFE.putShort(j4, s4);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void setMemory(long j4, long j5, byte b5) {
        UNSAFE.setMemory(j4, j5, b5);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void putByte(byte[] bArr, int i4, byte b5) {
        UNSAFE.putByte(bArr, BYTE_ARRAY_BASE_OFFSET + i4, b5);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void putShort(byte[] bArr, int i4, short s4) {
        UNSAFE.putShort(bArr, BYTE_ARRAY_BASE_OFFSET + i4, s4);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static void setMemory(Object obj, long j4, long j5, byte b5) {
        UNSAFE.setMemory(obj, j4, j5, b5);
    }
