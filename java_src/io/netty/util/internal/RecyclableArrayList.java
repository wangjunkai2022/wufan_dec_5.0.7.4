...
public final class RecyclableArrayList extends ArrayList<Object> {
    ...
    public Object set(int i4, Object obj) {
        Object obj2 = super.set(i4, ObjectUtil.checkNotNull(obj, "element"));
        this.insertSinceRecycled = true;
        return obj2;
    }
    ...
    private RecyclableArrayList(ObjectPool.Handle<RecyclableArrayList> handle, int i4) {
        super(i4);
        this.handle = handle;
    }
    ...
    public void add(int i4, Object obj) {
        super.add(i4, ObjectUtil.checkNotNull(obj, "element"));
        this.insertSinceRecycled = true;
    }
