...
final class LocationAwareSlf4JLogger extends AbstractInternalLogger {
    ...
    private void log(int i4, String str) {
        this.logger.log((Marker) null, FQCN, i4, str, (Object[]) null, (Throwable) null);
    }
    ...
    private void log(int i4, String str, Throwable th) {
        this.logger.log((Marker) null, FQCN, i4, str, (Object[]) null, th);
    }

    private void log(int i4, org.slf4j.helpers.FormattingTuple formattingTuple) {
        this.logger.log((Marker) null, FQCN, i4, formattingTuple.getMessage(), formattingTuple.getArgArray(), formattingTuple.getThrowable());
    }
