...
public final class ThrowableUtil {
    ...
    public static <T extends Throwable> T unknownStackTrace(T t4, Class<?> cls, String str) {
        t4.setStackTrace(new StackTraceElement[]{new StackTraceElement(cls.getName(), str, null, -1)});
        return t4;
    }
