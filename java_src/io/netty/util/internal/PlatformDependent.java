...
public final class PlatformDependent {
    ...
    static {
        ...
        boolean z4 = (cleaner2 == cleaner || SystemPropertyUtil.getBoolean("io.netty.noPreferDirect", false)) ? false : true;
        DIRECT_BUFFER_PREFERRED = z4;
        if (internalLoggerFactory.isDebugEnabled()) {
            internalLoggerFactory.debug("-Dio.netty.noPreferDirect: {}", Boolean.valueOf(true ^ z4));
        }
    ...
    private static int getIntSafe(byte[] bArr, int i4) {
        ...
        if (BIG_ENDIAN_NATIVE_ORDER) {
            i5 = (bArr[i4] << BinaryMemcacheOpcodes.FLUSHQ) | ((bArr[i4 + 1] & 255) << 16) | ((bArr[i4 + 2] & 255) << 8);
            i6 = bArr[i4 + 3] & 255;
        } else {
            i5 = (bArr[i4] & 255) | ((bArr[i4 + 1] & 255) << 8) | ((bArr[i4 + 2] & 255) << 16);
            i6 = bArr[i4 + 3] << BinaryMemcacheOpcodes.FLUSHQ;
        }
        return i6 | i5;
    }
    ...
    private static int hashCodeAsciiSanitizeByte(char c5) {
        return c5 & 31;
    }
    ...
    */
    ...
    public static void putByte(long j4, byte b5) {
        PlatformDependent0.putByte(j4, b5);
    }
    ...
    public static void putShort(long j4, short s4) {
        PlatformDependent0.putShort(j4, s4);
    }
    ...
    public static void setMemory(byte[] bArr, int i4, long j4, byte b5) {
        PlatformDependent0.setMemory(bArr, BYTE_ARRAY_BASE_OFFSET + i4, j4, b5);
    }
    ...
    public static void putByte(byte[] bArr, int i4, byte b5) {
        PlatformDependent0.putByte(bArr, i4, b5);
    }
    ...
    public static void putShort(byte[] bArr, int i4, short s4) {
        PlatformDependent0.putShort(bArr, i4, s4);
    }

    public static void setMemory(long j4, long j5, byte b5) {
        PlatformDependent0.setMemory(j4, j5, b5);
    }
    ...
    public static <K, V> ConcurrentMap<K, V> newConcurrentHashMap(int i4, float f5) {
        return new ConcurrentHashMap(i4, f5);
    }
    ...
    public static <K, V> ConcurrentMap<K, V> newConcurrentHashMap(int i4, float f5, int i5) {
        return new ConcurrentHashMap(i4, f5, i5);
    }
