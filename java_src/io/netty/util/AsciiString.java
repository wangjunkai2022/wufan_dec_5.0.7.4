...
public final class AsciiString implements CharSequence, Comparable<CharSequence> {
    ...
    public static final class AsciiCaseInsensitiveCharEqualityComparator implements CharEqualityComparator {
        ...
        public boolean equals(char c5, char c6) {
            return AsciiString.equalsIgnoreCase(c5, c6);
        }
    }
    ...
    public interface CharEqualityComparator {
        boolean equals(char c5, char c6);
    }
    ...
    public static char b2c(byte b5) {
        return (char) (b5 & 255);
    }
    ...
    private static byte c2b0(char c5) {
        return (byte) c5;
    }
    ...
    private static boolean equalsIgnoreCase(byte b5, byte b6) {
        return b5 == b6 || toLowerCase(b5) == toLowerCase(b6);
    }
    ...
    private static boolean isLowerCase(byte b5) {
        return b5 >= 97 && b5 <= 122;
    }

    public static boolean isUpperCase(byte b5) {
        return b5 >= 65 && b5 <= 90;
    }
    ...
    public static boolean regionMatchesAscii(CharSequence charSequence, boolean z4, int i4, CharSequence charSequence2, int i5, int i6) {
        if (charSequence == null || charSequence2 == null) {
            return false;
        }
        ...
        if (charSequence instanceof AsciiString) {
            return ((AsciiString) charSequence).regionMatches(z4, i4, charSequence2, i5, i6);
        }
        return regionMatchesCharSequences(charSequence, i4, charSequence2, i5, i6, z4 ? AsciiCaseInsensitiveCharEqualityComparator.INSTANCE : DefaultCharEqualityComparator.INSTANCE);
    }
    ...
    public AsciiString replace(char c5, char c6) {
        if (c5 > 255) {
            return this;
        }
        byte c2b0 = c2b0(c5);
        ...
        while (i4 < i5) {
            if (this.value[i4] == c2b0) {
                ...
                while (true) {
                    i4++;
                    if (i4 < i5) {
                        byte b5 = this.value[i4];
                        int i7 = i4 - this.offset;
                        if (b5 == c2b0) {
                            b5 = c2b;
                        }
                        allocateUninitializedArray[i7] = b5;
                    } else {
                        return new AsciiString(allocateUninitializedArray, false);
                    }
                }
    ...
    public AsciiString toLowerCase() {
        ...
        while (true) {
            ...
            byte b5 = this.value[arrayOffset];
            if (b5 >= 65 && b5 <= 90) {
                z4 = false;
                break;
            }
    ...
    public AsciiString(byte[] bArr, boolean z4) {
        this(bArr, 0, bArr.length, z4);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static boolean equalsIgnoreCase(char c5, char c6) {
        return c5 == c6 || toLowerCase(c5) == toLowerCase(c6);
    }
    ...
    public int indexOf(CharSequence charSequence, int i4) {
        ...
        if (length <= 0) {
            int i5 = this.length;
            return i4 < i5 ? i4 : i5;
        } else if (length <= this.length - i4 && (charAt = charSequence.charAt(0)) <= 255) {
    ...
    public AsciiString[] split(char c5) {
    ...
    public AsciiString(byte[] bArr, int i4, int i5, boolean z4) {
        if (z4) {
    ...
    public AsciiString subSequence(int i4, int i5, boolean z4) {
        int i6 = i5 - i4;
        if (!MathUtil.isOutOfBounds(i4, i6, length())) {
            if (i4 == 0 && i5 == length()) {
                return this;
            ...
            return new AsciiString(this.value, i4 + this.offset, i6, z4);
        }
    ...
    public boolean regionMatches(boolean z4, int i4, CharSequence charSequence, int i5, int i6) {
        if (!z4) {
    ...
    private static byte toLowerCase(byte b5) {
        return isUpperCase(b5) ? (byte) (b5 + 32) : b5;
    }

    private static byte toUpperCase(byte b5) {
        return isLowerCase(b5) ? (byte) (b5 - 32) : b5;
    }

    private int parseInt(int i4, int i5, int i6, boolean z4) {
    ...
    private long parseLong(int i4, int i5, int i6, boolean z4) {
        long j4 = i6;
    ...
    public static char toLowerCase(char c5) {
        return isUpperCase(c5) ? (char) (c5 + ' ') : c5;
    }
    ...
    public int indexOf(char c5, int i4) {
        if (c5 > 255) {
            return -1;
        }
        if (i4 < 0) {
    ...
    public AsciiString(ByteBuffer byteBuffer, boolean z4) {
        this(byteBuffer, byteBuffer.position(), byteBuffer.remaining(), z4);
    }

    public static boolean regionMatches(CharSequence charSequence, boolean z4, int i4, CharSequence charSequence2, int i5, int i6) {
        if (charSequence == null || charSequence2 == null) {
            return false;
        }
        ...
        return regionMatchesCharSequences(charSequence, i4, charSequence2, i5, i6, z4 ? GeneralCaseInsensitiveCharEqualityComparator.INSTANCE : DefaultCharEqualityComparator.INSTANCE);
    }

    public AsciiString(ByteBuffer byteBuffer, int i4, int i5, boolean z4) {
    ...
    public static int indexOf(CharSequence charSequence, char c5, int i4) {
        if (charSequence instanceof String) {
            return ((String) charSequence).indexOf(c5, i4);
        }
        if (charSequence instanceof AsciiString) {
            return ((AsciiString) charSequence).indexOf(c5, i4);
        }
        if (charSequence == null) {
            return -1;
        }
