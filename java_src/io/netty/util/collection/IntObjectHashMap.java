...
public class IntObjectHashMap<V> implements IntObjectMap<V> {
    ...
    public final class MapEntry implements Map.Entry<Integer, V> {
        ...
        public V setValue(V v2) {
            ...
            IntObjectHashMap.this.values[this.entryIndex] = IntObjectHashMap.toInternal(v2);
            return v4;
        }
    ...
    public void putAll(Map<? extends Integer, ? extends V> map) {
        if (map instanceof IntObjectHashMap) {
            ...
            while (true) {
                ...
                V v2 = vArr[i4];
                if (v2 != null) {
                    put(intObjectHashMap.keys[i4], (int) v2);
                }
                i4++;
            }
        } else {
    ...
    public IntObjectHashMap(int i4, float f5) {
    ...
    public V put2(Integer num, V v2) {
        return put(objectToKey(num), (int) v2);
    }
}
