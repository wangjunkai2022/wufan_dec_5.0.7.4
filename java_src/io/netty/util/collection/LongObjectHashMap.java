...
public class LongObjectHashMap<V> implements LongObjectMap<V> {
    ...
    public final class MapEntry implements Map.Entry<Long, V> {
        ...
        public V setValue(V v2) {
            ...
            LongObjectHashMap.this.values[this.entryIndex] = LongObjectHashMap.toInternal(v2);
            return v4;
        }
    ...
    public void putAll(Map<? extends Long, ? extends V> map) {
        if (map instanceof LongObjectHashMap) {
            ...
            while (true) {
                ...
                V v2 = vArr[i4];
                if (v2 != null) {
                    put(longObjectHashMap.keys[i4], (long) v2);
                }
                i4++;
            }
        } else {
    ...
    public LongObjectHashMap(int i4, float f5) {
    ...
    public V put2(Long l4, V v2) {
        return put(objectToKey(l4), (long) v2);
    }
}
