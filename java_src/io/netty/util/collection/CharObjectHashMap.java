...
public class CharObjectHashMap<V> implements CharObjectMap<V> {
    ...
    public final class MapEntry implements Map.Entry<Character, V> {
        ...
        public V setValue(V v2) {
            ...
            CharObjectHashMap.this.values[this.entryIndex] = CharObjectHashMap.toInternal(v2);
            return v4;
        }
    ...
    private static int hashCode(char c5) {
        return c5;
    }

    private int hashIndex(char c5) {
        return hashCode(c5) & this.mask;
    }

    private int indexOf(char c5) {
        int hashIndex = hashIndex(c5);
        int i4 = hashIndex;
    ...
    public boolean containsKey(char c5) {
        return indexOf(c5) >= 0;
    }
    ...
    @Override // io.netty.util.collection.CharObjectMap
    public V get(char c5) {
        int indexOf = indexOf(c5);
        if (indexOf == -1) {
            return null;
        }
    ...
    public String keyToString(char c5) {
    ...
    public void putAll(Map<? extends Character, ? extends V> map) {
        if (map instanceof CharObjectHashMap) {
            ...
            while (true) {
                ...
                V v2 = vArr[i4];
                if (v2 != null) {
                    put(charObjectHashMap.keys[i4], (char) v2);
                }
                i4++;
            }
        } else {
    ...
    public CharObjectHashMap(int i4, float f5) {
    ...
    public V put2(Character ch, V v2) {
        return put(objectToKey(ch), (char) v2);
    }
}
