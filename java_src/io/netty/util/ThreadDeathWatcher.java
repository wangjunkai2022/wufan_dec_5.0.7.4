...
public final class ThreadDeathWatcher {
    ...
    public static final class Entry {
        ...
        Entry(Thread thread, Runnable runnable, boolean z4) {
            this.thread = thread;
            this.task = runnable;
            this.isWatch = z4;
        }
    ...
    private static void schedule(Thread thread, Runnable runnable, boolean z4) {
        pendingEntries.add(new Entry(thread, runnable, z4));
