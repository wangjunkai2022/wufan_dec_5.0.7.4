...
public abstract class AbstractEventExecutor extends AbstractExecutorService implements EventExecutor {
    ...
    @Override // io.netty.util.concurrent.EventExecutor
    public <V> Future<V> newSucceededFuture(V v2) {
        return new SucceededFuture(this, v2);
    }

    @Override // java.util.concurrent.AbstractExecutorService
    protected final <T> RunnableFuture<T> newTaskFor(Runnable runnable, T t4) {
        return new PromiseTask(this, runnable, t4);
    }
    ...
    public <T> Future<T> submit(Runnable runnable, T t4) {
        return (Future) super.submit(runnable, (Runnable) t4);
    }
