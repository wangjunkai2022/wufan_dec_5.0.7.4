...
public class SimpleChannelPool implements ChannelPool {
    ...
    private Future<Channel> acquireHealthyFromPoolOrNew(final Promise<Channel> promise) {
        ...
        if (pollChannel == null) {
            Bootstrap mo29clone = this.bootstrap.mo29clone();
    ...
    public SimpleChannelPool(Bootstrap bootstrap, ChannelPoolHandler channelPoolHandler, ChannelHealthChecker channelHealthChecker, boolean z4) {
        this(bootstrap, channelPoolHandler, channelHealthChecker, z4, true);
    }

    public SimpleChannelPool(Bootstrap bootstrap, final ChannelPoolHandler channelPoolHandler, ChannelHealthChecker channelHealthChecker, boolean z4, boolean z5) {
        ...
        this.releaseHealthCheck = z4;
        Bootstrap mo29clone = ((Bootstrap) ObjectUtil.checkNotNull(bootstrap, "bootstrap")).mo29clone();
        this.bootstrap = mo29clone;
        mo29clone.handler(new ChannelInitializer<Channel>() { // from class: io.netty.channel.pool.SimpleChannelPool.1
            static final /* synthetic */ boolean $assertionsDisabled = false;
