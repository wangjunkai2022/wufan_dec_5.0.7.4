...
public class AdaptiveRecvByteBufAllocator extends DefaultMaxMessagesRecvByteBufAllocator {
    ...
    private final class HandleImpl extends DefaultMaxMessagesRecvByteBufAllocator.MaxMessageHandle {
        ...
        HandleImpl(int i4, int i5, int i6) {
            super();
            this.minIndex = i4;
            this.maxIndex = i5;
        ...
        private void record(int i4) {
            if (i4 <= AdaptiveRecvByteBufAllocator.SIZE_TABLE[Math.max(0, this.index - 1)]) {
                if (this.decreaseNow) {
        ...
        public void lastBytesRead(int i4) {
            if (i4 == attemptedBytesRead()) {
                record(i4);
            }
            super.lastBytesRead(i4);
        }
    ...
    public AdaptiveRecvByteBufAllocator(int i4, int i5, int i6) {
        ObjectUtil.checkPositive(i4, "minimum");
        if (i5 < i4) {
    ...
    public AdaptiveRecvByteBufAllocator respectMaybeMoreData(boolean z4) {
