...
final class LinuxSocket extends Socket {
    ...
    private static final InetAddress INET_ANY = unsafeInetAddrByName(b.f54683j);
    private static final long MAX_UINT32_T = 4294967295L;

    /* JADX INFO: Access modifiers changed from: package-private */
    public LinuxSocket(int i4) {
        super(i4);
    }

    private static InetAddress deriveInetAddress(NetworkInterface networkInterface, boolean z4) {
        InetAddress inetAddress = z4 ? INET6_ANY : INET_ANY;
        if (networkInterface != null) {
            Enumeration<InetAddress> inetAddresses = networkInterface.getInetAddresses();
            while (inetAddresses.hasMoreElements()) {
                InetAddress nextElement = inetAddresses.nextElement();
                if ((nextElement instanceof Inet6Address) == z4) {
                    return nextElement;
                }
            }
        }
    ...
    private static native int getInterface(int i4, boolean z4);

    private static native int getIpMulticastLoop(int i4, boolean z4) throws IOException;
    ...
    private static native void joinGroup(int i4, boolean z4, byte[] bArr, byte[] bArr2, int i5, int i6) throws IOException;

    private static native void joinSsmGroup(int i4, boolean z4, byte[] bArr, byte[] bArr2, int i5, int i6, byte[] bArr3) throws IOException;

    private static native void leaveGroup(int i4, boolean z4, byte[] bArr, byte[] bArr2, int i5, int i6) throws IOException;

    private static native void leaveSsmGroup(int i4, boolean z4, byte[] bArr, byte[] bArr2, int i5, int i6, byte[] bArr3) throws IOException;

    public static LinuxSocket newSocketDgram(boolean z4) {
        return new LinuxSocket(Socket.newSocketDgram0(z4));
    }
    ...
    public static LinuxSocket newSocketStream(boolean z4) {
        return new LinuxSocket(Socket.newSocketStream0(z4));
    }
    ...
    private static native void setInterface(int i4, boolean z4, byte[] bArr, int i5, int i6) throws IOException;

    private static native void setIpFreeBind(int i4, int i5) throws IOException;

    private static native void setIpMulticastLoop(int i4, boolean z4, int i5) throws IOException;
    ...
    private static native void setTcpMd5Sig(int i4, boolean z4, byte[] bArr, int i5, byte[] bArr2) throws IOException;
    ...
    public NetworkInterface getNetworkInterface() throws IOException {
        int i4 = getInterface(intValue(), this.ipv6);
        if (this.ipv6) {
            if (PlatformDependent.javaVersion() >= 7) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public int recvmmsg(NativeDatagramPacketArray.NativeDatagramPacket[] nativeDatagramPacketArr, int i4, int i5) throws IOException {
        return Native.recvmmsg(intValue(), this.ipv6, nativeDatagramPacketArr, i4, i5);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public int sendmmsg(NativeDatagramPacketArray.NativeDatagramPacket[] nativeDatagramPacketArr, int i4, int i5) throws IOException {
        return Native.sendmmsg(intValue(), this.ipv6, nativeDatagramPacketArr, i4, i5);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void setIpFreeBind(boolean z4) throws IOException {
        setIpFreeBind(intValue(), z4 ? 1 : 0);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void setIpRecvOrigDestAddr(boolean z4) throws IOException {
        setIpRecvOrigDestAddr(intValue(), z4 ? 1 : 0);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void setIpTransparent(boolean z4) throws IOException {
        setIpTransparent(intValue(), z4 ? 1 : 0);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void setLoopbackModeDisabled(boolean z4) throws IOException {
        setIpMulticastLoop(intValue(), this.ipv6, !z4 ? 1 : 0);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void setSoBusyPoll(int i4) throws IOException {
        setSoBusyPoll(intValue(), i4);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void setTcpCork(boolean z4) throws IOException {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void setTcpFastOpen(int i4) throws IOException {
        setTcpFastOpen(intValue(), i4);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void setTcpFastOpenConnect(boolean z4) throws IOException {
        setTcpFastOpenConnect(intValue(), z4 ? 1 : 0);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void setTcpKeepCnt(int i4) throws IOException {
        setTcpKeepCnt(intValue(), i4);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void setTcpKeepIdle(int i4) throws IOException {
        setTcpKeepIdle(intValue(), i4);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void setTcpKeepIntvl(int i4) throws IOException {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void setTcpQuickAck(boolean z4) throws IOException {
        setTcpQuickAck(intValue(), z4 ? 1 : 0);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void setTcpUserTimeout(int i4) throws IOException {
        setTcpUserTimeout(intValue(), i4);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void setTimeToLive(int i4) throws IOException {
