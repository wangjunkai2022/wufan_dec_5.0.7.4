...
public final class EpollServerSocketChannel extends AbstractEpollServerChannel implements ServerSocketChannel {
    ...
    protected Channel newChildChannel(int i4, byte[] bArr, int i5, int i6) throws Exception {
        return new EpollSocketChannel(this, new LinuxSocket(i4), NativeInetAddress.address(bArr, i5, i6));
    }
    ...
    public EpollServerSocketChannel(int i4) {
    ...
    EpollServerSocketChannel(LinuxSocket linuxSocket, boolean z4) {
