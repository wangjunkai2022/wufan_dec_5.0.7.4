...
class NioDatagramChannelConfig extends DefaultDatagramChannelConfig {
                        ...
                        if (cls3 == null) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    throw new Error("cannot locate the setOption() method", e5);
                                }
                            } catch (Exception e6) {
                                throw new Error("cannot locate the getOption() method", e6);
                            }
                        }
                        obj3 = obj4;
                    } catch (Exception e7) {
                        throw new Error("cannot locate the IP_MULTICAST_LOOP field", e7);
                    }
                } catch (Exception e8) {
                    throw new Error("cannot locate the IP_MULTICAST_IF field", e8);
                }
            } catch (Exception e9) {
                throw new Error("cannot locate the IP_MULTICAST_TTL field", e9);
            }
        } else {
            method = null;
            declaredMethod = null;
    ...
    public DatagramChannelConfig setLoopbackModeDisabled(boolean z4) {
        setOption0(IP_MULTICAST_LOOP, Boolean.valueOf(z4));
        return this;
    }
    ...
    public <T> boolean setOption(ChannelOption<T> channelOption, T t4) {
        if (PlatformDependent.javaVersion() >= 7 && (channelOption instanceof NioChannelOption)) {
            return NioChannelOption.setOption(this.javaChannel, (NioChannelOption) channelOption, t4);
        }
