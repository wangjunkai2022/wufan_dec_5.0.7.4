...
public class NioServerSocketChannel extends AbstractNioMessageChannel implements ServerSocketChannel {
    ...
    private final class NioServerSocketChannelConfig extends DefaultServerSocketChannelConfig {
        private java.nio.channels.ServerSocketChannel jdkChannel() {
            return ((NioServerSocketChannel) this.channel).mo30javaChannel();
        }
    ...
    protected int doReadMessages(List<Object> list) throws Exception {
        SocketChannel accept = SocketUtils.accept(mo30javaChannel());
        if (accept != null) {
            try {
    ...
    public boolean isActive() {
        return isOpen() && mo30javaChannel().socket().isBound();
    }
    ...
    public java.nio.channels.ServerSocketChannel mo30javaChannel() {
        return (java.nio.channels.ServerSocketChannel) super.mo30javaChannel();
    }
    ...
    public NioServerSocketChannel(java.nio.channels.ServerSocketChannel serverSocketChannel) {
        ...
        this.config = new NioServerSocketChannelConfig(this, mo30javaChannel().socket());
    }
}
