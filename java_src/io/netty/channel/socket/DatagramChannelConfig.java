...
public interface DatagramChannelConfig extends ChannelConfig {
    ...
    @Override // io.netty.channel.ChannelConfig
    DatagramChannelConfig setAutoClose(boolean z4);

    @Override // io.netty.channel.ChannelConfig
    DatagramChannelConfig setAutoRead(boolean z4);

    DatagramChannelConfig setBroadcast(boolean z4);
    ...
    DatagramChannelConfig setLoopbackModeDisabled(boolean z4);
    ...
    DatagramChannelConfig setReuseAddress(boolean z4);
