...
final class KQueueEventArray {
    ...
    private static native void evSet(long j4, int i4, short s4, short s5, int i5);
    ...
    public void evSet(AbstractKQueueChannel abstractKQueueChannel, short s4, short s5, int i4) {
        ...
        int i5 = this.size;
        this.size = i5 + 1;
        evSet(getKEventOffset(i5) + this.memoryAddress, abstractKQueueChannel.socket.intValue(), s4, s5, i4);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void realloc(boolean z4) {
