...
public class KQueueChannelConfig extends DefaultChannelConfig {
    ...
    public <T> boolean setOption(ChannelOption<T> channelOption, T t4) {
        ...
        if (channelOption == KQueueChannelOption.RCV_ALLOC_TRANSPORT_PROVIDES_GUESS) {
            setRcvAllocTransportProvidesGuess(((Boolean) t4).booleanValue());
            return true;
        }
        return super.setOption(channelOption, t4);
    }

    public KQueueChannelConfig setRcvAllocTransportProvidesGuess(boolean z4) {
        this.transportProvidesGuess = z4;
        return this;
    }
    ...
    @Override // io.netty.channel.DefaultChannelConfig, io.netty.channel.ChannelConfig
    public KQueueChannelConfig setAutoRead(boolean z4) {
