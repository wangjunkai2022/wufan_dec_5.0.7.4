...
public abstract class AbstractKQueueChannel extends AbstractChannel implements UnixChannel {
        ...
        */
        ...
        public final void clearReadFilter0() {
            try {
                ...
                AbstractKQueueChannel.this.pipeline().fireExceptionCaught((Throwable) e5);
        ...
        public final void readReadyFinally(ChannelConfig channelConfig) {
            ...
            if (!this.allocHandle.isReadEOF() && (!(z4 = this.readPending) || !this.maybeMoreDataToRead)) {
        ...
        public void shutdownInput(boolean z4) {
            if (z4 && AbstractKQueueChannel.this.connectPromise != null) {
                finishConnect();
            }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public AbstractKQueueChannel(Channel channel, BsdSocket bsdSocket, boolean z4) {
        super(channel);
    ...
    private void evSet(short s4, short s5) {
        if (isRegistered()) {
            evSet0(s4, s5);
        }
    }

    private void evSet0(short s4, short s5) {
        evSet0(s4, s5, 0);
    }
    ...
    void readFilter(boolean z4) throws IOException {
        if (this.readFilterEnabled != z4) {
            this.readFilterEnabled = z4;
            evSet(Native.EVFILT_READ, z4 ? Native.EV_ADD_CLEAR_ENABLE : Native.EV_DELETE_DISABLE);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void writeFilter(boolean z4) throws IOException {
        if (this.writeFilterEnabled != z4) {
            this.writeFilterEnabled = z4;
            evSet(Native.EVFILT_WRITE, z4 ? Native.EV_ADD_CLEAR_ENABLE : Native.EV_DELETE_DISABLE);
        }
    }

    private void evSet0(short s4, short s5, int i4) {
        if (isOpen()) {
            ((KQueueEventLoop) eventLoop()).evSet(this, s4, s5, i4);
        }
    }
