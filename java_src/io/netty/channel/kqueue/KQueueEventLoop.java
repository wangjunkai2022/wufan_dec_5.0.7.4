...
public final class KQueueEventLoop extends SingleThreadEventLoop {
    ...
    private int kqueueWait(boolean z4) throws IOException {
        if (z4 && hasTasks()) {
            return kqueueWaitNow();
        }
        long delayNanos = delayNanos(System.nanoTime());
        int min = (int) Math.min(delayNanos / k.f60238a, 2147483647L);
        return kqueueWait(min, (int) Math.min(delayNanos - (min * k.f60238a), 2147483647L));
    }
    ...
    protected void cleanup() {
        try {
            try {
                ...
                logger.warn("Failed to close the kqueue fd.", (Throwable) e5);
            }
        } finally {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void evSet(AbstractKQueueChannel abstractKQueueChannel, short s4, short s5, int i4) {
        this.changeList.evSet(abstractKQueueChannel, s4, s5, i4);
    }
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(16:(2:1|2)|(1:50)(2:4|(2:49|33)(3:6|7|(11:9|10|11|(2:(1:14)|15)(3:38|(1:40)|41)|16|(1:20)|21|22|24|(3:26|27|(2:29|30)(1:32))(1:34)|33)))|42|(1:44)(1:48)|45|(1:47)|10|11|(0)(0)|16|(2:18|20)|21|22|24|(0)(0)|33) */
    ...
    */
    ...
    public void wakeup(boolean z4) {
        if (z4 || !WAKEN_UP_UPDATER.compareAndSet(this, 0, 1)) {
            return;
        }
        wakeup();
    }
