...
public class DefaultChannelGroup extends AbstractSet<Channel> implements ChannelGroup {
    ...
    public boolean add(Channel channel) {
        boolean z4 = (channel instanceof ServerChannel ? this.serverChannels : this.nonServerChannels).putIfAbsent(channel.id(), channel) == null;
        if (z4) {
    ...
    public DefaultChannelGroup(EventExecutor eventExecutor, boolean z4) {
        this("group-0x" + Integer.toHexString(nextId.incrementAndGet()), eventExecutor, z4);
    }

    @Override // io.netty.channel.group.ChannelGroup
    public ChannelGroupFuture write(Object obj, ChannelMatcher channelMatcher, boolean z4) {
    ...
    @Override // io.netty.channel.group.ChannelGroup
    public ChannelGroupFuture writeAndFlush(Object obj, ChannelMatcher channelMatcher, boolean z4) {
        ChannelGroupFuture defaultChannelGroupFuture;
        ObjectUtil.checkNotNull(obj, "message");
        if (z4) {
            for (Channel channel : this.nonServerChannels.values()) {
    ...
    public DefaultChannelGroup(String str, EventExecutor eventExecutor, boolean z4) {
