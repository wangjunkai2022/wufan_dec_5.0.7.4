...
public class NioEventLoopGroup extends MultithreadEventLoopGroup {
    ...
    public void setIoRatio(int i4) {
        Iterator<EventExecutor> it2 = iterator();
        while (it2.hasNext()) {
            ((NioEventLoop) it2.next()).setIoRatio(i4);
        }
    }
    ...
    public NioEventLoopGroup(int i4, Executor executor, EventExecutorChooserFactory eventExecutorChooserFactory, SelectorProvider selectorProvider, SelectStrategyFactory selectStrategyFactory, RejectedExecutionHandler rejectedExecutionHandler, EventLoopTaskQueueFactory eventLoopTaskQueueFactory) {
        super(i4, executor, eventExecutorChooserFactory, selectorProvider, selectStrategyFactory, rejectedExecutionHandler, eventLoopTaskQueueFactory);
    }
}
