...
public abstract class AbstractNioChannel extends AbstractChannel {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setReadPending0(boolean z4) {
        this.readPending = z4;
        if (z4) {
            return;
        }
    ...
    protected void doRegister() throws Exception {
        ...
        while (true) {
            try {
                this.selectionKey = mo30javaChannel().register(eventLoop().unwrappedSelector(), 0, this);
                return;
    ...
    public SelectableChannel mo30javaChannel() {
        return this.ch;
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Deprecated
    public void setReadPending(final boolean z4) {
        if (isRegistered()) {
            NioEventLoop eventLoop = eventLoop();
            if (eventLoop.inEventLoop()) {
                setReadPending0(z4);
                ...
                eventLoop.execute(new Runnable() { // from class: io.netty.channel.nio.AbstractNioChannel.2
                    @Override // java.lang.Runnable
                    public void run() {
                        AbstractNioChannel.this.setReadPending0(z4);
                    }
                });
                return;
            }
    ...
    public abstract class AbstractNioUnsafe extends AbstractChannel.AbstractUnsafe implements NioUnsafe {
        ...
        public final SelectableChannel ch() {
            return AbstractNioChannel.this.mo30javaChannel();
        }
