...
public class DefaultChannelPipeline implements ChannelPipeline {
        ...
        void execute() {
            ...
            try {
                ...
                if (DefaultChannelPipeline.logger.isWarnEnabled()) {
                    DefaultChannelPipeline.logger.warn("Can't invoke handlerAdded() as the EventExecutor {} rejected it, removing handler {}.", executor, this.ctx.name(), e5);
                }
    ...
    public final class PendingHandlerRemovedTask extends PendingHandlerCallback {
        ...
        void execute() {
            ...
            try {
                ...
                if (DefaultChannelPipeline.logger.isWarnEnabled()) {
                    DefaultChannelPipeline.logger.warn("Can't invoke handlerRemoved() as the EventExecutor {} rejected it, removing handler {}.", executor, this.ctx.name(), e5);
                }
                this.ctx.setRemoved();
            }
        }
    ...
    private void callHandlerCallbackLater(AbstractChannelHandlerContext abstractChannelHandlerContext, boolean z4) {
        PendingHandlerCallback pendingHandlerAddedTask = z4 ? new PendingHandlerAddedTask(abstractChannelHandlerContext) : new PendingHandlerRemovedTask(abstractChannelHandlerContext);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void destroyDown(Thread thread, final AbstractChannelHandlerContext abstractChannelHandlerContext, boolean z4) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void destroyUp(final AbstractChannelHandlerContext abstractChannelHandlerContext, boolean z4) {
        ...
        destroyDown(currentThread, abstractChannelHandlerContext2.prev, z4);
    }
