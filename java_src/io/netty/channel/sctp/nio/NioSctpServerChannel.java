...
public class NioSctpServerChannel extends AbstractNioMessageChannel implements SctpServerChannel {
    ...
    public NioSctpServerChannel() {
        ...
        this.config = new NioSctpServerChannelConfig(this, mo30javaChannel());
    }
    ...
    private static com.sun.nio.sctp.SctpServerChannel newSocket() {
        try {
            ...
            throw new ChannelException("Failed to open a server socket.", e5);
        }
    }
    ...
    protected void doBind(SocketAddress socketAddress) throws Exception {
        mo30javaChannel().bind(socketAddress, this.config.getBacklog());
    }
    ...
    protected int doReadMessages(List<Object> list) throws Exception {
        SctpChannel accept = mo30javaChannel().accept();
        if (accept == null) {
            return 0;
        }
    ...
    public com.sun.nio.sctp.SctpServerChannel mo30javaChannel() {
