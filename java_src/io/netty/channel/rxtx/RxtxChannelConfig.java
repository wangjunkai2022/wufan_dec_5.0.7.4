...
public interface RxtxChannelConfig extends ChannelConfig {
    ...
    @Override // io.netty.channel.ChannelConfig
    RxtxChannelConfig setAutoClose(boolean z4);

    @Override // io.netty.channel.ChannelConfig
    RxtxChannelConfig setAutoRead(boolean z4);
    ...
    RxtxChannelConfig setDtr(boolean z4);
    ...
    RxtxChannelConfig setRts(boolean z4);
