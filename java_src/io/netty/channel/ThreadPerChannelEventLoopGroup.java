...
public class ThreadPerChannelEventLoopGroup extends AbstractEventExecutorGroup implements EventLoopGroup {
    ...
    public ThreadPerChannelEventLoopGroup(int i4, Executor executor, Object... objArr) {
        ...
        ObjectUtil.checkPositiveOrZero(i4, "maxChannels");
        ...
        this.tooManyChannels = (ChannelException) ThrowableUtil.unknownStackTrace(ChannelException.newStatic("too many channels (max: " + i4 + ')', null), ThreadPerChannelEventLoopGroup.class, "nextChild()");
    }
