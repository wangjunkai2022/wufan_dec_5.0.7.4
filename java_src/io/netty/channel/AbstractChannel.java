...
public abstract class AbstractChannel extends DefaultAttributeMap implements Channel {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void validateFileRegion(DefaultFileRegion defaultFileRegion, long j4) throws IOException {
        DefaultFileRegion.validate(defaultFileRegion, j4);
    }
    ...
    public abstract class AbstractUnsafe implements Channel.Unsafe {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void fireChannelInactiveAndDeregister(boolean z4) {
            deregister(voidPromise(), z4 && !AbstractChannel.this.isActive());
        }
        ...
        public void invokeLater(Runnable runnable) {
            try {
                ...
                AbstractChannel.logger.warn("Can't invoke task later as EventLoop rejected it", (Throwable) e5);
            }
        }
        ...
        public void register0(ChannelPromise channelPromise) {
            try {
                if (channelPromise.setUncancellable() && ensureOpen(channelPromise)) {
                    boolean z4 = this.neverRegistered;
            ...
            if (AbstractChannel.this.isActive()) {
                try {
                    ...
                    invokeLater(new Runnable() { // from class: io.netty.channel.AbstractChannel.AbstractUnsafe.9
                        ...
                        public void run() {
                            AbstractChannel.this.pipeline.fireExceptionCaught((Throwable) e5);
                        }
                    });
                    close(voidPromise());
                }
        ...
        public final void closeForcibly() {
            ...
            try {
                ...
                AbstractChannel.logger.warn("Failed to close a channel.", (Throwable) e5);
            }
        }
        ...
        private void deregister(final ChannelPromise channelPromise, final boolean z4) {
            if (channelPromise.setUncancellable()) {
        ...
        private void close(final ChannelPromise channelPromise, final Throwable th, final ClosedChannelException closedChannelException, final boolean z4) {
            if (channelPromise.setUncancellable()) {
                                ...
                                AbstractUnsafe.this.invokeLater(new Runnable() { // from class: io.netty.channel.AbstractChannel.AbstractUnsafe.6.1
                                    ...
                                    public void run() {
                                        ...
                                        if (channelOutboundBuffer2 != null) {
                                            channelOutboundBuffer2.failFlushed(th, z4);
                ...
                try {
                    ...
                    if (channelOutboundBuffer != null) {
                        channelOutboundBuffer.failFlushed(th, z4);
                        channelOutboundBuffer.close(closedChannelException);
                    }
                }
            }
