...
public abstract class AbstractAddressResolver<T extends SocketAddress> implements AddressResolver<T> {
    ...
    protected abstract void doResolve(T t4, Promise<T> promise) throws Exception;

    protected abstract void doResolveAll(T t4, Promise<List<T>> promise) throws Exception;
    ...
    public final Future<T> resolve(SocketAddress socketAddress) {
        ...
        try {
            ...
            return executor().newFailedFuture(e5);
        }
    }
