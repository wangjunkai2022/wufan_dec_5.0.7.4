...
public abstract class DnsQueryContext implements FutureListener<AddressedEnvelope<DnsResponse, InetSocketAddress>> {
        ...
        if (queryTimeoutMillis > 0) {
            this.timeoutFuture = this.parent.ch.eventLoop().schedule(new Runnable() { // from class: io.netty.resolver.dns.DnsQueryContext.4
                ...
                public void run() {
                    ...
                    dnsQueryContext.tryFailure("query via " + DnsQueryContext.this.protocol() + " timed out after " + queryTimeoutMillis + " milliseconds", null, true);
                }
            }, queryTimeoutMillis, TimeUnit.MILLISECONDS);
        }
    }

    private void sendQuery(final DnsQuery dnsQuery, boolean z4, final ChannelPromise channelPromise) {
        if (this.parent.channelFuture.isDone()) {
            writeQuery(dnsQuery, z4, channelPromise);
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void writeQuery(DnsQuery dnsQuery, boolean z4, ChannelPromise channelPromise) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void query(boolean z4, ChannelPromise channelPromise) {
        ...
        sendQuery(newQuery, z4, channelPromise);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public boolean tryFailure(String str, Throwable th, boolean z4) {
