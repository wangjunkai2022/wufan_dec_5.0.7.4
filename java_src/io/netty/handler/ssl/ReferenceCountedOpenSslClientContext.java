...
public final class ReferenceCountedOpenSslClientContext extends ReferenceCountedOpenSslContext {
    ...
    public static final class OpenSslClientCertificateCallback implements CertificateCallback {
        ...
        private static String clientKeyType(byte b5) {
            if (b5 != 1) {
                if (b5 != 3) {
                    switch (b5) {
                        case 64:
        ...
        private static Set<String> supportedClientKeyTypes(byte[] bArr) {
            ...
            for (byte b5 : bArr) {
                String clientKeyType = clientKeyType(b5);
    ...
    public ReferenceCountedOpenSslClientContext(X509Certificate[] x509CertificateArr, TrustManagerFactory trustManagerFactory, X509Certificate[] x509CertificateArr2, PrivateKey privateKey, String str, KeyManagerFactory keyManagerFactory, Iterable<String> iterable, CipherSuiteFilter cipherSuiteFilter, ApplicationProtocolConfig applicationProtocolConfig, String[] strArr, long j4, long j5, boolean z4, String str2) throws SSLException {
        super(iterable, cipherSuiteFilter, applicationProtocolConfig, j4, j5, 0, (Certificate[]) x509CertificateArr2, ClientAuth.NONE, strArr, false, z4, true);
        try {
        ...
        try {
            try {
                ...
                try {
                    ...
                    setVerifyCallback(j4, openSslEngineMap, ReferenceCountedOpenSslContext.chooseTrustManager(trustManagerFactory.getTrustManagers()));
