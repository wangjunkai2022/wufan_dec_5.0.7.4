...
public abstract class SslContext {
    ...
    private static PrivateKey getPrivateKeyFromByteBuffer(ByteBuf byteBuf, String str) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeySpecException, InvalidAlgorithmParameterException, KeyException, IOException {
        ...
        try {
            try {
                ...
                throw new InvalidKeySpecException("Neither RSA, DSA nor EC worked", e5);
            }
    ...
    public static SslContext newClientContextInternal(SslProvider sslProvider, Provider provider, X509Certificate[] x509CertificateArr, TrustManagerFactory trustManagerFactory, X509Certificate[] x509CertificateArr2, PrivateKey privateKey, String str, KeyManagerFactory keyManagerFactory, Iterable<String> iterable, CipherSuiteFilter cipherSuiteFilter, ApplicationProtocolConfig applicationProtocolConfig, String[] strArr, long j4, long j5, boolean z4, String str2) throws SSLException {
        ...
        if (i4 == 1) {
            ...
            return new OpenSslClientContext(x509CertificateArr, trustManagerFactory, x509CertificateArr2, privateKey, str, keyManagerFactory, iterable, cipherSuiteFilter, applicationProtocolConfig, strArr, j4, j5, z4, str2);
        } else if (i4 == 3) {
            verifyNullSslContextProvider(defaultClientProvider, provider);
            return new ReferenceCountedOpenSslClientContext(x509CertificateArr, trustManagerFactory, x509CertificateArr2, privateKey, str, keyManagerFactory, iterable, cipherSuiteFilter, applicationProtocolConfig, strArr, j4, j5, z4, str2);
        } else {
    ...
    public static SslContext newServerContextInternal(SslProvider sslProvider, Provider provider, X509Certificate[] x509CertificateArr, TrustManagerFactory trustManagerFactory, X509Certificate[] x509CertificateArr2, PrivateKey privateKey, String str, KeyManagerFactory keyManagerFactory, Iterable<String> iterable, CipherSuiteFilter cipherSuiteFilter, ApplicationProtocolConfig applicationProtocolConfig, long j4, long j5, ClientAuth clientAuth, String[] strArr, boolean z4, boolean z5, String str2) throws SSLException {
        ...
        if (i4 == 1) {
            if (!z5) {
                return new JdkSslServerContext(provider, x509CertificateArr, trustManagerFactory, x509CertificateArr2, privateKey, str, keyManagerFactory, iterable, cipherSuiteFilter, applicationProtocolConfig, j4, j5, clientAuth, strArr, z4, str2);
            }
            ...
            return new OpenSslServerContext(x509CertificateArr, trustManagerFactory, x509CertificateArr2, privateKey, str, keyManagerFactory, iterable, cipherSuiteFilter, applicationProtocolConfig, j4, j5, clientAuth, strArr, z4, z5, str2);
        } else if (i4 == 3) {
            verifyNullSslContextProvider(defaultServerProvider, provider);
            return new ReferenceCountedOpenSslServerContext(x509CertificateArr, trustManagerFactory, x509CertificateArr2, privateKey, str, keyManagerFactory, iterable, cipherSuiteFilter, applicationProtocolConfig, j4, j5, clientAuth, strArr, z4, z5, str2);
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public SslHandler newHandler(ByteBufAllocator byteBufAllocator, boolean z4) {
        return new SslHandler(newEngine(byteBufAllocator), z4);
    }
    ...
    public SslHandler newHandler(ByteBufAllocator byteBufAllocator, boolean z4, Executor executor) {
        return new SslHandler(newEngine(byteBufAllocator), z4, executor);
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public SslHandler newHandler(ByteBufAllocator byteBufAllocator, String str, int i4, boolean z4) {
        return new SslHandler(newEngine(byteBufAllocator, str, i4), z4);
    }
    ...
    public SslHandler newHandler(ByteBufAllocator byteBufAllocator, String str, int i4, boolean z4, Executor executor) {
        return new SslHandler(newEngine(byteBufAllocator, str, i4), z4, executor);
    }
