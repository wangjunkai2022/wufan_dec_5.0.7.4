...
public final class OpenSslCachingX509KeyManagerFactory extends KeyManagerFactory {
    ...
    public OpenSslCachingX509KeyManagerFactory(final KeyManagerFactory keyManagerFactory, int i4) {
        ...
        this.maxCachedEntries = ObjectUtil.checkPositive(i4, "maxCachedEntries");
    }
}
