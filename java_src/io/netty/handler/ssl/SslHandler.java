...
public class SslHandler extends ByteToMessageDecoder implements ChannelOutboundHandler {
    ...
    public static abstract class SslEngineType {
        ...
        static {
            ...
            SslEngineType sslEngineType = new SslEngineType("TCNATIVE", 0, true, cumulator) { // from class: io.netty.handler.ssl.SslHandler.SslEngineType.1
                ...
                ByteBuf allocateWrapBuffer(SslHandler sslHandler, ByteBufAllocator byteBufAllocator, int i4, int i5) {
                    return byteBufAllocator.directBuffer(((ReferenceCountedOpenSslEngine) sslHandler.engine).calculateMaxLengthForWrap(i4, i5));
                }
            ...
            SslEngineType sslEngineType2 = new SslEngineType("CONSCRYPT", 1, true, cumulator) { // from class: io.netty.handler.ssl.SslHandler.SslEngineType.2
                @Override // io.netty.handler.ssl.SslHandler.SslEngineType
                ByteBuf allocateWrapBuffer(SslHandler sslHandler, ByteBufAllocator byteBufAllocator, int i4, int i5) {
                    return byteBufAllocator.directBuffer(((ConscryptAlpnSslEngine) sslHandler.engine).calculateOutNetBufSize(i4, i5));
                }
        ...
        abstract ByteBuf allocateWrapBuffer(SslHandler sslHandler, ByteBufAllocator byteBufAllocator, int i4, int i5);
        ...
        private SslEngineType(String str, int i4, boolean z4, ByteToMessageDecoder.Cumulator cumulator) {
                    ...
                    if (i4 == 2) {
                        ...
                        if (i4 == 4) {
                            ...
                            try {
                                ...
                                sslHandler5.handleUnwrapThrowable(sslHandler5.ctx, e5);
                                return;
                            }
                        } else {
    ...
    private ByteBuf allocateOutNetBuf(ChannelHandlerContext channelHandlerContext, int i4, int i5) {
        return this.engineType.allocateWrapBuffer(this, channelHandlerContext.alloc(), i4, i5);
    }

    private void applyHandshakeTimeout() {
        final Promise<Channel> promise = this.handshakePromise;
        final long j4 = this.handshakeTimeoutMillis;
        ...
        final ScheduledFuture<?> schedule = this.ctx.executor().schedule(new Runnable() { // from class: io.netty.handler.ssl.SslHandler.5
            ...
            public void run() {
                ...
                SslHandshakeTimeoutException sslHandshakeTimeoutException = new SslHandshakeTimeoutException("handshake timed out after " + j4 + "ms");
                try {
    ...
    private void closeOutboundAndChannel(ChannelHandlerContext channelHandlerContext, final ChannelPromise channelPromise, boolean z4) throws Exception {
        this.outboundClosed = true;
        this.engine.closeOutbound();
    ...
    private void finishWrap(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf, ChannelPromise channelPromise, boolean z4, boolean z5) {
        if (byteBuf == null) {
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean wrapNonAppData(final ChannelHandlerContext channelHandlerContext, boolean z4) throws SSLException {
        ByteBufAllocator alloc = channelHandlerContext.alloc();
    ...
    public SslHandler(SSLEngine sSLEngine, boolean z4) {
        this(sSLEngine, z4, ImmediateExecutor.INSTANCE);
    }

    private void setHandshakeFailure(ChannelHandlerContext channelHandlerContext, Throwable th, boolean z4, boolean z5, boolean z6) {
        String message;
        try {
            this.outboundClosed = true;
            this.engine.closeOutbound();
            if (z4) {
                try {
                    ...
                    InternalLogger internalLogger = logger;
                    if (internalLogger.isDebugEnabled() && ((message = e5.getMessage()) == null || (!message.contains("possible truncation attack") && !message.contains("closing inbound before receiving peer's close_notify")))) {
                        internalLogger.debug("{} SSLEngine.closeInbound() raised an exception.", channelHandlerContext.channel(), e5);
                    }
                }
            }
            if (this.handshakePromise.tryFailure(th) || z6) {
                SslUtils.handleHandshakeFailure(channelHandlerContext, th, z5);
            }
        } finally {
    ...
    public SslHandler(SSLEngine sSLEngine, boolean z4, Executor executor) {
        ...
        this.handshakeTimeoutMillis = c.f49010a;
