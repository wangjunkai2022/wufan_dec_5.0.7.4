...
public final class SslUtils {
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void handleHandshakeFailure(ChannelHandlerContext channelHandlerContext, Throwable th, boolean z4) {
    ...
    public static boolean isValidHostNameForSNI(String str) {
        return (str == null || str.indexOf(46) <= 0 || str.endsWith(h0.f27805a) || NetUtil.isValidIpV4Address(str) || NetUtil.isValidIpV6Address(str)) ? false : true;
    }
    ...
    private static int unsignedShortBE(ByteBuffer byteBuffer, int i4) {
        return shortBE(byteBuffer, i4) & UShort.MAX_VALUE;
    }
