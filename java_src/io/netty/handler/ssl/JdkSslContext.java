...
public class JdkSslContext extends SslContext {
    ...
    @Deprecated
    public JdkSslContext(SSLContext sSLContext, boolean z4, ClientAuth clientAuth) {
        this(sSLContext, z4, (Iterable<String>) null, (CipherSuiteFilter) IdentityCipherSuiteFilter.INSTANCE, (JdkApplicationProtocolNegotiator) JdkDefaultApplicationProtocolNegotiator.INSTANCE, clientAuth, (String[]) null, false);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static JdkApplicationProtocolNegotiator toNegotiator(ApplicationProtocolConfig applicationProtocolConfig, boolean z4) {
    ...
    @Deprecated
    public JdkSslContext(SSLContext sSLContext, boolean z4, Iterable<String> iterable, CipherSuiteFilter cipherSuiteFilter, ApplicationProtocolConfig applicationProtocolConfig, ClientAuth clientAuth) {
        this(sSLContext, z4, iterable, cipherSuiteFilter, applicationProtocolConfig, clientAuth, (String[]) null, false);
    }
    ...
    public final SSLEngine newEngine(ByteBufAllocator byteBufAllocator, String str, int i4) {
        return configureAndWrapEngine(context().createSSLEngine(str, i4), byteBufAllocator);
    }

    public JdkSslContext(SSLContext sSLContext, boolean z4, Iterable<String> iterable, CipherSuiteFilter cipherSuiteFilter, ApplicationProtocolConfig applicationProtocolConfig, ClientAuth clientAuth, String[] strArr, boolean z5) {
        this(sSLContext, z4, iterable, cipherSuiteFilter, toNegotiator(applicationProtocolConfig, !z4), clientAuth, strArr == null ? null : (String[]) strArr.clone(), z5);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public JdkSslContext(SSLContext sSLContext, boolean z4, Iterable<String> iterable, CipherSuiteFilter cipherSuiteFilter, JdkApplicationProtocolNegotiator jdkApplicationProtocolNegotiator, ClientAuth clientAuth, String[] strArr, boolean z5) {
        super(z5);
