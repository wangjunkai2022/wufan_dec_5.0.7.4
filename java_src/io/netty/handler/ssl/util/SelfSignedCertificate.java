    ...
    private static void safeClose(File file, OutputStream outputStream) {
        try {
            ...
            if (logger.isWarnEnabled()) {
                ...
                internalLogger.warn("Failed to close a file: " + file, (Throwable) e5);
            }
        }
    }
    ...
    */
    public SelfSignedCertificate(java.lang.String r5, java.security.SecureRandom r6, int r7, java.util.Date r8, java.util.Date r9) throws java.security.cert.CertificateException {
        /*
            ...
            java.security.KeyPairGenerator r1 = java.security.KeyPairGenerator.getInstance(r1)     // Catch: java.security.NoSuchAlgorithmException -> Lbe
            r1.initialize(r7, r6)     // Catch: java.security.NoSuchAlgorithmException -> Lbe
            java.security.KeyPair r7 = r1.generateKeyPair()     // Catch: java.security.NoSuchAlgorithmException -> Lbe
        ...
        Lab:
            ...
            r6.<init>(r7, r5)
            io.netty.util.internal.ThrowableUtil.addSuppressed(r6, r1)
            throw r6
        Lbe:
            r5 = move-exception
