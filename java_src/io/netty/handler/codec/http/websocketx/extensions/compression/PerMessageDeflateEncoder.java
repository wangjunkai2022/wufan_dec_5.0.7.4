...
class PerMessageDeflateEncoder extends DeflateEncoder {
    ...
    PerMessageDeflateEncoder(int i4, int i5, boolean z4) {
    ...
    public PerMessageDeflateEncoder(int i4, int i5, boolean z4, WebSocketExtensionFilter webSocketExtensionFilter) {
