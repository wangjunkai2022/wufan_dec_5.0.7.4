...
public class ContinuationWebSocketFrame extends WebSocketFrame {
    ...
    public ContinuationWebSocketFrame(boolean z4, int i4, ByteBuf byteBuf) {
        super(z4, i4, byteBuf);
    }
    ...
    public ContinuationWebSocketFrame(boolean z4, int i4, String str) {
        this(z4, i4, fromText(str));
    }
