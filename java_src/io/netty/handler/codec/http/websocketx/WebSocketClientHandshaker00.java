...
public class WebSocketClientHandshaker00 extends WebSocketClientHandshaker {
    ...
    public WebSocketClientHandshaker00(URI uri, WebSocketVersion webSocketVersion, String str, HttpHeaders httpHeaders, int i4, long j4) {
        this(uri, webSocketVersion, str, httpHeaders, i4, j4, false);
    }

    @Override // io.netty.handler.codec.http.websocketx.WebSocketClientHandshaker
    public WebSocketClientHandshaker00 setForceCloseTimeoutMillis(long j4) {
        super.setForceCloseTimeoutMillis(j4);
        return this;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public WebSocketClientHandshaker00(URI uri, WebSocketVersion webSocketVersion, String str, HttpHeaders httpHeaders, int i4, long j4, boolean z4) {
        super(uri, webSocketVersion, str, httpHeaders, i4, j4, z4);
    }
}
