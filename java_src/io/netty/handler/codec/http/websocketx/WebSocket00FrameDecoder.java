...
public class WebSocket00FrameDecoder extends ReplayingDecoder<Void> implements WebSocketFrameDecoder {
    ...
    private WebSocketFrame decodeBinaryFrame(ChannelHandlerContext channelHandlerContext, byte b5, ByteBuf byteBuf) {
        byte readByte;
        long j4 = 0;
        int i4 = 0;
        do {
            readByte = byteBuf.readByte();
            j4 = (j4 << 7) | (readByte & ByteCompanionObject.MAX_VALUE);
