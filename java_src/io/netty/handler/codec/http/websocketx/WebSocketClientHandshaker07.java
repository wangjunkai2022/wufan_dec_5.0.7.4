...
public class WebSocketClientHandshaker07 extends WebSocketClientHandshaker {
    ...
    public WebSocketClientHandshaker07(URI uri, WebSocketVersion webSocketVersion, String str, boolean z4, HttpHeaders httpHeaders, int i4) {
    ...
    public WebSocketClientHandshaker07(URI uri, WebSocketVersion webSocketVersion, String str, boolean z4, HttpHeaders httpHeaders, int i4, boolean z5, boolean z6) {
        this(uri, webSocketVersion, str, z4, httpHeaders, i4, z5, z6, c.f49010a);
    }

    @Override // io.netty.handler.codec.http.websocketx.WebSocketClientHandshaker
    public WebSocketClientHandshaker07 setForceCloseTimeoutMillis(long j4) {
        super.setForceCloseTimeoutMillis(j4);
        return this;
    }

    public WebSocketClientHandshaker07(URI uri, WebSocketVersion webSocketVersion, String str, boolean z4, HttpHeaders httpHeaders, int i4, boolean z5, boolean z6, long j4) {
        this(uri, webSocketVersion, str, z4, httpHeaders, i4, z5, z6, j4, false);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public WebSocketClientHandshaker07(URI uri, WebSocketVersion webSocketVersion, String str, boolean z4, HttpHeaders httpHeaders, int i4, boolean z5, boolean z6, long j4, boolean z7) {
