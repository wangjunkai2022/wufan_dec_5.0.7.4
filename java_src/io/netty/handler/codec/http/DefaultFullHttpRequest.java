...
public class DefaultFullHttpRequest extends DefaultHttpRequest implements FullHttpRequest {
    ...
    public DefaultFullHttpRequest(HttpVersion httpVersion, HttpMethod httpMethod, String str, boolean z4) {
        this(httpVersion, httpMethod, str, Unpooled.buffer(0), z4);
    }
    ...
    public DefaultFullHttpRequest(HttpVersion httpVersion, HttpMethod httpMethod, String str, ByteBuf byteBuf, boolean z4) {
        super(httpVersion, httpMethod, str, z4);
        this.content = (ByteBuf) ObjectUtil.checkNotNull(byteBuf, "content");
        this.trailingHeader = new DefaultHttpHeaders(z4);
    }
