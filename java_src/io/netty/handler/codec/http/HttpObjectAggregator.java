...
public class HttpObjectAggregator extends MessageAggregator<HttpObject, HttpMessage, HttpContent, FullHttpMessage> {
    ...
    private static Object continueResponse(HttpMessage httpMessage, int i4, ChannelPipeline channelPipeline) {
    ...
    public HttpObjectAggregator(int i4, boolean z4) {
        super(i4);
        this.closeOnExpectationFailed = z4;
    }
    ...
    public Object newContinueResponse(HttpMessage httpMessage, int i4, ChannelPipeline channelPipeline) {
        Object continueResponse = continueResponse(httpMessage, i4, channelPipeline);
