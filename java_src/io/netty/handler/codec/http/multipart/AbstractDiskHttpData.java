...
public abstract class AbstractDiskHttpData extends AbstractHttpData {
    ...
    public void addContent(ByteBuf byteBuf, boolean z4) throws IOException {
        if (byteBuf != null) {
            try {
                ...
                if (this.fileChannel == null) {
                    this.fileChannel = new RandomAccessFile(this.file, e.f71861e0).getChannel();
                }
                int i4 = 0;
    ...
    */
    ...
    public void setContent(ByteBuf byteBuf) throws IOException {
        ...
        try {
            ...
            RandomAccessFile randomAccessFile = new RandomAccessFile(this.file, e.f71861e0);
