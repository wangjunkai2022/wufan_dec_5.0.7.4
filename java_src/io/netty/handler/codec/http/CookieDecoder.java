...
public final class CookieDecoder {
    ...
    private CookieDecoder(boolean z4) {
        this.strict = z4;
    }
    ...
    private DefaultCookie initCookie(String str, String str2) {
        ...
        if (str == null || str.length() == 0) {
            ...
            if (unwrapValue == null) {
                ...
                boolean z4 = unwrapValue.length() != str2.length();
                ...
                defaultCookie.setWrap(z4);
                return defaultCookie;
            }
        }
    }

    public static Set<Cookie> decode(String str, boolean z4) {
        return (z4 ? STRICT : LAX).doDecode(str);
    }
}
