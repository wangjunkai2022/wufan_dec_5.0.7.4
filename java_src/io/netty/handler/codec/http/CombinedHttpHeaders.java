...
public class CombinedHttpHeaders extends DefaultHttpHeaders {
    ...
    public CombinedHttpHeaders(boolean z4) {
        super(new CombinedHttpHeadersImpl(AsciiString.CASE_INSENSITIVE_HASHER, DefaultHttpHeaders.valueConverter(z4), DefaultHttpHeaders.nameValidator(z4)));
    }

    @Override // io.netty.handler.codec.http.HttpHeaders
    public boolean containsValue(CharSequence charSequence, CharSequence charSequence2, boolean z4) {
        return super.containsValue(charSequence, StringUtil.trimOws(charSequence2), z4);
    }
}
