...
public class DefaultLastHttpContent extends DefaultHttpContent implements LastHttpContent {
    ...
    private static final class TrailingHttpHeaders extends DefaultHttpHeaders {
        ...
        TrailingHttpHeaders(boolean z4) {
            super(z4, z4 ? TrailerNameValidator : DefaultHeaders.NameValidator.NOT_NULL);
        }
    }
    ...
    public DefaultLastHttpContent(ByteBuf byteBuf, boolean z4) {
        super(byteBuf);
        this.trailingHeaders = new TrailingHttpHeaders(z4);
