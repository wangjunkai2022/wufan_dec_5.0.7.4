...
public abstract class HttpHeaders implements Iterable<Map.Entry<String, String>> {
    ...
    private static boolean containsCommaSeparatedTrimmed(CharSequence charSequence, CharSequence charSequence2, boolean z4) {
        if (z4) {
            ...
            if (indexOf == -1) {
                ...
                int i4 = 0;
                while (!AsciiString.contentEqualsIgnoreCase(AsciiString.trim(charSequence.subSequence(i4, indexOf)), charSequence2)) {
                    i4 = indexOf + 1;
                    indexOf = AsciiString.indexOf(charSequence, StringUtil.COMMA, i4);
                    if (indexOf == -1) {
                        if (i4 < charSequence.length() && AsciiString.contentEqualsIgnoreCase(AsciiString.trim(charSequence.subSequence(i4, charSequence.length())), charSequence2)) {
                            return true;
                        }
                    }
                }
            ...
            if (indexOf2 == -1) {
                ...
                int i5 = 0;
                while (!AsciiString.contentEquals(AsciiString.trim(charSequence.subSequence(i5, indexOf2)), charSequence2)) {
                    i5 = indexOf2 + 1;
                    indexOf2 = AsciiString.indexOf(charSequence, StringUtil.COMMA, i5);
                    if (indexOf2 == -1) {
                        if (i5 < charSequence.length() && AsciiString.contentEquals(AsciiString.trim(charSequence.subSequence(i5, charSequence.length())), charSequence2)) {
                            return true;
                        }
                    }
                }
    ...
    public static void setKeepAlive(HttpMessage httpMessage, boolean z4) {
        HttpUtil.setKeepAlive(httpMessage, z4);
    }
    ...
    public abstract HttpHeaders addShort(CharSequence charSequence, short s4);
    ...
    public boolean containsValue(CharSequence charSequence, CharSequence charSequence2, boolean z4) {
        ...
        while (valueCharSequenceIterator.hasNext()) {
            if (containsCommaSeparatedTrimmed(valueCharSequenceIterator.next(), charSequence2, z4)) {
                return true;
            }
        }
        return false;
    ...
    public abstract short getShort(CharSequence charSequence, short s4);
    ...
    public abstract HttpHeaders setShort(CharSequence charSequence, short s4);
    ...
    public static void set100ContinueExpected(HttpMessage httpMessage, boolean z4) {
        HttpUtil.set100ContinueExpected(httpMessage, z4);
    }
    ...
    public boolean contains(CharSequence charSequence, CharSequence charSequence2, boolean z4) {
        return contains(charSequence.toString(), charSequence2.toString(), z4);
    }
}
