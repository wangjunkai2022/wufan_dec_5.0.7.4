...
public class LengthFieldPrepender extends MessageToMessageEncoder<ByteBuf> {
    ...
    public LengthFieldPrepender(int i4, boolean z4) {
        this(i4, 0, z4);
    }
    ...
    public LengthFieldPrepender(int i4, int i5, boolean z4) {
        this(ByteOrder.BIG_ENDIAN, i4, i5, z4);
    }

    public LengthFieldPrepender(ByteOrder byteOrder, int i4, int i5, boolean z4) {
        ...
        this.lengthIncludesLengthFieldLength = z4;
