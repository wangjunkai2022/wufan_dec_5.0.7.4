...
public final class HAProxyProxiedProtocol {
    ...
    public enum AddressFamily {
        ...
        public static AddressFamily valueOf(byte b5) {
            int i4 = b5 & FAMILY_MASK;
            byte b6 = (byte) i4;
            if (b6 != 0) {
                if (b6 != 16) {
                    if (b6 != 32) {
    ...
    public enum TransportProtocol {
        ...
        TransportProtocol(byte b5) {
            this.transportByte = b5;
        }
        ...
        public static TransportProtocol valueOf(byte b5) {
            int i4 = b5 & 15;
            byte b6 = (byte) i4;
            if (b6 != 0) {
                if (b6 != 1) {
    ...
    private HAProxyProxiedProtocol(String str, int i4, byte b5, AddressFamily addressFamily, TransportProtocol transportProtocol) {
        this.byteValue = b5;
    ...
    public static HAProxyProxiedProtocol valueOf(byte b5) {
        if (b5 != 0) {
            if (b5 != 17) {
                if (b5 != 18) {
                    if (b5 != 33) {
                        if (b5 != 34) {
                            if (b5 != 49) {
                                ...
                                throw new IllegalArgumentException("unknown transport protocol + address family: " + (b5 & 255));
                            }
                            return UNIX_STREAM;
                        }
                        return UDP6;
