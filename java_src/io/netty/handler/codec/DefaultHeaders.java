...
public class DefaultHeaders<K, V, T extends Headers<K, V, T>> implements Headers<K, V, T> {
    ...
    private void add0(int i4, int i5, K k4, V v2) {
        HeaderEntry<K, V>[] headerEntryArr = this.entries;
        headerEntryArr[i5] = newHeaderEntry(i4, k4, v2, headerEntryArr[i5]);
        this.size++;
    }
    ...
    public T add(K k4, V v2) {
        ...
        add0(hashCode, index(hashCode), k4, v2);
        return thisT();
    }

    @Override // io.netty.handler.codec.Headers
    public T addBoolean(K k4, boolean z4) {
        return add((DefaultHeaders<K, V, T>) k4, (K) this.valueConverter.convertBoolean(z4));
    }

    @Override // io.netty.handler.codec.Headers
    public T addByte(K k4, byte b5) {
        return add((DefaultHeaders<K, V, T>) k4, (K) this.valueConverter.convertByte(b5));
    }

    @Override // io.netty.handler.codec.Headers
    public T addChar(K k4, char c5) {
        return add((DefaultHeaders<K, V, T>) k4, (K) this.valueConverter.convertChar(c5));
    }

    @Override // io.netty.handler.codec.Headers
    public T addDouble(K k4, double d5) {
        return add((DefaultHeaders<K, V, T>) k4, (K) this.valueConverter.convertDouble(d5));
    }

    @Override // io.netty.handler.codec.Headers
    public T addFloat(K k4, float f5) {
        return add((DefaultHeaders<K, V, T>) k4, (K) this.valueConverter.convertFloat(f5));
    }
    ...
    public T addShort(K k4, short s4) {
        return add((DefaultHeaders<K, V, T>) k4, (K) this.valueConverter.convertShort(s4));
    }
    ...
    public boolean containsBoolean(K k4, boolean z4) {
        return contains(k4, this.valueConverter.convertBoolean(z4));
    }

    @Override // io.netty.handler.codec.Headers
    public boolean containsByte(K k4, byte b5) {
        return contains(k4, this.valueConverter.convertByte(b5));
    }

    @Override // io.netty.handler.codec.Headers
    public boolean containsChar(K k4, char c5) {
        return contains(k4, this.valueConverter.convertChar(c5));
    }

    @Override // io.netty.handler.codec.Headers
    public boolean containsDouble(K k4, double d5) {
        return contains(k4, this.valueConverter.convertDouble(d5));
    }

    @Override // io.netty.handler.codec.Headers
    public boolean containsFloat(K k4, float f5) {
        return contains(k4, this.valueConverter.convertFloat(f5));
    }
    ...
    public Boolean getBoolean(K k4) {
        ...
        if (v2 != null) {
            try {
                return Boolean.valueOf(this.valueConverter.convertToBoolean(v2));
    ...
    public Byte getByte(K k4) {
        ...
        if (v2 != null) {
            try {
                return Byte.valueOf(this.valueConverter.convertToByte(v2));
            } catch (RuntimeException unused) {
                return null;
            }
        }
    ...
    public Double getDouble(K k4) {
        ...
        if (v2 != null) {
            try {
                return Double.valueOf(this.valueConverter.convertToDouble(v2));
            } catch (RuntimeException unused) {
                return null;
            }
        }
    ...
    public Float getFloat(K k4) {
        ...
        if (v2 != null) {
            try {
                return Float.valueOf(this.valueConverter.convertToFloat(v2));
            } catch (RuntimeException unused) {
                return null;
            }
        }
    ...
    public Integer getInt(K k4) {
        ...
        if (v2 != null) {
            try {
                return Integer.valueOf(this.valueConverter.convertToInt(v2));
            } catch (RuntimeException unused) {
                return null;
            }
        }
    ...
    public Long getLong(K k4) {
        ...
        if (v2 != null) {
            try {
                return Long.valueOf(this.valueConverter.convertToLong(v2));
            } catch (RuntimeException unused) {
                return null;
            }
        }
    ...
    public Short getShort(K k4) {
        ...
        if (v2 != null) {
            try {
                return Short.valueOf(this.valueConverter.convertToShort(v2));
            } catch (RuntimeException unused) {
                return null;
            }
        }
    ...
    public Long getTimeMillis(K k4) {
        ...
        if (v2 != null) {
            try {
                return Long.valueOf(this.valueConverter.convertToTimeMillis(v2));
            } catch (RuntimeException unused) {
                return null;
            }
        }
    ...
    protected HeaderEntry<K, V> newHeaderEntry(int i4, K k4, V v2, HeaderEntry<K, V> headerEntry) {
        return new HeaderEntry<>(i4, k4, v2, headerEntry, this.head);
    }
    ...
    public T setBoolean(K k4, boolean z4) {
        return set((DefaultHeaders<K, V, T>) k4, (K) this.valueConverter.convertBoolean(z4));
    }

    @Override // io.netty.handler.codec.Headers
    public T setByte(K k4, byte b5) {
        return set((DefaultHeaders<K, V, T>) k4, (K) this.valueConverter.convertByte(b5));
    }

    @Override // io.netty.handler.codec.Headers
    public T setChar(K k4, char c5) {
        return set((DefaultHeaders<K, V, T>) k4, (K) this.valueConverter.convertChar(c5));
    }

    @Override // io.netty.handler.codec.Headers
    public T setDouble(K k4, double d5) {
        return set((DefaultHeaders<K, V, T>) k4, (K) this.valueConverter.convertDouble(d5));
    }

    @Override // io.netty.handler.codec.Headers
    public T setFloat(K k4, float f5) {
        return set((DefaultHeaders<K, V, T>) k4, (K) this.valueConverter.convertFloat(f5));
    }
    ...
    public T setShort(K k4, short s4) {
        return set((DefaultHeaders<K, V, T>) k4, (K) this.valueConverter.convertShort(s4));
    }
    ...
    public boolean contains(K k4, V v2) {
        return contains(k4, v2, HashingStrategy.JAVA_HASHER);
    }
    ...
    public static class HeaderEntry<K, V> implements Map.Entry<K, V> {
        ...
        HeaderEntry(int i4, K k4, V v2, HeaderEntry<K, V> headerEntry, HeaderEntry<K, V> headerEntry2) {
            this.hash = i4;
            this.key = k4;
            this.value = v2;
            this.next = headerEntry;
    ...
    public final boolean contains(K k4, V v2, HashingStrategy<? super V> hashingStrategy) {
        ObjectUtil.checkNotNull(k4, "name");
        int hashCode = this.hashingStrategy.hashCode(k4);
        for (HeaderEntry<K, V> headerEntry = this.entries[index(hashCode)]; headerEntry != null; headerEntry = headerEntry.next) {
            if (headerEntry.hash == hashCode && this.hashingStrategy.equals(k4, headerEntry.key) && hashingStrategy.equals(v2, (V) headerEntry.value)) {
                return true;
            }
        }
        return false;
    ...
    public V getAndRemove(K k4, V v2) {
        V andRemove = getAndRemove(k4);
        return andRemove == null ? v2 : andRemove;
    }
    ...
    public boolean getBooleanAndRemove(K k4, boolean z4) {
        ...
        return booleanAndRemove != null ? booleanAndRemove.booleanValue() : z4;
    }
    ...
    public byte getByteAndRemove(K k4, byte b5) {
        ...
        return byteAndRemove != null ? byteAndRemove.byteValue() : b5;
    }
    ...
    public char getCharAndRemove(K k4, char c5) {
        ...
        return charAndRemove != null ? charAndRemove.charValue() : c5;
    }

    @Override // io.netty.handler.codec.Headers
    public double getDouble(K k4, double d5) {
        Double d6 = getDouble(k4);
    ...
    public double getDoubleAndRemove(K k4, double d5) {
        ...
        return doubleAndRemove != null ? doubleAndRemove.doubleValue() : d5;
    }

    @Override // io.netty.handler.codec.Headers
    public float getFloat(K k4, float f5) {
        Float f6 = getFloat(k4);
    ...
    public float getFloatAndRemove(K k4, float f5) {
        ...
        return floatAndRemove != null ? floatAndRemove.floatValue() : f5;
    }
