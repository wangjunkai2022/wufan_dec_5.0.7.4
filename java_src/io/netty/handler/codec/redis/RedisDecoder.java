...
public final class RedisDecoder extends ByteToMessageDecoder {
    ...
    public static final class ToPositiveLongProcessor implements ByteProcessor {
        ...
        public boolean process(byte b5) throws Exception {
            if (b5 >= 48 && b5 <= 57) {
                this.result = (this.result * 10) + (b5 - 48);
                return true;
            }
            throw new RedisCodecException("bad byte in number: " + ((int) b5));
        }
    ...
    */
    protected void decode(io.netty.channel.ChannelHandlerContext r2, io.netty.buffer.ByteBuf r3, java.util.List<java.lang.Object> r4) throws java.lang.Exception {
        /*
            r1 = this;
        L0:
    ...
    public RedisDecoder(boolean z4) {
        this(65536, FixedRedisMessagePool.INSTANCE, z4);
    }

    public RedisDecoder(int i4, RedisMessagePool redisMessagePool) {
        this(i4, redisMessagePool, false);
    }

    public RedisDecoder(int i4, RedisMessagePool redisMessagePool, boolean z4) {
