...
public final class RtspResponseStatuses {
    ...
    public static final HttpResponseStatus UNSUPPORTED_TRANSPORT = new HttpResponseStatus(f.f61812n, "Unsupported transport");
    public static final HttpResponseStatus DESTINATION_UNREACHABLE = new HttpResponseStatus(f.f61813o, "Destination unreachable");
