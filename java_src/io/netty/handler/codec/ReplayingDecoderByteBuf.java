...
final class ReplayingDecoderByteBuf extends ByteBuf {
    ...
    public int bytesBefore(byte b5) {
        int bytesBefore = this.buffer.bytesBefore(b5);
        if (bytesBefore >= 0) {
            return bytesBefore;
        }
        throw REPLAY;
    ...
    public int indexOf(int i4, int i5, byte b5) {
        ...
        if (Math.max(i4, i5) <= this.buffer.writerIndex()) {
            return this.buffer.indexOf(i4, i5, b5);
        }
        throw REPLAY;
    }
    ...
    public boolean isReadable(int i4) {
        return !this.terminated || this.buffer.isReadable(i4);
    }
    ...
    public int bytesBefore(int i4, byte b5) {
        return bytesBefore(this.buffer.readerIndex(), i4, b5);
    }
    ...
    public int bytesBefore(int i4, int i5, byte b5) {
        ...
        if (i4 < writerIndex) {
            if (i4 <= writerIndex - i5) {
                return this.buffer.bytesBefore(i4, i5, b5);
            }
            int bytesBefore = this.buffer.bytesBefore(i4, writerIndex - i4, b5);
            if (bytesBefore >= 0) {
                return bytesBefore;
            }
            throw REPLAY;
