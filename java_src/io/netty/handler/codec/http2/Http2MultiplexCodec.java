...
public class Http2MultiplexCodec extends Http2FrameCodec {
    ...
    public Http2MultiplexCodec(Http2ConnectionEncoder http2ConnectionEncoder, Http2ConnectionDecoder http2ConnectionDecoder, Http2Settings http2Settings, ChannelHandler channelHandler, ChannelHandler channelHandler2, boolean z4) {
        super(http2ConnectionEncoder, http2ConnectionDecoder, http2Settings, z4);
    ...
    static /* synthetic */ int access$004(Http2MultiplexCodec http2MultiplexCodec) {
        int i4 = http2MultiplexCodec.idCount + 1;
        http2MultiplexCodec.idCount = i4;
        return i4;
    }
    ...
    final void onHttp2StreamStateChanged(ChannelHandlerContext channelHandlerContext, Http2FrameCodec.DefaultHttp2FrameStream defaultHttp2FrameStream) {
        ...
        int i4 = AnonymousClass2.$SwitchMap$io$netty$handler$codec$http2$Http2Stream$State[defaultHttp2FrameStream.state().ordinal()];
        if (i4 != 1) {
            if (i4 != 2 && i4 != 3) {
