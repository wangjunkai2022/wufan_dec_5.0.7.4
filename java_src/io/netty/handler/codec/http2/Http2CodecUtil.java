...
public final class Http2CodecUtil {
    ...
    public static void headerListSizeExceeded(int i4, long j4, boolean z4) throws Http2Exception {
        throw Http2Exception.headerListSizeError(i4, Http2Error.PROTOCOL_ERROR, z4, "Header size exceeded max allowed size (%d)", Long.valueOf(j4));
    }
    ...
    public static boolean isOutboundStream(boolean z4, int i4) {
        return i4 > 0 && z4 == ((i4 & 1) == 0);
    }

    public static boolean isStreamIdValid(int i4) {
        return i4 >= 0;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean isStreamIdValid(int i4, boolean z4) {
        if (isStreamIdValid(i4)) {
            return z4 == ((i4 & 1) == 0);
        }
        return false;
    }
    ...
    public static void writeFrameHeader(ByteBuf byteBuf, int i4, byte b5, Http2Flags http2Flags, int i5) {
        byteBuf.ensureWritable(i4 + 9);
        writeFrameHeaderInternal(byteBuf, i4, b5, http2Flags, i5);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static void writeFrameHeaderInternal(ByteBuf byteBuf, int i4, byte b5, Http2Flags http2Flags, int i5) {
