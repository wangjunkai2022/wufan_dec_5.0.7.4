...
public final class Http2Settings extends CharObjectHashMap<Long> {
    ...
    public Integer getIntValue(char c5) {
        Long l4 = get(c5);
        if (l4 == null) {
            return null;
        }
    ...
    public Http2Settings(int i4, float f5) {
        super(i4, f5);
    }
    ...
    public Long put(char c5, Long l4) {
        verifyStandardSetting(c5, l4);
        return (Long) super.put(c5, (char) l4);
    }
    ...
    public Http2Settings pushEnabled(boolean z4) {
        put((char) 2, z4 ? TRUE : FALSE);
        return this;
    }
}
