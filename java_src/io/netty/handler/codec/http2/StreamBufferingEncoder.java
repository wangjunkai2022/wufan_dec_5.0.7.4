...
public class StreamBufferingEncoder extends DecoratingHttp2ConnectionEncoder {
    ...
    public final class DataFrame extends Frame {
        ...
        DataFrame(ByteBuf byteBuf, int i4, boolean z4, ChannelPromise channelPromise) {
    ...
    public final class HeadersFrame extends Frame {
        ...
        HeadersFrame(Http2Headers http2Headers, int i4, short s4, boolean z4, int i5, boolean z5, ChannelPromise channelPromise) {
            super(channelPromise);
    ...
    public ChannelFuture writeData(ChannelHandlerContext channelHandlerContext, int i4, ByteBuf byteBuf, int i5, boolean z4, ChannelPromise channelPromise) {
        if (isExistingStream(i4)) {
            return super.writeData(channelHandlerContext, i4, byteBuf, i5, z4, channelPromise);
        }
        PendingStream pendingStream = this.pendingStreams.get(Integer.valueOf(i4));
        if (pendingStream != null) {
            pendingStream.frames.add(new DataFrame(byteBuf, i5, z4, channelPromise));
        } else {
    ...
    public ChannelFuture writeHeaders(ChannelHandlerContext channelHandlerContext, int i4, Http2Headers http2Headers, int i5, boolean z4, ChannelPromise channelPromise) {
        return writeHeaders(channelHandlerContext, i4, http2Headers, 0, (short) 16, false, i5, z4, channelPromise);
    }
    ...
    public ChannelFuture writeHeaders(ChannelHandlerContext channelHandlerContext, int i4, Http2Headers http2Headers, int i5, short s4, boolean z4, int i6, boolean z5, ChannelPromise channelPromise) {
        ...
        if (!isExistingStream(i4) && !connection().goAwayReceived()) {
            if (canCreateStream()) {
                return super.writeHeaders(channelHandlerContext, i4, http2Headers, i5, s4, z4, i6, z5, channelPromise);
            }
            PendingStream pendingStream = this.pendingStreams.get(Integer.valueOf(i4));
            if (pendingStream == null) {
            ...
            pendingStream.frames.add(new HeadersFrame(http2Headers, i5, s4, z4, i6, z5, channelPromise));
            return channelPromise;
        }
        return super.writeHeaders(channelHandlerContext, i4, http2Headers, i5, s4, z4, i6, z5, channelPromise);
    }
