...
public class Http2StreamFrameToHttpObjectCodec extends MessageToMessageCodec<Http2StreamFrame, HttpObject> {
    ...
    public Http2StreamFrameToHttpObjectCodec(boolean z4, boolean z5) {
        this.isServer = z4;
    ...
    private void encodeLastContent(LastHttpContent lastHttpContent, List<Object> list) {
        boolean z4 = !(lastHttpContent instanceof FullHttpMessage) && lastHttpContent.trailingHeaders().isEmpty();
        if (lastHttpContent.content().isReadable() || z4) {
        ...
        if (httpObject instanceof HttpMessage) {
            ...
            if (httpObject instanceof FullHttpMessage) {
                ...
                if (!fullHttpMessage.content().isReadable() && fullHttpMessage.trailingHeaders().isEmpty()) {
                    z4 = true;
                    list.add(new DefaultHttp2HeadersFrame(http2Headers, z4));
                }
            }
            z4 = false;
            list.add(new DefaultHttp2HeadersFrame(http2Headers, z4));
    ...
    public Http2StreamFrameToHttpObjectCodec(boolean z4) {
        this(z4, true);
    }
}
