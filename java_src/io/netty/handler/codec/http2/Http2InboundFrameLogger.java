...
public class Http2InboundFrameLogger implements Http2FrameReader {
    ...
    public void readFrame(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf, final Http2FrameListener http2FrameListener) throws Http2Exception {
        this.reader.readFrame(channelHandlerContext, byteBuf, new Http2FrameListener() { // from class: io.netty.handler.codec.http2.Http2InboundFrameLogger.1
            ...
            public int onDataRead(ChannelHandlerContext channelHandlerContext2, int i4, ByteBuf byteBuf2, int i5, boolean z4) throws Http2Exception {
                Http2InboundFrameLogger.this.logger.logData(Http2FrameLogger.Direction.INBOUND, channelHandlerContext2, i4, byteBuf2, i5, z4);
                return http2FrameListener.onDataRead(channelHandlerContext2, i4, byteBuf2, i5, z4);
            }
            ...
            @Override // io.netty.handler.codec.http2.Http2FrameListener
            public void onHeadersRead(ChannelHandlerContext channelHandlerContext2, int i4, Http2Headers http2Headers, int i5, boolean z4) throws Http2Exception {
                Http2InboundFrameLogger.this.logger.logHeaders(Http2FrameLogger.Direction.INBOUND, channelHandlerContext2, i4, http2Headers, i5, z4);
                http2FrameListener.onHeadersRead(channelHandlerContext2, i4, http2Headers, i5, z4);
            }

            @Override // io.netty.handler.codec.http2.Http2FrameListener
            public void onPingAckRead(ChannelHandlerContext channelHandlerContext2, long j4) throws Http2Exception {
                Http2InboundFrameLogger.this.logger.logPingAck(Http2FrameLogger.Direction.INBOUND, channelHandlerContext2, j4);
                http2FrameListener.onPingAckRead(channelHandlerContext2, j4);
            }

            @Override // io.netty.handler.codec.http2.Http2FrameListener
            public void onPingRead(ChannelHandlerContext channelHandlerContext2, long j4) throws Http2Exception {
                Http2InboundFrameLogger.this.logger.logPing(Http2FrameLogger.Direction.INBOUND, channelHandlerContext2, j4);
                http2FrameListener.onPingRead(channelHandlerContext2, j4);
            }

            @Override // io.netty.handler.codec.http2.Http2FrameListener
            public void onPriorityRead(ChannelHandlerContext channelHandlerContext2, int i4, int i5, short s4, boolean z4) throws Http2Exception {
                Http2InboundFrameLogger.this.logger.logPriority(Http2FrameLogger.Direction.INBOUND, channelHandlerContext2, i4, i5, s4, z4);
                http2FrameListener.onPriorityRead(channelHandlerContext2, i4, i5, s4, z4);
            }
            ...
            @Override // io.netty.handler.codec.http2.Http2FrameListener
            public void onUnknownFrame(ChannelHandlerContext channelHandlerContext2, byte b5, int i4, Http2Flags http2Flags, ByteBuf byteBuf2) throws Http2Exception {
                Http2InboundFrameLogger.this.logger.logUnknownFrame(Http2FrameLogger.Direction.INBOUND, channelHandlerContext2, b5, i4, http2Flags, byteBuf2);
                http2FrameListener.onUnknownFrame(channelHandlerContext2, b5, i4, http2Flags, byteBuf2);
            }
            ...
            @Override // io.netty.handler.codec.http2.Http2FrameListener
            public void onHeadersRead(ChannelHandlerContext channelHandlerContext2, int i4, Http2Headers http2Headers, int i5, short s4, boolean z4, int i6, boolean z5) throws Http2Exception {
                Http2InboundFrameLogger.this.logger.logHeaders(Http2FrameLogger.Direction.INBOUND, channelHandlerContext2, i4, http2Headers, i5, s4, z4, i6, z5);
                http2FrameListener.onHeadersRead(channelHandlerContext2, i4, http2Headers, i5, s4, z4, i6, z5);
            }
        });
    }
}
