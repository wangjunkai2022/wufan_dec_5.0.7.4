...
public class Http2OutboundFrameLogger implements Http2FrameWriter {
    ...
    public ChannelFuture writeData(ChannelHandlerContext channelHandlerContext, int i4, ByteBuf byteBuf, int i5, boolean z4, ChannelPromise channelPromise) {
        this.logger.logData(Http2FrameLogger.Direction.OUTBOUND, channelHandlerContext, i4, byteBuf, i5, z4);
        return this.writer.writeData(channelHandlerContext, i4, byteBuf, i5, z4, channelPromise);
    }
    ...
    public ChannelFuture writeFrame(ChannelHandlerContext channelHandlerContext, byte b5, int i4, Http2Flags http2Flags, ByteBuf byteBuf, ChannelPromise channelPromise) {
        this.logger.logUnknownFrame(Http2FrameLogger.Direction.OUTBOUND, channelHandlerContext, b5, i4, http2Flags, byteBuf);
        return this.writer.writeFrame(channelHandlerContext, b5, i4, http2Flags, byteBuf, channelPromise);
    }
    ...
    public ChannelFuture writeHeaders(ChannelHandlerContext channelHandlerContext, int i4, Http2Headers http2Headers, int i5, boolean z4, ChannelPromise channelPromise) {
        this.logger.logHeaders(Http2FrameLogger.Direction.OUTBOUND, channelHandlerContext, i4, http2Headers, i5, z4);
        return this.writer.writeHeaders(channelHandlerContext, i4, http2Headers, i5, z4, channelPromise);
    }
    ...
    public ChannelFuture writePing(ChannelHandlerContext channelHandlerContext, boolean z4, long j4, ChannelPromise channelPromise) {
        ...
        return this.writer.writePing(channelHandlerContext, z4, j4, channelPromise);
    }
    ...
    public ChannelFuture writePriority(ChannelHandlerContext channelHandlerContext, int i4, int i5, short s4, boolean z4, ChannelPromise channelPromise) {
        this.logger.logPriority(Http2FrameLogger.Direction.OUTBOUND, channelHandlerContext, i4, i5, s4, z4);
        return this.writer.writePriority(channelHandlerContext, i4, i5, s4, z4, channelPromise);
    }
    ...
    public ChannelFuture writeHeaders(ChannelHandlerContext channelHandlerContext, int i4, Http2Headers http2Headers, int i5, short s4, boolean z4, int i6, boolean z5, ChannelPromise channelPromise) {
        this.logger.logHeaders(Http2FrameLogger.Direction.OUTBOUND, channelHandlerContext, i4, http2Headers, i5, s4, z4, i6, z5);
        return this.writer.writeHeaders(channelHandlerContext, i4, http2Headers, i5, s4, z4, i6, z5, channelPromise);
    }
}
