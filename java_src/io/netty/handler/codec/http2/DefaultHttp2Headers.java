...
public class DefaultHttp2Headers extends DefaultHeaders<CharSequence, CharSequence, Http2Headers> implements Http2Headers {
    ...
    private static final ByteProcessor HTTP2_NAME_VALIDATOR_PROCESSOR = new ByteProcessor() { // from class: io.netty.handler.codec.http2.DefaultHttp2Headers.1
        ...
        public boolean process(byte b5) {
            return !AsciiString.isUpperCase(b5);
        }
    };
    ...
    public DefaultHttp2Headers(boolean z4) {
        super(AsciiString.CASE_SENSITIVE_HASHER, CharSequenceValueConverter.INSTANCE, z4 ? HTTP2_NAME_VALIDATOR : DefaultHeaders.NameValidator.NOT_NULL);
    ...
    public boolean contains(CharSequence charSequence, CharSequence charSequence2, boolean z4) {
        return contains((DefaultHttp2Headers) charSequence, charSequence2, (HashingStrategy<? super CharSequence>) (z4 ? AsciiString.CASE_INSENSITIVE_HASHER : AsciiString.CASE_SENSITIVE_HASHER));
    }

    public DefaultHttp2Headers(boolean z4, int i4) {
        super(AsciiString.CASE_SENSITIVE_HASHER, CharSequenceValueConverter.INSTANCE, z4 ? HTTP2_NAME_VALIDATOR : DefaultHeaders.NameValidator.NOT_NULL, i4);
        this.firstNonPseudo = this.head;
    }
}
