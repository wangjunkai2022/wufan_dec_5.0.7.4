...
public class DefaultHttp2ConnectionEncoder implements Http2ConnectionEncoder, Http2SettingsReceivedConsumer {
    ...
    public abstract class FlowControlledBase implements Http2RemoteFlowController.FlowControlled, ChannelFutureListener {
        ...
        FlowControlledBase(Http2Stream http2Stream, int i4, boolean z4, ChannelPromise channelPromise) {
            ObjectUtil.checkPositiveOrZero(i4, "padding");
            this.padding = i4;
            this.endOfStream = z4;
    ...
    private final class FlowControlledData extends FlowControlledBase {
        ...
        FlowControlledData(Http2Stream http2Stream, ByteBuf byteBuf, int i4, boolean z4, ChannelPromise channelPromise) {
            super(http2Stream, i4, z4, channelPromise);
    ...
    public final class FlowControlledHeaders extends FlowControlledBase {
        ...
        FlowControlledHeaders(Http2Stream http2Stream, Http2Headers http2Headers, boolean z4, int i4, short s4, boolean z5, int i5, boolean z6, ChannelPromise channelPromise) {
            super(http2Stream, i5, z6, channelPromise.unvoid());
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static ChannelFuture sendHeaders(Http2FrameWriter http2FrameWriter, ChannelHandlerContext channelHandlerContext, int i4, Http2Headers http2Headers, boolean z4, int i5, short s4, boolean z5, int i6, boolean z6, ChannelPromise channelPromise) {
        if (z4) {
            return http2FrameWriter.writeHeaders(channelHandlerContext, i4, http2Headers, i5, s4, z5, i6, z6, channelPromise);
        }
        return http2FrameWriter.writeHeaders(channelHandlerContext, i4, http2Headers, i6, z6, channelPromise);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static boolean validateHeadersSentState(Http2Stream http2Stream, Http2Headers http2Headers, boolean z4, boolean z5) {
        boolean z6 = z4 && HttpStatusClass.valueOf(http2Headers.status()) == HttpStatusClass.INFORMATIONAL;
        if (((z6 || !z5) && http2Stream.isHeadersSent()) || http2Stream.isTrailersSent()) {
            throw new IllegalStateException("Stream " + http2Stream.id() + " sent too many headers EOS: " + z5);
        }
        return z6;
    }
    ...
    private ChannelFuture writeHeaders0(ChannelHandlerContext channelHandlerContext, int i4, Http2Headers http2Headers, boolean z4, int i5, short s4, boolean z5, int i6, boolean z6, ChannelPromise channelPromise) {
        int i7;
            ...
            if (stream == null) {
                try {
                    ...
                    if (this.connection.remote().mayHaveCreatedStream(i4)) {
                        channelPromise2.tryFailure(new IllegalStateException("Stream no longer exists: " + i4, e5));
                        return channelPromise2;
                    }
                    throw e5;
                }
            } else {
                int i8 = AnonymousClass2.$SwitchMap$io$netty$handler$codec$http2$Http2Stream$State[stream.state().ordinal()];
                if (i8 != 1 && i8 != 2) {
                    if (i8 == 3) {
                        stream.open(z6);
                    } else {
            ...
            if (z6) {
                try {
                    if (flowController.hasFlowControlled(http2Stream)) {
                        flowController.addFlowControlled(http2Stream, new FlowControlledHeaders(http2Stream, http2Headers, z4, i5, s4, z5, i6, true, channelPromise));
                        return channelPromise2;
                    }
                } catch (Throwable th) {
                    th = th;
                    i7 = channelHandlerContext;
                    this.lifecycleManager.onError(i7, true, th);
                    channelPromise2.tryFailure(th);
                    return channelPromise2;
                }
            }
            channelPromise2 = channelPromise.unvoid();
            validateHeadersSentState = validateHeadersSentState(http2Stream, http2Headers, this.connection.isServer(), z6);
            i7 = i4;
            sendHeaders = sendHeaders(this.frameWriter, channelHandlerContext, i7, http2Headers, z4, i5, s4, z5, i6, z6, channelPromise2);
    ...
    public ChannelFuture writeData(ChannelHandlerContext channelHandlerContext, int i4, ByteBuf byteBuf, int i5, boolean z4, ChannelPromise channelPromise) {
        try {
            ...
            flowController().addFlowControlled(requireStream, new FlowControlledData(requireStream, byteBuf, i5, z4, channelPromise));
    ...
    public ChannelFuture writeFrame(ChannelHandlerContext channelHandlerContext, byte b5, int i4, Http2Flags http2Flags, ByteBuf byteBuf, ChannelPromise channelPromise) {
        return this.frameWriter.writeFrame(channelHandlerContext, b5, i4, http2Flags, byteBuf, channelPromise);
    }
    ...
    public ChannelFuture writeHeaders(ChannelHandlerContext channelHandlerContext, int i4, Http2Headers http2Headers, int i5, boolean z4, ChannelPromise channelPromise) {
        return writeHeaders0(channelHandlerContext, i4, http2Headers, false, 0, (short) 0, false, i5, z4, channelPromise);
    }
    ...
    public ChannelFuture writePing(ChannelHandlerContext channelHandlerContext, boolean z4, long j4, ChannelPromise channelPromise) {
        return this.frameWriter.writePing(channelHandlerContext, z4, j4, channelPromise);
    }
    ...
    public ChannelFuture writePriority(ChannelHandlerContext channelHandlerContext, int i4, int i5, short s4, boolean z4, ChannelPromise channelPromise) {
        return this.frameWriter.writePriority(channelHandlerContext, i4, i5, s4, z4, channelPromise);
    }
    ...
    public ChannelFuture writePushPromise(ChannelHandlerContext channelHandlerContext, int i4, int i5, Http2Headers http2Headers, int i6, ChannelPromise channelPromise) {
        ...
        try {
            if (!this.connection.goAwayReceived()) {
                Http2Stream requireStream = requireStream(i4);
                this.connection.local().reservePushStream(i5, requireStream);
                channelPromise2 = channelPromise.unvoid();
                try {
                    ChannelFuture writePushPromise = this.frameWriter.writePushPromise(channelHandlerContext, i4, i5, http2Headers, i6, channelPromise2);
    ...
    public ChannelFuture writeHeaders(ChannelHandlerContext channelHandlerContext, int i4, Http2Headers http2Headers, int i5, short s4, boolean z4, int i6, boolean z5, ChannelPromise channelPromise) {
        return writeHeaders0(channelHandlerContext, i4, http2Headers, true, i5, s4, z4, i6, z5, channelPromise);
    }
}
