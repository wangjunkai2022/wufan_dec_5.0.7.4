...
final class HpackEncoder {
    ...
    private void encodeHeader(ByteBuf byteBuf, CharSequence charSequence, CharSequence charSequence2, boolean z4, long j4) {
        if (z4) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public HpackEncoder(boolean z4) {
        this(z4, 16, 512);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public HpackEncoder(boolean z4, int i4, int i5) {
        ...
        this.ignoreMaxHeaderListSize = z4;
