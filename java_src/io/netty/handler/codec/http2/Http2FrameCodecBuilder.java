...
public class Http2FrameCodecBuilder extends AbstractHttp2ConnectionHandlerBuilder<Http2FrameCodec, Http2FrameCodecBuilder> {
    ...
    Http2FrameCodecBuilder(boolean z4) {
        server(z4);
    ...
    @Override // io.netty.handler.codec.http2.AbstractHttp2ConnectionHandlerBuilder
    public Http2FrameCodecBuilder autoAckPingFrame(boolean z4) {
        return (Http2FrameCodecBuilder) super.autoAckPingFrame(z4);
    }

    @Override // io.netty.handler.codec.http2.AbstractHttp2ConnectionHandlerBuilder
    public Http2FrameCodecBuilder autoAckSettingsFrame(boolean z4) {
        return (Http2FrameCodecBuilder) super.autoAckSettingsFrame(z4);
    }
    ...
    @Override // io.netty.handler.codec.http2.AbstractHttp2ConnectionHandlerBuilder
    public Http2FrameCodecBuilder decoupleCloseAndGoAway(boolean z4) {
        return (Http2FrameCodecBuilder) super.decoupleCloseAndGoAway(z4);
    }
    ...
    @Override // io.netty.handler.codec.http2.AbstractHttp2ConnectionHandlerBuilder
    public Http2FrameCodecBuilder encoderIgnoreMaxHeaderListSize(boolean z4) {
        return (Http2FrameCodecBuilder) super.encoderIgnoreMaxHeaderListSize(z4);
    }
    ...
    @Override // io.netty.handler.codec.http2.AbstractHttp2ConnectionHandlerBuilder
    public Http2FrameCodecBuilder validateHeaders(boolean z4) {
        return (Http2FrameCodecBuilder) super.validateHeaders(z4);
    }
    ...
    @Override // io.netty.handler.codec.http2.AbstractHttp2ConnectionHandlerBuilder
    public Http2FrameCodecBuilder decoderEnforceMaxConsecutiveEmptyDataFrames(int i4) {
        return (Http2FrameCodecBuilder) super.decoderEnforceMaxConsecutiveEmptyDataFrames(i4);
    }

    @Override // io.netty.handler.codec.http2.AbstractHttp2ConnectionHandlerBuilder
    public Http2FrameCodecBuilder encoderEnforceMaxConcurrentStreams(boolean z4) {
        return (Http2FrameCodecBuilder) super.encoderEnforceMaxConcurrentStreams(z4);
    }

    @Override // io.netty.handler.codec.http2.AbstractHttp2ConnectionHandlerBuilder
    public Http2FrameCodecBuilder encoderEnforceMaxQueuedControlFrames(int i4) {
        return (Http2FrameCodecBuilder) super.encoderEnforceMaxQueuedControlFrames(i4);
    }
