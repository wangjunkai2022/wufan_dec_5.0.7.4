...
final class HpackDecoder {
    ...
    private static final class Http2HeadersSink implements Sink {
        ...
        Http2HeadersSink(int i4, Http2Headers http2Headers, long j4, boolean z4) {
        ...
        public void appendToHeaderList(CharSequence charSequence, CharSequence charSequence2) {
            ...
            boolean z4 = (sizeOf > this.maxHeaderListSize) | this.exceededMaxLength;
            this.exceededMaxLength = z4;
            if (z4 || this.validationException != null) {
                return;
            }
            if (this.validate) {
                try {
    ...
    private CharSequence readStringLiteral(ByteBuf byteBuf, int i4, boolean z4) throws Http2Exception {
        if (z4) {
    ...
    public void decode(int i4, ByteBuf byteBuf, Http2Headers http2Headers, boolean z4) throws Http2Exception {
        Http2HeadersSink http2HeadersSink = new Http2HeadersSink(i4, http2Headers, this.maxHeaderListSize, z4);
        ...
        while (byteBuf.isReadable()) {
            switch (i4) {
                case 0:
                    ...
                    if (readByte < 0) {
                        i5 = readByte & ByteCompanionObject.MAX_VALUE;
                        if (i5 == 0) {
                        ...
                        i5 = readByte & Utf8.REPLACEMENT_BYTE;
                        if (i5 == 0) {
                            i4 = 4;
                            break;
                        } else if (i5 == 63) {
                ...
                case 4:
                    ...
                    i5 = readByte2 & ByteCompanionObject.MAX_VALUE;
                    if (i5 != 127) {
                        z5 = z4;
                        i6 = i5;
                        i4 = 6;
                ...
                case 6:
                    if (byteBuf.readableBytes() >= i6) {
                        charSequence = readStringLiteral(byteBuf, i6, z5);
                        i4 = 7;
                        break;
                    } else {
                ...
                case 7:
                    ...
                    z4 = (readByte3 & 128) == 128;
                    i5 = readByte3 & ByteCompanionObject.MAX_VALUE;
                    if (i5 == 0) {
                ...
                case 9:
                    if (byteBuf.readableBytes() >= i7) {
                        insertHeader(sink, charSequence, readStringLiteral(byteBuf, i7, z5), indexType);
                        i4 = 0;
                        break;
                    } else {
                        throw notEnoughDataException(byteBuf);
    ...
    static long decodeULE128(ByteBuf byteBuf, long j4) throws Http2Exception {
        ...
        while (readerIndex < writerIndex) {
            ...
            if (i4 == 56 && ((b5 & 128) != 0 || (b5 == Byte.MAX_VALUE && !z4))) {
