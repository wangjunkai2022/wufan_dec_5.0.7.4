...
public class DelegatingDecompressorFrameListener extends Http2FrameListenerDecorator {
    ...
    public final class ConsumedBytesConverter implements Http2LocalFlowController {
        ...
        public void receiveFlowControlledFrame(Http2Stream http2Stream, ByteBuf byteBuf, int i4, boolean z4) throws Http2Exception {
            this.flowController.receiveFlowControlledFrame(http2Stream, byteBuf, i4, z4);
        }
    ...
    public static final class Http2Decompressor {
        ...
        int consumeBytes(int i4, int i5) throws Http2Exception {
            ObjectUtil.checkPositiveOrZero(i5, "decompressedBytes");
            ...
            if (i6 - i5 >= 0) {
                ...
                double d8 = i7;
                Double.isNaN(d8);
                int min = Math.min(i7, (int) Math.ceil(d8 * d7));
    ...
    private void initDecompressor(ChannelHandlerContext channelHandlerContext, int i4, Http2Headers http2Headers, boolean z4) throws Http2Exception {
        Http2Stream stream = this.connection.stream(i4);
        if (stream == null) {
            return;
        }
        Http2Decompressor decompressor = decompressor(stream);
        if (decompressor == null && !z4) {
    ...
    public int onDataRead(ChannelHandlerContext channelHandlerContext, int i4, ByteBuf byteBuf, int i5, boolean z4) throws Http2Exception {
        ...
        try {
            ...
            if (nextReadableBuf == null && z4 && decompressor2.finish()) {
            ...
            try {
                ...
                while (true) {
                    try {
                        ...
                        boolean z5 = nextReadableBuf2 == null && z4;
                        if (z5 && decompressor2.finish()) {
                            nextReadableBuf2 = nextReadableBuf(decompressor2);
                            z5 = nextReadableBuf2 == null;
                        }
                        decompressor.incrementDecompressedBytes(byteBuf2.readableBytes());
                        flowController.consumeBytes(stream, this.listener.onDataRead(channelHandlerContext, i4, byteBuf2, i6, z5));
    ...
    public DelegatingDecompressorFrameListener(Http2Connection http2Connection, Http2FrameListener http2FrameListener, boolean z4) {
    ...
    public void onHeadersRead(ChannelHandlerContext channelHandlerContext, int i4, Http2Headers http2Headers, int i5, short s4, boolean z4, int i6, boolean z5) throws Http2Exception {
        initDecompressor(channelHandlerContext, i4, http2Headers, z5);
