...
abstract class DnsResponseDecoder<A extends SocketAddress> {
    ...
    private boolean decodeRecords(DnsResponse dnsResponse, DnsSection dnsSection, ByteBuf byteBuf, int i4) throws Exception {
        while (i4 > 0) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final DnsResponse decode(A a5, A a6, ByteBuf byteBuf) throws Exception {
        int readUnsignedShort = byteBuf.readUnsignedShort();
        int readUnsignedShort2 = byteBuf.readUnsignedShort();
        if ((readUnsignedShort2 >> 15) != 0) {
            DnsResponse newResponse = newResponse(a5, a6, readUnsignedShort, DnsOpCode.valueOf((byte) ((readUnsignedShort2 >> 11) & 15)), DnsResponseCode.valueOf((byte) (readUnsignedShort2 & 15)));
    ...
    protected abstract DnsResponse newResponse(A a5, A a6, int i4, DnsOpCode dnsOpCode, DnsResponseCode dnsResponseCode) throws Exception;
}
