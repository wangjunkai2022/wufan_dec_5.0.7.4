...
public class DnsRecordType implements Comparable<DnsRecordType> {
    ...
    static {
        ...
        SIG = dnsRecordType10;
        DnsRecordType dnsRecordType11 = new DnsRecordType(25, KeyMap.keySection);
        KEY = dnsRecordType11;
        ...
        DnsRecordType dnsRecordType35 = new DnsRecordType(Opcodes.INVOKE_POLYMORPHIC_RANGE, "IXFR");
        IXFR = dnsRecordType35;
        DnsRecordType dnsRecordType36 = new DnsRecordType(Opcodes.INVOKE_CUSTOM, "AXFR");
        ...
        TA = dnsRecordType39;
        DnsRecordType dnsRecordType40 = new DnsRecordType(a.f64235f, "DLV");
        DLV = dnsRecordType40;
        BY_NAME = new HashMap();
