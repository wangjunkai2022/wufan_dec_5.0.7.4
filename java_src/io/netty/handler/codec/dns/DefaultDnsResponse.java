...
public class DefaultDnsResponse extends AbstractDnsMessage implements DnsResponse {
    ...
    public DnsResponse setAuthoritativeAnswer(boolean z4) {
        this.authoritativeAnswer = z4;
        return this;
    }
    ...
    public DnsResponse setRecursionAvailable(boolean z4) {
        this.recursionAvailable = z4;
        return this;
    }

    public DnsResponse setTruncated(boolean z4) {
        this.truncated = z4;
        return this;
    }
    ...
    @Override // io.netty.handler.codec.dns.AbstractDnsMessage, io.netty.handler.codec.dns.DnsMessage
    public DnsResponse setRecursionDesired(boolean z4) {
        return (DnsResponse) super.setRecursionDesired(z4);
    }
