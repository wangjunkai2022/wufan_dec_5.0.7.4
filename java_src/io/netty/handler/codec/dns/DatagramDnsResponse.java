...
public class DatagramDnsResponse extends DefaultDnsResponse implements AddressedEnvelope<DatagramDnsResponse, InetSocketAddress> {
    ...
    public DatagramDnsResponse setAuthoritativeAnswer(boolean z4) {
        return (DatagramDnsResponse) super.setAuthoritativeAnswer(z4);
    }
    ...
    @Override // io.netty.handler.codec.dns.DefaultDnsResponse, io.netty.handler.codec.dns.DnsResponse
    public DatagramDnsResponse setRecursionAvailable(boolean z4) {
        return (DatagramDnsResponse) super.setRecursionAvailable(z4);
    }

    @Override // io.netty.handler.codec.dns.DefaultDnsResponse, io.netty.handler.codec.dns.DnsResponse
    public DatagramDnsResponse setTruncated(boolean z4) {
        return (DatagramDnsResponse) super.setTruncated(z4);
    }
    ...
    @Override // io.netty.handler.codec.dns.DefaultDnsResponse, io.netty.handler.codec.dns.AbstractDnsMessage, io.netty.handler.codec.dns.DnsMessage
    public DatagramDnsResponse setRecursionDesired(boolean z4) {
        return (DatagramDnsResponse) super.setRecursionDesired(z4);
    }
