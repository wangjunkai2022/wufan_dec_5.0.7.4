...
public class JZlibEncoder extends ZlibEncoder {
    ...
    private final Deflater f69196z;
    ...
    public ChannelFuture finishEncode(ChannelHandlerContext channelHandlerContext, ChannelPromise channelPromise) {
        ...
        this.finished = true;
        try {
            this.f69196z.next_in = EmptyArrays.EMPTY_BYTES;
            this.f69196z.next_in_index = 0;
            this.f69196z.avail_in = 0;
            byte[] bArr = new byte[32];
            this.f69196z.next_out = bArr;
            this.f69196z.next_out_index = 0;
            this.f69196z.avail_out = 32;
            int deflate = this.f69196z.deflate(4);
            if (deflate != 0 && deflate != 1) {
                channelPromise.setFailure((Throwable) ZlibUtil.deflaterException(this.f69196z, "compression failure", deflate));
                return channelPromise;
            }
            if (this.f69196z.next_out_index != 0) {
                byteBuf = Unpooled.wrappedBuffer(bArr, 0, this.f69196z.next_out_index);
            } else {
                byteBuf = Unpooled.EMPTY_BUFFER;
            }
            this.f69196z.deflateEnd();
            this.f69196z.next_in = null;
            this.f69196z.next_out = null;
    ...
    public void encode(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf, ByteBuf byteBuf2) throws Exception {
        ...
        try {
            ...
            this.f69196z.avail_in = readableBytes;
            if (hasArray) {
                this.f69196z.next_in = byteBuf.array();
                this.f69196z.next_in_index = byteBuf.arrayOffset() + byteBuf.readerIndex();
            } else {
                byte[] bArr = new byte[readableBytes];
                byteBuf.getBytes(byteBuf.readerIndex(), bArr);
                this.f69196z.next_in = bArr;
                this.f69196z.next_in_index = 0;
            }
            int i4 = this.f69196z.next_in_index;
            double d5 = readableBytes;
            Double.isNaN(d5);
            int ceil = ((int) Math.ceil(d5 * 1.001d)) + 12 + this.wrapperOverhead;
            byteBuf2.ensureWritable(ceil);
            this.f69196z.avail_out = ceil;
            this.f69196z.next_out = byteBuf2.array();
            this.f69196z.next_out_index = byteBuf2.arrayOffset() + byteBuf2.writerIndex();
            int i5 = this.f69196z.next_out_index;
            int deflate = this.f69196z.deflate(2);
            byteBuf.skipBytes(this.f69196z.next_in_index - i4);
            if (deflate != 0) {
                ZlibUtil.fail(this.f69196z, "compression failure", deflate);
            }
            int i6 = this.f69196z.next_out_index - i5;
            if (i6 > 0) {
