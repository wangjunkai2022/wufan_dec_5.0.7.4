...
final class Bzip2DivSufSort {
    ...
    */
    ...
    private int sortTypeBstar(int[] iArr, int[] iArr2) {
        ...
        trSort(i48, i48, 1);
        if ((bArr[i19] & 255) < (bArr[0] & 255) || (bArr[i19] == bArr[0] && z4)) {
            if (z4) {
                i8 = i48;
            } else {
                i8 = i48 - 1;
    ...
    private void ssMerge(int i4, int i5, int i6, int i7, int[] iArr, int i8, int i9, int i10) {
        ...
        while (true) {
            ...
            if (i21 <= i9) {
                ...
                i16 = stackEntry.f69191a;
                i17 = stackEntry.f69192b;
                i18 = stackEntry.f69193c;
                i12 = stackEntry.f69194d;
            } else {
                int i22 = i18;
                int i23 = i17 - i16;
                if (i23 <= i9) {
                    ...
                    i16 = stackEntry2.f69191a;
                    i17 = stackEntry2.f69192b;
                    i18 = stackEntry2.f69193c;
                    i12 = stackEntry2.f69194d;
                } else {
                    ...
                    if (i25 > 0) {
                        ...
                        i16 = stackEntry3.f69191a;
                        i17 = stackEntry3.f69192b;
                        i18 = stackEntry3.f69193c;
                        i12 = stackEntry3.f69194d;
                    }
                }
            }
            i19 = i12;
    ...
    private void ssMultiKeyIntroSort(int i4, int i5, int i6, int i7) {
        ...
        while (true) {
            ...
            if (i18 <= 8) {
                ...
                int i19 = stackEntry.f69191a;
                int i20 = stackEntry.f69192b;
                int i21 = stackEntry.f69193c;
                ssLog2 = stackEntry.f69194d;
                i17 = i19;
                i13 = i20;
                i14 = i21;
            } else {
