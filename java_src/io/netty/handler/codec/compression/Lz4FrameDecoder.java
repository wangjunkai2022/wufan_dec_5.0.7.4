...
public class Lz4FrameDecoder extends ByteToMessageDecoder {
    ...
    public Lz4FrameDecoder(boolean z4) {
        this(LZ4Factory.fastestInstance(), z4);
    }

    public Lz4FrameDecoder(LZ4Factory lZ4Factory, boolean z4) {
        this(lZ4Factory, z4 ? new Lz4XXHash32(-1756908916) : null);
    }
