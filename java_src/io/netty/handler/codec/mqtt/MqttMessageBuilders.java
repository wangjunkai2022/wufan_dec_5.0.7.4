...
public final class MqttMessageBuilders {
    ...
    public static final class ConnAckBuilder {
        ...
        public ConnAckBuilder sessionPresent(boolean z4) {
    ...
    public static final class ConnectBuilder {
        ...
        public ConnectBuilder cleanSession(boolean z4) {
        ...
        public ConnectBuilder hasPassword(boolean z4) {
            this.hasPassword = z4;
            return this;
        }

        public ConnectBuilder hasUser(boolean z4) {
            this.hasUser = z4;
            return this;
        }
        ...
        public ConnectBuilder willFlag(boolean z4) {
            this.willFlag = z4;
            return this;
        }
        ...
        public ConnectBuilder willRetain(boolean z4) {
            this.willRetain = z4;
            return this;
        }
    ...
    public static final class PublishBuilder {
        ...
        public PublishBuilder retained(boolean z4) {
            this.retained = z4;
            return this;
        }
