...
public enum MqttConnectReturnCode {
    ...
    public static MqttConnectReturnCode valueOf(byte b5) {
        Map<Byte, MqttConnectReturnCode> map = VALUE_TO_CODE_MAP;
        if (map.containsKey(Byte.valueOf(b5))) {
            return map.get(Byte.valueOf(b5));
        }
        throw new IllegalArgumentException("unknown connect return code: " + (b5 & 255));
    }
}
