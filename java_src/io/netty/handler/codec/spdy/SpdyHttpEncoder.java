...
public class SpdyHttpEncoder extends MessageToMessageEncoder<HttpObject> {
    ...
    public SpdyHttpEncoder(SpdyVersion spdyVersion, boolean z4, boolean z5) {
        ObjectUtil.checkNotNull(spdyVersion, "version");
        this.headersToLowerCase = z4;
    ...
    protected void encode2(ChannelHandlerContext channelHandlerContext, HttpObject httpObject, List<Object> list) throws Exception {
        ...
        if (httpObject instanceof HttpRequest) {
            ...
            z4 = createSynStreamFrame.isLast() || createSynStreamFrame.isUnidirectional();
            z5 = true;
        } else {
            z4 = false;
            z5 = false;
        ...
        if (httpObject instanceof HttpResponse) {
            ...
            z4 = createHeadersFrame.isLast();
            z5 = true;
        }
        if (!(httpObject instanceof HttpContent) || z4) {
            z6 = z5;
        } else {
