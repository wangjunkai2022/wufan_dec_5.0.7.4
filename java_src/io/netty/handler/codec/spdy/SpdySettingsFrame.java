...
public interface SpdySettingsFrame extends SpdyFrame {
    ...
    SpdySettingsFrame setClearPreviouslyPersistedSettings(boolean z4);

    SpdySettingsFrame setPersistValue(int i4, boolean z4);

    SpdySettingsFrame setPersisted(int i4, boolean z4);

    SpdySettingsFrame setValue(int i4, int i5);

    SpdySettingsFrame setValue(int i4, int i5, boolean z4, boolean z5);
}
