...
public class SpdyFrameCodec extends ByteToMessageDecoder implements SpdyFrameDecoderDelegate, ChannelOutboundHandler {
    ...
    public void readDataFrame(int i4, boolean z4, ByteBuf byteBuf) {
        this.read = true;
        DefaultSpdyDataFrame defaultSpdyDataFrame = new DefaultSpdyDataFrame(i4, byteBuf);
        defaultSpdyDataFrame.setLast(z4);
    ...
    public void readHeaderBlock(ByteBuf byteBuf) {
        try {
            try {
                ...
                this.ctx.fireExceptionCaught((Throwable) e5);
            }
        } finally {
            byteBuf.release();
        }
    ...
    */
    ...
    @Override // io.netty.handler.codec.spdy.SpdyFrameDecoderDelegate
    public void readHeadersFrame(int i4, boolean z4) {
        ...
        defaultSpdyHeadersFrame.setLast(z4);
    }
    ...
    @Override // io.netty.handler.codec.spdy.SpdyFrameDecoderDelegate
    public void readSetting(int i4, int i5, boolean z4, boolean z5) {
        this.spdySettingsFrame.setValue(i4, i5, z4, z5);
    }
    ...
    @Override // io.netty.handler.codec.spdy.SpdyFrameDecoderDelegate
    public void readSettingsFrame(boolean z4) {
        this.read = true;
        ...
        defaultSpdySettingsFrame.setClearPreviouslyPersistedSettings(z4);
    }

    @Override // io.netty.handler.codec.spdy.SpdyFrameDecoderDelegate
    public void readSynReplyFrame(int i4, boolean z4) {
        DefaultSpdySynReplyFrame defaultSpdySynReplyFrame = new DefaultSpdySynReplyFrame(i4, this.validateHeaders);
        defaultSpdySynReplyFrame.setLast(z4);
        this.spdyHeadersFrame = defaultSpdySynReplyFrame;
    }

    @Override // io.netty.handler.codec.spdy.SpdyFrameDecoderDelegate
    public void readSynStreamFrame(int i4, int i5, byte b5, boolean z4, boolean z5) {
        DefaultSpdySynStreamFrame defaultSpdySynStreamFrame = new DefaultSpdySynStreamFrame(i4, i5, b5, this.validateHeaders);
        defaultSpdySynStreamFrame.setLast(z4);
        defaultSpdySynStreamFrame.setUnidirectional(z5);
    ...
    public SpdyFrameCodec(SpdyVersion spdyVersion, boolean z4) {
    ...
    public SpdyFrameCodec(SpdyVersion spdyVersion, int i4, int i5, int i6, int i7, int i8, boolean z4) {
        this(spdyVersion, i4, SpdyHeaderBlockDecoder.newInstance(spdyVersion, i5), SpdyHeaderBlockEncoder.newInstance(spdyVersion, i6, i7, i8), z4);
    }

    protected SpdyFrameCodec(SpdyVersion spdyVersion, int i4, SpdyHeaderBlockDecoder spdyHeaderBlockDecoder, SpdyHeaderBlockEncoder spdyHeaderBlockEncoder, boolean z4) {
