...
public class DefaultSpdyHeaders extends DefaultHeaders<CharSequence, CharSequence, SpdyHeaders> implements SpdyHeaders {
    ...
    public DefaultSpdyHeaders(boolean z4) {
        super(AsciiString.CASE_INSENSITIVE_HASHER, z4 ? HeaderValueConverterAndValidator.INSTANCE : CharSequenceValueConverter.INSTANCE, z4 ? SpdyNameValidator : DefaultHeaders.NameValidator.NOT_NULL);
    }
    ...
    public boolean contains(CharSequence charSequence, CharSequence charSequence2, boolean z4) {
        return contains((DefaultSpdyHeaders) charSequence, charSequence2, (HashingStrategy<? super CharSequence>) (z4 ? AsciiString.CASE_INSENSITIVE_HASHER : AsciiString.CASE_SENSITIVE_HASHER));
    }
}
