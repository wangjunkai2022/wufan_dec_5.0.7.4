...
public class SpdyFrameDecoder {
    ...
    private static boolean hasFlag(byte b5, byte b6) {
        return (b5 & b6) != 0;
    }

    private static boolean isValidFrameHeader(int i4, int i5, byte b5, int i6) {
        switch (i5) {
            case 0:
                return i4 != 0;
            case 1:
            ...
            switch (AnonymousClass1.$SwitchMap$io$netty$handler$codec$spdy$SpdyFrameDecoder$State[this.state.ordinal()]) {
                ...
                case 2:
                    ...
                    if (i8 == 0) {
                        ...
                        if (byteBuf.readableBytes() >= min) {
                            ...
                            this.delegate.readDataFrame(this.streamId, z4, buffer);
                            break;
                        } else {
                            return;
                        }
                ...
                case 3:
                    if (byteBuf.readableBytes() >= 10) {
                        ...
                        byte b5 = (byte) ((byteBuf.getByte(readerIndex2 + 8) >> 5) & 7);
                        ...
                        if (i10 == 0) {
                            ...
                            this.delegate.readSynStreamFrame(i10, unsignedInt, b5, hasFlag, hasFlag2);
                            break;
                        }
                    } else {
                        return;
                ...
                case 7:
                    if (this.numSettings == 0) {
                        ...
                        byte b6 = byteBuf.getByte(byteBuf.readerIndex());
                        ...
                        boolean hasFlag5 = hasFlag(b6, (byte) 1);
                        boolean hasFlag6 = hasFlag(b6, (byte) 2);
                        byteBuf.skipBytes(8);
                        this.numSettings--;
    ...
    public SpdyFrameDecoder(SpdyVersion spdyVersion, SpdyFrameDecoderDelegate spdyFrameDecoderDelegate, int i4) {
        ...
        this.maxChunkSize = ObjectUtil.checkPositive(i4, "maxChunkSize");
        this.state = State.READ_COMMON_HEADER;
    }
}
