...
public class SpdySessionHandler extends ChannelDuplexHandler {
    ...
    public SpdySessionHandler(SpdyVersion spdyVersion, boolean z4) {
        this.minorVersion = ((SpdyVersion) ObjectUtil.checkNotNull(spdyVersion, "version")).getMinorVersion();
        this.server = z4;
    }

    private boolean acceptStream(int i4, byte b5, boolean z4, boolean z5) {
        ...
        this.spdySession.acceptStream(i4, b5, z4, z5, this.initialSendWindowSize, this.initialReceiveWindowSize, isRemoteInitiatedId);
    ...
    private void halfCloseStream(int i4, boolean z4, ChannelFuture channelFuture) {
        if (z4) {
    ...
    private boolean isRemoteInitiatedId(int i4) {
        ...
        boolean z4 = this.server;
        return (z4 && !isServerId) || (!z4 && isServerId);
    }
    ...
    private void issueStreamError(ChannelHandlerContext channelHandlerContext, int i4, SpdyStreamStatus spdyStreamStatus) {
        boolean z4 = !this.spdySession.isRemoteSideClosed(i4);
    ...
    public void setSessionReceiveWindowSize(int i4) {
        ObjectUtil.checkPositiveOrZero(i4, "sessionReceiveWindowSize");
