...
public class SpdyHeaderBlockJZlibEncoder extends SpdyHeaderBlockRawEncoder {
    ...
    private ByteBuf encode(ByteBufAllocator byteBufAllocator) {
        ...
        int ceil;
        try {
            i4 = this.f69211z.next_in_index;
            i5 = this.f69211z.next_out_index;
            double length = this.f69211z.next_in.length;
            Double.isNaN(length);
        ...
        try {
            this.f69211z.next_out = byteBuf.array();
            this.f69211z.next_out_index = byteBuf.arrayOffset() + byteBuf.writerIndex();
            this.f69211z.avail_out = ceil;
            int deflate = this.f69211z.deflate(2);
            byteBuf.skipBytes(this.f69211z.next_in_index - i4);
            if (deflate == 0) {
                int i6 = this.f69211z.next_out_index - i5;
                if (i6 > 0) {
                    byteBuf.writerIndex(byteBuf.writerIndex() + i6);
                }
                this.f69211z.next_in = null;
                this.f69211z.next_out = null;
                return byteBuf;
            }
    ...
    private void setInput(ByteBuf byteBuf) {
        ...
        this.f69211z.next_in = bArr;
        this.f69211z.next_in_index = i4;
        this.f69211z.avail_in = readableBytes;
    }
