...
public class DefaultStompHeaders extends DefaultHeaders<CharSequence, CharSequence, StompHeaders> implements StompHeaders {
    ...
    public boolean contains(CharSequence charSequence, CharSequence charSequence2, boolean z4) {
        return contains((DefaultStompHeaders) charSequence, charSequence2, (HashingStrategy<? super CharSequence>) (z4 ? AsciiString.CASE_INSENSITIVE_HASHER : AsciiString.CASE_SENSITIVE_HASHER));
    }
}
