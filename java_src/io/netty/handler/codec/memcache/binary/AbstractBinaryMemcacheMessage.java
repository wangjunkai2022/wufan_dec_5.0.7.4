...
public abstract class AbstractBinaryMemcacheMessage extends AbstractMemcacheObject implements BinaryMemcacheMessage {
    ...
    @Override // io.netty.handler.codec.memcache.binary.BinaryMemcacheMessage
    public BinaryMemcacheMessage setDataType(byte b5) {
        this.dataType = b5;
        return this;
    }
    ...
    public BinaryMemcacheMessage setExtras(ByteBuf byteBuf) {
        ...
        this.extras = byteBuf;
        short s4 = this.extrasLength;
        byte readableBytes = byteBuf == null ? (byte) 0 : (byte) byteBuf.readableBytes();
        this.extrasLength = readableBytes;
        this.totalBodyLength = (this.totalBodyLength + readableBytes) - s4;
        return this;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public BinaryMemcacheMessage setExtrasLength(byte b5) {
        this.extrasLength = b5;
        return this;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public BinaryMemcacheMessage setKeyLength(short s4) {
        this.keyLength = s4;
        return this;
    }

    @Override // io.netty.handler.codec.memcache.binary.BinaryMemcacheMessage
    public BinaryMemcacheMessage setMagic(byte b5) {
        this.magic = b5;
        return this;
    }
    ...
    @Override // io.netty.handler.codec.memcache.binary.BinaryMemcacheMessage
    public BinaryMemcacheMessage setOpcode(byte b5) {
        this.opcode = b5;
        return this;
    }
