...
public final class SmtpRequests {
    ...
    public static SmtpRequest mail(CharSequence charSequence, CharSequence... charSequenceArr) {
        ...
        if (charSequenceArr != null && charSequenceArr.length != 0) {
            ...
            if (charSequence != null) {
                charSequence3 = "FROM:<" + ((Object) charSequence) + Typography.greater;
            } else {
        ...
        if (charSequence != null) {
            charSequence2 = "FROM:<" + ((Object) charSequence) + Typography.greater;
        } else {
    ...
    public static SmtpRequest rcpt(CharSequence charSequence, CharSequence... charSequenceArr) {
        ...
        return new DefaultSmtpRequest(smtpCommand, "TO:<" + ((Object) charSequence) + Typography.greater);
    }
    ...
    public static SmtpRequest vrfy(CharSequence charSequence) {
        return new DefaultSmtpRequest(SmtpCommand.VRFY, (CharSequence) ObjectUtil.checkNotNull(charSequence, aw.f63382m));
    }
}
