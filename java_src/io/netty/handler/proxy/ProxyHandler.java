...
public abstract class ProxyHandler extends ChannelDuplexHandler {
    ...
    private boolean safeRemoveDecoder() {
        try {
            ...
            logger.warn("Failed to remove proxy decoders:", (Throwable) e5);
            return false;
        }
    }
    ...
    private boolean safeRemoveEncoder() {
        try {
            ...
            logger.warn("Failed to remove proxy encoders:", (Throwable) e5);
            return false;
        }
    }
    ...
    public final void channelInactive(ChannelHandlerContext channelHandlerContext) throws Exception {
        if (this.finished) {
            ...
            setConnectFailure(new ProxyConnectException(exceptionMessage(NetworkUtil.NETWORK_CLASS_DISCONNECTED)));
        }
    }
