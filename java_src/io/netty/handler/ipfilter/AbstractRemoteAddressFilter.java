...
public abstract class AbstractRemoteAddressFilter<T extends SocketAddress> extends ChannelInboundHandlerAdapter {
    ...
    protected abstract boolean accept(ChannelHandlerContext channelHandlerContext, T t4) throws Exception;

    protected void channelAccepted(ChannelHandlerContext channelHandlerContext, T t4) {
    }
    ...
    protected ChannelFuture channelRejected(ChannelHandlerContext channelHandlerContext, T t4) {
        return null;
    }
}
