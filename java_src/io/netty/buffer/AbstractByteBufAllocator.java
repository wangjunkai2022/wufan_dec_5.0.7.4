...
public abstract class AbstractByteBufAllocator implements ByteBufAllocator {
    ...
    public static ByteBuf toLeakAwareBuffer(ByteBuf byteBuf) {
        ...
        } else if ((i4 != 2 && i4 != 3) || (track = AbstractByteBuf.leakDetector.track(byteBuf)) == null) {
            return byteBuf;
        } else {
    ...
    public int calculateNewCapacity(int i4, int i5) {
        ObjectUtil.checkPositiveOrZero(i4, "minNewCapacity");
        if (i4 <= i5) {
            if (i4 == 4194304) {
                return 4194304;
            }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public AbstractByteBufAllocator(boolean z4) {
        this.directByDefault = z4 && PlatformDependent.hasUnsafe();
    ...
    public static CompositeByteBuf toLeakAwareBuffer(CompositeByteBuf compositeByteBuf) {
        ...
        } else if ((i4 != 2 && i4 != 3) || (track = AbstractByteBuf.leakDetector.track(compositeByteBuf)) == null) {
            return compositeByteBuf;
        } else {
