...
public abstract class AbstractUnsafeSwappedByteBuf extends SwappedByteBuf {
    ...
    protected abstract void _setShort(AbstractByteBuf abstractByteBuf, int i4, short s4);
    ...
    @Override // io.netty.buffer.SwappedByteBuf, io.netty.buffer.ByteBuf
    public final ByteBuf setDouble(int i4, double d5) {
        setLong(i4, Double.doubleToRawLongBits(d5));
        return this;
    }

    @Override // io.netty.buffer.SwappedByteBuf, io.netty.buffer.ByteBuf
    public final ByteBuf setFloat(int i4, float f5) {
    ...
    public final ByteBuf setShort(int i4, int i5) {
        ...
        _setShort(abstractByteBuf, i4, s4);
        return this;
    }
    ...
    @Override // io.netty.buffer.SwappedByteBuf, io.netty.buffer.ByteBuf
    public final ByteBuf writeDouble(double d5) {
    ...
    public final ByteBuf writeShort(int i4) {
        ...
        _setShort(abstractByteBuf, i5, s4);
