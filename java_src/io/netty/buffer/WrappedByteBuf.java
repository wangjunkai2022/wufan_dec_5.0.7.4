...
public class WrappedByteBuf extends ByteBuf {
    ...
    public int bytesBefore(byte b5) {
        return this.buf.bytesBefore(b5);
    }
    ...
    public int indexOf(int i4, int i5, byte b5) {
        return this.buf.indexOf(i4, i5, b5);
    }
    ...
    public ByteBuf setDouble(int i4, double d5) {
        this.buf.setDouble(i4, d5);
        return this;
    }

    @Override // io.netty.buffer.ByteBuf
    public ByteBuf setFloat(int i4, float f5) {
        this.buf.setFloat(i4, f5);
        return this;
    }
    ...
    public ByteBuf writeDouble(double d5) {
        this.buf.writeDouble(d5);
        return this;
    }

    @Override // io.netty.buffer.ByteBuf
    public ByteBuf writeFloat(float f5) {
        this.buf.writeFloat(f5);
        return this;
    }
    ...
    public int bytesBefore(int i4, byte b5) {
        return this.buf.bytesBefore(i4, b5);
    }
    ...
    public int ensureWritable(int i4, boolean z4) {
        return this.buf.ensureWritable(i4, z4);
    }
    ...
    public int bytesBefore(int i4, int i5, byte b5) {
        return this.buf.bytesBefore(i4, i5, b5);
    }
