...
public abstract class ByteBuf implements ReferenceCounted, Comparable<ByteBuf> {
    ...
    public abstract int bytesBefore(byte b5);

    public abstract int bytesBefore(int i4, byte b5);

    public abstract int bytesBefore(int i4, int i5, byte b5);
    ...
    public abstract int ensureWritable(int i4, boolean z4);
    ...
    public abstract int indexOf(int i4, int i5, byte b5);
    ...
    public abstract ByteBuf setBoolean(int i4, boolean z4);
    ...
    public abstract ByteBuf setDouble(int i4, double d5);

    public ByteBuf setDoubleLE(int i4, double d5) {
        return setLongLE(i4, Double.doubleToRawLongBits(d5));
    }

    public abstract ByteBuf setFloat(int i4, float f5);

    public ByteBuf setFloatLE(int i4, float f5) {
        return setIntLE(i4, Float.floatToRawIntBits(f5));
    }
    ...
    public abstract ByteBuf writeBoolean(boolean z4);
    ...
    public abstract ByteBuf writeDouble(double d5);

    public ByteBuf writeDoubleLE(double d5) {
        return writeLongLE(Double.doubleToRawLongBits(d5));
    }

    public abstract ByteBuf writeFloat(float f5);

    public ByteBuf writeFloatLE(float f5) {
        return writeIntLE(Float.floatToRawIntBits(f5));
    }
