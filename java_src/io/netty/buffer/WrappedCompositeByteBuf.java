...
public class WrappedCompositeByteBuf extends CompositeByteBuf {
    ...
    public CompositeByteBuf addFlattenedComponents(boolean z4, ByteBuf byteBuf) {
        this.wrapped.addFlattenedComponents(z4, byteBuf);
        return this;
    }
    ...
    public int bytesBefore(byte b5) {
        return this.wrapped.bytesBefore(b5);
    }
    ...
    public int indexOf(int i4, int i5, byte b5) {
        return this.wrapped.indexOf(i4, i5, b5);
    }
    ...
    public int bytesBefore(int i4, byte b5) {
        return this.wrapped.bytesBefore(i4, b5);
    }
    ...
    public int ensureWritable(int i4, boolean z4) {
        return this.wrapped.ensureWritable(i4, z4);
    }
    ...
    public CompositeByteBuf setDouble(int i4, double d5) {
        this.wrapped.setDouble(i4, d5);
        return this;
    }

    @Override // io.netty.buffer.CompositeByteBuf, io.netty.buffer.AbstractByteBuf, io.netty.buffer.ByteBuf
    public CompositeByteBuf setFloat(int i4, float f5) {
        this.wrapped.setFloat(i4, f5);
        return this;
    }
    ...
    public CompositeByteBuf writeDouble(double d5) {
        this.wrapped.writeDouble(d5);
        return this;
    }

    @Override // io.netty.buffer.CompositeByteBuf, io.netty.buffer.AbstractByteBuf, io.netty.buffer.ByteBuf
    public CompositeByteBuf writeFloat(float f5) {
        this.wrapped.writeFloat(f5);
        return this;
    }
    ...
    public CompositeByteBuf addComponent(boolean z4, ByteBuf byteBuf) {
        this.wrapped.addComponent(z4, byteBuf);
        return this;
    }
    ...
    public int bytesBefore(int i4, int i5, byte b5) {
        return this.wrapped.bytesBefore(i4, i5, b5);
    }
    ...
    public CompositeByteBuf addComponent(boolean z4, int i4, ByteBuf byteBuf) {
        this.wrapped.addComponent(z4, i4, byteBuf);
        return this;
    }
    ...
    public CompositeByteBuf addComponents(boolean z4, ByteBuf... byteBufArr) {
        this.wrapped.addComponents(z4, byteBufArr);
        return this;
    }
    ...
    public CompositeByteBuf addComponents(boolean z4, Iterable<ByteBuf> iterable) {
        this.wrapped.addComponents(z4, iterable);
        return this;
    }
