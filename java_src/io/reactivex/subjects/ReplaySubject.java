...
public final class ReplaySubject<T> extends Subject<T> {
    ...
    static final class SizeAndTimeBoundReplayBuffer<T> extends AtomicReference<Object> implements ReplayBuffer<T> {
        ...
        public void add(T t4) {
            TimedNode<Object> timedNode = new TimedNode<>(t4, this.scheduler.now(this.unit));
        ...
        public T getValue() {
            ...
            if (timedNode.time >= this.scheduler.now(this.unit) - this.maxAge && (t4 = (T) timedNode.value) != null) {
                return (NotificationLite.isComplete(t4) || NotificationLite.isError(t4)) ? (T) timedNode2.value : t4;
            }
            return null;
        }
    ...
    static final class SizeBoundReplayBuffer<T> extends AtomicReference<Object> implements ReplayBuffer<T> {
        ...
        public T getValue() {
            ...
            return (NotificationLite.isComplete(t4) || NotificationLite.isError(t4)) ? (T) node2.value : t4;
        }
