...
public abstract class Single<T> implements SingleSource<T> {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Single<T> just(T t4) {
        ObjectHelper.requireNonNull(t4, "value is null");
        return RxJavaPlugins.onAssembly(new SingleJust(t4));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final Single<T> onErrorReturnItem(T t4) {
        ObjectHelper.requireNonNull(t4, "value is null");
        return RxJavaPlugins.onAssembly(new SingleOnErrorReturn(this, null, t4));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <E extends SingleObserver<? super T>> E subscribeWith(E e5) {
        subscribe(e5);
        return e5;
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T, U> Single<T> using(Callable<U> callable, Function<? super U, ? extends SingleSource<? extends T>> function, Consumer<? super U> consumer, boolean z4) {
        ObjectHelper.requireNonNull(callable, "resourceSupplier is null");
        ObjectHelper.requireNonNull(function, "singleFunction is null");
        ObjectHelper.requireNonNull(consumer, "disposer is null");
        return RxJavaPlugins.onAssembly(new SingleUsing(callable, function, consumer, z4));
    }
    ...
    @SchedulerSupport(SchedulerSupport.COMPUTATION)
    @CheckReturnValue
    public final Single<T> delay(long j4, TimeUnit timeUnit, boolean z4) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Single<T> delay(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z4) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new SingleDelay(this, j4, timeUnit, scheduler, z4));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final Single<T> retry(long j4, Predicate<? super Throwable> predicate) {
        return toSingle(toFlowable().retry(j4, predicate));
    }
