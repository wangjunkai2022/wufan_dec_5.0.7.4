...
public abstract class Flowable<T> implements Publisher<T> {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t4) {
        ObjectHelper.requireNonNull(t4, "item is null");
        return RxJavaPlugins.onAssembly(new FlowableJust(t4));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T, R> Flowable<R> zipArray(Function<? super Object[], ? extends R> function, boolean z4, int i4, Publisher<? extends T>... publisherArr) {
        if (publisherArr.length == 0) {
            return empty();
        }
        ObjectHelper.requireNonNull(function, "zipper is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableZip(publisherArr, null, function, i4, z4));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T, R> Flowable<R> zipIterable(Iterable<? extends Publisher<? extends T>> iterable, Function<? super Object[], ? extends R> function, boolean z4, int i4) {
        ObjectHelper.requireNonNull(function, "zipper is null");
        ObjectHelper.requireNonNull(iterable, "sources is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableZip(null, iterable, function, i4, z4));
    }
    ...
    public final Iterable<T> blockingMostRecent(T t4) {
        return new BlockingFlowableMostRecent(this, t4);
    }
    ...
    public final <U> Single<U> collectInto(U u4, BiConsumer<? super U, ? super T> biConsumer) {
        ObjectHelper.requireNonNull(u4, "initialItem is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapEagerDelayError(Function<? super T, ? extends Publisher<? extends R>> function, boolean z4) {
        return concatMapEagerDelayError(function, bufferSize(), bufferSize(), z4);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> defaultIfEmpty(T t4) {
        ObjectHelper.requireNonNull(t4, "item is null");
    ...
    @BackpressureSupport(BackpressureKind.SPECIAL)
    @CheckReturnValue
    public final Single<T> first(T t4) {
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Single<T> last(T t4) {
        ObjectHelper.requireNonNull(t4, "defaultItem");
        return RxJavaPlugins.onAssembly(new FlowableLastSingle(this, t4));
    }
    ...
    public final Flowable<T> limit(long j4) {
        if (j4 >= 0) {
            return RxJavaPlugins.onAssembly(new FlowableLimit(this, j4));
        }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> onErrorReturnItem(T t4) {
        ObjectHelper.requireNonNull(t4, "item is null");
        return onErrorReturn(Functions.justFunction(t4));
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Single<T> single(T t4) {
        ObjectHelper.requireNonNull(t4, "defaultItem is null");
        return RxJavaPlugins.onAssembly(new FlowableSingleSingle(this, t4));
    }
    ...
    @BackpressureSupport(BackpressureKind.SPECIAL)
    @CheckReturnValue
    public final <E extends Subscriber<? super T>> E subscribeWith(E e5) {
        subscribe(e5);
        return e5;
    }
    ...
    <R> Flowable<R> switchMap0(Function<? super T, ? extends Publisher<? extends R>> function, int i4, boolean z4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        ...
        return RxJavaPlugins.onAssembly(new FlowableSwitchMap(this, function, i4, z4));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> concatArrayEagerDelayError(int i4, int i5, Publisher<? extends T>... publisherArr) {
        return fromArray(publisherArr).concatMapEagerDelayError(Functions.identity(), i4, i5, true);
    }
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @CheckReturnValue
    public static <T, D> Flowable<T> using(Callable<? extends D> callable, Function<? super D, ? extends Publisher<? extends T>> function, Consumer<? super D> consumer, boolean z4) {
        ObjectHelper.requireNonNull(callable, "resourceSupplier is null");
        ObjectHelper.requireNonNull(function, "sourceSupplier is null");
        ObjectHelper.requireNonNull(consumer, "disposer is null");
        return RxJavaPlugins.onAssembly(new FlowableUsing(callable, function, consumer, z4));
    }
    ...
    public final Completable concatMapCompletable(Function<? super T, ? extends CompletableSource> function, int i4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapCompletable(this, function, ErrorMode.IMMEDIATE, i4));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Completable concatMapCompletableDelayError(Function<? super T, ? extends CompletableSource> function, boolean z4) {
        return concatMapCompletableDelayError(function, z4, 2);
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapDelayError(Function<? super T, ? extends Publisher<? extends R>> function, int i4, boolean z4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "prefetch");
        if (this instanceof ScalarCallable) {
            Object call = ((ScalarCallable) this).call();
        ...
        return RxJavaPlugins.onAssembly(new FlowableConcatMap(this, function, i4, z4 ? ErrorMode.END : ErrorMode.BOUNDARY));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapEagerDelayError(Function<? super T, ? extends Publisher<? extends R>> function, int i4, int i5, boolean z4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        ObjectHelper.verifyPositive(i5, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapEager(this, function, i4, i5, z4 ? ErrorMode.END : ErrorMode.BOUNDARY));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapMaybe(Function<? super T, ? extends MaybeSource<? extends R>> function, int i4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapMaybe(this, function, ErrorMode.IMMEDIATE, i4));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapMaybeDelayError(Function<? super T, ? extends MaybeSource<? extends R>> function, boolean z4) {
        return concatMapMaybeDelayError(function, z4, 2);
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapSingle(Function<? super T, ? extends SingleSource<? extends R>> function, int i4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapSingle(this, function, ErrorMode.IMMEDIATE, i4));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapSingleDelayError(Function<? super T, ? extends SingleSource<? extends R>> function, boolean z4) {
        return concatMapSingleDelayError(function, z4, 2);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends R>> function, boolean z4) {
        return flatMap(function, z4, bufferSize(), bufferSize());
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Completable flatMapCompletable(Function<? super T, ? extends CompletableSource> function, boolean z4, int i4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapCompletableCompletable(this, function, z4, i4));
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final <R> Flowable<R> flatMapMaybe(Function<? super T, ? extends MaybeSource<? extends R>> function, boolean z4, int i4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapMaybe(this, function, z4, i4));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final <R> Flowable<R> flatMapSingle(Function<? super T, ? extends SingleSource<? extends R>> function, boolean z4, int i4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapSingle(this, function, z4, i4));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <K> Flowable<GroupedFlowable<K, T>> groupBy(Function<? super T, ? extends K> function, boolean z4) {
        return (Flowable<GroupedFlowable<K, T>>) groupBy(function, Functions.identity(), z4, bufferSize());
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> observeOn(Scheduler scheduler, boolean z4) {
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Flowable<T> onBackpressureBuffer(boolean z4) {
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> sample(long j4, TimeUnit timeUnit, boolean z4) {
        return sample(j4, timeUnit, Schedulers.computation(), z4);
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> throttleLatest(long j4, TimeUnit timeUnit, boolean z4) {
        return throttleLatest(j4, timeUnit, Schedulers.computation(), z4);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t4, T t5) {
        ObjectHelper.requireNonNull(t4, "The first item is null");
        ObjectHelper.requireNonNull(t5, "The second item is null");
    ...
    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    public final void blockingSubscribe(Consumer<? super T> consumer, int i4) {
        FlowableBlockingSubscribe.subscribe(this, consumer, Functions.ON_ERROR_MISSING, Functions.EMPTY_ACTION, i4);
    }
    ...
    public final <U extends Collection<? super T>> Flowable<U> buffer(int i4, int i5, Callable<U> callable) {
        ObjectHelper.verifyPositive(i4, QuarkInstallAppActivity_.f36990i);
        ObjectHelper.verifyPositive(i5, u.f9954p);
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Completable concatMapCompletableDelayError(Function<? super T, ? extends CompletableSource> function, boolean z4, int i4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapCompletable(this, function, z4 ? ErrorMode.END : ErrorMode.BOUNDARY, i4));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapMaybeDelayError(Function<? super T, ? extends MaybeSource<? extends R>> function, boolean z4, int i4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapMaybe(this, function, z4 ? ErrorMode.END : ErrorMode.BOUNDARY, i4));
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> concatMapSingleDelayError(Function<? super T, ? extends SingleSource<? extends R>> function, boolean z4, int i4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapSingle(this, function, z4 ? ErrorMode.END : ErrorMode.BOUNDARY, i4));
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Single<T> elementAt(long j4, T t4) {
        if (j4 >= 0) {
            ObjectHelper.requireNonNull(t4, "defaultItem is null");
            return RxJavaPlugins.onAssembly(new FlowableElementAtSingle(this, j4, t4));
        }
        throw new IndexOutOfBoundsException("index >= 0 required but it was " + j4);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> observeOn(Scheduler scheduler, boolean z4, int i4) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableObserveOn(this, scheduler, z4, i4));
    }
    ...
    public final <R> Single<R> reduce(R r4, BiFunction<R, ? super T, R> biFunction) {
        ...
        ObjectHelper.requireNonNull(biFunction, "reducer is null");
        return RxJavaPlugins.onAssembly(new FlowableReduceSeedSingle(this, r4, biFunction));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> scan(R r4, BiFunction<R, ? super T, R> biFunction) {
        ObjectHelper.requireNonNull(r4, "seed is null");
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @CheckReturnValue
    public final Flowable<T> subscribeOn(@NonNull Scheduler scheduler, boolean z4) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new FlowableSubscribeOn(this, scheduler, z4));
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> throttleLatest(long j4, TimeUnit timeUnit, Scheduler scheduler) {
        return throttleLatest(j4, timeUnit, scheduler, false);
    }
    ...
    public final Flowable<Flowable<T>> window(long j4, long j5, int i4) {
        ObjectHelper.verifyPositive(j5, u.f9954p);
        ObjectHelper.verifyPositive(j4, QuarkInstallAppActivity_.f36990i);
        ObjectHelper.verifyPositive(i4, "bufferSize");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> concatDelayError(Publisher<? extends Publisher<? extends T>> publisher, int i4, boolean z4) {
        return fromPublisher(publisher).concatMapDelayError(Functions.identity(), i4, z4);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> delay(long j4, TimeUnit timeUnit, boolean z4) {
        return delay(j4, timeUnit, Schedulers.computation(), z4);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends R>> function, boolean z4, int i4) {
        return flatMap(function, z4, i4, bufferSize());
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <K, V> Flowable<GroupedFlowable<K, V>> groupBy(Function<? super T, ? extends K> function, Function<? super T, ? extends V> function2, boolean z4) {
        return groupBy(function, function2, z4, bufferSize());
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> onBackpressureBuffer(int i4, boolean z4) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> startWith(T t4) {
        ObjectHelper.requireNonNull(t4, "item is null");
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> throttleLatest(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z4) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new FlowableThrottleLatest(this, j4, timeUnit, scheduler, z4));
    }
    ...
    public final T blockingFirst(T t4) {
        ...
        subscribe((FlowableSubscriber) blockingFirstSubscriber);
        T blockingGet = blockingFirstSubscriber.blockingGet();
        return blockingGet != null ? blockingGet : t4;
    }
    ...
    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    public final void blockingSubscribe(Consumer<? super T> consumer, Consumer<? super Throwable> consumer2, int i4) {
        FlowableBlockingSubscribe.subscribe(this, consumer, consumer2, Functions.EMPTY_ACTION, i4);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends R>> function, boolean z4, int i4, int i5) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        ...
        return RxJavaPlugins.onAssembly(new FlowableFlatMap(this, function, z4, i4, i5));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <K, V> Flowable<GroupedFlowable<K, V>> groupBy(Function<? super T, ? extends K> function, Function<? super T, ? extends V> function2, boolean z4, int i4) {
        ObjectHelper.requireNonNull(function, "keySelector is null");
        ObjectHelper.requireNonNull(function2, "valueSelector is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableGroupBy(this, function, function2, i4, z4, null));
    }
    ...
    @BackpressureSupport(BackpressureKind.SPECIAL)
    @CheckReturnValue
    public final Flowable<T> onBackpressureBuffer(int i4, boolean z4, boolean z5) {
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableOnBackpressureBuffer(this, i4, z5, z4, Functions.EMPTY_ACTION));
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Flowable<T> skipLast(long j4, TimeUnit timeUnit, boolean z4) {
        return skipLast(j4, timeUnit, Schedulers.computation(), z4, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final TestSubscriber<T> test(long j4, boolean z4) {
        TestSubscriber<T> testSubscriber = new TestSubscriber<>(j4);
        if (z4) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t4, T t5, T t6) {
        ObjectHelper.requireNonNull(t4, "The first item is null");
        ObjectHelper.requireNonNull(t5, "The second item is null");
        ObjectHelper.requireNonNull(t6, "The third item is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> delay(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z4) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new FlowableDelay(this, Math.max(0L, j4), timeUnit, scheduler, z4));
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<T> sample(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z4) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new FlowableSampleTimed(this, j4, timeUnit, scheduler, z4));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U, R> Flowable<R> zipWith(Publisher<? extends U> publisher, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z4) {
        return zip(this, publisher, biFunction, z4);
    }
    ...
    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    public final void blockingSubscribe(Consumer<? super T> consumer, Consumer<? super Throwable> consumer2, Action action, int i4) {
        FlowableBlockingSubscribe.subscribe(this, consumer, consumer2, action, i4);
    }
    ...
    @BackpressureSupport(BackpressureKind.SPECIAL)
    @CheckReturnValue
    public final Flowable<T> onBackpressureBuffer(int i4, boolean z4, boolean z5, Action action) {
        ObjectHelper.requireNonNull(action, "onOverflow is null");
        ObjectHelper.verifyPositive(i4, "capacity");
        return RxJavaPlugins.onAssembly(new FlowableOnBackpressureBuffer(this, i4, z5, z4, action));
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Flowable<T> skipLast(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z4) {
        return skipLast(j4, timeUnit, scheduler, z4, bufferSize());
    }

    @SchedulerSupport("custom")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> takeLast(long j4, long j5, TimeUnit timeUnit, Scheduler scheduler, boolean z4, int i4) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        if (j4 >= 0) {
            return RxJavaPlugins.onAssembly(new FlowableTakeLastTimed(this, j4, j5, timeUnit, scheduler, i4, z4));
        }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U, R> Flowable<R> zipWith(Publisher<? extends U> publisher, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z4, int i4) {
        return zip(this, publisher, biFunction, z4, i4);
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final Flowable<T> skipLast(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z4, int i4) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableSkipLastTimed(this, j4, timeUnit, scheduler, i4 << 1, z4));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T1, T2, R> Flowable<R> zip(Publisher<? extends T1> publisher, Publisher<? extends T2> publisher2, BiFunction<? super T1, ? super T2, ? extends R> biFunction, boolean z4) {
        ObjectHelper.requireNonNull(publisher, "source1 is null");
        ObjectHelper.requireNonNull(publisher2, "source2 is null");
        return zipArray(Functions.toFunction(biFunction), z4, bufferSize(), publisher, publisher2);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <K, V> Flowable<GroupedFlowable<K, V>> groupBy(Function<? super T, ? extends K> function, Function<? super T, ? extends V> function2, boolean z4, int i4, Function<? super Consumer<Object>, ? extends Map<K, Object>> function3) {
        ObjectHelper.requireNonNull(function, "keySelector is null");
        ObjectHelper.requireNonNull(function2, "valueSelector is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        ObjectHelper.requireNonNull(function3, "evictingMapFactory is null");
        return RxJavaPlugins.onAssembly(new FlowableGroupBy(this, function, function2, i4, z4, function3));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t4, T t5, T t6, T t7) {
        ObjectHelper.requireNonNull(t4, "The first item is null");
        ObjectHelper.requireNonNull(t5, "The second item is null");
        ObjectHelper.requireNonNull(t6, "The third item is null");
        ObjectHelper.requireNonNull(t7, "The fourth item is null");
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final <U> Flowable<T> sample(Publisher<U> publisher, boolean z4) {
        ObjectHelper.requireNonNull(publisher, "sampler is null");
        return RxJavaPlugins.onAssembly(new FlowableSamplePublisher(this, publisher, z4));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T1, T2, R> Flowable<R> zip(Publisher<? extends T1> publisher, Publisher<? extends T2> publisher2, BiFunction<? super T1, ? super T2, ? extends R> biFunction, boolean z4, int i4) {
        ObjectHelper.requireNonNull(publisher, "source1 is null");
        ObjectHelper.requireNonNull(publisher2, "source2 is null");
        return zipArray(Functions.toFunction(biFunction), z4, i4, publisher, publisher2);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> takeLast(long j4, TimeUnit timeUnit, boolean z4) {
        return takeLast(j4, timeUnit, Schedulers.computation(), z4, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t4, T t5, T t6, T t7, T t8) {
        ObjectHelper.requireNonNull(t4, "The first item is null");
        ObjectHelper.requireNonNull(t5, "The second item is null");
        ObjectHelper.requireNonNull(t6, "The third item is null");
        ObjectHelper.requireNonNull(t7, "The fourth item is null");
        ObjectHelper.requireNonNull(t8, "The fifth item is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> takeLast(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z4) {
        return takeLast(j4, timeUnit, scheduler, z4, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final Flowable<T> takeLast(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z4, int i4) {
        return takeLast(Long.MAX_VALUE, j4, timeUnit, scheduler, z4, i4);
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final <U extends Collection<? super T>> Flowable<U> buffer(long j4, TimeUnit timeUnit, Scheduler scheduler, int i4, Callable<U> callable, boolean z4) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(callable, "bufferSupplier is null");
        ObjectHelper.verifyPositive(i4, QuarkInstallAppActivity_.f36990i);
        return RxJavaPlugins.onAssembly(new FlowableBufferTimed(this, j4, j4, timeUnit, scheduler, callable, i4, z4));
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<Flowable<T>> window(long j4, TimeUnit timeUnit, long j5, boolean z4) {
        return window(j4, timeUnit, Schedulers.computation(), j5, z4);
    }
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<Flowable<T>> window(long j4, TimeUnit timeUnit, Scheduler scheduler, long j5, boolean z4) {
        return window(j4, timeUnit, scheduler, j5, z4, bufferSize());
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t4, T t5, T t6, T t7, T t8, T t9) {
        ObjectHelper.requireNonNull(t4, "The first item is null");
        ObjectHelper.requireNonNull(t5, "The second item is null");
        ObjectHelper.requireNonNull(t6, "The third item is null");
        ObjectHelper.requireNonNull(t7, "The fourth item is null");
        ObjectHelper.requireNonNull(t8, "The fifth item is null");
        ObjectHelper.requireNonNull(t9, "The sixth item is null");
    ...
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    public final Flowable<Flowable<T>> window(long j4, TimeUnit timeUnit, Scheduler scheduler, long j5, boolean z4, int i4) {
        ObjectHelper.verifyPositive(i4, "bufferSize");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.verifyPositive(j5, QuarkInstallAppActivity_.f36990i);
        return RxJavaPlugins.onAssembly(new FlowableWindowTimed(this, j4, j4, timeUnit, scheduler, j5, i4, z4));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U, R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends U>> function, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z4) {
        return flatMap(function, biFunction, z4, bufferSize(), bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U, R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends U>> function, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z4, int i4) {
        return flatMap(function, biFunction, z4, i4, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final <U, R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends U>> function, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z4, int i4, int i5) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.requireNonNull(biFunction, "combiner is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        ObjectHelper.verifyPositive(i5, "bufferSize");
        return flatMap(FlowableInternalHelper.flatMapWithCombiner(function, biFunction), z4, i4, i5);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t4, T t5, T t6, T t7, T t8, T t9, T t10) {
        ObjectHelper.requireNonNull(t4, "The first item is null");
        ObjectHelper.requireNonNull(t5, "The second item is null");
        ObjectHelper.requireNonNull(t6, "The third item is null");
        ObjectHelper.requireNonNull(t7, "The fourth item is null");
        ObjectHelper.requireNonNull(t8, "The fifth item is null");
        ObjectHelper.requireNonNull(t9, "The sixth item is null");
        ObjectHelper.requireNonNull(t10, "The seventh item is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t4, T t5, T t6, T t7, T t8, T t9, T t10, T t11) {
        ObjectHelper.requireNonNull(t4, "The first item is null");
        ObjectHelper.requireNonNull(t5, "The second item is null");
        ObjectHelper.requireNonNull(t6, "The third item is null");
        ObjectHelper.requireNonNull(t7, "The fourth item is null");
        ...
        ObjectHelper.requireNonNull(t9, "The sixth item is null");
        ObjectHelper.requireNonNull(t10, "The seventh item is null");
        ObjectHelper.requireNonNull(t11, "The eighth item is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t4, T t5, T t6, T t7, T t8, T t9, T t10, T t11, T t12) {
        ObjectHelper.requireNonNull(t4, "The first item is null");
        ObjectHelper.requireNonNull(t5, "The second item is null");
        ObjectHelper.requireNonNull(t6, "The third item is null");
        ObjectHelper.requireNonNull(t7, "The fourth item is null");
        ...
        ObjectHelper.requireNonNull(t10, "The seventh item is null");
        ObjectHelper.requireNonNull(t11, "The eighth item is null");
        ObjectHelper.requireNonNull(t12, "The ninth is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> Flowable<T> just(T t4, T t5, T t6, T t7, T t8, T t9, T t10, T t11, T t12, T t13) {
        ObjectHelper.requireNonNull(t4, "The first item is null");
        ObjectHelper.requireNonNull(t5, "The second item is null");
        ObjectHelper.requireNonNull(t6, "The third item is null");
        ObjectHelper.requireNonNull(t7, "The fourth item is null");
        ...
        ObjectHelper.requireNonNull(t10, "The seventh item is null");
        ObjectHelper.requireNonNull(t11, "The eighth item is null");
        ObjectHelper.requireNonNull(t12, "The ninth item is null");
        ObjectHelper.requireNonNull(t13, "The tenth item is null");
