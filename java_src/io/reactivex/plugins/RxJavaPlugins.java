...
public final class RxJavaPlugins {
    ...
    @NonNull
    static <T, R> R apply(@NonNull Function<T, R> function, @NonNull T t4) {
        try {
    ...
    @NonNull
    static <T, U, R> R apply(@NonNull BiFunction<T, U, R> biFunction, @NonNull T t4, @NonNull U u4) {
        try {
            return biFunction.apply(t4, u4);
        } catch (Throwable th) {
            throw ExceptionHelper.wrapOrThrow(th);
        }
    }
