...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public static <T> Observable<T> just(T t4) {
        ObjectHelper.requireNonNull(t4, "The item is null");
        return RxJavaPlugins.onAssembly(new ObservableJust(t4));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T, R> Observable<R> zipArray(Function<? super Object[], ? extends R> function, boolean z4, int i4, ObservableSource<? extends T>... observableSourceArr) {
        if (observableSourceArr.length == 0) {
            return empty();
        }
        ObjectHelper.requireNonNull(function, "zipper is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new ObservableZip(observableSourceArr, null, function, i4, z4));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T, R> Observable<R> zipIterable(Iterable<? extends ObservableSource<? extends T>> iterable, Function<? super Object[], ? extends R> function, boolean z4, int i4) {
        ObjectHelper.requireNonNull(function, "zipper is null");
        ObjectHelper.requireNonNull(iterable, "sources is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new ObservableZip(null, iterable, function, i4, z4));
    }
    ...
    public final Iterable<T> blockingMostRecent(T t4) {
        return new BlockingObservableMostRecent(this, t4);
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> concatMapEagerDelayError(Function<? super T, ? extends ObservableSource<? extends R>> function, boolean z4) {
        return concatMapEagerDelayError(function, Integer.MAX_VALUE, bufferSize(), z4);
    }
    ...
    public final Single<T> last(T t4) {
        ObjectHelper.requireNonNull(t4, "defaultItem is null");
        return RxJavaPlugins.onAssembly(new ObservableLastSingle(this, t4));
    }
    ...
    public final Single<T> single(T t4) {
        ObjectHelper.requireNonNull(t4, "defaultItem is null");
        return RxJavaPlugins.onAssembly(new ObservableSingleSingle(this, t4));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <E extends Observer<? super T>> E subscribeWith(E e5) {
        subscribe(e5);
        return e5;
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T, D> Observable<T> using(Callable<? extends D> callable, Function<? super D, ? extends ObservableSource<? extends T>> function, Consumer<? super D> consumer, boolean z4) {
        ObjectHelper.requireNonNull(callable, "resourceSupplier is null");
        ObjectHelper.requireNonNull(function, "sourceSupplier is null");
        ObjectHelper.requireNonNull(consumer, "disposer is null");
        return RxJavaPlugins.onAssembly(new ObservableUsing(callable, function, consumer, z4));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> concatMapDelayError(Function<? super T, ? extends ObservableSource<? extends R>> function, int i4, boolean z4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "prefetch");
        if (this instanceof ScalarCallable) {
            Object call = ((ScalarCallable) this).call();
        ...
        return RxJavaPlugins.onAssembly(new ObservableConcatMap(this, function, i4, z4 ? ErrorMode.END : ErrorMode.BOUNDARY));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> concatMapEagerDelayError(Function<? super T, ? extends ObservableSource<? extends R>> function, int i4, int i5, boolean z4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        ObjectHelper.verifyPositive(i5, "prefetch");
        return RxJavaPlugins.onAssembly(new ObservableConcatMapEager(this, function, z4 ? ErrorMode.END : ErrorMode.BOUNDARY, i4, i5));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> concatMapMaybeDelayError(Function<? super T, ? extends MaybeSource<? extends R>> function, boolean z4) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> concatMapSingleDelayError(Function<? super T, ? extends SingleSource<? extends R>> function, boolean z4) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends R>> function, boolean z4) {
        return flatMap(function, z4, Integer.MAX_VALUE);
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final Completable flatMapCompletable(Function<? super T, ? extends CompletableSource> function, boolean z4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        return RxJavaPlugins.onAssembly(new ObservableFlatMapCompletableCompletable(this, function, z4));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> flatMapMaybe(Function<? super T, ? extends MaybeSource<? extends R>> function, boolean z4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        return RxJavaPlugins.onAssembly(new ObservableFlatMapMaybe(this, function, z4));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> flatMapSingle(Function<? super T, ? extends SingleSource<? extends R>> function, boolean z4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        return RxJavaPlugins.onAssembly(new ObservableFlatMapSingle(this, function, z4));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <K> Observable<GroupedObservable<K, T>> groupBy(Function<? super T, ? extends K> function, boolean z4) {
        return (Observable<GroupedObservable<K, T>>) groupBy(function, Functions.identity(), z4, bufferSize());
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> observeOn(Scheduler scheduler, boolean z4) {
    ...
    @SchedulerSupport(SchedulerSupport.COMPUTATION)
    @CheckReturnValue
    public final Observable<T> sample(long j4, TimeUnit timeUnit, boolean z4) {
    ...
    @SchedulerSupport(SchedulerSupport.COMPUTATION)
    @CheckReturnValue
    public final Observable<T> throttleLatest(long j4, TimeUnit timeUnit, boolean z4) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> just(T t4, T t5) {
    ...
    public final Completable concatMapCompletableDelayError(Function<? super T, ? extends CompletableSource> function, boolean z4, int i4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "prefetch");
        return RxJavaPlugins.onAssembly(new ObservableConcatMapCompletable(this, function, z4 ? ErrorMode.END : ErrorMode.BOUNDARY, i4));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> concatMapMaybeDelayError(Function<? super T, ? extends MaybeSource<? extends R>> function, boolean z4, int i4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "prefetch");
        return RxJavaPlugins.onAssembly(new ObservableConcatMapMaybe(this, function, z4 ? ErrorMode.END : ErrorMode.BOUNDARY, i4));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> concatMapSingleDelayError(Function<? super T, ? extends SingleSource<? extends R>> function, boolean z4, int i4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "prefetch");
        return RxJavaPlugins.onAssembly(new ObservableConcatMapSingle(this, function, z4 ? ErrorMode.END : ErrorMode.BOUNDARY, i4));
    }
    ...
    public final Single<T> elementAt(long j4, T t4) {
        if (j4 >= 0) {
            ObjectHelper.requireNonNull(t4, "defaultItem is null");
            return RxJavaPlugins.onAssembly(new ObservableElementAtSingle(this, j4, t4));
        }
        throw new IndexOutOfBoundsException("index >= 0 required but it was " + j4);
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends R>> function, boolean z4, int i4) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> observeOn(Scheduler scheduler, boolean z4, int i4) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new ObservableObserveOn(this, scheduler, z4, i4));
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> throttleLatest(long j4, TimeUnit timeUnit, Scheduler scheduler) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> concatDelayError(ObservableSource<? extends ObservableSource<? extends T>> observableSource, int i4, boolean z4) {
        ObjectHelper.requireNonNull(observableSource, "sources is null");
        ObjectHelper.verifyPositive(i4, "prefetch is null");
        return RxJavaPlugins.onAssembly(new ObservableConcatMap(observableSource, Functions.identity(), i4, z4 ? ErrorMode.END : ErrorMode.BOUNDARY));
    }
    ...
    @SchedulerSupport(SchedulerSupport.COMPUTATION)
    @CheckReturnValue
    public final Observable<T> delay(long j4, TimeUnit timeUnit, boolean z4) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends R>> function, boolean z4, int i4, int i5) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        ...
        return RxJavaPlugins.onAssembly(new ObservableFlatMap(this, function, z4, i4, i5));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final <K, V> Observable<GroupedObservable<K, V>> groupBy(Function<? super T, ? extends K> function, Function<? super T, ? extends V> function2, boolean z4) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> throttleLatest(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z4) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new ObservableThrottleLatest(this, j4, timeUnit, scheduler, z4));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <K, V> Observable<GroupedObservable<K, V>> groupBy(Function<? super T, ? extends K> function, Function<? super T, ? extends V> function2, boolean z4, int i4) {
        ObjectHelper.requireNonNull(function, "keySelector is null");
        ObjectHelper.requireNonNull(function2, "valueSelector is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new ObservableGroupBy(this, function, function2, i4, z4));
    }
    ...
    @SchedulerSupport(SchedulerSupport.TRAMPOLINE)
    @CheckReturnValue
    public final Observable<T> skipLast(long j4, TimeUnit timeUnit, boolean z4) {
        return skipLast(j4, timeUnit, Schedulers.trampoline(), z4, bufferSize());
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> just(T t4, T t5, T t6) {
        ObjectHelper.requireNonNull(t4, "The first item is null");
        ObjectHelper.requireNonNull(t5, "The second item is null");
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> delay(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z4) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new ObservableDelay(this, j4, timeUnit, scheduler, z4));
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> sample(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z4) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new ObservableSampleTimed(this, j4, timeUnit, scheduler, z4));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <U, R> Observable<R> zipWith(ObservableSource<? extends U> observableSource, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z4) {
        return zip(this, observableSource, biFunction, z4);
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> skipLast(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z4) {
        return skipLast(j4, timeUnit, scheduler, z4, bufferSize());
    }

    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> takeLast(long j4, long j5, TimeUnit timeUnit, Scheduler scheduler, boolean z4, int i4) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        if (j4 >= 0) {
            return RxJavaPlugins.onAssembly(new ObservableTakeLastTimed(this, j4, j5, timeUnit, scheduler, i4, z4));
        }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <U, R> Observable<R> zipWith(ObservableSource<? extends U> observableSource, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z4, int i4) {
        return zip(this, observableSource, biFunction, z4, i4);
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> skipLast(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z4, int i4) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(i4, "bufferSize");
        return RxJavaPlugins.onAssembly(new ObservableSkipLastTimed(this, j4, timeUnit, scheduler, i4 << 1, z4));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> just(T t4, T t5, T t6, T t7) {
        ObjectHelper.requireNonNull(t4, "The first item is null");
        ObjectHelper.requireNonNull(t5, "The second item is null");
        ObjectHelper.requireNonNull(t6, "The third item is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <U> Observable<T> sample(ObservableSource<U> observableSource, boolean z4) {
        ObjectHelper.requireNonNull(observableSource, "sampler is null");
        return RxJavaPlugins.onAssembly(new ObservableSampleWithObservable(this, observableSource, z4));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T1, T2, R> Observable<R> zip(ObservableSource<? extends T1> observableSource, ObservableSource<? extends T2> observableSource2, BiFunction<? super T1, ? super T2, ? extends R> biFunction, boolean z4) {
        ObjectHelper.requireNonNull(observableSource, "source1 is null");
        ObjectHelper.requireNonNull(observableSource2, "source2 is null");
        return zipArray(Functions.toFunction(biFunction), z4, bufferSize(), observableSource, observableSource2);
    }
    ...
    @SchedulerSupport(SchedulerSupport.TRAMPOLINE)
    @CheckReturnValue
    public final Observable<T> takeLast(long j4, TimeUnit timeUnit, boolean z4) {
        return takeLast(j4, timeUnit, Schedulers.trampoline(), z4, bufferSize());
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> just(T t4, T t5, T t6, T t7, T t8) {
        ObjectHelper.requireNonNull(t4, "The first item is null");
        ObjectHelper.requireNonNull(t5, "The second item is null");
        ObjectHelper.requireNonNull(t6, "The third item is null");
        ObjectHelper.requireNonNull(t7, "The fourth item is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T1, T2, R> Observable<R> zip(ObservableSource<? extends T1> observableSource, ObservableSource<? extends T2> observableSource2, BiFunction<? super T1, ? super T2, ? extends R> biFunction, boolean z4, int i4) {
        ObjectHelper.requireNonNull(observableSource, "source1 is null");
        ObjectHelper.requireNonNull(observableSource2, "source2 is null");
        return zipArray(Functions.toFunction(biFunction), z4, i4, observableSource, observableSource2);
    }
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> takeLast(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z4) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<T> takeLast(long j4, TimeUnit timeUnit, Scheduler scheduler, boolean z4, int i4) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final <U extends Collection<? super T>> Observable<U> buffer(long j4, TimeUnit timeUnit, Scheduler scheduler, int i4, Callable<U> callable, boolean z4) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(callable, "bufferSupplier is null");
        ObjectHelper.verifyPositive(i4, QuarkInstallAppActivity_.f36990i);
        return RxJavaPlugins.onAssembly(new ObservableBufferTimed(this, j4, j4, timeUnit, scheduler, callable, i4, z4));
    }

    @SchedulerSupport(SchedulerSupport.COMPUTATION)
    @CheckReturnValue
    public final Observable<Observable<T>> window(long j4, TimeUnit timeUnit, long j5, boolean z4) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<Observable<T>> window(long j4, TimeUnit timeUnit, Scheduler scheduler, long j5, boolean z4) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> just(T t4, T t5, T t6, T t7, T t8, T t9) {
        ObjectHelper.requireNonNull(t4, "The first item is null");
        ObjectHelper.requireNonNull(t5, "The second item is null");
        ObjectHelper.requireNonNull(t6, "The third item is null");
        ObjectHelper.requireNonNull(t7, "The fourth item is null");
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final Observable<Observable<T>> window(long j4, TimeUnit timeUnit, Scheduler scheduler, long j5, boolean z4, int i4) {
        ObjectHelper.verifyPositive(i4, "bufferSize");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.verifyPositive(j5, QuarkInstallAppActivity_.f36990i);
        return RxJavaPlugins.onAssembly(new ObservableWindowTimed(this, j4, j4, timeUnit, scheduler, j5, i4, z4));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <U, R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends U>> function, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z4) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <U, R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends U>> function, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z4, int i4) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <U, R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends U>> function, BiFunction<? super T, ? super U, ? extends R> biFunction, boolean z4, int i4, int i5) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.requireNonNull(biFunction, "combiner is null");
        return flatMap(ObservableInternalHelper.flatMapWithCombiner(function, biFunction), z4, i4, i5);
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> just(T t4, T t5, T t6, T t7, T t8, T t9, T t10) {
        ObjectHelper.requireNonNull(t4, "The first item is null");
        ObjectHelper.requireNonNull(t5, "The second item is null");
        ObjectHelper.requireNonNull(t6, "The third item is null");
        ObjectHelper.requireNonNull(t7, "The fourth item is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> just(T t4, T t5, T t6, T t7, T t8, T t9, T t10, T t11) {
        ObjectHelper.requireNonNull(t4, "The first item is null");
        ObjectHelper.requireNonNull(t5, "The second item is null");
        ObjectHelper.requireNonNull(t6, "The third item is null");
        ObjectHelper.requireNonNull(t7, "The fourth item is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> just(T t4, T t5, T t6, T t7, T t8, T t9, T t10, T t11, T t12) {
        ObjectHelper.requireNonNull(t4, "The first item is null");
        ObjectHelper.requireNonNull(t5, "The second item is null");
        ObjectHelper.requireNonNull(t6, "The third item is null");
        ObjectHelper.requireNonNull(t7, "The fourth item is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> Observable<T> just(T t4, T t5, T t6, T t7, T t8, T t9, T t10, T t11, T t12, T t13) {
        ObjectHelper.requireNonNull(t4, "The first item is null");
        ObjectHelper.requireNonNull(t5, "The second item is null");
        ObjectHelper.requireNonNull(t6, "The third item is null");
        ObjectHelper.requireNonNull(t7, "The fourth item is null");
