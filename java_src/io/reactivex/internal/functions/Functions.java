...
public final class Functions {
    ...
    static final class Array2Func<T1, T2, R> implements Function<Object[], R> {
        ...
        final BiFunction<? super T1, ? super T2, ? extends R> f69248f;

        Array2Func(BiFunction<? super T1, ? super T2, ? extends R> biFunction) {
            this.f69248f = biFunction;
        }

        @Override // io.reactivex.functions.Function
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 2) {
                return this.f69248f.apply(objArr[0], objArr[1]);
            }
    ...
    static final class Array3Func<T1, T2, T3, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        final Function3<T1, T2, T3, R> f69249f;

        Array3Func(Function3<T1, T2, T3, R> function3) {
            this.f69249f = function3;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 3) {
                return (R) this.f69249f.apply(objArr[0], objArr[1], objArr[2]);
            }
    ...
    static final class Array4Func<T1, T2, T3, T4, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        final Function4<T1, T2, T3, T4, R> f69250f;

        Array4Func(Function4<T1, T2, T3, T4, R> function4) {
            this.f69250f = function4;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 4) {
                return (R) this.f69250f.apply(objArr[0], objArr[1], objArr[2], objArr[3]);
            }
    ...
    static final class Array5Func<T1, T2, T3, T4, T5, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        private final Function5<T1, T2, T3, T4, T5, R> f69251f;

        Array5Func(Function5<T1, T2, T3, T4, T5, R> function5) {
            this.f69251f = function5;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 5) {
                return (R) this.f69251f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4]);
            }
    ...
    static final class Array6Func<T1, T2, T3, T4, T5, T6, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        final Function6<T1, T2, T3, T4, T5, T6, R> f69252f;

        Array6Func(Function6<T1, T2, T3, T4, T5, T6, R> function6) {
            this.f69252f = function6;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 6) {
                return (R) this.f69252f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5]);
            }
    ...
    static final class Array7Func<T1, T2, T3, T4, T5, T6, T7, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        final Function7<T1, T2, T3, T4, T5, T6, T7, R> f69253f;

        Array7Func(Function7<T1, T2, T3, T4, T5, T6, T7, R> function7) {
            this.f69253f = function7;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 7) {
                return (R) this.f69253f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6]);
            }
    ...
    static final class Array8Func<T1, T2, T3, T4, T5, T6, T7, T8, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        final Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> f69254f;

        Array8Func(Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> function8) {
            this.f69254f = function8;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 8) {
                return (R) this.f69254f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6], objArr[7]);
            }
    ...
    static final class Array9Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        final Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> f69255f;

        Array9Func(Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> function9) {
            this.f69255f = function9;
        }
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 9) {
                return (R) this.f69255f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6], objArr[7], objArr[8]);
            }
    ...
    static final class ClassFilter<T, U> implements Predicate<T> {
        ...
        @Override // io.reactivex.functions.Predicate
        public boolean test(T t4) throws Exception {
            return this.clazz.isInstance(t4);
        }
    }
    ...
    static final class EqualsPredicate<T> implements Predicate<T> {
        ...
        EqualsPredicate(T t4) {
            this.value = t4;
        }

        @Override // io.reactivex.functions.Predicate
        public boolean test(T t4) throws Exception {
            return ObjectHelper.equals(t4, this.value);
        }
    }
    ...
    static final class NotificationOnNext<T> implements Consumer<T> {
        ...
        @Override // io.reactivex.functions.Consumer
        public void accept(T t4) throws Exception {
            this.onNotification.accept(Notification.createOnNext(t4));
        }
    }
    ...
    static final class TimestampFunction<T> implements Function<T, Timed<T>> {
        ...
        @Override // io.reactivex.functions.Function
        public Timed<T> apply(T t4) throws Exception {
            return new Timed<>(t4, this.scheduler.now(this.unit), this.unit);
        }
    }
    ...
    static final class ToMapKeySelector<K, T> implements BiConsumer<Map<K, T>, T> {
        ...
        public void accept(Map<K, T> map, T t4) throws Exception {
            map.put(this.keySelector.apply(t4), t4);
        }
    }
    ...
    static final class ToMapKeyValueSelector<K, V, T> implements BiConsumer<Map<K, V>, T> {
        ...
        public void accept(Map<K, V> map, T t4) throws Exception {
            map.put(this.keySelector.apply(t4), this.valueSelector.apply(t4));
        }
    }
    ...
    static final class ToMultimapKeyValueSelector<K, V, T> implements BiConsumer<Map<K, Collection<V>>, T> {
        ...
        public void accept(Map<K, Collection<V>> map, T t4) throws Exception {
            ...
            collection.add(this.valueSelector.apply(t4));
        }
    }
    ...
    public static <T> Callable<T> justCallable(T t4) {
        return new JustValue(t4);
    }

    public static <T, U> Function<T, U> justFunction(U u4) {
        return new JustValue(u4);
    }
