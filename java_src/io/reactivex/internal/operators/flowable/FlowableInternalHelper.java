...
public final class FlowableInternalHelper {
    ...
    public static final class FlatMapIntoIterable<T, U> implements Function<T, Publisher<U>> {
        ...
        public Publisher<U> apply(T t4) throws Exception {
            return new FlowableFromIterable((Iterable) ObjectHelper.requireNonNull(this.mapper.apply(t4), "The mapper returned a null Iterable"));
        }
    }
    ...
    public static final class FlatMapWithCombinerInner<U, R, T> implements Function<U, R> {
        ...
        public R apply(U u4) throws Exception {
            return this.combiner.apply((T) this.f69267t, u4);
        }
    }
    ...
    public static final class FlatMapWithCombinerOuter<T, R, U> implements Function<T, Publisher<R>> {
        ...
        public Publisher<R> apply(T t4) throws Exception {
            return new FlowableMapPublisher((Publisher) ObjectHelper.requireNonNull(this.mapper.apply(t4), "The mapper returned a null Publisher"), new FlatMapWithCombinerInner(this.combiner, t4));
        }
    }
    ...
    public static final class ItemDelayFunction<T, U> implements Function<T, Publisher<T>> {
        ...
        public Publisher<T> apply(T t4) throws Exception {
            return new FlowableTakePublisher((Publisher) ObjectHelper.requireNonNull(this.itemDelay.apply(t4), "The itemDelay returned a null Publisher"), 1L).map(Functions.justFunction(t4)).defaultIfEmpty(t4);
        }
    }
