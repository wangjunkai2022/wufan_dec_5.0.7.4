...
public final class FlowableFlatMapCompletable<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class FlatMapCompletableMainSubscriber<T> extends BasicIntQueueSubscription<T> implements FlowableSubscriber<T> {
        ...
        FlatMapCompletableMainSubscriber(Subscriber<? super T> subscriber, Function<? super T, ? extends CompletableSource> function, boolean z4, int i4) {
    ...
    public FlowableFlatMapCompletable(Flowable<T> flowable, Function<? super T, ? extends CompletableSource> function, boolean z4, int i4) {
        super(flowable);
        this.mapper = function;
        this.delayErrors = z4;
        this.maxConcurrency = i4;
