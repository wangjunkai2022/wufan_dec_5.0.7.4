...
public final class FlowableScalarXMap {
    ...
    public static final class ScalarXMapFlowable<T, R> extends Flowable<R> {
        ...
        ScalarXMapFlowable(T t4, Function<? super T, ? extends Publisher<? extends R>> function) {
            this.value = t4;
    ...
    public static <T, U> Flowable<U> scalarXMap(T t4, Function<? super T, ? extends Publisher<? extends U>> function) {
        return RxJavaPlugins.onAssembly(new ScalarXMapFlowable(t4, function));
    }
