...
public final class FlowableWindowBoundarySelector<T, B, V> extends AbstractFlowableWithUpstream<T, Flowable<T>> {
    ...
    public static final class OperatorWindowBoundaryCloseSubscriber<T, V> extends DisposableSubscriber<V> {
        ...
        final UnicastProcessor<T> f69274w;
    ...
    public static final class WindowBoundaryMainSubscriber<T, B, V> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements Subscription {
        ...
        void close(OperatorWindowBoundaryCloseSubscriber<T, V> operatorWindowBoundaryCloseSubscriber) {
            ...
            this.queue.offer(new WindowOperation(operatorWindowBoundaryCloseSubscriber.f69274w, null));
            if (enter()) {
                drainLoop();
            }
        }
        ...
        void drainLoop() {
            ...
            while (true) {
                ...
                if (z4 && z5) {
                    ...
                    UnicastProcessor<T> unicastProcessor3 = windowOperation.f69275w;
                    if (unicastProcessor3 != null) {
                        if (list.remove(unicastProcessor3)) {
                            windowOperation.f69275w.onComplete();
    ...
    public static final class WindowOperation<T, B> {
        ...
        /* renamed from: w  reason: collision with root package name */
        final UnicastProcessor<T> f69275w;

        WindowOperation(UnicastProcessor<T> unicastProcessor, B b5) {
            this.f69275w = unicastProcessor;
            this.open = b5;
        }
    }
