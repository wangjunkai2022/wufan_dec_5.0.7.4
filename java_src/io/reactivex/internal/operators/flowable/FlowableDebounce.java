...
public final class FlowableDebounce<T, U> extends AbstractFlowableWithUpstream<T, T> {
    ...
    public static final class DebounceSubscriber<T, U> extends AtomicLong implements FlowableSubscriber<T>, Subscription {
        ...
        static final class DebounceInnerSubscriber<T, U> extends DisposableSubscriber<U> {
            ...
            DebounceInnerSubscriber(DebounceSubscriber<T, U> debounceSubscriber, long j4, T t4) {
        ...
        public void onNext(T t4) {
            ...
            try {
                Publisher publisher = (Publisher) ObjectHelper.requireNonNull(this.debounceSelector.apply(t4), "The publisher supplied is null");
                DebounceInnerSubscriber debounceInnerSubscriber = new DebounceInnerSubscriber(this, j4, t4);
