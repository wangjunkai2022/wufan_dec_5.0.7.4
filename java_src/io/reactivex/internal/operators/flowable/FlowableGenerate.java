...
public final class FlowableGenerate<T, S> extends Flowable<T> {
    ...
    static final class GeneratorSubscription<T, S> extends AtomicLong implements Emitter<T>, Subscription {
        ...
        GeneratorSubscription(Subscriber<? super T> subscriber, BiFunction<S, ? super Emitter<T>, S> biFunction, Consumer<? super S> consumer, S s4) {
        ...
        private void dispose(S s4) {
            try {
                this.disposeState.accept(s4);
            } catch (Throwable th) {
