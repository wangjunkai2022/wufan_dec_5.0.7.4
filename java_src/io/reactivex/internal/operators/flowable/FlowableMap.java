...
public final class FlowableMap<T, U> extends AbstractFlowableWithUpstream<T, U> {
    ...
    static final class MapConditionalSubscriber<T, U> extends BasicFuseableConditionalSubscriber<T, U> {
        ...
        public void onNext(T t4) {
            ...
            try {
                this.downstream.onNext(ObjectHelper.requireNonNull(this.mapper.apply(t4), "The mapper function returned a null value."));
            } catch (Throwable th) {
                fail(th);
            }
        }
        ...
        public boolean tryOnNext(T t4) {
            ...
            try {
                return this.downstream.tryOnNext(ObjectHelper.requireNonNull(this.mapper.apply(t4), "The mapper function returned a null value."));
            } catch (Throwable th) {
                fail(th);
                return true;
            }
