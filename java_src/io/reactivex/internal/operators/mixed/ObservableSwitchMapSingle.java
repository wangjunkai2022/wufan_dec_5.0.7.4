...
public final class ObservableSwitchMapSingle<T, R> extends Observable<R> {
    ...
    static final class SwitchMapSingleMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        SwitchMapSingleMainObserver(Observer<? super R> observer, Function<? super T, ? extends SingleSource<? extends R>> function, boolean z4) {
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                } else if (!z5 && switchMapSingleObserver.item != null) {
