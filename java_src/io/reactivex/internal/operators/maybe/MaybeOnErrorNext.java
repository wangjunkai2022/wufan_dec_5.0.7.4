...
public final class MaybeOnErrorNext<T> extends AbstractMaybeWithUpstream<T, T> {
    ...
    static final class OnErrorNextMaybeObserver<T> extends AtomicReference<Disposable> implements MaybeObserver<T>, Disposable {
        ...
        OnErrorNextMaybeObserver(MaybeObserver<? super T> maybeObserver, Function<? super Throwable, ? extends MaybeSource<? extends T>> function, boolean z4) {
            this.downstream = maybeObserver;
    ...
    public MaybeOnErrorNext(MaybeSource<T> maybeSource, Function<? super Throwable, ? extends MaybeSource<? extends T>> function, boolean z4) {
        super(maybeSource);
        this.resumeFunction = function;
        this.allowFatal = z4;
    }
