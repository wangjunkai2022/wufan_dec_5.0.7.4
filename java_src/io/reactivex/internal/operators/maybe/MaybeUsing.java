...
public final class MaybeUsing<T, D> extends Maybe<T> {
    ...
    static final class UsingObserver<T, D> extends AtomicReference<Object> implements MaybeObserver<T>, Disposable {
        ...
        UsingObserver(MaybeObserver<? super T> maybeObserver, D d5, Consumer<? super D> consumer, boolean z4) {
            super(d5);
    ...
    public MaybeUsing(Callable<? extends D> callable, Function<? super D, ? extends MaybeSource<? extends T>> function, Consumer<? super D> consumer, boolean z4) {
