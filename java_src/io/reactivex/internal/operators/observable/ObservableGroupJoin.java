...
public final class ObservableGroupJoin<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AbstractObservableWithUpstream<TLeft, R> {
    ...
    static final class GroupJoinDisposable<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AtomicInteger implements Disposable, JoinSupport {
        ...
        public void innerClose(boolean z4, LeftRightEndObserver leftRightEndObserver) {
            synchronized (this) {
                this.queue.offer(z4 ? LEFT_CLOSE : RIGHT_CLOSE, leftRightEndObserver);
            }
            drain();
        }
    ...
    public interface JoinSupport {
        void innerClose(boolean z4, LeftRightEndObserver leftRightEndObserver);
    ...
    public static final class LeftRightEndObserver extends AtomicReference<Disposable> implements Observer<Object>, Disposable {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public LeftRightEndObserver(JoinSupport joinSupport, boolean z4, int i4) {
