...
public final class ObservableInternalHelper {
    ...
    public static final class FlatMapIntoIterable<T, U> implements Function<T, ObservableSource<U>> {
        ...
        public ObservableSource<U> apply(T t4) throws Exception {
            return new ObservableFromIterable((Iterable) ObjectHelper.requireNonNull(this.mapper.apply(t4), "The mapper returned a null Iterable"));
        }
    }
    ...
    public static final class FlatMapWithCombinerInner<U, R, T> implements Function<U, R> {
        ...
        private final T f69287t;

        FlatMapWithCombinerInner(BiFunction<? super T, ? super U, ? extends R> biFunction, T t4) {
        ...
        public R apply(U u4) throws Exception {
            return this.combiner.apply((T) this.f69287t, u4);
        }
    }
    ...
    public static final class FlatMapWithCombinerOuter<T, R, U> implements Function<T, ObservableSource<R>> {
        ...
        public ObservableSource<R> apply(T t4) throws Exception {
            return new ObservableMap((ObservableSource) ObjectHelper.requireNonNull(this.mapper.apply(t4), "The mapper returned a null ObservableSource"), new FlatMapWithCombinerInner(this.combiner, t4));
        }
    }
    ...
    public static final class ItemDelayFunction<T, U> implements Function<T, ObservableSource<T>> {
        ...
        public ObservableSource<T> apply(T t4) throws Exception {
            return new ObservableTake((ObservableSource) ObjectHelper.requireNonNull(this.itemDelay.apply(t4), "The itemDelay returned a null ObservableSource"), 1L).map(Functions.justFunction(t4)).defaultIfEmpty(t4);
        }
    }
    ...
    public static final class SimpleBiGenerator<T, S> implements BiFunction<S, Emitter<T>, S> {
        ...
        public S apply(S s4, Emitter<T> emitter) throws Exception {
            this.consumer.accept(s4, emitter);
            return s4;
        }
    }
