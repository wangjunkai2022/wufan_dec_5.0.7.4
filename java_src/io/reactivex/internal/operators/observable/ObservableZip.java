...
public final class ObservableZip<T, R> extends Observable<R> {
    ...
    static final class ZipCoordinator<T, R> extends AtomicInteger implements Disposable {
        ...
        ZipCoordinator(Observer<? super R> observer, Function<? super Object[], ? extends R> function, int i4, boolean z4) {
        ...
        boolean checkTerminated(boolean z4, boolean z5, Observer<? super R> observer, boolean z6, ZipObserver<?, ?> zipObserver) {
            if (this.cancelled) {
                cancel();
                return true;
            } else if (z4) {
        ...
        public void drain() {
            ...
            while (true) {
                ...
                for (ZipObserver<T, R> zipObserver : zipObserverArr) {
                    if (tArr[i6] == null) {
                        boolean z5 = zipObserver.done;
                        T poll = zipObserver.queue.poll();
                        boolean z6 = poll == null;
                        if (checkTerminated(z5, z6, observer, z4, zipObserver)) {
                            return;
                        }
                        if (z6) {
                            i5++;
                    ...
                    } else if (zipObserver.done && !z4 && (th = zipObserver.error) != null) {
                        cancel();
                        observer.onError(th);
                        return;
                    }
    ...
    public ObservableZip(ObservableSource<? extends T>[] observableSourceArr, Iterable<? extends ObservableSource<? extends T>> iterable, Function<? super Object[], ? extends R> function, int i4, boolean z4) {
