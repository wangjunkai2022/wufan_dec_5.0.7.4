    ...
    static final class FlatMapSingleObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        final class InnerObserver extends AtomicReference<Disposable> implements SingleObserver<R>, Disposable {
            ...
            public void onSuccess(R r4) {
                FlatMapSingleObserver.this.innerSuccess(this, r4);
            }
        }

        FlatMapSingleObserver(Observer<? super R> observer, Function<? super T, ? extends SingleSource<? extends R>> function, boolean z4) {
        ...
        void innerSuccess(FlatMapSingleObserver<T, R>.InnerObserver innerObserver, R r4) {
            this.set.delete(innerObserver);
            if (get() == 0) {
