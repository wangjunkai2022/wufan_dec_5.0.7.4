...
public final class ObservableUsing<T, D> extends Observable<T> {
    ...
    static final class UsingObserver<T, D> extends AtomicBoolean implements Observer<T>, Disposable {
        ...
        UsingObserver(Observer<? super T> observer, D d5, Consumer<? super D> consumer, boolean z4) {
    ...
    public ObservableUsing(Callable<? extends D> callable, Function<? super D, ? extends ObservableSource<? extends T>> function, Consumer<? super D> consumer, boolean z4) {
