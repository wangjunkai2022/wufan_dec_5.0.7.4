    ...
    static final class FlatMapMaybeObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        final class InnerObserver extends AtomicReference<Disposable> implements MaybeObserver<R>, Disposable {
            ...
            public void onSuccess(R r4) {
                FlatMapMaybeObserver.this.innerSuccess(this, r4);
            }
        }

        FlatMapMaybeObserver(Observer<? super R> observer, Function<? super T, ? extends MaybeSource<? extends R>> function, boolean z4) {
        ...
        void innerSuccess(FlatMapMaybeObserver<T, R>.InnerObserver innerObserver, R r4) {
            this.set.delete(innerObserver);
            if (get() == 0) {
                if (compareAndSet(0, 1)) {
