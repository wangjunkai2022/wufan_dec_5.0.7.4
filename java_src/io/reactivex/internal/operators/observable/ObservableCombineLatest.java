...
public final class ObservableCombineLatest<T, R> extends Observable<R> {
    ...
    public static final class CombinerObserver<T, R> extends AtomicReference<Disposable> implements Observer<T> {
        ...
        public void onNext(T t4) {
            this.parent.innerNext(this.index, t4);
        }
    ...
    static final class LatestCoordinator<T, R> extends AtomicInteger implements Disposable {
        ...
        LatestCoordinator(Observer<? super R> observer, Function<? super Object[], ? extends R> function, int i4, int i5, boolean z4) {
    ...
    public ObservableCombineLatest(ObservableSource<? extends T>[] observableSourceArr, Iterable<? extends ObservableSource<? extends T>> iterable, Function<? super Object[], ? extends R> function, int i4, boolean z4) {
