...
public final class ObservableFlatMap<T, U> extends AbstractObservableWithUpstream<T, U> {
    ...
    static final class MergeObserver<T, U> extends AtomicInteger implements Disposable, Observer<T> {
        ...
        MergeObserver(Observer<? super U> observer, Function<? super T, ? extends ObservableSource<? extends U>> function, boolean z4, int i4, int i5) {
        ...
        */
        ...
        public void onNext(T t4) {
            ...
            try {
                ObservableSource<? extends U> observableSource = (ObservableSource) ObjectHelper.requireNonNull(this.mapper.apply(t4), "The mapper returned a null ObservableSource");
        ...
        void tryEmit(U u4, InnerObserver<T, U> innerObserver) {
