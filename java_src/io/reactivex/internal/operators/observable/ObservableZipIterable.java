...
public final class ObservableZipIterable<T, U, V> extends Observable<V> {
    ...
    static final class ZipIterableObserver<T, U, V> implements Observer<T>, Disposable {
        ...
        public void onNext(T t4) {
            ...
            try {
                try {
                    this.downstream.onNext(ObjectHelper.requireNonNull(this.zipper.apply(t4, ObjectHelper.requireNonNull(this.iterator.next(), "The iterator returned a null value")), "The zipper function returned a null value"));
                    try {
