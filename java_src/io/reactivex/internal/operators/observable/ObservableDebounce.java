...
public final class ObservableDebounce<T, U> extends AbstractObservableWithUpstream<T, T> {
    ...
    public static final class DebounceObserver<T, U> implements Observer<T>, Disposable {
        ...
        static final class DebounceInnerObserver<T, U> extends DisposableObserver<U> {
            ...
            DebounceInnerObserver(DebounceObserver<T, U> debounceObserver, long j4, T t4) {
        ...
        public void onNext(T t4) {
            ...
            try {
                ObservableSource observableSource = (ObservableSource) ObjectHelper.requireNonNull(this.debounceSelector.apply(t4), "The ObservableSource supplied is null");
                DebounceInnerObserver debounceInnerObserver = new DebounceInnerObserver(this, j4, t4);
