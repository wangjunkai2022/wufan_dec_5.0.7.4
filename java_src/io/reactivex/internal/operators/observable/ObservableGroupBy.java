...
public final class ObservableGroupBy<T, K, V> extends AbstractObservableWithUpstream<T, GroupedObservable<K, V>> {
    ...
    public static final class GroupByObserver<T, K, V> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void onNext(T t4) {
            try {
                ...
                try {
                    groupedUnicast.onNext(ObjectHelper.requireNonNull(this.valueSelector.apply(t4), "The value supplied is null"));
                } catch (Throwable th) {
    ...
    public static final class GroupedUnicast<K, T> extends GroupedObservable<K, T> {
        ...
        public static <T, K> GroupedUnicast<K, T> createWith(K k4, int i4, GroupByObserver<?, K, T> groupByObserver, boolean z4) {
            return new GroupedUnicast<>(k4, new State(i4, groupByObserver, k4, z4));
        }
    ...
    public static final class State<T, K> extends AtomicInteger implements Disposable, ObservableSource<T> {
        ...
        boolean checkTerminated(boolean z4, boolean z5, Observer<? super T> observer, boolean z6) {
            if (this.cancelled.get()) {
                this.queue.clear();
            ...
            while (true) {
                if (observer != null) {
                    while (true) {
                        ...
                        boolean z6 = obj == null;
                        if (checkTerminated(z5, z6, observer, z4)) {
                            return;
                        }
                        if (z6) {
                            break;
