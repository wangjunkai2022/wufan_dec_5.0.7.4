...
public final class ParallelReduce<T, R> extends ParallelFlowable<R> {
    ...
    static final class ParallelReduceSubscriber<T, R> extends DeferredScalarSubscriber<T, R> {
        ...
        ParallelReduceSubscriber(Subscriber<? super R> subscriber, R r4, BiFunction<R, ? super T, R> biFunction) {
            super(subscriber);
            this.accumulator = r4;
        ...
        public void onNext(T t4) {
            ...
            try {
                this.accumulator = (R) ObjectHelper.requireNonNull(this.reducer.apply(this.accumulator, t4), "The reducer returned a null value");
            } catch (Throwable th) {
