...
public final class ParallelMap<T, R> extends ParallelFlowable<R> {
    ...
    static final class ParallelMapConditionalSubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onNext(T t4) {
            ...
            try {
                this.downstream.onNext(ObjectHelper.requireNonNull(this.mapper.apply(t4), "The mapper returned a null value"));
            } catch (Throwable th) {
        ...
        public boolean tryOnNext(T t4) {
            ...
            try {
                return this.downstream.tryOnNext(ObjectHelper.requireNonNull(this.mapper.apply(t4), "The mapper returned a null value"));
            } catch (Throwable th) {
                Exceptions.throwIfFatal(th);
                cancel();
                onError(th);
