...
public final class SpscLinkedArrayQueue<T> implements SimplePlainQueue<T> {
    ...
    private T newBufferPoll(AtomicReferenceArray<Object> atomicReferenceArray, long j4, int i4) {
        ...
        T t4 = (T) lvElement(atomicReferenceArray, calcWrappedOffset);
        if (t4 != null) {
    ...
    private void resize(AtomicReferenceArray<Object> atomicReferenceArray, long j4, int i4, T t4, long j5) {
        AtomicReferenceArray<Object> atomicReferenceArray2 = new AtomicReferenceArray<>(atomicReferenceArray.length());
        this.producerBuffer = atomicReferenceArray2;
        this.producerLookAhead = (j5 + j4) - 1;
        soElement(atomicReferenceArray2, i4, t4);
    ...
    private boolean writeToQueue(AtomicReferenceArray<Object> atomicReferenceArray, T t4, long j4, int i4) {
        soElement(atomicReferenceArray, i4, t4);
        soProducerIndex(j4 + 1);
        return true;
    }
    ...
    public boolean offer(T t4) {
        ...
        if (lpProducerIndex < this.producerLookAhead) {
            return writeToQueue(atomicReferenceArray, t4, lpProducerIndex, calcWrappedOffset);
        }
        ...
        if (lvElement(atomicReferenceArray, calcWrappedOffset(j4, i4)) == null) {
            ...
            resize(atomicReferenceArray, lpProducerIndex, calcWrappedOffset, t4, i4);
            return true;
        }
    }
    ...
    public T peek() {
        ...
        T t4 = (T) lvElement(atomicReferenceArray, calcWrappedOffset(lpConsumerIndex, i4));
        return t4 == HAS_NEXT ? newBufferPeek(lvNextBufferAndUnlink(atomicReferenceArray, i4 + 1), lpConsumerIndex, i4) : t4;
    }
    ...
    public boolean offer(T t4, T t5) {
        ...
        if (lvElement(atomicReferenceArray, calcWrappedOffset(j4, i4)) == null) {
            ...
            soElement(atomicReferenceArray, calcWrappedOffset + 1, t5);
            soElement(atomicReferenceArray, calcWrappedOffset, t4);
            soProducerIndex(j4);
            return true;
        }
        AtomicReferenceArray<Object> atomicReferenceArray2 = new AtomicReferenceArray<>(atomicReferenceArray.length());
        ...
        soElement(atomicReferenceArray2, calcWrappedOffset2 + 1, t5);
        soElement(atomicReferenceArray2, calcWrappedOffset2, t4);
        soNext(atomicReferenceArray, atomicReferenceArray2);
