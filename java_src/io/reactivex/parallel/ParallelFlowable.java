...
public abstract class ParallelFlowable<T> {
    ...
    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> concatMapDelayError(@NonNull Function<? super T, ? extends Publisher<? extends R>> function, boolean z4) {
        return concatMapDelayError(function, 2, z4);
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> concatMapDelayError(@NonNull Function<? super T, ? extends Publisher<? extends R>> function, int i4, boolean z4) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "prefetch");
        return RxJavaPlugins.onAssembly(new ParallelConcatMap(this, function, i4, z4 ? ErrorMode.END : ErrorMode.BOUNDARY));
    }

    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> flatMap(@NonNull Function<? super T, ? extends Publisher<? extends R>> function, boolean z4) {
        return flatMap(function, z4, Integer.MAX_VALUE, Flowable.bufferSize());
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> flatMap(@NonNull Function<? super T, ? extends Publisher<? extends R>> function, boolean z4, int i4) {
        return flatMap(function, z4, i4, Flowable.bufferSize());
    }
    ...
    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> flatMap(@NonNull Function<? super T, ? extends Publisher<? extends R>> function, boolean z4, int i4, int i5) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i4, "maxConcurrency");
        ObjectHelper.verifyPositive(i5, "prefetch");
        return RxJavaPlugins.onAssembly(new ParallelFlatMap(this, function, z4, i4, i5));
    }
