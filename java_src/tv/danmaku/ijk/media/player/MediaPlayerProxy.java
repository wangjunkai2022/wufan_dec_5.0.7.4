...
public class MediaPlayerProxy implements IMediaPlayer {
    ...
    public void setKeepInBackground(boolean z4) {
        this.mBackEndMediaPlayer.setKeepInBackground(z4);
    }
    ...
    public void setLooping(boolean z4) {
        this.mBackEndMediaPlayer.setLooping(z4);
    }
    ...
    public void setScreenOnWhilePlaying(boolean z4) {
        this.mBackEndMediaPlayer.setScreenOnWhilePlaying(z4);
    }
    ...
    public void setVolume(float f5, float f6) {
        this.mBackEndMediaPlayer.setVolume(f5, f6);
    }
