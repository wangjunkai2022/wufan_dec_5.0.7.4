...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    public static class DefaultMediaCodecSelector implements OnMediaCodecSelectListener {
        ...
        public String onMediaCodecSelect(IMediaPlayer iMediaPlayer, String str, int i4, int i5) {
            ...
            if (Build.VERSION.SDK_INT >= 16 && !TextUtils.isEmpty(str)) {
                ...
                String.format(Locale.US, "onSelectCodec: mime=%s, profile=%d, level=%d", str, Integer.valueOf(i4), Integer.valueOf(i5));
    ...
    private native float _getPropertyFloat(int i4, float f5);
    ...
    private native void _setPropertyFloat(int i4, float f5);
    ...
    public float getSpeed(float f5) {
    ...
    public void setCacheShare(int i4) {
        _setPropertyLong(FFP_PROP_INT64_SHARE_CACHE_DATA, i4);
    }
