...
public final class Http2Reader implements Closeable {
    ...
    private void readData(Handler handler, int i4, byte b5, int i5) throws IOException {
        ...
        boolean z4 = (b5 & 1) != 0;
        if (!((b5 & 32) != 0)) {
            short readByte = (b5 & 8) != 0 ? (short) (this.source.readByte() & 255) : (short) 0;
            handler.data(z4, i5, this.source, lengthWithoutPadding(i4, b5, readByte));
    ...
    private void readHeaders(Handler handler, int i4, byte b5, int i5) throws IOException {
        if (i5 != 0) {
            ...
            handler.headers(z4, i5, -1, readHeaderBlock(lengthWithoutPadding(i4, b5, readByte), readByte, b5, i5));
            return;
        }
    ...
    private void readPing(Handler handler, int i4, byte b5, int i5) throws IOException {
        ...
        if (i5 == 0) {
            handler.ping((b5 & 1) != 0, this.source.readInt(), this.source.readInt());
            return;
        }
    ...
    private void readPushPromise(Handler handler, int i4, byte b5, int i5) throws IOException {
        if (i5 != 0) {
            short readByte = (b5 & 8) != 0 ? (short) (this.source.readByte() & 255) : (short) 0;
            handler.pushPromise(i5, this.source.readInt() & Integer.MAX_VALUE, readHeaderBlock(lengthWithoutPadding(i4 - 4, b5, readByte), readByte, b5, i5));
            return;
        }
