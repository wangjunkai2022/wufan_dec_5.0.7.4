...
public final class Http2Stream {
    ...
    public final class FramingSink implements Sink {
        ...
        private void emitFrame(boolean z4) throws IOException {
            ...
            try {
                ...
                http2Stream3.connection.writeData(http2Stream3.id, z4 && min == this.sendBuffer.size(), this.sendBuffer, min);
            } finally {
        ...
        void receive(BufferedSource bufferedSource, long j4) throws IOException {
            ...
            while (j4 > 0) {
                synchronized (Http2Stream.this) {
                    z4 = this.finished;
                    z5 = true;
                    z6 = this.readBuffer.size() + j4 > this.maxByteCount;
                }
                if (z6) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public Http2Stream(int i4, Http2Connection http2Connection, boolean z4, boolean z5, @Nullable Headers headers) {
