...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    private boolean recover(IOException iOException, StreamAllocation streamAllocation, boolean z4, Request request) {
        streamAllocation.streamFailed(iOException);
        if (this.client.retryOnConnectionFailure()) {
            return !(z4 && (request.body() instanceof UnrepeatableRequestBody)) && isRecoverable(iOException, z4) && streamAllocation.hasMoreRoutes();
        }
        return false;
    }
        ...
        while (!this.canceled) {
            try {
                try {
                    ...
                    if (!recover(e6, streamAllocation, !(e6 instanceof ConnectionShutdownException), request)) {
                        throw e6;
                    }
                } catch (RouteException e7) {
                    if (!recover(e7.getLastConnectException(), streamAllocation, false, request)) {
