...
public final class WebSocketWriter {
    ...
    public final class FrameSink implements Sink {
        ...
        public void write(Buffer buffer, long j4) throws IOException {
            if (!this.closed) {
                ...
                boolean z4 = this.isFirstFrame && this.contentLength != -1 && WebSocketWriter.this.buffer.size() > this.contentLength - 8192;
    ...
    public WebSocketWriter(boolean z4, BufferedSink bufferedSink, Random random) {
        ...
        this.maskCursor = z4 ? new Buffer.UnsafeCursor() : null;
    }
    ...
    void writeMessageFrame(int i4, long j4, boolean z4, boolean z5) throws IOException {
        if (!this.writerClosed) {
            if (!z4) {
                i4 = 0;
            }
