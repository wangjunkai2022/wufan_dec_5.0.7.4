...
public class JdkWithJettyBootPlatform extends Platform {
    ...
    public void configureTlsExtensions(SSLSocket sSLSocket, String str, List<Protocol> list) {
        try {
            ...
            throw Util.assertionError("unable to set alpn", e5);
        }
    }
    ...
    public String getSelectedProtocol(SSLSocket sSLSocket) {
        try {
            ...
            boolean z4 = jettyNegoProvider.unsupported;
            if (!z4 && jettyNegoProvider.selected == null) {
            ...
            throw Util.assertionError("unable to get selected protocol", e5);
        }
    }
}
