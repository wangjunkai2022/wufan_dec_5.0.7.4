...
public final class Http1Codec implements HttpCodec {
    ...
    public abstract class AbstractSource implements Source {
        ...
        protected final void endOfInput(boolean z4, IOException iOException) throws IOException {
    ...
    public class ChunkedSource extends AbstractSource {
        ...
        private void readChunkSize() throws IOException {
            ...
            try {
                ...
                throw new ProtocolException("expected chunk size and optional extensions but was \"" + this.bytesRemainingInChunk + trim + a.f71493g);
