...
public final class StreamAllocation {
    ...
    private RealConnection findConnection(int i4, int i5, int i6, int i7, boolean z4) throws IOException {
        ...
        realConnection2.connect(i4, i5, i6, i7, z4, this.call, this.eventListener);
    ...
    private RealConnection findHealthyConnection(int i4, int i5, int i6, int i7, boolean z4, boolean z5) throws IOException {
        while (true) {
            RealConnection findConnection = findConnection(i4, i5, i6, i7, z4);
            synchronized (this.connectionPool) {
    ...
    public void streamFinished(boolean z4, HttpCodec httpCodec, long j4, IOException iOException) {
        RealConnection realConnection;
        Socket deallocate;
        boolean z5;
