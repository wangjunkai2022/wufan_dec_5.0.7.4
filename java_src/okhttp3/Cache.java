    ...
    static int readInt(BufferedSource bufferedSource) throws IOException {
        try {
            ...
            if (readDecimalLong < 0 || readDecimalLong > 2147483647L || !readUtf8LineStrict.isEmpty()) {
                throw new IOException("expected an int but was \"" + readDecimalLong + readUtf8LineStrict + a.f71493g);
            }
            ...
            try {
                ...
                if (isHttps()) {
                    ...
                    if (readUtf8LineStrict.length() <= 0) {
                        ...
                        throw new IOException("expected \"\" but was \"" + readUtf8LineStrict + a.f71493g);
                    }
                } else {
                    this.handshake = null;
                }
