...
public final class HttpUrl {
    ...
    static String canonicalize(String str, int i4, int i5, String str2, boolean z4, boolean z5, boolean z6, boolean z7, Charset charset) {
        int i6 = i4;
        while (i6 < i5) {
            int codePointAt = str.codePointAt(i6);
            if (codePointAt >= 32 && codePointAt != 127 && (codePointAt < 128 || !z7)) {
                if (str2.indexOf(codePointAt) == -1 && ((codePointAt != 37 || (z4 && (!z5 || percentEncoded(str, i6, i5)))) && (codePointAt != 43 || !z6))) {
                    i6 += Character.charCount(codePointAt);
                }
            }
            Buffer buffer = new Buffer();
            buffer.writeUtf8(str, i4, i6);
            canonicalize(buffer, str, i6, i5, str2, z4, z5, z6, z7, charset);
    ...
    public static String percentDecode(String str, boolean z4) {
    ...
    public static final class Builder {
        ...
        private boolean isDot(String str) {
            return str.equals(h0.f27805a) || str.equalsIgnoreCase("%2e");
        }
        ...
        private void push(String str, int i4, int i5, boolean z4, boolean z5) {
            String canonicalize = HttpUrl.canonicalize(str, i4, i5, HttpUrl.PATH_SEGMENT_ENCODE_SET, z5, false, false, true, null);
        ...
        */
        ...
        Builder reencodeForUri() {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                this.encodedPathSegments.set(i4, HttpUrl.canonicalize(this.encodedPathSegments.get(i4), HttpUrl.PATH_SEGMENT_ENCODE_SET_URI, true, true, false, true));
            }
            ...
            if (list != null) {
                ...
                for (int i5 = 0; i5 < size2; i5++) {
                    ...
                    if (str != null) {
                        this.encodedQueryNamesAndValues.set(i5, HttpUrl.canonicalize(str, HttpUrl.QUERY_COMPONENT_ENCODE_SET_URI, true, true, true, true));
                    }
                }
            }
        ...
        public Builder scheme(String str) {
            ...
            if (str.equalsIgnoreCase(f.f10923a)) {
                this.scheme = f.f10923a;
    ...
    static String percentDecode(String str, int i4, int i5, boolean z4) {
        for (int i6 = i4; i6 < i5; i6++) {
            char charAt = str.charAt(i6);
            if (charAt == '%' || (charAt == '+' && z4)) {
                Buffer buffer = new Buffer();
                buffer.writeUtf8(str, i4, i6);
                percentDecode(buffer, str, i6, i5, z4);
                return buffer.readUtf8();
            }
        }
        return str.substring(i4, i5);
    ...
    static void canonicalize(Buffer buffer, String str, int i4, int i5, String str2, boolean z4, boolean z5, boolean z6, boolean z7, Charset charset) {
        Buffer buffer2 = null;
        while (i4 < i5) {
            ...
            if (!z4 || (codePointAt != 9 && codePointAt != 10 && codePointAt != 12 && codePointAt != 13)) {
                ...
                } else if (codePointAt >= 32 && codePointAt != 127 && ((codePointAt < 128 || !z7) && str2.indexOf(codePointAt) == -1 && (codePointAt != 37 || (z4 && (!z5 || percentEncoded(str, i4, i5)))))) {
    ...
    static void percentDecode(Buffer buffer, String str, int i4, int i5, boolean z4) {
        int i6;
        while (i4 < i5) {
            int codePointAt = str.codePointAt(i4);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static String canonicalize(String str, String str2, boolean z4, boolean z5, boolean z6, boolean z7, Charset charset) {
    ...
    static String canonicalize(String str, String str2, boolean z4, boolean z5, boolean z6, boolean z7) {
        return canonicalize(str, 0, str.length(), str2, z4, z5, z6, z7, null);
    }
}
