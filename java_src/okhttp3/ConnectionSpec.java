...
public final class ConnectionSpec {
    ...
    private ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z4) {
    ...
    public void apply(SSLSocket sSLSocket, boolean z4) {
    ...
    public boolean equals(@Nullable Object obj) {
        if (obj instanceof ConnectionSpec) {
            ...
            boolean z4 = this.tls;
            if (z4 != connectionSpec.tls) {
                return false;
            }
            return !z4 || (Arrays.equals(this.cipherSuites, connectionSpec.cipherSuites) && Arrays.equals(this.tlsVersions, connectionSpec.tlsVersions) && this.supportsTlsExtensions == connectionSpec.supportsTlsExtensions);
        }
        return false;
    }
    ...
    public static final class Builder {
        ...
        public Builder supportsTlsExtensions(boolean z4) {
            if (this.tls) {
