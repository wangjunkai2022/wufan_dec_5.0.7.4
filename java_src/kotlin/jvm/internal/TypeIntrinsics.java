...
public class TypeIntrinsics {
    ...
    public static Object beforeCheckcastToFunctionOfArity(Object obj, int i4) {
        if (obj != null && !isFunctionOfArity(obj, i4)) {
            throwCce(obj, "kotlin.jvm.functions.Function" + i4);
        }
        return obj;
    }
    ...
    public static boolean isFunctionOfArity(Object obj, int i4) {
        return (obj instanceof Function) && getFunctionArity(obj) == i4;
    }
    ...
    private static <T extends Throwable> T sanitizeStackTrace(T t4) {
        return (T) Intrinsics.sanitizeStackTrace(t4, TypeIntrinsics.class.getName());
    }
    ...
    public static Object beforeCheckcastToFunctionOfArity(Object obj, int i4, String str) {
        if (obj != null && !isFunctionOfArity(obj, i4)) {
            throwCce(str);
        }
        return obj;
