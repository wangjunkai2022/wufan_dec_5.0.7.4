...
public final class DebugMetadataKt {
    ...
    private static final void checkDebugMetadataVersion(int i4, int i5) {
        if (i5 <= i4) {
            return;
        }
    ...
    public static final String[] getSpilledVariableFieldMapping(@NotNull BaseContinuationImpl baseContinuationImpl) {
        ...
        int[] i4 = debugMetadataAnnotation.i();
        int length = i4.length;
        for (int i5 = 0; i5 < length; i5++) {
            if (i4[i5] == label) {
                arrayList.add(debugMetadataAnnotation.s()[i5]);
                arrayList.add(debugMetadataAnnotation.n()[i5]);
            }
        }
    ...
    public static final StackTraceElement getStackTraceElement(@NotNull BaseContinuationImpl baseContinuationImpl) {
        ...
        checkDebugMetadataVersion(1, debugMetadataAnnotation.v());
        int label = getLabel(baseContinuationImpl);
        int i4 = label < 0 ? -1 : debugMetadataAnnotation.l()[label];
        ...
        return new StackTraceElement(str, debugMetadataAnnotation.m(), debugMetadataAnnotation.f(), i4);
    }
}
