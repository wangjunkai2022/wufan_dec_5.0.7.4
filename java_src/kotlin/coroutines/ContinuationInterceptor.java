...
public interface ContinuationInterceptor extends CoroutineContext.Element {
    ...
    public static final class DefaultImpls {
        public static <R> R fold(@NotNull ContinuationInterceptor continuationInterceptor, R r4, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> operation) {
        ...
        public static <E extends CoroutineContext.Element> E get(@NotNull ContinuationInterceptor continuationInterceptor, @NotNull CoroutineContext.Key<E> key) {
            ...
            if (key instanceof AbstractCoroutineContextKey) {
                ...
                if (abstractCoroutineContextKey.isSubKey$kotlin_stdlib(continuationInterceptor.getKey())) {
                    E e5 = (E) abstractCoroutineContextKey.tryCast$kotlin_stdlib(continuationInterceptor);
