...
public final class Regex implements Serializable {
    ...
    public static /* synthetic */ MatchResult find$default(Regex regex, CharSequence charSequence, int i4, int i5, Object obj) {
        if ((i5 & 2) != 0) {
            i4 = 0;
        }
    ...
    public static /* synthetic */ Sequence findAll$default(Regex regex, CharSequence charSequence, int i4, int i5, Object obj) {
        if ((i5 & 2) != 0) {
            i4 = 0;
        }
    ...
    public static /* synthetic */ Sequence splitToSequence$default(Regex regex, CharSequence charSequence, int i4, int i5, Object obj) {
        if ((i5 & 2) != 0) {
            i4 = 0;
        }
    ...
    @Nullable
    public final MatchResult find(@NotNull CharSequence input, int i4) {
        Intrinsics.checkNotNullParameter(input, "input");
    ...
    @NotNull
    public final Sequence<MatchResult> findAll(@NotNull final CharSequence input, final int i4) {
        ...
        if (i4 >= 0 && i4 <= input.length()) {
            generateSequence = SequencesKt__SequencesKt.generateSequence((Function0) new Function0<MatchResult>() { // from class: kotlin.text.Regex$findAll$1
                ...
                public final MatchResult invoke() {
                    return Regex.this.find(input, i4);
                }
    ...
    @Nullable
    public final MatchResult matchAt(@NotNull CharSequence input, int i4) {
        Intrinsics.checkNotNullParameter(input, "input");
    ...
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    @NotNull
    public final Sequence<String> splitToSequence(@NotNull CharSequence input, int i4) {
