...
public class z {
    ...
    private Set<String> f55873e = new HashSet();

    /* renamed from: f  reason: collision with root package name */
    private Set<String> f55874f = new HashSet();

    /* renamed from: g  reason: collision with root package name */
    private Set<String> f55875g = new HashSet();

    /* renamed from: h  reason: collision with root package name */
    private Set<String> f55876h = new HashSet();

    /* renamed from: a  reason: collision with root package name */
    private String f55869a = i.a("f118f1f9431de3a626df48d7302911", "0820");

    /* renamed from: b  reason: collision with root package name */
    private String f55870b = i.a("f118f1ef4616f3fc27d1", "0820");

    /* renamed from: c  reason: collision with root package name */
    private String f55871c = i.a("f118f1e84f0bf5ba3bd1579c6d35", "0820");

    /* renamed from: d  reason: collision with root package name */
    private String f55872d = i.a("fc03e7a44510", "0820");
    ...
    */
    ...
    public JSONObject d() {
        try {
            Set<String> set = this.f55873e;
            if (set == null || set.size() <= 0) {
                return null;
            }
            JSONObject jSONObject = new JSONObject();
            for (String str : this.f55873e) {
                if (str.contains(this.f55869a)) {
                    jSONObject.put("0", 1);
                } else if (str.contains(this.f55870b)) {
                    jSONObject.put("1", 1);
                } else if (str.contains(this.f55871c)) {
                    jSONObject.put("2", 1);
                }
            }
    ...
    public int a() {
        try {
            Set<String> set = this.f55874f;
            if (set == null || set.size() <= 0) {
                return 0;
            }
            return this.f55874f.size();
        } catch (Exception unused) {
            return 0;
        }
    }
