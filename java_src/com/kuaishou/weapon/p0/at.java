...
public class at {
    ...
    private JSONObject f55281a;

    /* renamed from: b  reason: collision with root package name */
    private boolean f55282b;
    ...
    public at(Context context) {
        if (Engine.loadSuccess) {
            try {
                String pqr = Engine.getInstance(context).pqr(Integer.valueOf(ck.f55414g).intValue(), 0, 100, "");
                if (TextUtils.isEmpty(pqr)) {
                    return;
                }
                this.f55281a = new JSONObject(pqr);
    ...
    public String a(String str) {
        JSONObject jSONObject = this.f55281a;
        if (jSONObject != null) {
            try {
        ...
        if (jSONObject != null) {
            try {
                ...
                if (TextUtils.equals(str, "46")) {
                    ...
                    String a5 = i.a("aae31bed33c490b6613a", "0701");
                    String a6 = i.a("99e111e83fc4d0a7662b", "0701");
                    if (TextUtils.isEmpty(string) || string.length() <= 3) {
                        return null;
                    }
        ...
        if (jSONObject != null) {
            try {
                ...
                for (int i5 = 0; i5 < jSONArray.length(); i5++) {
                    ...
                    if (!replace.contains(packageName) && !packageName.contains(replace) && !a5.contains(substring)) {
                        hashSet.add(replace);
                    }
                }
                if (hashSet.size() > 0) {
