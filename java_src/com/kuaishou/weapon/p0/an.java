...
public class an {
    ...
    public static final String f55274a = "de.robv.android.xposed.XposedHelpers";

    /* renamed from: b  reason: collision with root package name */
    public static final String f55275b = "de.robv.android.xposed.XposedBridge";

    /* renamed from: c  reason: collision with root package name */
    public static final String f55276c = "com.elderdrivers.riru.edxp.config.EdXpConfigGlobal";
    ...
    */
    ...
    public Set<String> b() {
        Set keySet;
        try {
            Class<?> loadClass = ClassLoader.getSystemClassLoader().loadClass(f55275b);
            if (loadClass != null) {
    ...
    public Set<String> c() {
        Set keySet;
        try {
            Class<?> loadClass = ClassLoader.getSystemClassLoader().loadClass(f55274a);
            if (loadClass != null) {
    ...
    public JSONObject d() {
        try {
            ...
            jSONObject.put(com.join.mgps.Util.v.f28122v, a(ActivityManager.class, "getRunningServices", Integer.TYPE) ? 1 : 0);
            return jSONObject;
        } catch (Exception unused) {
            return null;
        }
    ...
    public JSONObject e() {
        try {
            JSONObject jSONObject = new JSONObject();
            int i4 = 1;
            boolean a5 = a(MediaRecorder.class, "setOutputFile", String.class);
            if (a5) {
                jSONObject.put("0", a5 ? 1 : 0);
            }
            boolean a6 = a(Camera.class, "takePicture", Camera.ShutterCallback.class, Camera.PictureCallback.class, Camera.PictureCallback.class);
            if (a6) {
                jSONObject.put("1", a6 ? 1 : 0);
            }
            boolean a7 = a(MediaPlayer.class, "setDataSource", Context.class, Uri.class);
            if (a7) {
                if (!a7) {
                    i4 = 0;
                }
    ...
    public JSONObject f() {
        ...
        try {
            ...
            a5 = a(Cipher.class, "doFinal", byte[].class);
            jSONObject.put("0", a5 ? 1 : 0);
            boolean a7 = a(SecureRandom.class, "setSeed", byte[].class);
            jSONObject.put("1", a7 ? 1 : 0);
            if (a7) {
                a5 = true;
            }
            boolean a8 = a(MessageDigest.class, "update", byte[].class);
            jSONObject.put("2", a8 ? 1 : 0);
            if (a8) {
                a5 = true;
            }
            boolean a9 = a(MessageDigest.class, "getInstance", String.class);
            jSONObject.put("3", a9 ? 1 : 0);
            if (a9) {
                a5 = true;
            }
            boolean a10 = a(Uri.class, "parse", String.class);
            jSONObject.put("4", a10 ? 1 : 0);
            if (a10) {
                a5 = true;
            }
            boolean a11 = a(SQLiteDatabase.class, "execSQL", String.class);
            jSONObject.put("5", a11 ? 1 : 0);
            if (a11) {
                a5 = true;
            }
            a6 = a(Activity.class, "finish", new Class[0]);
            jSONObject.put("6", a6 ? 1 : 0);
        } catch (Exception unused) {
        }
        if (a6 ? true : a5) {
            return jSONObject;
    ...
    public JSONObject g() {
        ...
        try {
            jSONObject = new JSONObject();
            boolean a5 = a(JSONObject.class, "toString", new Class[0]);
            if (a5) {
                jSONObject.put("0", a5 ? 1 : 0);
            }
            boolean a6 = a(TextUtils.class, "isEmpty", CharSequence.class);
            if (a6) {
                jSONObject.put("1", a6 ? 1 : 0);
            }
            boolean a7 = a(JSONArray.class, "toString", new Class[0]);
            if (a7) {
                jSONObject.put("2", a7 ? 1 : 0);
            }
            boolean a8 = a(Cipher.class, "doFinal", byte[].class);
            if (a8) {
                jSONObject.put("3", a8 ? 1 : 0);
            }
            boolean a9 = a(ByteArrayOutputStream.class, "toByteArray", new Class[0]);
            if (a9) {
                jSONObject.put("4", a9 ? 1 : 0);
            }
            boolean a10 = a(FileOutputStream.class, "write", byte[].class);
            if (a10) {
                jSONObject.put("5", a10 ? 1 : 0);
            }
            boolean a11 = a(HttpURLConnection.class, "setRequestProperty", String.class, String.class);
            if (a11) {
