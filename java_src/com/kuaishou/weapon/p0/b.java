...
public final class b {
    ...
    public static final String f55291a = "AES/CBC/NoPadding";

    /* renamed from: b  reason: collision with root package name */
    public static final int f55292b = 16;

    /* renamed from: c  reason: collision with root package name */
    public static final String f55293c = "a3NyaXNrY3RsYnVzaW5zc3Z4cHprd3NwYWlvcXBrc3M=";

    /* renamed from: d  reason: collision with root package name */
    private static final String f55294d = "AES/CBC/PKCS5Padding";

    /* renamed from: e  reason: collision with root package name */
    private static final String f55295e = "AES";

    /* renamed from: f  reason: collision with root package name */
    private static final String f55296f = "AES/CBC/PKCS7Padding";

    public static byte[] a(String str, String str2, byte[] bArr) {
        SecretKeySpec secretKeySpec = new SecretKeySpec(str.getBytes(), f55295e);
        Cipher cipher = Cipher.getInstance(f55294d);
        cipher.init(1, secretKeySpec, new IvParameterSpec(str2.getBytes()));
        return cipher.doFinal(bArr);
    }

    public static byte[] b(String str, String str2, byte[] bArr) {
        SecretKeySpec secretKeySpec = new SecretKeySpec(str2.getBytes(), f55295e);
        Cipher cipher = Cipher.getInstance(f55294d);
    ...
    */
    ...
    public static byte[] a(byte[] bArr, byte[] bArr2, boolean z4) {
        try {
            SecretKeySpec secretKeySpec = new SecretKeySpec(bArr, f55295e);
            Cipher cipher = Cipher.getInstance(f55294d);
