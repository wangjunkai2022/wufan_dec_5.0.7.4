...
public class bo {
    public static int a(Context context) {
        ...
        try {
            if (Build.VERSION.SDK_INT >= 23 && (sensorManager = (SensorManager) context.getSystemService(com.umeng.analytics.pro.bm.ac)) != null) {
    ...
    public static long a() {
        ...
        try {
            ...
            try {
                ...
                long currentTimeMillis = System.currentTimeMillis() - ((long) (d5 * 1000.0d));
                try {
                    dataInputStream2.close();
                } catch (IOException unused4) {
                }
