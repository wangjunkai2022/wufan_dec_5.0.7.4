...
public class ac {
    ...
    public String c(Context context) {
        try {
            Object invoke = Class.forName(InstrumentationProxy.f64868d).getMethod(InstrumentationProxy.f64869e, new Class[0]).invoke(null, new Object[0]);
    ...
    */
    ...
    public boolean f(Context context) {
        try {
            ...
            String a5 = a(i4, Build.VERSION.SDK_INT);
            if (TextUtils.isEmpty(str)) {
                return false;
            }
            return !str.startsWith(a5);
        } catch (Exception unused) {
            return false;
        }
    }
