...
public class di {
    ...
    */
        ...
        try {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (readLine == null) {
                        break;
                    } else if (readLine.contains(net.lingala.zip4j.util.e.F0) || readLine.contains("@")) {
                        if (readLine.contains(net.lingala.zip4j.util.e.F0)) {
                            readLine = readLine.substring(readLine.indexOf(net.lingala.zip4j.util.e.F0));
    ...
    public static String b() {
        try {
            String a5 = a(" pidof adbd ");
            if (TextUtils.isEmpty(a5)) {
                return null;
            }
            return a5.length() > 10 ? a5.substring(0, 10) : a5;
        } catch (Exception unused) {
            return null;
        }
    }
