...
public class al {
    ...
    public static JSONObject a() {
        ...
        try {
            ...
            for (int i5 = 0; i5 < 3; i5++) {
                String a5 = aa.a().a(strArr[i5]);
                if (!TextUtils.isEmpty(a5)) {
                    jSONObject.put(strArr[i5].substring(strArr[i5].lastIndexOf(46) + 1), a5);
                }
            }
            try {
    ...
    public static JSONObject b(Context context) {
        ...
        try {
            int a5 = bp.a(strArr);
            if (a5 > 0) {
                jSONObject.put(com.xinzhu.overmind.utils.helpers.f.f68332a, a5);
            }
