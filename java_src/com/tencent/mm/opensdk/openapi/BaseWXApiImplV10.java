...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    public BaseWXApiImplV10(Context context, String str, boolean z4, int i4) {
        this.checkSignature = false;
        this.launchMode = 2;
        Log.d(TAG, "<init>, appId = " + str + ", checkSignature = " + z4 + ", launchMode = " + i4);
        this.context = context;
        this.appId = str;
        this.checkSignature = z4;
        this.launchMode = i4;
        b.f62800a = context.getApplicationContext();
    }
    ...
    public int getWXAppSupportAPI() {
        ...
        b.f62804e.submit(new Runnable() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.1
            ...
            public void run() {
                try {
                    ...
                    Log.w(BaseWXApiImplV10.TAG, e5.getMessage());
                }
        ...
        if (this.wxSdkVersion == 0) {
            try {
                ...
                Log.e(TAG, "get from metaData failed : " + e6.getMessage());
            }
        }
    ...
    public boolean registerApp(String str, long j4) {
        ...
        c0662a.f62761a = "com.tencent.mm";
        c0662a.f62762b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0662a.f62763c = "weixin://registerapp?appid=" + this.appId;
        c0662a.f62764d = j4;
        return a.a(this.context, c0662a);
    }
    ...
    public void unregisterApp() {
        ...
        a.C0662a c0662a = new a.C0662a();
        c0662a.f62761a = "com.tencent.mm";
        c0662a.f62762b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0662a.f62763c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c0662a);
    }
}
