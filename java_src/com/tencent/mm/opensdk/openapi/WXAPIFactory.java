...
public class WXAPIFactory {
    ...
    public static IWXAPI createWXAPI(Context context, String str, boolean z4, int i4) {
        Log.d(TAG, "createWXAPI, appId = " + str + ", checkSignature = " + z4 + ", launchMode = " + i4);
        return new WXApiImplV10(context, str, z4, i4);
    }
}
