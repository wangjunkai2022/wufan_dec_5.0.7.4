...
public class LogType {
    ...
    public static int addType(int i4, int i5) {
        return (i4 | i5) & 1048849;
    }

    public static boolean isForANR(int i4) {
        return (i4 & 1048576) != 0;
    }

    public static boolean isForJava(int i4) {
        return (i4 & 16) != 0;
    }

    public static boolean isForNative(int i4) {
        return (i4 & 1) != 0;
    }

    public static boolean isForUnexp(int i4) {
        return (i4 & 256) != 0;
    }

    public static int removeType(int i4, int i5) {
        return i4 & ((i5 & 1048849) ^ (-1));
    }
}
