...
public class c {
    ...
    static final /* synthetic */ boolean f63064a = true;

    /* renamed from: b  reason: collision with root package name */
    private static String f63065b = "";
    ...
    public static byte[] a() {
        return new byte[]{48, BinaryMemcacheOpcodes.APPENDQ, 6, 55};
    }
    ...
    */
    ...
    public static void a(byte[] bArr, int i4, byte[] bArr2) {
        if (!f63064a && bArr2.length != 4) {
