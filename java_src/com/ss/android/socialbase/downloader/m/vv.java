...
public class vv extends SQLiteOpenHelper {
    ...
    private boolean f61179m;

    private vv() {
        super(com.ss.android.socialbase.downloader.downloader.p.ky(), "downloader.db", (SQLiteDatabase.CursorFactory) null, 15);
        this.f61179m = false;
    }
    ...
    public SQLiteDatabase getReadableDatabase() {
        ...
        if (!this.f61179m && ky != null) {
            try {
                File file = new File("/data/data/" + ky.getPackageName() + "/database/main/");
                if (!file.exists()) {
                    file.mkdir();
                }
    ...
    public void onConfigure(SQLiteDatabase sQLiteDatabase) {
        ...
        if (com.ss.android.socialbase.downloader.n.vv.p().m("disable_sqlite_wal") <= 0 || Build.VERSION.SDK_INT != 28) {
            return;
        }
    ...
    public void onDowngrade(SQLiteDatabase sQLiteDatabase, int i4, int i5) {
        if (com.ss.android.socialbase.downloader.p.vv.vv()) {
            com.ss.android.socialbase.downloader.p.vv.vv("onDowngrade");
        }
    }
