...
public class Downloader extends m {
    ...
    public static synchronized void initOrCover(DownloaderBuilder downloaderBuilder, boolean z4) {
        synchronized (Downloader.class) {
            ...
            if (instance == null) {
                ...
                p.vv(downloaderBuilder);
            } else {
                if (z4) {
                    p.m(downloaderBuilder);
                }
            }
        }
    }
    ...
    @Override // com.ss.android.socialbase.downloader.downloader.m
    public /* bridge */ /* synthetic */ vu getDownloadNotificationEventListener(int i4) {
    ...
    @Override // com.ss.android.socialbase.downloader.downloader.m
    public /* bridge */ /* synthetic */ g getReserveWifiStatusListener() {
    ...
    @Override // com.ss.android.socialbase.downloader.downloader.m
    public /* bridge */ /* synthetic */ void registerDownloadCacheSyncListener(com.ss.android.socialbase.downloader.depend.b bVar) {
        super.registerDownloadCacheSyncListener(bVar);
    }

    @Override // com.ss.android.socialbase.downloader.downloader.m
    public /* bridge */ /* synthetic */ void registerDownloaderProcessConnectedListener(td tdVar) {
        super.registerDownloaderProcessConnectedListener(tdVar);
    }
    ...
    @Override // com.ss.android.socialbase.downloader.downloader.m
    public /* bridge */ /* synthetic */ void setDownloadNotificationEventListener(int i4, vu vuVar) {
        super.setDownloadNotificationEventListener(i4, vuVar);
    }
    ...
    @Override // com.ss.android.socialbase.downloader.downloader.m
    public /* bridge */ /* synthetic */ void setReserveWifiStatusListener(g gVar) {
        super.setReserveWifiStatusListener(gVar);
    }
    ...
    @Override // com.ss.android.socialbase.downloader.downloader.m
    public /* bridge */ /* synthetic */ void unRegisterDownloadCacheSyncListener(com.ss.android.socialbase.downloader.depend.b bVar) {
        super.unRegisterDownloadCacheSyncListener(bVar);
    }

    @Override // com.ss.android.socialbase.downloader.downloader.m
    public /* bridge */ /* synthetic */ void unRegisterDownloaderProcessConnectedListener(td tdVar) {
        super.unRegisterDownloaderProcessConnectedListener(tdVar);
    }
    ...
    @Override // com.ss.android.socialbase.downloader.downloader.m
    public /* bridge */ /* synthetic */ void cancel(int i4, boolean z4) {
        super.cancel(i4, z4);
    }

    @Override // com.ss.android.socialbase.downloader.downloader.m
    public /* bridge */ /* synthetic */ void clearDownloadData(int i4, boolean z4) {
        super.clearDownloadData(i4, z4);
    }
    ...
    @Override // com.ss.android.socialbase.downloader.downloader.m
    @Deprecated
    public /* bridge */ /* synthetic */ void setMainThreadListener(int i4, IDownloadListener iDownloadListener, boolean z4) {
        super.setMainThreadListener(i4, iDownloadListener, z4);
    }
}
