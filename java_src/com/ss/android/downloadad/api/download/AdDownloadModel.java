...
import com.ss.android.download.api.p.m;
import com.ss.android.downloadlib.addownload.b;
import com.ss.android.socialbase.downloader.depend.IDownloadFileUriProvider;
import com.ss.android.socialbase.downloader.n.vv;
...
public class AdDownloadModel implements DownloadModel {
    ...
    public static final class Builder {
        ...
        public Builder setQuickAppModel(i iVar) {
            this.model.mQuickAppModel = iVar;
            return this;
        }
    ...
    private static void appendQuickAppUrlFromJson(JSONObject jSONObject, Builder builder) {
        ...
        builder.setQuickAppModel(new i.vv().vv(optString).vv());
    }
    ...
    public static AdDownloadModel fromJson(JSONObject jSONObject) {
        ...
        try {
            ...
            b.x().vv(e5, "AdDownloadModel fromJson");
        }
    ...
    public AdDownloadModel setQuickAppModel(i iVar) {
        this.mQuickAppModel = iVar;
        return this;
    }
    ...
    public boolean shouldDownloadWithPatchApply() {
        return m.vv(vv.vv(getDownloadSettings()), getMimeType());
    }
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            jSONObject.putOpt(bm.f63454o, this.mPackageName);
            jSONObject.putOpt(COSHttpResponseKey.DOWNLOAD_URL, this.mDownloadUrl);
            ...
            i iVar = this.mQuickAppModel;
            if (iVar != null) {
                jSONObject.putOpt("quick_app_url", iVar.vv());
            }
            ...
            b.x().vv(e5, "AdDownloadModel toJson");
        }
        return jSONObject;
    }
