...
public class AppConfig_gba extends BaseAppConfig {
    private static final char[] HEX_DIGITS;
    public static String PATH = "/papa91/gba/";
    public static String[] deviceDescrip;
    public static int[] deviceID;
    public static String[] deviceName;

    static {
        BaseAppConfig.EMU_NAME = "gba";
        initPath(null);
    ...
    static int getNumCores() {
        try {
            return new File("/sys/devices/system/cpu/").listFiles(new FileFilter() { // from class: com.papa91.arcapp.AppConfig_gba.1CpuFilter
