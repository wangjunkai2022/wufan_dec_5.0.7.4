...
public class AppConfig_md extends BaseAppConfig {
    public static final boolean DEBUG = false;
    private static final char[] HEX_DIGITS;
    public static String PATH = "/papa91/md/";
    public static String[] deviceDescrip;
    public static int[] deviceID;
    public static String[] deviceName;

    static {
        BaseAppConfig.EMU_NAME = "md";
        initPath(null);
    ...
    static int getNumCores() {
        try {
            return new File("/sys/devices/system/cpu/").listFiles(new FileFilter() { // from class: com.papa91.arcapp.AppConfig_md.1CpuFilter
    ...
    static boolean isGameFile(String str) {
        return ((!str.endsWith(".zip") && !str.endsWith(".md") && !str.endsWith(".cue") && !str.endsWith(".bin")) || str.endsWith("pgm.zip") || str.endsWith("neogeo.zip")) ? false : true;
    }
