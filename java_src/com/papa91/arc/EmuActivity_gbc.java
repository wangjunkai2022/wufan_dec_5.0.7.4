...
import com.papa91.arcapp.AppConfig_gbc;
...
public class EmuActivity_gbc extends EmuBaseActivity implements a.d {
    public static String AD_APP_KEY = "1105707114";
    private static String appId = "900009625";
    private static String appKey = "TRmcvTXrAeZezbsq";
    public static String cpuFreq = getCurCpuFreq();
    public static String cpuNum = "" + Runtime.getRuntime().availableProcessors();
    private static EmuActivity_gbc emuActivity;
    ...
    public static void exitActivty(int i4) {
        try {
            ...
            AppConfig_gbc.logE("...................exitActivty : ");
            EmuBaseActivity.gameOut(EmuBaseActivity.GameID, currentTimeMillis, EmuBaseActivity.UserID);
        } catch (Exception e5) {
            e5.printStackTrace();
        }
    ...
    public void createRom() {
        String str = "{\"romPath\":\"" + EmuBaseActivity.assetsPath + "/rom/xianjian\",\"startMode\":0,\"userID\":\"2000\",\"gameID\":\"509474702\",\"version\":\"2\",\"roomID\":\"10000\",\"sopath\":\"" + (getDir("jniLibs", 0).getAbsolutePath() + net.lingala.zip4j.util.e.F0) + "\",\"assetspath\":\"" + EmuBaseActivity.assetsPath + "\",\"classname\":\"com/papa91/arc/EmuActivity_gbc\",\"serverIP\":\"121.201.0.114 \",\"serverPort\":\"5369\",\"porder\":0}";
        EmuBaseActivity.initLaunchConfig(new String[]{BaseAppConfig.PREF_SCREEN_MODE, "appPath", "libPath", BaseAppConfig.PREF_ENABLE_AUDIO, "vibriorMode", "gameMode"}, new String[]{EmuBaseActivity.screenMOde, BaseAppConfig.APP_PATH, AppConfig_gbc.getLibpath(this), EmuBaseActivity.enableAudio, EmuBaseActivity.vibriorMode, "GBC"});
        if (str != null) {
    ...
    public void loadRom() {
        createRom();
        BaseAppConfig.ROM_PATH = EmuBaseActivity.assetsPath + "/rom/xianjian";
    ...
    public void onCreate(Bundle bundle) {
        ...
        sb2.append("/1/so_gbc");
        EmuBaseActivity.assetsPath = file.getAbsolutePath() + "/1/assets_gbc/";
        ...
        if (intent != null && (stringExtra = intent.getStringExtra(BaseAppConfig.KEY_ROM_PATH)) != null && stringExtra != "") {
            ...
            AppConfig_gbc.logE("json ........................... rompath : " + EmuBaseActivity.romPath);
        }
        AppConfig_gbc.initialise(this);
        updateConfig();
        ...
        if (stringExtra2 != null) {
            ...
            AppConfig_gbc.logE(stringExtra2);
            try {
                try {
                ...
                AppConfig_gbc.logE("...................KEY_START_FID : " + String.valueOf(EmuBaseActivity.fid));
                asyncConfig();
                saveLog(EmuBaseActivity.romPath + ".log", stringExtra2);
                onLoadNativeLibraries();
                intent.getIntExtra("startMode", 0);
                EmuBaseActivity.initLaunchConfig(new String[]{BaseAppConfig.PREF_SCREEN_MODE, "appPath", "libPath", BaseAppConfig.PREF_ENABLE_AUDIO, "vibriorMode", "version", "cpuNum", "cpuFreq", "gameMode"}, new String[]{EmuBaseActivity.screenMOde, BaseAppConfig.APP_PATH, AppConfig_gbc.getLibpath(this), EmuBaseActivity.enableAudio, EmuBaseActivity.vibriorMode, EmuBaseActivity.version, cpuNum, cpuFreq, "GBC"});
            ...
            AppConfig_gbc.logE("json not load");
