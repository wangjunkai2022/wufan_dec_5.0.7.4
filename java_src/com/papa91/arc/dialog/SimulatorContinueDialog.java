...
public class SimulatorContinueDialog extends BaseDialog implements View.OnClickListener {
    ...
    public SimulatorContinueDialog(@NonNull Context context) {
    ...
    public SimulatorContinueDialog setConfirmText(CharSequence charSequence) {
        this.btn_ok.setText(charSequence);
        return this;
    }

    public SimulatorContinueDialog setTipContent(CharSequence charSequence) {
        this.tv_content.setText(charSequence);
        return this;
    }

    public SimulatorContinueDialog setTipTitle(CharSequence charSequence) {
        this.tv_title.setText(charSequence);
        return this;
    }

    public SimulatorContinueDialog(@NonNull Context context, int i4) {
        super(context, i4);
        setContentView(R.layout.dialog_simulator_continue);
