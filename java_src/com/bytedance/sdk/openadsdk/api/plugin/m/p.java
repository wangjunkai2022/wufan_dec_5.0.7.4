...
public class p {
    ...
    private X509TrustManager m() throws IOException {
        try {
    ...
    */
    public java.lang.String vv(boolean r4, java.lang.String r5, byte[] r6) {
        /*
            r3 = this;
            r0 = 0
            ...
            javax.net.ssl.X509TrustManager r5 = r3.m()     // Catch: java.lang.Throwable -> L7e java.lang.Exception -> L80
            javax.net.ssl.SSLSocketFactory r5 = r3.vv(r5)     // Catch: java.lang.Throwable -> L7e java.lang.Exception -> L80
            ...
            com.bytedance.sdk.openadsdk.api.plugin.m.vv r1 = com.bytedance.sdk.openadsdk.api.plugin.m.vv.vv     // Catch: java.lang.Exception -> L7c java.lang.Throwable -> L89
        ...
        L4d:
            ...
            java.lang.String r4 = vv(r4, r6)     // Catch: java.lang.Exception -> L7c java.lang.Throwable -> L89
            ...
            byte[] r1 = vv(r1, r2)     // Catch: java.lang.Exception -> L7c java.lang.Throwable -> L89
        ...
        L92:
            goto L91
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.sdk.openadsdk.api.plugin.m.p.vv(boolean, java.lang.String, byte[]):java.lang.String");
    }

    private static byte[] vv(InputStream inputStream, int i4) throws IOException {
        if (inputStream == null) {
            return null;
        }
        if (i4 <= 0) {
    ...
    private static String vv(String str, String str2) {
        if (str != null) {
            ...
            for (int i4 = 1; i4 < split.length; i4++) {
                String[] split2 = split[i4].trim().split(SimpleComparison.EQUAL_TO_OPERATION, 0);
    ...
    private SSLSocketFactory vv(X509TrustManager x509TrustManager) throws IOException {
        try {
