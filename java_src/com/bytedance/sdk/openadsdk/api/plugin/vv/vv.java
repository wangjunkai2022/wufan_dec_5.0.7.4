package com.bytedance.sdk.openadsdk.api.plugin.vv;
...
public final class vv implements Bridge {
    ...
    */
    public <T> T call(int r2, com.bykv.vk.openvk.api.proto.ValueSet r3, java.lang.Class<T> r4) {
        ...
        L15:
            ...
            com.bytedance.sdk.openadsdk.api.plugin.o r3 = com.bytedance.sdk.openadsdk.api.plugin.o.vv(r3)
            r3.m(r2)
        L22:
            return r4
        L23:
            com.bytedance.pangle.plugin.Plugin r2 = r1.vv(r3)
            if (r2 == 0) goto L32
        ...
        L5d:
            if (r3 == 0) goto L68
            java.lang.String r2 = r3.stringValue(r0)
            java.lang.String r2 = com.bytedance.sdk.openadsdk.api.plugin.o.vv(r2)
            goto L6a
        L68:
            java.lang.String r2 = ""
        L6a:
        ...
        La0:
            ...
            com.bytedance.pangle.PluginClassLoader r2 = r2.mClassLoader
            return r2
        Lad:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.sdk.openadsdk.api.plugin.vv.vv.call(int, com.bykv.vk.openvk.api.proto.ValueSet, java.lang.Class):java.lang.Object");
    }
    ...
    private Plugin vv(ValueSet valueSet) {
        if (valueSet == null) {
            return null;
        }
