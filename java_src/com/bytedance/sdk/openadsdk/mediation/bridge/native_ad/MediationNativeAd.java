...
public class MediationNativeAd implements Bridge {
    ...
    public String getAdm() {
        MediationAdLoaderImpl mediationAdLoaderImpl = this.vv;
    ...
    public boolean isClientBidding() {
        return this.vv.isClientBidding();
    }

    public boolean isExpress() {
        Bridge bridge = this.mGMAd;
        if (bridge != null) {
            return ((Boolean) bridge.call(q.a.f63908u, null, Boolean.class)).booleanValue();
        }
        return false;
    }

    public boolean isMultiBidding() {
        return this.vv.isMultiBidding();
    }

    public boolean isServerBidding() {
        return this.vv.isServerBidding();
    }
    ...
    public void shakeViewDismissed() {
        Bridge bridge = this.mGMAd;
        if (bridge != null) {
            bridge.call(q.a.f63909v, null, Void.class);
        }
    }
