...
import com.bytedance.sdk.openadsdk.mediation.vv.vv.vv;
...
public abstract class MediationCustomAdBaseLoader implements IMediationAdLoader {
    ...
    public final void load(Context context, ValueSet valueSet) {
        ...
        loadInner(context, vv.vv(create.getAdSlotValueSet()), new com.bytedance.sdk.openadsdk.mediation.custom.MediationCustomServiceConfig(create.getMediationCustomServiceConfigValue()), create.getGMCustomAdLoader());
    }
