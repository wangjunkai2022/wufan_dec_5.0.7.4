...
public class ComponentManager {
    ...
    public static Intent registerReceiver(Context context, PluginBroadcastReceiver pluginBroadcastReceiver, IntentFilter intentFilter, String str) {
        ...
        a5.f8509b.put(pluginBroadcastReceiver, aVar);
    ...
    public static void unregisterReceiver(Context context, PluginBroadcastReceiver pluginBroadcastReceiver) {
        if (pluginBroadcastReceiver != null) {
            com.bytedance.pangle.receiver.c a5 = com.bytedance.pangle.receiver.c.a();
            for (Map.Entry<String, c.a> entry : a5.f8508a.entrySet()) {
                c.a value = entry.getValue();
                if (value != null) {
                    try {
                        if (value.f8512b.size() > 0) {
                            value.f8512b.remove(pluginBroadcastReceiver);
                        }
                    } catch (Throwable th) {
                        ZeusLogger.w(ZeusLogger.TAG_RECEIVER, "unregisterReceiver-plugin-receiver->action:" + value.f8511a + "[exception]:", th);
                    }
                }
                BroadcastReceiver broadcastReceiver = a5.f8509b.get(pluginBroadcastReceiver);
                if (broadcastReceiver != null) {
                    try {
                        a5.f8510c.remove(Integer.valueOf(broadcastReceiver.hashCode()));
                        a5.f8509b.remove(pluginBroadcastReceiver);
    ...
    public static Intent registerReceiver(Context context, PluginBroadcastReceiver pluginBroadcastReceiver, IntentFilter intentFilter, String str, Handler handler, String str2) {
        ...
        a5.f8509b.put(pluginBroadcastReceiver, aVar);
        if (handler != null) {
            a5.f8510c.add(Integer.valueOf(aVar.hashCode()));
        }
        a5.a(intentFilter, pluginBroadcastReceiver);
        return registerReceiver;
    }
