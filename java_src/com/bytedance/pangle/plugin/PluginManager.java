...
public class PluginManager {
    ...
    public boolean checkPluginInstalled(String str) {
        ...
        boolean z4 = plugin != null && plugin.isInstalled();
    ...
    public void setAllowDownloadPlugin(String str, int i4, boolean z4) {
        ZeusLogger.d(ZeusLogger.TAG_PPM, "PluginManager setAllowDownloadPlugin, " + str + " " + i4 + " " + z4);
        if (getPlugin(str) != null) {
            ...
            edit.apply();
            ZeusLogger.i(ZeusLogger.TAG_INIT, "ZeusSpUtils markAllowDownloadFlag packageName=" + str + " version=" + i4 + " disable=" + z5);
        }
    }
    ...
    public void tryOfflineInternalPlugin(String str, int i4) {
        ...
        ZeusLogger.d(ZeusLogger.TAG_PPM, "PluginManager offlineInternalPlugin, pkgName:" + str + " pluginVer:" + i4 + " apiVer:" + plugin.getApiVersionCode());
        l a5 = l.a();
