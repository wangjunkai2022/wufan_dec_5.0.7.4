...
public final class c {
    ...
    private static final i f8477a = i.a();
    ...
    public final boolean a(String str) {
        ...
        synchronized (plugin) {
            if (!plugin.isInstalled()) {
                ...
                a(com.bytedance.pangle.c.b.f8258i, b.a.D, plugin.mPkgName, plugin.getVersion(), -1L, (String) null);
                ...
                if (a6) {
                    ...
                    a(com.bytedance.pangle.c.b.f8259j, b.a.E, plugin.mPkgName, plugin.getVersion(), a5.a(), sb.toString());
                    ...
                    a(com.bytedance.pangle.c.b.f8259j, b.a.F, plugin.mPkgName, plugin.getVersion(), -1L, sb.toString());
    ...
    */
    ...
    private static void a(Plugin plugin, String str) {
        ...
        for (String str2 : hashMap.keySet()) {
            ...
            StringBuilder sb = new StringBuilder();
            sb.append((str3 == null || !str3.contains(h0.f27805a)) ? plugin.mPkgName + h0.f27805a : "");
