...
public final class LocalBroadcastManager {
    ...
    public static final class b {
        ...
        /* renamed from: a  reason: collision with root package name */
        final IntentFilter f8225a;

        /* renamed from: b  reason: collision with root package name */
        final PluginBroadcastReceiver f8226b;
        ...
        b(IntentFilter intentFilter, PluginBroadcastReceiver pluginBroadcastReceiver) {
            this.f8225a = intentFilter;
            this.f8226b = pluginBroadcastReceiver;
        }
    ...
    final void executePendingBroadcasts() {
        ...
        while (true) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                a aVar = aVarArr[i4];
                int size2 = aVar.f8224b.size();
                for (int i5 = 0; i5 < size2; i5++) {
                    b bVar = aVar.f8224b.get(i5);
                    if (!bVar.f8228d) {
                        bVar.f8226b.onReceive(this.mAppContext, aVar.f8223a);
                    }
                }
            }
        }
            ...
            if (arrayList3 != null) {
                ...
                while (i5 < arrayList3.size()) {
                    ...
                    if (bVar.f8227c) {
                        ...
                        arrayList2 = arrayList3;
                        str2 = resolveTypeIfNeeded;
                        int match = bVar.f8225a.match(action, resolveTypeIfNeeded, scheme, data, categories, TAG);
                        if (match >= 0) {
                            if (z4) {
                ...
                if (arrayList5 != null) {
                    for (int i6 = 0; i6 < arrayList5.size(); i6++) {
                        ((b) arrayList5.get(i6)).f8227c = false;
                    }
    ...
    public final void unregisterReceiver(PluginBroadcastReceiver pluginBroadcastReceiver) {
        synchronized (this.mReceivers) {
            ...
            for (int size = remove.size() - 1; size >= 0; size--) {
                ...
                bVar.f8228d = true;
                for (int i4 = 0; i4 < bVar.f8225a.countActions(); i4++) {
                    String action = bVar.f8225a.getAction(i4);
                    ArrayList<b> arrayList = this.mActions.get(action);
                    if (arrayList != null) {
                        for (int size2 = arrayList.size() - 1; size2 >= 0; size2--) {
                            b bVar2 = arrayList.get(size2);
                            if (bVar2.f8226b == pluginBroadcastReceiver) {
                                bVar2.f8228d = true;
