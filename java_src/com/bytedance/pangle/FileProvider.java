...
public class FileProvider extends ContentProvider {
    ...
    private static final String[] f8217a = {"_display_name", "_size"};

    /* renamed from: b  reason: collision with root package name */
    private static final File f8218b = new File(net.lingala.zip4j.util.e.F0);
                    ...
                    if (next == 2) {
                        ...
                        if (file != null) {
                            ...
                            if (!TextUtils.isEmpty(str2)) {
                                try {
                                    bVar.f8220a.put(str2, a5.getCanonicalFile());
    ...
    public void attachInfo(@NonNull Context context, @NonNull ProviderInfo providerInfo) {
        ...
        if (!providerInfo.exported) {
            if (providerInfo.grantUriPermissions) {
                if (f8219c == null) {
                    f8219c = new b(providerInfo.authority);
                    return;
                }
    ...
    public int delete(@NonNull Uri uri, @Nullable String str, @Nullable String[] strArr) {
        return f8219c.a(uri).delete() ? 1 : 0;
    }

    @Override // android.content.ContentProvider
    public String getType(@NonNull Uri uri) {
        File a5 = f8219c.a(uri);
    ...
    public ParcelFileDescriptor openFile(@NonNull Uri uri, @NonNull String str) {
        ...
        if ("r".equals(str)) {
            ...
            i4 = 704643072;
        } else if (net.lingala.zip4j.util.e.f71861e0.equals(str)) {
            i4 = 939524096;
    ...
    public static class b implements a {
        ...
        /* renamed from: a  reason: collision with root package name */
        final HashMap<String, File> f8220a = new HashMap<>();
        ...
        public final Uri a(File file) {
            ...
            try {
                ...
                for (Map.Entry<String, File> entry2 : this.f8220a.entrySet()) {
                ...
                if (entry != null) {
                    ...
                    return new Uri.Builder().scheme("content").authority(this.f8221b).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(substring, net.lingala.zip4j.util.e.F0)).build();
                }
        ...
        public final File a(Uri uri) {
            ...
            File file = this.f8220a.get(decode);
            if (file != null) {
