...
public interface g extends IInterface {
    ...
    public static abstract class a extends Binder implements g {
        ...
        public static class C0217a implements g {
            ...
            public static g f8392a;

            /* renamed from: b  reason: collision with root package name */
            private IBinder f8393b;
            ...
            public final void a(ComponentName componentName, IBinder iBinder) {
                ...
                try {
                    ...
                    if (!this.f8393b.transact(1, obtain, obtain2, 0) && a.b() != null) {
            ...
            public final int a() {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.pangle.ServiceConnection");
                    if (!this.f8393b.transact(2, obtain, obtain2, 0) && a.b() != null) {
                        return a.b().a();
                    }
                    obtain2.readException();
