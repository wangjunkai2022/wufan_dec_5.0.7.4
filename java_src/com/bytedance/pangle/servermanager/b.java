...
public final class b {
    ...
    private static final Object f8554a = new Object();

    /* renamed from: b  reason: collision with root package name */
    private static final Object f8555b = new Object();

    /* renamed from: c  reason: collision with root package name */
    private static final Object f8556c = new Object();

    /* renamed from: d  reason: collision with root package name */
    private static final Map<String, Boolean> f8557d = new ConcurrentHashMap();

    /* renamed from: e  reason: collision with root package name */
    private static final Map<String, e> f8558e = new ConcurrentHashMap();

    /* renamed from: f  reason: collision with root package name */
    private static c f8559f;

    public static e a(String str) {
        Boolean bool = f8557d.get(str);
        if (bool == null || !bool.booleanValue()) {
            f8558e.remove(str);
        }
        Map<String, e> map = f8558e;
        if (map.get(str) == null) {
            synchronized (f8555b) {
    ...
    */
    private static android.os.IInterface a(java.lang.String r6, final java.lang.String r7) {
        /*
            ...
            if (r0 == 0) goto L4d
            android.os.IBinder r0 = r0.f8553a
            goto L4e
        L4d:
            r0 = r3
        L4e:
            ...
            java.util.Map<java.lang.String, java.lang.Boolean> r1 = com.bytedance.pangle.servermanager.b.f8557d     // Catch: android.os.RemoteException -> L9a
