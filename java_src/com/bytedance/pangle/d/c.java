...
public final class c {
    ...
    private static File f8296a;

    /* renamed from: b  reason: collision with root package name */
    private static File f8297b;

    /* renamed from: c  reason: collision with root package name */
    private static File f8298c;
    ...
    public static String b() {
        ...
        if (f8298c == null) {
            ...
            f8298c = new File(filesDir, ".pangle" + h.f8431a);
        }
        return a(f8298c);
    }
    ...
    public static String c() {
        ...
        try {
            if ("mounted".equals(Environment.getExternalStorageState())) {
                File externalFilesDir = appApplication.getExternalFilesDir(".pangle" + h.f8432b);
    ...
    private static void d() {
        if (f8296a == null) {
            ...
            File file = new File(filesDir, MediationConstant.ADN_PANGLE + h.f8433c);
            f8296a = file;
            a(file);
        }
    }
    ...
    public static String a() {
        ...
        if (f8297b == null) {
            ...
            if (downloadDir == null) {
                File filesDir = appApplication.getFilesDir();
                downloadDir = new File(filesDir, ".pangle" + h.f8432b);
            }
            f8297b = downloadDir;
        }
        return a(f8297b);
