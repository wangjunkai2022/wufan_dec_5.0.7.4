    ...
    public static abstract class a extends Binder implements e {
        ...
        public boolean onTransact(int i4, Parcel parcel, Parcel parcel2, int i5) {
            if (i4 == 1) {
                ...
                ComponentName a5 = a(parcel.readInt() != 0 ? (Intent) Intent.CREATOR.createFromParcel(parcel) : null, parcel.readString());
                ...
                parcel.enforceInterface("com.bytedance.pangle.IServiceManager");
                boolean b5 = b(parcel.readInt() != 0 ? (Intent) Intent.CREATOR.createFromParcel(parcel) : null, parcel.readString());
                parcel2.writeNoException();
                parcel2.writeInt(b5 ? 1 : 0);
                return true;
            } else if (i4 == 3) {
                parcel.enforceInterface("com.bytedance.pangle.IServiceManager");
                boolean a6 = a(parcel.readInt() != 0 ? (Intent) Intent.CREATOR.createFromParcel(parcel) : null, g.a.a(parcel.readStrongBinder()), parcel.readInt(), parcel.readString());
                parcel2.writeNoException();
        ...
        public static class C0216a implements e {
            ...
            public final ComponentName a(Intent intent, String str) {
                ...
                try {
                    ...
                    if (!this.f8320b.transact(1, obtain, obtain2, 0) && a.a() != null) {
            ...
            public final boolean b(Intent intent, String str) {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    if (!this.f8320b.transact(2, obtain, obtain2, 0) && a.a() != null) {
            ...
            public final boolean a(Intent intent, g gVar, int i4, String str) {
                ...
                try {
                    ...
                    obtain.writeInt(i4);
                    obtain.writeString(str);
                    if (!this.f8320b.transact(3, obtain, obtain2, 0) && a.a() != null) {
            ...
            public final void a(g gVar) {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.pangle.IServiceManager");
                    obtain.writeStrongBinder(gVar != null ? gVar.asBinder() : null);
                    if (!this.f8320b.transact(4, obtain, obtain2, 0) && a.a() != null) {
                        a.a().a(gVar);
                    } else {
                        obtain2.readException();
                    }
