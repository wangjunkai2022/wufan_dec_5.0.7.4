...
public class IntentUtils {
    ...
    static HashMap<Long, WeakReference<Bundle>> f8236a = new HashMap<>();
    ...
    public static void a(Intent intent, String str) {
        ...
        if (longExtra != 0) {
            ...
            f8236a.put(Long.valueOf(longExtra), new WeakReference<>(extras));
    ...
    public static void a(Intent intent) {
        long longExtra = intent.getLongExtra("pangle_use_memory", 0L);
        if (longExtra != 0) {
            WeakReference<Bundle> remove = f8236a.remove(Long.valueOf(longExtra));
