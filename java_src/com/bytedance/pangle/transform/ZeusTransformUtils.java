...
public class ZeusTransformUtils {
        ...
        if (Build.VERSION.SDK_INT <= 23) {
            try {
                ...
                for (String str : new HashSet(sConstructorMap.keySet())) {
                    if (!str.startsWith("android.view.") && !str.startsWith("android.widget.") && !str.startsWith("android.webkit.") && str.contains(h0.f27805a)) {
            ...
            if (context2 instanceof IPluginActivity) {
                ...
                try {
                    ...
                    if (TextUtils.isEmpty(str2)) {
                        ...
                        if (!assetPaths.contains(e.F0 + str + "/version")) {
                            return context;
                        }
    ...
    public static int getIdentifier(Object obj, String str, String str2, String str3, String str4) {
        if (obj instanceof Resources) {
            ...
            if (!TextUtils.equals(a.f73126a, str3)) {
                str3 = str4;
            }
    ...
    public static View inflate(LayoutInflater layoutInflater, int i4, ViewGroup viewGroup, boolean z4, String str) {
        ...
        View inflate = layoutInflater.inflate(i4, viewGroup, z4);
        clearConstructorCache();
        return inflate;
    }
    ...
    public static int mapRes(int i4, String str, String str2) {
        ...
        if (identifier == 0) {
            identifier = Zeus.getAppApplication().getResources().getIdentifier(str2.replace("_", h0.f27805a), str, Zeus.getAppApplication().getPackageName());
        }
        if (identifier == 0) {
            ZeusLogger.d(ZeusLogger.TAG_RESOURCES, "Cant find res, resName = " + str2 + ", pluginResId = " + i4);
        }
        return identifier;
    }
    ...
    public static Object preCheckCast(Object obj, Class cls, String str) {
        ...
        if (obj instanceof Context) {
            ...
            if ((obj instanceof PluginFragmentActivityWrapper) && z4) {
            ...
            } else if ((obj instanceof PluginActivityWrapper) && z4) {
                ...
                return ((obj instanceof GenerateProxyActivity) && z4) ? ((GenerateProxyActivity) obj).mTargetActivity : obj;
            }
        }
        return obj;
    }
    ...
    public static View inflate(LayoutInflater layoutInflater, XmlPullParser xmlPullParser, ViewGroup viewGroup, boolean z4, String str) {
        ...
        clearConstructorCache();
        View inflate = ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(xmlPullParser, viewGroup, z4);
        clearConstructorCache();
        return inflate;
    }
