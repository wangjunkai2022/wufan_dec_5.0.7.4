...
public class DatabaseTableConfigUtil {
    ...
    private static void assignConfigField(int i4, DatabaseFieldConfig databaseFieldConfig, Field field, Object obj) {
        switch (i4) {
            case 1:
            ...
            case 29:
                ...
                return;
            default:
                throw new IllegalStateException("Could not find support for DatabaseField number " + i4);
        }
    }
    ...
    private static DatabaseFieldConfig buildConfig(DatabaseField databaseField, String str, Field field) throws Exception {
        ...
        while (true) {
            ...
            Object obj2 = valueField.get(objArr[i4]);
            if (obj2 != null) {
                assignConfigField(iArr[i4], databaseFieldConfig, field, obj2);
            }
            i4++;
        }
    }
        ...
        try {
            ...
            if (invocationHandler.getClass() == annotationFactoryClazz && (obj = elementsField.get(invocationHandler)) != null && obj.getClass() == cls) {
                ...
                for (int i4 = 0; i4 < objArr.length; i4++) {
                    iArr[i4] = configFieldNameToNum((String) nameField.get(objArr[i4]));
                }
                return iArr;
            }
