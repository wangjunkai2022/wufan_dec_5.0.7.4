...
public class DateTimeType extends BaseDataType {
    ...
    public Object javaToSqlArg(FieldType fieldType, Object obj) throws SQLException {
        try {
            ...
            throw SqlExceptionUtil.create("Could not use reflection to get millis from Joda DateTime: " + obj, e5);
        }
    }
    ...
    public Object sqlArgToJava(FieldType fieldType, Object obj, int i4) throws SQLException {
        try {
            ...
            throw SqlExceptionUtil.create("Could not use reflection to construct a Joda DateTime", e5);
        }
    }
