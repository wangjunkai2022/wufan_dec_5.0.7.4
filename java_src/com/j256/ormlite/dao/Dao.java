...
public interface Dao<T, ID> extends CloseableIterable<T> {
    ...
    public static class CreateOrUpdateStatus {
        ...
        public CreateOrUpdateStatus(boolean z4, boolean z5, int i4) {
            this.created = z4;
            this.updated = z5;
            this.numLinesChanged = i4;
        }
    ...
    void assignEmptyForeignCollection(T t4, String str) throws SQLException;
    ...
    int create(T t4) throws SQLException;

    T createIfNotExists(T t4) throws SQLException;

    CreateOrUpdateStatus createOrUpdate(T t4) throws SQLException;

    int delete(PreparedDelete<T> preparedDelete) throws SQLException;

    int delete(T t4) throws SQLException;
    ...
    ID extractId(T t4) throws SQLException;
    ...
    CloseableIterator<T> iterator(PreparedQuery<T> preparedQuery, int i4) throws SQLException;

    T mapSelectStarRow(DatabaseResults databaseResults) throws SQLException;

    String objectToString(T t4);

    boolean objectsEqual(T t4, T t5) throws SQLException;
    ...
    List<T> queryForMatching(T t4) throws SQLException;

    List<T> queryForMatchingArgs(T t4) throws SQLException;

    T queryForSameId(T t4) throws SQLException;
    ...
    void setAutoCommit(DatabaseConnection databaseConnection, boolean z4) throws SQLException;
    ...
    void setObjectCache(boolean z4) throws SQLException;
    ...
    int updateId(T t4, ID id) throws SQLException;
