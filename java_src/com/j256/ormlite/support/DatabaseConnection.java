...
public interface DatabaseConnection {
    ...
    CompiledStatement compileStatement(String str, StatementBuilder.StatementType statementType, FieldType[] fieldTypeArr, int i4) throws SQLException;

    int delete(String str, Object[] objArr, FieldType[] fieldTypeArr) throws SQLException;

    int executeStatement(String str, int i4) throws SQLException;
