...
public class DatabaseConnectionProxy implements DatabaseConnection {
    ...
    @Override // com.j256.ormlite.support.DatabaseConnection
    public CompiledStatement compileStatement(String str, StatementBuilder.StatementType statementType, FieldType[] fieldTypeArr, int i4) throws SQLException {
        DatabaseConnection databaseConnection = this.proxy;
        if (databaseConnection == null) {
            return null;
        }
        return databaseConnection.compileStatement(str, statementType, fieldTypeArr, i4);
    }
    ...
    public int executeStatement(String str, int i4) throws SQLException {
        ...
        return databaseConnection.executeStatement(str, i4);
    }
