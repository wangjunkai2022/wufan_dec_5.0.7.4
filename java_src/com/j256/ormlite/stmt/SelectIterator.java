...
public class SelectIterator<T, ID> implements CloseableIterator<T> {
    ...
    public boolean hasNext() {
        try {
            ...
            this.last = null;
            closeQuietly();
            throw new IllegalStateException("Errors getting more results of " + this.dataClass, e5);
        }
    }
    ...
    public T moveRelative(int i4) throws SQLException {
        ...
        this.first = false;
        if (this.results.moveRelative(i4)) {
            return getCurrent();
        }
        return null;
    }
    ...
    public void remove() {
        try {
            ...
            closeQuietly();
            throw new IllegalStateException("Could not delete " + this.dataClass + " object " + this.last, e5);
        }
    }
