...
public class InSubQuery extends BaseComparison {
    ...
    private final boolean f14497in;
    private final QueryBuilder.InternalQueryBuilderWrapper subQueryBuilder;

    public InSubQuery(String str, FieldType fieldType, QueryBuilder.InternalQueryBuilderWrapper internalQueryBuilderWrapper, boolean z4) throws SQLException {
