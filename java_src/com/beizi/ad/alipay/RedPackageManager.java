...
public class RedPackageManager {
                    ...
                    new OpenAuthTask(this.val$context).execute("", OpenAuthTask.BizType.AccountAuth, hashMap, new OpenAuthTask.Callback() { // from class: com.beizi.ad.alipay.RedPackageManager.3.1
                        public void onResult(int i4, String str2, Bundle bundle) {
                            ...
                            if (bundle != null && bundle.containsKey(RedPackageManager.AUTH_CODE_KEY)) {
                                ...
                                IncentiveConfig n4 = g.a().n();
                                String a5 = b.a("aHR0cDovL3Nkay1hcGkuYWRuLXBsdXMuY29tLmNuL2FsaXBheS9hdXRoY29kZQ==");
                                ...
                                c.b().d().execute(new RedPackageRequest(a5, str3, aliPayEventBean, new Callback() { // from class: com.beizi.ad.alipay.RedPackageManager.3.1.1
                                    @Override // com.beizi.ad.alipay.inter.Callback
    ...
    public void authAliPayWithParams(Activity activity, Map<String, String> map, UserInfoListener userInfoListener) {
        ...
        try {
            IncentiveConfig n4 = g.a().n();
            String a5 = b.a("aHR0cDovL3Nkay1hcGkuYWRuLXBsdXMuY29tLmNuL2FsaXBheS91c2VyaW5mbw==");
            String str4 = "";
    ...
    public void authInfo(Map<String, String> map, final UserInfoListener userInfoListener) {
        ...
        try {
            ...
            if (n4 == null || TextUtils.isEmpty(n4.getUserInfoUrl())) {
                ...
                a5 = n4.getUserInfoUrl();
                str2 = n4.getMacro();
                str = n4.getAppId();
            }
            String str4 = TAG;
            l.b(str4, "userInfoUrl : " + a5 + " , appId : " + str);
            String str5 = TAG;
            StringBuilder sb = new StringBuilder();
            sb.append("macroStr : ");
            sb.append(str2);
            ...
            c.b().d().execute(new RedPackageRequest(a5, str2, aliPayEventBean, new Callback() { // from class: com.beizi.ad.alipay.RedPackageManager.2
                @Override // com.beizi.ad.alipay.inter.Callback
    ...
    public void rtaUser(final ResultListener resultListener) {
        try {
            IncentiveConfig n4 = g.a().n();
            String a5 = b.a("aHR0cDovL3Nkay1hcGkuYWRuLXBsdXMuY29tLmNuL2FsaXBheS9ydGE=");
            ...
            c.b().d().execute(new RedPackageRequest(a5, str, null, new Callback() { // from class: com.beizi.ad.alipay.RedPackageManager.1
                @Override // com.beizi.ad.alipay.inter.Callback
    ...
    public void welfareAliPayWithParams(Map<String, String> map, final WelfareListener welfareListener) {
        ...
        if (map != null) {
            try {
                if (map.containsKey("app_user_id_key")) {
                    ...
                    n4 = g.a().n();
                    a5 = b.a("aHR0cDovL3Nkay1hcGkuYWRuLXBsdXMuY29tLmNuL2FsaXBheS90cmFuc2Zlci9tb25leQ==");
                    str2 = MACRO_DEFAULT;
                    if (n4 != null && !TextUtils.isEmpty(n4.getTransferUrl())) {
                        a5 = n4.getTransferUrl();
                        str2 = n4.getMacro();
                    }
                    String str5 = TAG;
                    l.b(str5, "transferUrl : " + a5);
                    AliPayEventBean aliPayEventBean = new AliPayEventBean();
                    aliPayEventBean.setAppUserId(str);
                    aliPayEventBean.setAppOrderId(str4);
                    aliPayEventBean.setTransAmount(str3);
                    c.b().d().execute(new RedPackageRequest(a5, str2, aliPayEventBean, new Callback() { // from class: com.beizi.ad.alipay.RedPackageManager.4
                        @Override // com.beizi.ad.alipay.inter.Callback
                        public void failCallback(int i4, String str6) {
        ...
        c.b().d().execute(new RedPackageRequest(a5, str2, aliPayEventBean2, new Callback() { // from class: com.beizi.ad.alipay.RedPackageManager.4
            @Override // com.beizi.ad.alipay.inter.Callback
            public void failCallback(int i4, String str6) {
                WelfareListener welfareListener2 = welfareListener;
                if (welfareListener2 != null) {
