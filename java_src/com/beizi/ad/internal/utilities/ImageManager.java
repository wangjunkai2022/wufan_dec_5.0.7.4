...
public class ImageManager {
    ...
    public class RequestCreatorRunnble implements Runnable {
        ...
        private Bitmap getBitmapFile() {
            String str = this.url;
            File file = new File(h.c(ImageManager.mContext), HashingFunctions.md5(str.substring(str.lastIndexOf(e.F0) + 1)));
        ...
        public void run() {
            try {
                ...
                if (httpURLConnection.getResponseCode() == 200) {
                    ...
                    String str = this.url;
                    decodeStream.compress(Bitmap.CompressFormat.PNG, 100, new FileOutputStream(new File(h.c(ImageManager.mContext), HashingFunctions.md5(str.substring(str.lastIndexOf(e.F0) + 1)))));
                } else {
                    showError();
                }
    ...
    public void getBitmap(final String str, final BitmapLoadedListener bitmapLoadedListener) {
        ...
        File file = new File(h.d(mContext), HashingFunctions.md5(str.substring(str.lastIndexOf(e.F0) + 1)));
        if (file.exists() && file.length() > 0) {
            ...
            public void run() {
                try {
                    ...
                    if (httpURLConnection.getResponseCode() == 200) {
                        ...
                        String str2 = str;
                        decodeStream.compress(Bitmap.CompressFormat.PNG, 100, new FileOutputStream(new File(h.d(ImageManager.mContext), HashingFunctions.md5(str2.substring(str2.lastIndexOf(e.F0) + 1)))));
                    }
    ...
    public void getCacheBitmap(final String str, final BitmapLoadedListener bitmapLoadedListener) {
        ...
        File file = new File(h.c(mContext), HashingFunctions.md5(str.substring(str.lastIndexOf(e.F0) + 1)));
        if (file.exists() && file.length() > 0) {
            bitmap2 = BitmapFactory.decodeFile(file.getAbsolutePath());
        }
        if (bitmap2 != null) {
            ...
            public void run() {
                try {
                    ...
                    if (httpURLConnection.getResponseCode() == 200) {
                        ...
                        ImageManager.this.imageCache.put(str, decodeStream);
                        String str2 = str;
                        decodeStream.compress(Bitmap.CompressFormat.PNG, 100, new FileOutputStream(new File(h.c(ImageManager.mContext), HashingFunctions.md5(str2.substring(str2.lastIndexOf(e.F0) + 1)))));
                    }
                } catch (Exception unused) {
