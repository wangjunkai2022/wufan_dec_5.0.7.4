...
public class W3CEvent {
    ...
    public static W3CEvent createFromJSON(String str) {
        ...
        try {
            ...
            if (!jSONObject.isNull(b.f67677k)) {
                w3CEvent.setDescription(jSONObject.getString(b.f67677k));
            }
            ...
            if (!jSONObject.isNull("start")) {
                w3CEvent.setStart(jSONObject.getString("start"));
            }
    ...
    public Intent getInsertIntent() {
        Intent type;
        boolean z4 = !useMIME && Build.VERSION.SDK_INT >= 14;
        if (z4) {
            type = new Intent("android.intent.action.EDIT").setData(Uri.parse(com.beizi.ad.lance.a.b.a("Y29udGVudDovL2NvbS5hbmRyb2lkLmNhbGVuZGFyL2V2ZW50cw==")));
        } else {
        ...
        if (!StringUtil.isEmpty(getSummary())) {
            type.putExtra(b.f67677k, getSummary());
        }
        ...
        if (!StringUtil.isEmpty(getStatus()) && z4) {
            type.putExtra("eventStatus", getStatus());
        }
        if (!StringUtil.isEmpty(getTransparency()) && z4) {
        ...
        if (!StringUtil.isEmpty(getReminder())) {
            ...
            } else if (!StringUtil.isEmpty(getStart()) && z4) {
