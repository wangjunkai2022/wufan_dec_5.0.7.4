...
public class HaoboLog {
    ...
    public static synchronized boolean registerListener(HaoboLogListener haoboLogListener) {
        ...
        synchronized (HaoboLog.class) {
            if (haoboLogListener != null) {
                z4 = listeners.add(haoboLogListener) ? true : true;
            }
            z4 = false;
        }
        return z4;
    ...
    public static synchronized boolean unregisterListener(HaoboLogListener haoboLogListener) {
        ...
        synchronized (HaoboLog.class) {
            if (haoboLogListener != null) {
                z4 = listeners.remove(haoboLogListener) ? true : true;
            }
            z4 = false;
        }
        return z4;
    ...
    public static String getString(int i4, boolean z4) {
        try {
            Context context = sLogContext.get();
            if (context == null) {
                return null;
            }
            return context.getString(i4, Boolean.valueOf(z4));
        } catch (Exception e5) {
            e5.printStackTrace();
            return null;
        }
    ...
    public static String getString(int i4, int i5, int i6, int i7, int i8, String str, boolean z4) {
        try {
            Context context = sLogContext.get();
            if (context == null) {
                return null;
            }
            return context.getString(i4, Integer.valueOf(i5), Integer.valueOf(i6), Integer.valueOf(i7), Integer.valueOf(i8), str, Boolean.valueOf(z4));
        } catch (Exception e5) {
            e5.printStackTrace();
            return null;
        }
    ...
    public static String getString(int i4, boolean z4, int i5) {
        try {
            Context context = sLogContext.get();
            if (context == null) {
                return null;
            }
            return context.getString(i4, Boolean.valueOf(z4), Integer.valueOf(i5));
        } catch (Exception e5) {
            e5.printStackTrace();
            return null;
        }
