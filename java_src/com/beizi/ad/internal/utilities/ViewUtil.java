...
public class ViewUtil {
    ...
    public static AppCompatTextView createCloseButton(Context context) {
        ...
        layoutParams.setMargins((int) TypedValue.applyDimension(1, 5.0f, a5.k()), (int) TypedValue.applyDimension(1, 10.0f, a5.k()), (int) TypedValue.applyDimension(1, 42.0f, a5.k()), (int) TypedValue.applyDimension(1, 10.0f, a5.k()));
    ...
    public static AppCompatTextView createCountDown(Context context, int i4) {
        ...
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams((int) TypedValue.applyDimension(1, 30.0f, a5.k()), -2, 53);
        layoutParams.setMargins((int) TypedValue.applyDimension(1, 5.0f, a5.k()), (int) TypedValue.applyDimension(1, 10.0f, a5.k()), (int) TypedValue.applyDimension(1, 5.0f, a5.k()), (int) TypedValue.applyDimension(1, 10.0f, a5.k()));
        appCompatTextView.setLayoutParams(layoutParams);
    ...
    public static ImageView createImageCloseButton(Context context) {
        ...
        layoutParams.setMargins((int) TypedValue.applyDimension(1, 5.0f, a5.k()), (int) TypedValue.applyDimension(1, 0.0f, a5.k()), (int) TypedValue.applyDimension(1, 0.0f, a5.k()), (int) TypedValue.applyDimension(1, 5.0f, a5.k()));
    ...
    public static AppCompatTextView createInterstitialCountDown(Context context, int i4) {
        ...
        appCompatTextView.setText(Integer.toString(i4));
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams((int) TypedValue.applyDimension(1, 30.0f, a5.k()), -2, 53);
        layoutParams.setMargins((int) TypedValue.applyDimension(1, 0.0f, a5.k()), (int) TypedValue.applyDimension(1, 0.0f, a5.k()), (int) TypedValue.applyDimension(1, 0.0f, a5.k()), (int) TypedValue.applyDimension(1, 0.0f, a5.k()));
        appCompatTextView.setLayoutParams(layoutParams);
    ...
    public static AppCompatImageView createMuteButton(Context context, boolean z4) {
        AppCompatImageView appCompatImageView = new AppCompatImageView(context);
        appCompatImageView.setImageResource(z4 ? R.drawable.voice_off : R.drawable.voice_on);
        g a5 = g.a();
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-2, -2, 8388659);
        layoutParams.setMargins((int) TypedValue.applyDimension(1, 5.0f, a5.k()), (int) TypedValue.applyDimension(1, 15.0f, a5.k()), (int) TypedValue.applyDimension(1, 15.0f, a5.k()), (int) TypedValue.applyDimension(1, 15.0f, a5.k()));
    ...
    public static AppCompatTextView createCloseButton(Context context, int i4, int i5, int i6, int i7) {
        ...
        g a5 = g.a();
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-2, -2, 8388661);
        layoutParams.setMargins((int) TypedValue.applyDimension(1, i4 + 5, a5.k()), (int) TypedValue.applyDimension(1, i5 + 10, a5.k()), (int) TypedValue.applyDimension(1, i6 + 42, a5.k()), (int) TypedValue.applyDimension(1, i7 + 10, a5.k()));
        appCompatTextView.setLayoutParams(layoutParams);
        return appCompatTextView;
    }
    ...
    public static AppCompatTextView createCountDown(Context context, int i4, int i5, int i6, int i7, int i8) {
        ...
        appCompatTextView.setText(Integer.toString(i4));
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams((int) TypedValue.applyDimension(1, 30.0f, a5.k()), -2, 53);
        layoutParams.setMargins((int) TypedValue.applyDimension(1, i5 + 5, a5.k()), (int) TypedValue.applyDimension(1, i6 + 10, a5.k()), (int) TypedValue.applyDimension(1, i7 + 5, a5.k()), (int) TypedValue.applyDimension(1, i8 + 10, a5.k()));
        appCompatTextView.setLayoutParams(layoutParams);
