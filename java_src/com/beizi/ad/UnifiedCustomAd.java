...
public final class UnifiedCustomAd implements AdLifeControl {
    ...
    private final com.beizi.ad.internal.nativead.b f5204c;

    /* renamed from: d  reason: collision with root package name */
    private List<Pair<String, Integer>> f5205d;
    ...
    public void cancel() {
        com.beizi.ad.internal.nativead.b bVar = this.f5204c;
        if (bVar != null) {
            bVar.f6021a.a();
            this.f5204c.cancel(true);
        }
    }
    ...
    */
    public int getValidOptimizePercent() {
        /*
            r6 = this;
            com.beizi.ad.internal.nativead.b r0 = r6.f5204c
            r1 = -1
            if (r0 == 0) goto L39
            ...
            com.beizi.ad.internal.nativead.b r0 = r6.f5204c
            java.lang.String r0 = r0.i()
            java.util.List<android.util.Pair<java.lang.String, java.lang.Integer>> r2 = r6.f5205d
            if (r2 == 0) goto L39
    ...
    public void optimizeClickArea(int i4, View view, View view2, String str) {
        ...
        if (a5) {
            this.f5206e = com.beizi.ad.lance.a.g.a(i4, view, view2, str);
        }
    }
