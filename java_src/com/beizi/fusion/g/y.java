...
public class y {
    ...
    private static HashMap<String, Object> f7069a = new HashMap<>();

    /* renamed from: b  reason: collision with root package name */
    private static HashMap<String, Object> f7070b = new HashMap<>();

    /* renamed from: c  reason: collision with root package name */
    private static Comparator<EventItem> f7071c = new Comparator<EventItem>() { // from class: com.beizi.fusion.g.y.1
    ...
    private static HashMap<String, Long> f7072d = new HashMap<>();

    /* renamed from: e  reason: collision with root package name */
    private static HashMap<String, FreqItem> f7073e = new HashMap<>();

    /* renamed from: f  reason: collision with root package name */
    private static HashSet<String> f7074f = new HashSet<>();

    public static void a(Context context, String str) {
        try {
            ArrayList arrayList = (ArrayList) com.beizi.fusion.a.b.a(context).a(str);
            f7069a.put(str, a(arrayList));
            f7070b.put(str, b(arrayList));
            d("adUnitId = " + str + ",platFormMap get = " + f7069a.get(str) + ",channelMap get = " + f7070b.get(str));
        } catch (Exception e5) {
            e5.printStackTrace();
        }
    }
    ...
    public static int a(String str, String str2) {
        ...
        if ("200.000".equalsIgnoreCase(str2)) {
            HashMap<String, Object> hashMap = f7069a;
            if (hashMap != null && hashMap.get(str) != null) {
                d("getSpaceTodayEventTimes platFormMap.containsKey(adUnitId) = " + f7069a.containsKey(str));
                HashMap hashMap2 = (HashMap) f7069a.get(str);
                if (hashMap2 != null && (arrayList = (ArrayList) hashMap2.get(str2)) != null) {
                    Iterator it2 = arrayList.iterator();
                    while (it2.hasNext()) {
                        if (((EventItem) it2.next()).getTimeStamp().compareTo(valueOf) > 0) {
                            i4++;
                        }
                    }
                }
            ...
            HashMap<String, Object> hashMap3 = f7070b;
            if (hashMap3 != null && hashMap3.get(str) != null) {
                d("getSpaceTodayEventTimes channelMap.containsKey(adUnitId) = " + f7070b.containsKey(str));
                HashMap hashMap4 = (HashMap) f7070b.get(str);
                Iterator<String> it3 = f7074f.iterator();
                while (it3.hasNext()) {
                    ...
                    if (hashMap4 != null && hashMap4.get(next) != null) {
                        ...
                        if (hashMap5 != null && hashMap5.get(str2) != null) {
                            ...
                            if (arrayList2 != null && arrayList2.size() > 0) {
                                ...
                                while (it4.hasNext()) {
                                    if (((EventItem) it4.next()).getTimeStamp().compareTo(valueOf) > 0) {
                                        i4++;
                                    }
                                }
                            }
    ...
    public static boolean a(String str) {
        return f7069a.containsKey(str) && f7070b.containsKey(str);
    }
    ...
    */
    ...
    private static void a(String str, List<FreqItem> list) {
        ...
        for (FreqItem freqItem : list) {
            b5 = Math.max(freqItem.getInterval(), b5);
        }
        d("maxInterval = " + b5);
        f7072d.put(str, Long.valueOf(b5));
    }
    ...
    private static Map<String, List<EventItem>> a(List<EventItem> list) {
        ...
        if (list != null && list.size() != 0) {
            ...
            for (String str2 : hashMap.keySet()) {
                ...
                Collections.sort(arrayList3, f7071c);
    ...
    public static void a(String str, EventItem eventItem) {
        try {
            HashMap hashMap = (HashMap) f7069a.get(str);
            if (hashMap == null) {
                hashMap = new HashMap();
            }
            String code = eventItem.getCode();
            ...
            String spaceId = eventItem.getSpaceId();
            if (spaceId != null) {
                HashMap hashMap2 = (HashMap) f7070b.get(str);
                if (hashMap2 == null) {
    ...
    private static void a(EventItem eventItem, HashMap<String, List<EventItem>> hashMap, String str) {
        if (hashMap != null) {
            ...
            if (arrayList2 != null) {
                arrayList2.add(eventItem);
                Collections.sort(arrayList2, f7071c);
                hashMap.put(str, arrayList2);
            }
        }
    }
