...
public class v {
    ...
    public static final DownloadConfirmListener f7026b = new DownloadConfirmListener() { // from class: com.beizi.fusion.g.v.1
        ...
        public void onDownloadConfirm(Activity activity, int i4, String str, DownloadConfirmCallBack downloadConfirmCallBack) {
            if (activity != null) {
                try {
                    ...
                    af.a("DownloadConfirmHelper", "scenes:" + i4 + " info url:" + str);
                    u uVar = new u(activity, v.a(str), downloadConfirmCallBack);
                    if ((i4 & 256) != 0) {
                        uVar.a();
                        int i5 = i4 & (-257);
                        af.a("DownloadConfirmHelper", "real scenes:" + i5);
                    }
                    uVar.show();
                } catch (Exception e5) {
                    e5.printStackTrace();
    ...
    private static JSONObject f7028d;
    ...
    public static a b(String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            af.a("DownloadConfirmHelper", "请求应用信息返回值为空");
            return null;
        }
        try {
            JSONObject jSONObject = new JSONObject(str);
            if (jSONObject.optInt("ret", -1) != 0) {
                af.a("DownloadConfirmHelper", "请求应用信息返回值错误");
                return null;
            }
            JSONObject optJSONObject = jSONObject.optJSONObject("data");
            if (optJSONObject == null) {
                af.a("DownloadConfirmHelper", "请求应用信息返回值错误data");
                return null;
            }
            a aVar2 = new a();
            try {
                aVar2.f7029a = optJSONObject.optString("iconUrl");
                aVar2.f7030b = optJSONObject.optString(TTDownloadField.TT_APP_NAME);
                aVar2.f7031c = optJSONObject.optString(TTDownloadField.TT_VERSION_NAME);
                aVar2.f7032d = optJSONObject.optString("authorName");
                JSONArray optJSONArray = optJSONObject.optJSONArray("permissions");
                if (optJSONArray != null) {
                    aVar2.f7033e = new ArrayList();
                    for (int i4 = 0; i4 < optJSONArray.length(); i4++) {
                        String string = optJSONArray.getString(i4);
                        if (f7027c) {
                            aVar2.f7033e.add(optJSONArray.getString(i4));
                        } else {
                            JSONObject optJSONObject2 = f7028d.optJSONObject(string);
                            if (optJSONObject2 != null) {
                                String optString = optJSONObject2.optString("title");
                                if (!TextUtils.isEmpty(optString)) {
                                    aVar2.f7033e.add(optString);
                                }
                            }
                        }
                    }
                }
                aVar2.f7034f = optJSONObject.optString("privacyAgreement");
                long optLong = optJSONObject.optLong("apkPublishTime");
                if (optLong <= 946688401000L) {
                    optLong *= 1000;
                }
                aVar2.f7035g = optLong;
                aVar2.f7036h = optJSONObject.optLong("fileSize");
                return aVar2;
            } catch (JSONException e5) {
                e = e5;
                aVar = aVar2;
