...
public class a extends com.beizi.fusion.work.a {
    ...
    public void d() {
        ...
        String str = (String) at.b(this.f7520n, "__OAID__", "");
        ...
        if (dVar != null) {
            ...
            if (a5 != null) {
                ...
                if (!av.a("com.xyz.newad.hudong.ADInit")) {
                    t();
                    this.f7381m.postDelayed(new Runnable() { // from class: com.beizi.fusion.work.d.a.1
                ...
                u();
                ADInit.getInstance().init(this.f7520n, this.f7376h);
    ...
    protected void l() {
        w();
        ag();
        if (this.f7520n instanceof Activity) {
            FloatAD.get().finish((Activity) this.f7520n);
            Z();
            FloatAD.get().show((Activity) this.f7520n, this.f7377i, new FloatListener() { // from class: com.beizi.fusion.work.d.a.2
                public void onClick() {
                    a.this.E();
