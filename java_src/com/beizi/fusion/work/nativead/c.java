...
public class c extends b {
    ...
    public c(Context context, String str, long j4, long j5, AdSpacesBean.BuyerBean buyerBean, AdSpacesBean.ForwardBean forwardBean, com.beizi.fusion.d.e eVar, float f5, float f6) {
    ...
    public void aN() {
        try {
            ...
            if (complainBean != null && complainBean.getOpen() == 1) {
                p pVar = new p();
                pVar.a(((b) this).f7796n, ((b) this).f7802t, "3");
                pVar.a(new p.a() { // from class: com.beizi.fusion.work.nativead.c.1
                    @Override // com.beizi.fusion.g.p.a
                    public void a(String str) {
                        try {
                            c cVar = c.this;
                            at.a(((b) cVar).f7796n, cVar.O, Long.valueOf(System.currentTimeMillis()));
                            ((com.beizi.fusion.work.a) c.this).f7370b.S(str);
                            c.this.au();
                            c.this.I();
                            c.this.aO();
                            if (((com.beizi.fusion.work.a) c.this).f7372d != null && ((com.beizi.fusion.work.a) c.this).f7372d.r() != 2) {
                                ((com.beizi.fusion.work.a) c.this).f7372d.b(c.this.g(), ((b) c.this).f7803u);
                            }
                            c.this.G();
                        } catch (Exception e5) {
                            e5.printStackTrace();
    ...
    public void aP() {
        ...
        try {
            ...
            ((b) this).f7802t.measure(0, 0);
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams((((b) this).f7802t.getMeasuredWidth() * 2) / 3, -2);
            layoutParams.gravity = 83;
            ((b) this).f7802t.addView(downloadTextView, layoutParams);
        } catch (Exception e5) {
            e5.printStackTrace();
        }
    }
                ...
                public void onBitmapLoaded(Bitmap bitmap) {
                    ...
                    if (bitmap != null) {
                        try {
                            ...
                            c cVar = c.this;
                            double a5 = av.a(((b) cVar).f7796n, ((b) cVar).f7800r);
                            Double.isNaN(a5);
                            int i4 = (int) (a5 * 0.285d);
                            c cVar2 = c.this;
                            float f6 = ((b) cVar2).f7801s;
                            int a6 = f6 > 0.0f ? av.a(((b) cVar2).f7796n, f6) - av.a(((b) c.this).f7796n, 20.0f) : (int) (i4 / f5);
                            ...
                            if (c.this.X != null) {
                                c.this.X.setRectRadius(av.a(((b) c.this).f7796n, 8.0f));
                                if (Build.VERSION.SDK_INT >= 16) {
                                    c.this.X.setBackground(new BitmapDrawable(ac.a(((b) c.this).f7796n, bitmap, 20.0f)));
                                }
    ...
    public void aR() {
        try {
            ...
            ((b) this).f7802t.addView(linearLayout, new FrameLayout.LayoutParams(-2, -2, 85));
    ...
    public void b() {
        try {
            ...
            View inflate = LayoutInflater.from(((b) this).f7796n).inflate(R.layout.beizi_layout_native_left_text_right_picture_view, (ViewGroup) null);
            this.M = inflate;
            ...
            if (relativeLayout2 != null) {
                relativeLayout2.setPadding(0, av.a(((b) this).f7796n, 10.0f), av.a(((b) this).f7796n, 10.0f), 0);
            }
            if (linearLayout != null) {
                linearLayout.setPadding(av.a(((b) this).f7796n, 20.0f), av.a(((b) this).f7796n, 8.0f), av.a(((b) this).f7796n, 11.0f), 0);
            }
            ...
            if (relativeLayout != null) {
                relativeLayout.setPadding(0, av.a(((b) this).f7796n, 5.0f), 0, 0);
            }
            ...
            if (imageView != null) {
                imageView.setPadding(0, av.a(((b) this).f7796n, 10.0f), 0, 0);
            }
            TextView textView = this.U;
            if (textView != null) {
                as.a(textView, "#71A0FF", 0, null, av.a(((b) this).f7796n, 10.0f));
            }
            a(this.U, this.V);
            aQ();
            aH();
                ...
                public void onClick(View view) {
                    try {
                        if (c.this.aK()) {
                            if (c.this.aL()) {
                                c cVar = c.this;
                                at.a(((b) cVar).f7796n, cVar.J, Long.valueOf(System.currentTimeMillis()));
                                NativeAdResponse nativeAdResponse2 = nativeAdResponse;
                                c cVar2 = c.this;
                                NativeAdUtil.handleClick(nativeAdResponse2, ((b) cVar2).f7803u, String.valueOf(((b) cVar2).F), String.valueOf(((b) c.this).G), String.valueOf(((b) c.this).H), String.valueOf(c.this.I), 0);
                            } else {
                                c.this.aM();
                            }
                        } else {
