...
public class b extends com.beizi.fusion.work.a implements com.beizi.fusion.d.c {
    ...
    private TTFullScreenVideoAd f7716r;

    /* renamed from: s  reason: collision with root package name */
    private TTAdNative f7717s;
        ...
        if (dVar != null) {
            ...
            if (a5 != null) {
                ...
                if (!av.a("com.bytedance.sdk.openadsdk.TTAdNative")) {
                    t();
                    this.f7381m.postDelayed(new Runnable() { // from class: com.beizi.fusion.work.interstitial.b.1
                ...
                u();
                u.a(this, this.f7712n, this.f7376h, this.f7373e.getDirectDownload());
    ...
    protected void l() {
        ...
        this.f7717s = u.a().createAdNative(this.f7712n);
        this.f7717s.loadFullScreenVideoAd(new AdSlot.Builder().setCodeId(this.f7377i).setExpressViewAcceptedSize(500.0f, 500.0f).setSupportDeepLink(true).setAdLoadType(TTAdLoadType.PRELOAD).build(), new TTAdNative.FullScreenVideoAdListener() { // from class: com.beizi.fusion.work.interstitial.b.2
            private void a() {
                b.this.f7716r.setFullScreenVideoAdInteractionListener(new TTFullScreenVideoAd.FullScreenVideoAdInteractionListener() { // from class: com.beizi.fusion.work.interstitial.b.2.1

                    /* renamed from: a  reason: collision with root package name */
                    boolean f7720a = false;

                    /* renamed from: b  reason: collision with root package name */
                    boolean f7721b = false;
                ...
                b.this.f7716r.setDownloadListener(new TTAppDownloadListener() { // from class: com.beizi.fusion.work.interstitial.b.2.2
            ...
            public void onFullScreenVideoAdLoad(TTFullScreenVideoAd tTFullScreenVideoAd) {
                ...
                b.this.f7716r = tTFullScreenVideoAd;
                a();
                if (b.this.Y()) {
                    b.this.aG();
                } else {
    ...
    public void a(Activity activity) {
        TTFullScreenVideoAd tTFullScreenVideoAd = this.f7716r;
