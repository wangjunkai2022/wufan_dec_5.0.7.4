...
public class i extends e {
    ...
    public com.beizi.fusion.work.a a(AdSpacesBean.ForwardBean forwardBean, String str, AdSpacesBean.BuyerBean buyerBean, List<AdSpacesBean.RenderViewBean> list, com.beizi.fusion.work.a aVar) {
        ...
        str.hashCode();
        if (str.equals("CSJ")) {
            return new com.beizi.fusion.work.b.a(this.f6694b, this.f6697e, this.f6698f, sleepTime, buyerBean, forwardBean, this);
        }
        return !str.equals("KUAISHOU") ? aVar : new com.beizi.fusion.work.b.b(this.f6694b, this.f6697e, this.f6698f, sleepTime, buyerBean, forwardBean, this);
    }
}
