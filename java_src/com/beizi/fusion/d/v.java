...
public class v extends e {
    ...
    public com.beizi.fusion.work.a a(AdSpacesBean.ForwardBean forwardBean, String str, AdSpacesBean.BuyerBean buyerBean, List<AdSpacesBean.RenderViewBean> list, com.beizi.fusion.work.a aVar) {
        ...
        switch (c5) {
            case 0:
                aVar = new com.beizi.fusion.work.h.c(this.f6694b, sleepTime, buyerBean, forwardBean, this, this.f6763r);
                break;
            case 1:
                aVar = new com.beizi.fusion.work.h.d(this.f6694b, sleepTime, buyerBean, forwardBean, this, this.f6763r);
                break;
            case 2:
                aVar = new com.beizi.fusion.work.h.e(this.f6694b, sleepTime, buyerBean, forwardBean, this, this.f6763r);
                break;
        }
        return (au.b().equalsIgnoreCase(str) || "BEIZI".equalsIgnoreCase(str)) ? new com.beizi.fusion.work.h.b(this.f6694b, sleepTime, buyerBean, forwardBean, this, this.f6763r) : aVar;
    }
