...
public class RequestInfo {
    ...
    public RequestInfo init() {
        ...
        this.packageName = av.c(this.context);
        this.installTime = String.valueOf(av.a(this.context));
        this.updateTime = String.valueOf(av.b(this.context));
        this.appVersion = av.d(this.context);
        this.appVersionCode = String.valueOf(av.e(this.context));
        this.sdkVersion = "4.90.4.4";
