...
public class DevInfo {
    ...
    public DevInfo(Context context) {
        ...
        this.sdkUID = at.a(context, KEY_SDK_UID_NEW);
        this.sdkUIDOrig = at.a(context, KEY_SDK_UID_ORIG);
        this.devType = t.d(context);
        getScreenInformation(context);
        this.language = Locale.getDefault().getLanguage();
        this.root = av.a();
        if ((BeiZis.getCustomController() == null || BeiZis.getCustomController().isCanUseGaid()) && !((Boolean) at.b(context, "isLimitTrackGaid", Boolean.FALSE)).booleanValue()) {
            this.gaid = (String) at.b(context, "__GAID__", "");
        }
    ...
    private void generateSdkUID(Context context, String str, String str2) {
        ...
        String str3 = str + "_" + str2 + "_" + av.c(context) + "_1_" + generateFourDigitRandom + "_" + generateCurrentTimeMillis;
        String str4 = au.a(str3) + "_1_" + generateFourDigitRandom + "_" + generateCurrentTimeMillis;
        this.sdkUID = str4;
        at.a(context, KEY_SDK_UID_NEW, str4);
    }
    ...
    private void getScreenInformation(Context context) {
        try {
            ...
            float f5 = ((float) displayMetrics.heightPixels) / displayMetrics.ydpi;
            float f6 = ((float) displayMetrics.widthPixels) / displayMetrics.xdpi;
