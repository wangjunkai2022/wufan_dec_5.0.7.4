...
public class AdSpacesBean {
    ...
    public static class BuyerBean {
        ...
        public static class AliaseShakeViewBean {
            ...
            public void setRotatAmplitude(double d5) {
                this.rotatAmplitude = d5;
            }
            ...
            public void setShakeEndAmplitude(double d5) {
                this.shakeEndAmplitude = d5;
            }

            public void setShakeStartAmplitude(double d5) {
                this.shakeStartAmplitude = d5;
            }
        }
        ...
        public static class CoolRollViewBean {
            ...
            public void setRollMinusAmplitude(double d5) {
                this.rollMinusAmplitude = d5;
            }

            public void setRollPlusAmplitude(double d5) {
                this.rollPlusAmplitude = d5;
            }
        ...
        public static class EulerAngleRenderBean {
            ...
            @JsonNode(key = TypedValues.Custom.S_COLOR)
        ...
        public static class EulerAngleRuleBean {
            ...
            @JsonNode(key = MediationConstant.ADN_PANGLE)
        ...
        public static class EulerAngleStyleBean {
            ...
            @JsonNode(key = BaseAppConfig.KEY_END_GAME_SUBTITLE)
        ...
        public void setAvgPrice(double d5) {
            this.avgPrice = d5;
        }
    ...
    public static class CallBackStrategyBean {
        @JsonNode(key = QuarkInstallAppActivity_.f36990i)
    ...
    public static class ForwardBean implements Cloneable {
        ...
        @JsonNode(key = SimulatorExitPlayActivity_.O)
    ...
    public static class RandomStrategyBean {
        ...
        @JsonNode(key = SimulatorExitPlayActivity_.Q)
        private int max;
        @JsonNode(key = "min")
        private int min;
    ...
    public static class RenderViewBean {
        ...
        public void setPaddingHeight(double d5) {
            this.paddingHeight = d5;
        }
