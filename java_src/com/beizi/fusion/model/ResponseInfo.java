...
public class ResponseInfo {
    ...
    private void initFail() {
        this.isInit = false;
        c.a(this.context).a(new b(com.beizi.fusion.d.b.f6675b, "", "410.500", "", com.beizi.fusion.d.b.a().b(), "", "", String.valueOf(System.currentTimeMillis()), ""));
    }
    ...
    public synchronized ResponseInfo init() {
        c.a(this.context).a(new b(com.beizi.fusion.d.b.f6675b, "", "410.000", "", com.beizi.fusion.d.b.a().b(), "", "", String.valueOf(System.currentTimeMillis()), ""));
        String str = (String) at.b(this.context, "globalConfig", BeiZis.getTransferProtocol() ? DEFAULT_HTTPS_CONFIG_FILE : DEFAULT_CONFIG_FILE);
        if (!TextUtils.isEmpty(str)) {
            ...
            if (b5 != null) {
                ...
                if (objectFromData != null) {
                    ...
                    this.isInit = true;
                    w.a(this.context);
                    w.a(this.context, this.incentiveConfig);
                    c.a(this.context).a(new b(com.beizi.fusion.d.b.f6675b, "", "410.200", "", com.beizi.fusion.d.b.a().b(), "", "", String.valueOf(System.currentTimeMillis()), ""));
                } else {
                    initFail();
                }
            } else {
