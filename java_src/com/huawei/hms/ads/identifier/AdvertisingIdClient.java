...
public class AdvertisingIdClient {
    ...
    public static class XI implements Runnable {
        ...
        public final /* synthetic */ Context f14495XI;

        public XI(Context context) {
            this.f14495XI = context;
        }

        @Override // java.lang.Runnable
        public final void run() {
            try {
                AdvertisingIdClient.requestAdvertisingIdInfo(this.f14495XI);
                        ...
                        if (!bVar.f159b) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    obtain2.recycle();
                                    obtain.recycle();
                                    Info info = new Info(readString, z4);
                                    try {
    ...
    private static void updateAdvertisingIdInfo(Context context) {
        a.f157a.execute(new XI(context));
    }
    ...
    public static boolean verifyAdId(Context context, String str, boolean z4) {
        ...
        if (requestAdvertisingIdInfo != null && TextUtils.equals(str, requestAdvertisingIdInfo.getId())) {
            if (z4 == requestAdvertisingIdInfo.isLimitAdTrackingEnabled()) {
                return true;
            }
        }
        return false;
