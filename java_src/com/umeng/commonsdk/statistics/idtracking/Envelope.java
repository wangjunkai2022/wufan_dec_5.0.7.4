    ...
    public void export(Context context) {
        ...
        try {
            ...
            if (imprintProperty != null) {
                jSONObject.put(bm.f63446g, imprintProperty);
            }
            jSONObject.put("signature", hexString);
            jSONObject.put("checksum", hexString2);
            File file = new File(context.getFilesDir(), aw.b().b(aw.f63371b));
            if (!file.exists()) {
                file.mkdir();
            }
        ...
        try {
            ...
            if (imprintProperty != null) {
                jSONObject2.put(bm.f63446g, HelperUtils.getUmengMD5(imprintProperty));
            }
            HelperUtils.writeFile(new File(context.getFilesDir(), aw.b().b(aw.f63377h)), jSONObject2.toString());
        } catch (Throwable th2) {
            th2.printStackTrace();
        }
    }
