...
public class ImLatent implements d {
    ...
    private final long _ONE_HOURS_IN_MS = bi.f55326s;
    ...
    public void onImprintChanged(ImprintHandler.a aVar) {
        ...
        this.latentHour = (intValue > 36 ? intValue : 360) * bi.f55326s;
        int intValue2 = Integer.valueOf(aVar.a(bm.aW, "0")).intValue();
