...
public class k {
    ...
    public static final String f64315b = "_dsk_s";

    /* renamed from: c  reason: collision with root package name */
    public static final String f64316c = "_thm_z";

    /* renamed from: d  reason: collision with root package name */
    public static final String f64317d = "_gdf_r";

    /* renamed from: a  reason: collision with root package name */
    public static final String f64314a = aw.b().b(aw.f63388s);

    /* renamed from: e  reason: collision with root package name */
    private static Object f64318e = new Object();
    ...
    public static boolean c(Context context) {
        ...
        return (context == null || (sharedPreferences = context.getApplicationContext().getSharedPreferences(f64314a, 0)) == null || TextUtils.isEmpty(sharedPreferences.getString(f64315b, ""))) ? false : true;
    }

    public static String a(Context context) {
        try {
            SharedPreferences sharedPreferences = context.getApplicationContext().getSharedPreferences(f64314a, 0);
            if (sharedPreferences != null) {
                JSONObject jSONObject = new JSONObject();
                synchronized (f64318e) {
                    jSONObject.put(f64315b, sharedPreferences.getString(f64315b, ""));
                    jSONObject.put(f64316c, sharedPreferences.getString(f64316c, ""));
                    jSONObject.put(f64317d, sharedPreferences.getString(f64317d, ""));
                }
    ...
    public static void b(Context context, String[] strArr) {
        SharedPreferences sharedPreferences;
        if (context == null || (sharedPreferences = context.getApplicationContext().getSharedPreferences(f64314a, 0)) == null) {
            return;
        }
        synchronized (f64318e) {
            sharedPreferences.edit().putString(f64315b, strArr[0]).putString(f64316c, strArr[1]).putString(f64317d, strArr[2]).commit();
        }
    }
