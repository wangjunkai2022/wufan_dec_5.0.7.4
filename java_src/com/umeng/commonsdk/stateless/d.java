...
public class d {
    ...
    public static int f64351a;

    /* renamed from: b  reason: collision with root package name */
    private static Object f64352b = new Object();
    ...
    */
    ...
    public static File[] c(Context context) {
        ...
        try {
            synchronized (f64352b) {
                String str = context.getApplicationContext().getFilesDir() + File.separator + a.f64329f;
    ...
    public static String d(String str) {
        int lastIndexOf;
        int lastIndexOf2;
        return (!TextUtils.isEmpty(str) && str.indexOf("envelope") < 0 && (lastIndexOf = str.lastIndexOf("_")) >= 0 && (lastIndexOf2 = str.lastIndexOf(h0.f27805a)) >= 0) ? str.substring(lastIndexOf + 1, lastIndexOf2) : "";
    }
    ...
    */
    public static int a(android.content.Context r6, java.lang.String r7, java.lang.String r8, byte[] r9) {
        /*
            ...
            if (r6 == 0) goto L75
            r1 = 0
            java.lang.Object r2 = com.umeng.commonsdk.stateless.d.f64352b     // Catch: java.lang.Throwable -> L5d java.io.IOException -> L67
        ...
        try {
            synchronized (f64352b) {
                ...
                if (context != null && context.getApplicationContext() != null) {
                    String str = context.getApplicationContext().getFilesDir() + File.separator + a.f64328e;
                    if (!TextUtils.isEmpty(str)) {
    ...
    public static String a(Context context, boolean z4) {
        ...
        try {
            if (z4) {
                str = context.getApplicationContext().getFilesDir() + File.separator + a.f64328e;
            } else {
                str = context.getApplicationContext().getFilesDir() + File.separator + a.f64329f;
            }
            str2 = str;
            return str2;
        } catch (Throwable unused) {
