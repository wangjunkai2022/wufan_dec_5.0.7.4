...
public class UMEnvelopeBuild {
    ...
    private static JSONObject add2CacheTable(Context context, JSONObject jSONObject, JSONObject jSONObject2, String str, String str2, String str3) {
        if (jSONObject != null && jSONObject2 != null) {
            ...
            contentValues.put(bq.f63522e, str2);
            contentValues.put(bq.f63523f, a5.c(jSONObject.toString()));
            contentValues.put(bq.f63524g, a5.c(jSONObject2.toString()));
            contentValues.put(bq.f63525h, String.valueOf(currentTimeMillis));
            contentValues.put(bq.f63526i, randomUUID.toString());
            contentValues.put(bq.f63527j, str);
            contentValues.put(bq.f63528k, str3);
            bo.a(context).a(bq.f63520c, contentValues);
    ...
    public static JSONObject buildEnvelopeWithExtHeader(Context context, JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        if (jSONObject.has("st")) {
            ...
            str = jSONObject2.has(bm.ay) ? "i" : "a";
        }
        return buildEnvelopeWithExtHeader(context, jSONObject, jSONObject2, UMServerURL.PATH_ANALYTICS, str, "9.6.7");
    }
    ...
    */
    ...
    public static JSONObject buildEnvelopeWithExtHeader(Context context, JSONObject jSONObject, JSONObject jSONObject2, String str, String str2, String str3) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            if (!UMWorkDispatch.eventHasExist(com.umeng.commonsdk.internal.a.f64249t)) {
                UMWorkDispatch.sendEvent(context, com.umeng.commonsdk.internal.a.f64249t, com.umeng.commonsdk.internal.b.a(context).a(), null);
            }
