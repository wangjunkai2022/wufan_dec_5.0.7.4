...
public class UMProcessDBHelper {
    ...
    public class InsertEventCallback implements FileLockCallback {
        ...
        public boolean onFileLock(String str, Object obj) {
            ...
            String str2 = com.umeng.analytics.process.a.f63985c;
            if (str.startsWith(str2)) {
                str = str.replaceFirst(str2, "");
            }
            UMProcessDBHelper.this.insertEvents(str.replace(com.umeng.analytics.process.a.f63986d, ""), (JSONArray) obj);
            return true;
        }
    }
    ...
    private class ProcessToMainCallback implements FileLockCallback {
        ...
        public boolean onFileLock(String str) {
            ...
            UMProcessDBHelper.this.processToMain(str.replace(com.umeng.analytics.process.a.f63986d, ""));
            return true;
        }
    ...
    private List<a> datasAdapter(String str, JSONArray jSONArray) {
        ...
        for (int i4 = 0; i4 < jSONArray.length(); i4++) {
            try {
                ...
                a aVar = new a();
                aVar.f63976c = jSONObject.optString("id");
                aVar.f63980g = UMUtils.getAppVersionName(this.mContext);
                aVar.f63981h = UMUtils.getAppVersionCode(this.mContext);
                aVar.f63975b = jSONObject.optString("__i");
                aVar.f63978e = jSONObject.optInt("__t");
                aVar.f63979f = str;
                ...
                aVar.f63977d = com.umeng.common.a.a().a(jSONObject.toString());
                jSONObject.remove("ds");
                arrayList.add(aVar);
                ...
                try {
                    ...
                    for (a aVar : list) {
                        try {
                            ...
                            contentValues.put("__i", aVar.f63975b);
                            contentValues.put("__e", aVar.f63976c);
                            contentValues.put("__t", Integer.valueOf(aVar.f63978e));
                            contentValues.put(a.InterfaceC0670a.f63996f, aVar.f63979f);
                            contentValues.put("__av", aVar.f63980g);
                            contentValues.put("__vc", aVar.f63981h);
                            contentValues.put("__s", aVar.f63977d);
                            a5.insert(a.InterfaceC0670a.f63991a, null, contentValues);
                        } catch (Exception unused) {
                        }
                    }
    ...
    public void processToMain(String str) {
        if (dbIsExists(str)) {
            ...
            if (!readEventByProcess.isEmpty() && insertEvents_(com.umeng.analytics.process.a.f63990h, readEventByProcess)) {
    ...
    */
    private java.util.List<com.umeng.analytics.process.UMProcessDBHelper.a> readEventByProcess(java.lang.String r13) {
        ...
        L22:
            ...
            r4.f63974a = r5     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            ...
            r4.f63975b = r5     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = "__e"
            int r5 = r3.getColumnIndex(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = r3.getString(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            r4.f63976c = r5     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = "__s"
            int r5 = r3.getColumnIndex(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = r3.getString(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            r4.f63977d = r5     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = "__t"
            int r5 = r3.getColumnIndex(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            int r5 = r3.getInt(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            r4.f63978e = r5     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = "__pn"
            int r5 = r3.getColumnIndex(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = r3.getString(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            r4.f63979f = r5     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = "__av"
            int r5 = r3.getColumnIndex(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = r3.getString(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            r4.f63980g = r5     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = "__vc"
            int r5 = r3.getColumnIndex(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            java.lang.String r5 = r3.getString(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
            r4.f63981h = r5     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lb9
        ...
        try {
            ...
            if (size > 0) {
                for (int i4 = 0; i4 < size; i4++) {
                    sQLiteDatabase.execSQL("delete from __et_p where rowid=" + list.get(i4).f63974a);
                }
            } else {
                sQLiteDatabase.delete(a.InterfaceC0670a.f63991a, null, null);
            }
    ...
    */
    ...
    public JSONObject readVersionInfoFromColumId(Integer num) {
        ...
        cursor = null;
        try {
            sQLiteDatabase = c.a(this.mContext).a(com.umeng.analytics.process.a.f63990h);
            try {
                try {
                    sQLiteDatabase.beginTransaction();
                    Cursor query = sQLiteDatabase.query(a.InterfaceC0670a.f63991a, null, "rowid=?", new String[]{String.valueOf(num)}, null, null, null);
                    if (query != null) {
                        try {
                            try {
                                if (query.moveToNext()) {
                                    ...
                                    try {
                                        ...
                                        if (cursor != null) {
                                            try {
                                                ...
                                                c.a(this.mContext).b(com.umeng.analytics.process.a.f63990h);
                                                return jSONObject;
                                            }
                                        }
                                        if (sQLiteDatabase != null) {
