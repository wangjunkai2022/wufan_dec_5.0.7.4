...
public class UMProcessDBDatasSender implements UMLogDataProtocol {
    ...
    public class ReplaceCallback implements FileLockCallback {
        ...
        public boolean onFileLock(String str) {
            ...
            String str2 = a.f63985c;
            if (str.startsWith(str2)) {
                str = str.replaceFirst(str2, "");
            }
            UMProcessDBHelper.getInstance(UMProcessDBDatasSender.this.mContext).deleteEventDatas(str.replace(a.f63986d, ""), null, null);
            return true;
        }
    ...
    private int defconProcesserHandler() {
        int a5 = t.a().a(this.mContext);
        if (a5 != 0) {
            try {
                DBFileTraversalUtil.traverseDBFiles(b.a(this.mContext), new ReplaceCallback(), null);
            } catch (Exception unused) {
            }
            UMProcessDBHelper.getInstance(this.mContext).deleteEventDatas(a.f63990h, null, null);
        }
        return a5;
    }
    ...
    private JSONObject generalBody() {
        ...
        try {
            ...
            if (a5 != null && !TextUtils.isEmpty(a5[0]) && !TextUtils.isEmpty(a5[1])) {
                ...
                jSONObject2.put(f.M, a5[0]);
                jSONObject2.put(f.N, a5[1]);
    ...
    private JSONObject generalHeader() {
        ...
        try {
            ...
            jSONObject.put(f.f63696i, AnalyticsConfig.getVerticalType(this.mContext));
            String str3 = "9.6.7";
            if (AnalyticsConfig.getVerticalType(this.mContext) == 1) {
                ...
                jSONObject.put("sdk_version", "9.6.7");
            }
            String str4 = "";
            ...
            SharedPreferences sharedPreferences = PreferenceWrapper.getDefault(this.mContext);
            jSONObject.put(f.f63699l, UMEnvelopeBuild.imprintProperty(this.mContext, "pr_ve", null));
            jSONObject.put(f.f63700m, UMEnvelopeBuild.imprintProperty(this.mContext, "ud_da", null));
            jSONObject.put(f.an, "1.0.0");
            if (TextUtils.isEmpty(imprintProperty)) {
                jSONObject.put(f.f63699l, sharedPreferences.getString("vers_pre_version", "0"));
                jSONObject.put(f.f63700m, sharedPreferences.getString("vers_date", new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date(System.currentTimeMillis()))));
            }
        } catch (Throwable th) {
            th.printStackTrace();
        }
