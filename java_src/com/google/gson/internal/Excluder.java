...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    private boolean excludeClassInStrategy(Class<?> cls, boolean z4) {
        for (ExclusionStrategy exclusionStrategy : z4 ? this.serializationStrategies : this.deserializationStrategies) {
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z4, boolean z5) {
        ...
        if (z4) {
            ...
            m13clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z5) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            m13clone.deserializationStrategies = arrayList2;
    ...
    public Excluder withModifiers(int... iArr) {
        ...
        for (int i4 : iArr) {
            m13clone.modifiers = i4 | m13clone.modifiers;
        }
        return m13clone;
    }
