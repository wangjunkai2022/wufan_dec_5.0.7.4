...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private void createExpansionAnimation(@NonNull View view, View view2, boolean z4, boolean z5, @NonNull FabTransformationSpec fabTransformationSpec, float f5, float f6, @NonNull List<Animator> list, @NonNull List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof CircularRevealWidget) {
            ...
            if (z4) {
                ...
                createPreFillRadialExpansion(view2, timing.getDelay(), i4, i5, f7, list);
    ...
    private void createPostFillRadialExpansion(View view, long j4, long j5, long j6, int i4, int i5, float f5, @NonNull List<Animator> list) {
        if (Build.VERSION.SDK_INT >= 21) {
            long j7 = j4 + j5;
            if (j7 < j6) {
                Animator createCircularReveal = ViewAnimationUtils.createCircularReveal(view, i4, i5, f5, f5);
    ...
    private void createPreFillRadialExpansion(View view, long j4, int i4, int i5, float f5, @NonNull List<Animator> list) {
