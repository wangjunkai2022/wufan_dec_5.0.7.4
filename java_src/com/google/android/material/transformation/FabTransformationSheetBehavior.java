    ...
    private void updateImportantForAccessibility(@NonNull View view, boolean z4) {
        ...
        if (parent instanceof CoordinatorLayout) {
            ...
            for (int i4 = 0; i4 < childCount; i4++) {
                ...
                boolean z5 = (childAt.getLayoutParams() instanceof CoordinatorLayout.LayoutParams) && (((CoordinatorLayout.LayoutParams) childAt.getLayoutParams()).getBehavior() instanceof FabTransformationScrimBehavior);
                if (childAt != view && !z5) {
                    if (!z4) {
