...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    private void createMenuViewTranslationAnimation(final int i4, final boolean z4, @NonNull List<Animator> list) {
        ...
        if (Math.abs(actionMenuView.getTranslationX() - getActionMenuViewTranslationX(actionMenuView, i4, z4)) > 1.0f) {
            ...
            ofFloat2.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.bottomappbar.BottomAppBar.7
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    BottomAppBar.this.translateActionMenuView(actionMenuView, i4, z4, z5);
                }
            });
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void maybeAnimateMenuView(int i4, boolean z4) {
        ...
        createMenuViewTranslationAnimation(i4, z4, arrayList);
        AnimatorSet animatorSet = new AnimatorSet();
    ...
    private void translateActionMenuView(@NonNull ActionMenuView actionMenuView, int i4, boolean z4) {
        translateActionMenuView(actionMenuView, i4, z4, false);
    }
    ...
    protected int getActionMenuViewTranslationX(@NonNull ActionMenuView actionMenuView, int i4, boolean z4) {
        if (i4 == 1 && z4) {
            boolean isLayoutRtl = ViewUtils.isLayoutRtl(this);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void translateActionMenuView(@NonNull final ActionMenuView actionMenuView, final int i4, final boolean z4, boolean z5) {
        Runnable runnable = new Runnable() { // from class: com.google.android.material.bottomappbar.BottomAppBar.8
            @Override // java.lang.Runnable
            public void run() {
                ActionMenuView actionMenuView2 = actionMenuView;
                actionMenuView2.setTranslationX(BottomAppBar.this.getActionMenuViewTranslationX(actionMenuView2, i4, z4));
            }
        };
        if (z5) {
