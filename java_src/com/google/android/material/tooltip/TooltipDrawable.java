...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private EdgeTreatment createMarkerEdge() {
        ...
        return new OffsetEdgeTreatment(new MarkerEdgeTreatment(this.arrowSize), Math.min(Math.max(-calculatePointerOffset(), -f5), f5));
    }
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i4, @StyleRes int i5) {
        ...
        if (textAppearance != null) {
            ...
            if (obtainStyledAttributes.hasValue(i6)) {
                textAppearance.setTextColor(MaterialResources.getColorStateList(this.context, obtainStyledAttributes, i6));
            }
        }
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        canvas.translate(calculatePointerOffset, (float) (-(d6 - d7)));
        super.draw(canvas);
        drawText(canvas);
        canvas.restore();
    }
