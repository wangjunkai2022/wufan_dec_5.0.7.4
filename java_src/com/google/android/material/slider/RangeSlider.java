...
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    public RangeSlider(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.RangeSlider, i4, BaseSlider.DEF_STYLE_RES, new int[0]);
        int i5 = R.styleable.RangeSlider_values;
        if (obtainStyledAttributes.hasValue(i5)) {
            setValues(convertToFloat(obtainStyledAttributes.getResources().obtainTypedArray(obtainStyledAttributes.getResourceId(i5, 0))));
        }
