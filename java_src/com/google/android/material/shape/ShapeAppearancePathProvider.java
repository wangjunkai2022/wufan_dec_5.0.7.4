...
public class ShapeAppearancePathProvider {
    ...
    private void appendEdgePath(@NonNull ShapeAppearancePathSpec shapeAppearancePathSpec, int i4) {
        ...
        if (this.edgeIntersectionCheckEnabled && Build.VERSION.SDK_INT >= 19 && (edgeTreatmentForIndex.forceIntersection() || pathOverlapsCorner(this.edgePath, i4) || pathOverlapsCorner(this.edgePath, i5))) {
