...
public class ShapeAppearanceModel {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setAllCorners(int i4, @Dimension float f5) {
            return setAllCorners(MaterialShapeUtils.createCornerTreatment(i4)).setAllCornerSizes(f5);
        }
        ...
        @NonNull
        public Builder setBottomLeftCorner(int i4, @Dimension float f5) {
            return setBottomLeftCorner(MaterialShapeUtils.createCornerTreatment(i4)).setBottomLeftCornerSize(f5);
        }
        ...
        @NonNull
        public Builder setBottomRightCorner(int i4, @Dimension float f5) {
            return setBottomRightCorner(MaterialShapeUtils.createCornerTreatment(i4)).setBottomRightCornerSize(f5);
        }
        ...
        @NonNull
        public Builder setTopLeftCorner(int i4, @Dimension float f5) {
            return setTopLeftCorner(MaterialShapeUtils.createCornerTreatment(i4)).setTopLeftCornerSize(f5);
        }
        ...
        @NonNull
        public Builder setTopRightCorner(int i4, @Dimension float f5) {
            return setTopRightCorner(MaterialShapeUtils.createCornerTreatment(i4)).setTopRightCornerSize(f5);
        }
