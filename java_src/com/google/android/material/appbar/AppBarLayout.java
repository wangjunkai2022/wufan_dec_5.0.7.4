...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private boolean addAccessibilityScrollActions(final CoordinatorLayout coordinatorLayout, @NonNull final T t4, @NonNull final View view) {
            boolean z4 = false;
            if (getTopBottomOffsetForScrollingSibling() != (-t4.getTotalScrollRange())) {
        ...
        private void addActionToExpand(CoordinatorLayout coordinatorLayout, @NonNull final T t4, @NonNull AccessibilityNodeInfoCompat.AccessibilityActionCompat accessibilityActionCompat, final boolean z4) {
        ...
        private void animateOffsetTo(CoordinatorLayout coordinatorLayout, @NonNull T t4, int i4, float f5) {
            int height;
            ...
            animateOffsetWithDuration(coordinatorLayout, t4, i4, height);
        }
        ...
        private int interpolateOffset(@NonNull T t4, int i4) {
            ...
            while (true) {
                ...
                if (abs < childAt.getTop() || abs > childAt.getBottom()) {
                    ...
                    if (i5 > 0) {
                        float f5 = i5;
                        return Integer.signum(i4) * (childAt.getTop() + Math.round(f5 * scrollInterpolator.getInterpolation((abs - childAt.getTop()) / f5)));
                    }
                }
            }
            return i4;
        ...
        private void updateAccessibilityActions(CoordinatorLayout coordinatorLayout, @NonNull T t4) {
            ...
            if (t4.getTotalScrollRange() == 0 || (childWithScrollingBehavior = getChildWithScrollingBehavior(coordinatorLayout)) == null || !childrenHaveScrollFlags(t4)) {
                return;
            }
            ...
            this.coordinatorLayoutA11yScrollable = addAccessibilityScrollActions(coordinatorLayout, t4, childWithScrollingBehavior);
        }
        ...
        @Nullable
        SavedState saveScrollState(@Nullable Parcelable parcelable, @NonNull T t4) {
            ...
            for (int i4 = 0; i4 < childCount; i4++) {
                ...
                if (childAt.getTop() + topAndBottomOffset <= 0 && bottom >= 0) {
                    ...
                    savedState.fullyScrolled = !z4 && (-topAndBottomOffset) >= t4.getTotalScrollRange();
                    savedState.firstVisibleChildIndex = i4;
                    savedState.firstVisibleChildAtMinimumHeight = bottom == ViewCompat.getMinimumHeight(childAt) + t4.getTopInset();
        ...
        int getMaxDragOffset(@NonNull T t4) {
            return -t4.getDownNestedScrollRange();
        }

        int getScrollRangeForDragFling(@NonNull T t4) {
            return t4.getTotalScrollRange();
        }

        void onFlingFinished(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t4) {
        ...
        public void onRestoreInstanceState(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t4, Parcelable parcelable) {
            if (parcelable instanceof SavedState) {
                ...
                super.onRestoreInstanceState(coordinatorLayout, (CoordinatorLayout) t4, this.savedState.getSuperState());
                return;
            }
        ...
        int setHeaderTopBottomOffset(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t4, int i4, int i5, int i6) {
            int topBottomOffsetForScrollingSibling = getTopBottomOffsetForScrollingSibling();
            int i7 = 0;
    ...
    public interface LiftOnScrollListener {
        void onUpdate(@Dimension float f5, @ColorInt int i4);
    }
