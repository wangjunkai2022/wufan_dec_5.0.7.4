...
public abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    final boolean fling(CoordinatorLayout coordinatorLayout, @NonNull V v2, int i4, int i5, float f5) {
        ...
        this.scroller.fling(0, getTopAndBottomOffset(), 0, Math.round(f5), 0, 0, i4, i5);
    ...
    int getMaxDragOffset(@NonNull V v2) {
        return -v2.getHeight();
    }

    int getScrollRangeForDragFling(@NonNull V v2) {
        return v2.getHeight();
    }
    ...
    public boolean onInterceptTouchEvent(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 0) {
            ...
            boolean z4 = canDragView(v2) && coordinatorLayout.isPointInChildBounds(v2, x4, y4);
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final int scroll(CoordinatorLayout coordinatorLayout, V v2, int i4, int i5, int i6) {
        return setHeaderTopBottomOffset(coordinatorLayout, v2, getTopBottomOffsetForScrollingSibling() - i4, i5, i6);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v2, int i4) {
        return setHeaderTopBottomOffset(coordinatorLayout, v2, i4, Integer.MIN_VALUE, Integer.MAX_VALUE);
    }

    int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v2, int i4, int i5, int i6) {
        int clamp;
