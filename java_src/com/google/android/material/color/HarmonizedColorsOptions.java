...
public class HarmonizedColorsOptions {
    ...
    public static class Builder {
        ...
        public Builder setColorAttributeToHarmonizeWith(@AttrRes int i4) {
            this.colorAttributeToHarmonizeWith = i4;
            return this;
        }
    ...
    @StyleRes
    public int getThemeOverlayResourceId(@StyleRes int i4) {
        HarmonizedColorAttributes harmonizedColorAttributes = this.colorAttributes;
        return (harmonizedColorAttributes == null || harmonizedColorAttributes.getThemeOverlay() == 0) ? i4 : this.colorAttributes.getThemeOverlay();
    }
