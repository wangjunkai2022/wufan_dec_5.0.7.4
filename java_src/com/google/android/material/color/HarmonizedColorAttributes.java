...
public final class HarmonizedColorAttributes {
    ...
    private HarmonizedColorAttributes(@AttrRes @NonNull int[] iArr, @StyleRes int i4) {
    ...
    @NonNull
    public static HarmonizedColorAttributes create(@AttrRes @NonNull int[] iArr, @StyleRes int i4) {
