...
public final class MaterialContainerTransform extends Transition {
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f5) {
            ...
            rectF.set(f10 - (f12 / 2.0f), f11, (f12 / 2.0f) + f10, evaluate.currentStartHeight + f11);
            RectF rectF2 = this.currentEndBounds;
            FitModeResult fitModeResult = this.fitModeResult;
            float f13 = fitModeResult.currentEndWidth;
            rectF2.set(f10 - (f13 / 2.0f), f11, f10 + (f13 / 2.0f), fitModeResult.currentEndHeight + f11);
    ...
    private void maybeApplyThemeValues(Context context, boolean z4) {
        ...
        TransitionUtils.maybeApplyThemeDuration(this, context, z4 ? R.attr.motionDurationLong1 : R.attr.motionDurationMedium2);
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            if (rectF != null && shapeAppearanceModel != null) {
                ...
                if (rectF2 != null && shapeAppearanceModel2 != null) {
                    ...
                    RectF calculateDrawableBounds = calculateDrawableBounds(findAncestorById, view, f5, f6);
                    rectF.offset(f5, f6);
                    rectF2.offset(f5, f6);
