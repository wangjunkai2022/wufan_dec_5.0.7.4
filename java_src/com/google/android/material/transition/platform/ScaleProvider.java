...
public final class ScaleProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createScaleAnimator(final View view, float f5, float f6) {
        ...
        ObjectAnimator ofPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(view, PropertyValuesHolder.ofFloat(View.SCALE_X, scaleX * f5, scaleX * f6), PropertyValuesHolder.ofFloat(View.SCALE_Y, f5 * scaleY, f6 * scaleY));
