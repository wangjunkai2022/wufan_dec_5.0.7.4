...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private BadgeDrawable(@NonNull Context context, @XmlRes int i4, @AttrRes int i5, @StyleRes int i6, @Nullable BadgeState.State state) {
        ...
        this.state = new BadgeState(context, i4, i5, i6, state);
        restoreState();
    }
    ...
    private void calculateCenterAndBounds(@NonNull Context context, @NonNull Rect rect, @NonNull View view) {
        ...
        if (getNumber() <= 9) {
            ...
            float f8 = this.state.badgeWithTextRadius;
        ...
        if (badgeGravity2 != 8388659 && badgeGravity2 != 8388691) {
            if (ViewCompat.getLayoutDirection(view) == 0) {
                f6 = ((rect.right + this.halfBadgeWidth) - dimensionPixelSize) - totalHorizontalOffsetForState;
            } else {
                f6 = (rect.left - this.halfBadgeWidth) + dimensionPixelSize + totalHorizontalOffsetForState;
            }
            this.badgeCenterX = f6;
            return;
        }
        if (ViewCompat.getLayoutDirection(view) == 0) {
            f5 = (rect.left - this.halfBadgeWidth) + dimensionPixelSize + totalHorizontalOffsetForState;
        } else {
            f5 = ((rect.right + this.halfBadgeWidth) - dimensionPixelSize) - totalHorizontalOffsetForState;
        }
    ...
    public static BadgeDrawable createFromResource(@NonNull Context context, @XmlRes int i4) {
        return new BadgeDrawable(context, i4, DEFAULT_THEME_ATTR, DEFAULT_STYLE, null);
    }
    ...
    private void updateMaxBadgeNumber() {
        ...
        this.maxBadgeNumber = ((int) Math.pow(10.0d, d5 - 1.0d)) - 1;
    }
