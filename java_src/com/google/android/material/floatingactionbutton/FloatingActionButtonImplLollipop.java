...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    private Animator createElevationAnimator(float f5, float f6) {
        ...
        animatorSet.play(ObjectAnimator.ofFloat(this.view, "elevation", f5).setDuration(0L)).with(ObjectAnimator.ofFloat(this.view, View.TRANSLATION_Z, f6).setDuration(100L));
