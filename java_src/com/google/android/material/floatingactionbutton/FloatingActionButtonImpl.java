...
public class FloatingActionButtonImpl {
    ...
    private AnimatorSet createAnimator(@NonNull MotionSpec motionSpec, float f5, float f6, float f7) {
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this.view, View.ALPHA, f5);
        motionSpec.getTiming("opacity").apply(ofFloat);
        arrayList.add(ofFloat);
        ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(this.view, View.SCALE_X, f6);
        motionSpec.getTiming("scale").apply(ofFloat2);
        workAroundOreoBug(ofFloat2);
        arrayList.add(ofFloat2);
        ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(this.view, View.SCALE_Y, f6);
    ...
    private AnimatorSet createDefaultAnimator(final float f5, final float f6, final float f7) {
        AnimatorSet animatorSet = new AnimatorSet();
        ArrayList arrayList = new ArrayList();
    ...
    public void hide(@Nullable final InternalVisibilityChangedListener internalVisibilityChangedListener, final boolean z4) {
        ...
        if (shouldAnimateVisibilityChange()) {
            ...
            if (arrayList != null) {
                ...
                while (it2.hasNext()) {
                    createDefaultAnimator.addListener(it2.next());
                }
            }
            createDefaultAnimator.start();
            return;
        }
        this.view.internalSetVisibility(z4 ? 8 : 4, z4);
