...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    static boolean readMaterialCalendarStyleBoolean(@NonNull Context context, int i4) {
    ...
    public static final class Builder<S> {
        ...
        public MaterialDatePicker<S> build() {
            ...
            S s4 = this.selection;
            if (s4 != null) {
                this.dateSelector.setSelection(s4);
            }
        ...
        @NonNull
        public Builder<S> setNegativeButtonText(@StringRes int i4) {
        ...
        @NonNull
        public Builder<S> setPositiveButtonText(@StringRes int i4) {
        ...
        @NonNull
        public Builder<S> setSelection(S s4) {
            this.selection = s4;
            return this;
        }
