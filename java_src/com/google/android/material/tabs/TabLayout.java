...
public class TabLayout extends HorizontalScrollView {
    ...
    public class SlidingTabIndicator extends LinearLayout {
        ...
        void setIndicatorPositionFromTabPosition(int i4, float f5) {
            ValueAnimator valueAnimator = this.indicatorAnimator;
            if (valueAnimator != null && valueAnimator.isRunning()) {
                this.indicatorAnimator.cancel();
            }
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int i4, float f5, int i5) {
            ...
            if (tabLayout != null) {
                ...
                boolean z4 = false;
                tabLayout.setScrollPosition(i4, f5, i6 != 2 || this.previousScrollState == 1, (i6 == 2 && this.previousScrollState == 0) ? true : true);
            }
        }
    ...
    public final class TabView extends LinearLayout {
        ...
        private float approximateLineWidth(@NonNull Layout layout, int i4, float f5) {
    ...
    private int calculateScrollXForTab(int i4, float f5) {
        View childAt;
        int i5 = this.mode;
    ...
    */
    ...
    public void setScrollPosition(int i4, float f5, boolean z4, boolean z5) {
        ...
        if (z5) {
            this.slidingTabIndicator.setIndicatorPositionFromTabPosition(i4, f5);
        }
        ValueAnimator valueAnimator = this.scrollAnimator;
        if (valueAnimator != null && valueAnimator.isRunning()) {
            this.scrollAnimator.cancel();
        }
        scrollTo(i4 < 0 ? 0 : calculateScrollXForTab(i4, f5), 0);
        if (z4) {
