...
public class CircularRevealHelper {
    ...
    private void drawDebugCircle(@NonNull Canvas canvas, int i4, float f5) {
    ...
    private boolean shouldDrawCircularReveal() {
        CircularRevealWidget.RevealInfo revealInfo = this.revealInfo;
        boolean z4 = revealInfo == null || revealInfo.isInvalid();
        return STRATEGY == 0 ? !z4 && this.hasCircularRevealCache : !z4;
    }
