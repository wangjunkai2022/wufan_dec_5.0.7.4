...
public class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public DropdownMenuEndIconDelegate(@NonNull TextInputLayout textInputLayout, @DrawableRes int i4) {
        ...
        this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate.7
            ...
            public void onTouchExplorationStateChanged(boolean z4) {
                ...
                ViewCompat.setImportantForAccessibility(DropdownMenuEndIconDelegate.this.endIconView, z4 ? 2 : 1);
            }
        };
    ...
    private MaterialShapeDrawable getPopUpMaterialShapeDrawable(float f5, float f6, float f7, int i4) {
        ...
        MaterialShapeDrawable createWithElevationOverlay = MaterialShapeDrawable.createWithElevationOverlay(this.context, f7);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void updateOutlinedRippleEffect(@NonNull AutoCompleteTextView autoCompleteTextView) {
