...
public final class IndicatorViewController {
    ...
    private void createCaptionAnimators(@NonNull List<Animator> list, boolean z4, @Nullable TextView textView, int i4, int i5, int i6) {
        if (textView == null || !z4) {
            return;
        }
        if (i4 == i6 || i4 == i5) {
    ...
    private int getIndicatorPadding(boolean z4, @DimenRes int i4, int i5) {
    ...
    void hideHelperText() {
        ...
        updateCaptionViewsVisibility(i4, this.captionToShow, shouldAnimateCaptionView(this.helperTextView, ""));
    }
