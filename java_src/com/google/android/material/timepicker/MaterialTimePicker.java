...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setMinute(@IntRange(from = 0, to = 59) int i4) {
    ...
    private TimePickerPresenter initializeOrRetrieveActivePresenterForMode(int i4, @NonNull TimePickerView timePickerView, @NonNull ViewStub viewStub) {
        if (i4 == 0) {
