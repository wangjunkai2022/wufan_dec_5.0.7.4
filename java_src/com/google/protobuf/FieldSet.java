...
public final class FieldSet<FieldDescriptorType extends FieldDescriptorLite<FieldDescriptorType>> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int computeElementSize(WireFormat.FieldType fieldType, int i4, Object obj) {
        ...
        if (fieldDescriptorLite.isRepeated()) {
            ...
            if (fieldDescriptorLite.isPacked()) {
                for (Object obj2 : (List) obj) {
                    i4 += computeElementSizeNoTag(liteType, obj2);
                }
                return CodedOutputStream.computeTagSize(number) + i4 + CodedOutputStream.computeRawVarint32Size(i4);
            }
            for (Object obj3 : (List) obj) {
                i4 += computeElementSize(liteType, number, obj3);
            }
            return i4;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int getWireFormatForFieldType(WireFormat.FieldType fieldType, boolean z4) {
        if (z4) {
            return 2;
        }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void writeElement(CodedOutputStream codedOutputStream, WireFormat.FieldType fieldType, int i4, Object obj) throws IOException {
        if (fieldType == WireFormat.FieldType.GROUP) {
    ...
    public Map<FieldDescriptorType, Object> getAllFields() {
        ...
        for (int i4 = 0; i4 < this.fields.getNumArrayEntries(); i4++) {
            cloneFieldEntry(newFieldMap, this.fields.getArrayEntryAt(i4));
        }
    ...
    public int getMessageSetSerializedSize() {
        ...
        for (Map.Entry<FieldDescriptorType, Object> entry : this.fields.getOverflowEntries()) {
            i4 += getMessageSetSerializedSize(entry);
        }
        return i4;
    }

    public Object getRepeatedField(FieldDescriptorType fielddescriptortype, int i4) {
        if (fielddescriptortype.isRepeated()) {
            Object field = getField(fielddescriptortype);
            if (field != null) {
    ...
    public int getSerializedSize() {
        ...
        for (int i5 = 0; i5 < this.fields.getNumArrayEntries(); i5++) {
            ...
            i4 += computeFieldSize(arrayEntryAt.getKey(), arrayEntryAt.getValue());
        }
        for (Map.Entry<FieldDescriptorType, Object> entry : this.fields.getOverflowEntries()) {
            i4 += computeFieldSize(entry.getKey(), entry.getValue());
        }
        return i4;
    }
    ...
    public void setRepeatedField(FieldDescriptorType fielddescriptortype, int i4, Object obj) {
        if (fielddescriptortype.isRepeated()) {
            Object field = getField(fielddescriptortype);
            if (field != null) {
                verifyType(fielddescriptortype.getLiteType(), obj);
    ...
    /* renamed from: clone */
    public FieldSet<FieldDescriptorType> m15clone() {
