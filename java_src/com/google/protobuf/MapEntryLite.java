...
public class MapEntryLite<K, V> {
    ...
    public static class Metadata<K, V> {
        ...
        public Metadata(WireFormat.FieldType fieldType, K k4, WireFormat.FieldType fieldType2, V v2) {
    ...
    private MapEntryLite(WireFormat.FieldType fieldType, K k4, WireFormat.FieldType fieldType2, V v2) {
        this.metadata = new Metadata<>(fieldType, k4, fieldType2, v2);
        this.key = k4;
        this.value = v2;
    }

    static <K, V> int computeSerializedSize(Metadata<K, V> metadata, K k4, V v2) {
        return FieldSet.computeElementSize(metadata.keyType, 1, k4) + FieldSet.computeElementSize(metadata.valueType, 2, v2);
    }

    public static <K, V> MapEntryLite<K, V> newDefaultInstance(WireFormat.FieldType fieldType, K k4, WireFormat.FieldType fieldType2, V v2) {
        return new MapEntryLite<>(fieldType, k4, fieldType2, v2);
    }
    ...
    static <K, V> void writeTo(CodedOutputStream codedOutputStream, Metadata<K, V> metadata, K k4, V v2) throws IOException {
    ...
    public int computeMessageSize(int i4, K k4, V v2) {
        return CodedOutputStream.computeTagSize(i4) + CodedOutputStream.computeLengthDelimitedFieldSize(computeSerializedSize(this.metadata, k4, v2));
    }
    ...
    public void serializeTo(CodedOutputStream codedOutputStream, int i4, K k4, V v2) throws IOException {
        codedOutputStream.writeTag(i4, 2);
        codedOutputStream.writeUInt32NoTag(computeSerializedSize(this.metadata, k4, v2));
        writeTo(codedOutputStream, this.metadata, k4, v2);
    }
    ...
    private MapEntryLite(Metadata<K, V> metadata, K k4, V v2) {
