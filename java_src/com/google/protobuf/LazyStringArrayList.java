...
public class LazyStringArrayList extends AbstractProtobufList<String> implements LazyStringList, RandomAccess {
    ...
    private static class ByteArrayListView extends AbstractList<byte[]> implements RandomAccess {
        ...
        public void add(int i4, byte[] bArr) {
            this.list.add(i4, bArr);
            ((AbstractList) this).modCount++;
        }

        @Override // java.util.AbstractList, java.util.List
        public byte[] get(int i4) {
            return this.list.getByteArray(i4);
        }
        ...
        public byte[] set(int i4, byte[] bArr) {
            Object andReturn = this.list.setAndReturn(i4, bArr);
            ((AbstractList) this).modCount++;
    ...
    private static class ByteStringListView extends AbstractList<ByteString> implements RandomAccess {
        ...
        public ByteString set(int i4, ByteString byteString) {
            Object andReturn = this.list.setAndReturn(i4, byteString);
            ((AbstractList) this).modCount++;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public Object setAndReturn(int i4, ByteString byteString) {
        ensureIsMutable();
        return this.list.set(i4, byteString);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public Object setAndReturn(int i4, byte[] bArr) {
        ensureIsMutable();
        return this.list.set(i4, bArr);
    }
