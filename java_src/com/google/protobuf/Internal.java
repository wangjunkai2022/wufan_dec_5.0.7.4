...
public final class Internal {
    ...
    public interface DoubleList extends ProtobufList<Double> {
        ...
        double setDouble(int i4, double d5);
    }
    ...
    public interface FloatList extends ProtobufList<Float> {
        ...
        float setFloat(int i4, float f5);
    }
    ...
    public static class ListAdapter<F, T> extends AbstractList<T> {
        ...
        public T get(int i4) {
            return this.converter.convert(this.fromList.get(i4));
        }
    ...
    public static class MapAdapter<K, V, RealValue> extends AbstractMap<K, V> {
        ...
        public static <T extends EnumLite> Converter<Integer, T> newEnumConverter(final EnumLiteMap<T> enumLiteMap, final T t4) {
            return (Converter<Integer, T>) new Converter<Integer, T>() { // from class: com.google.protobuf.Internal.MapAdapter.1
                ...
                public EnumLite doForward(Integer num) {
                    ...
                    return findValueByNumber == null ? t4 : findValueByNumber;
                }
            };
        }
        ...
        public V put(K k4, V v2) {
            RealValue put = this.realMap.put(k4, this.valueConverter.doBackward(v2));
            if (put == null) {
                return null;
            }
    ...
    public static int partialHash(int i4, byte[] bArr, int i5, int i6) {
    ...
    static int hashCode(byte[] bArr, int i4, int i5) {
        int partialHash = partialHash(i5, bArr, i4, i5);
        if (partialHash == 0) {
            return 1;
        }
        return partialHash;
