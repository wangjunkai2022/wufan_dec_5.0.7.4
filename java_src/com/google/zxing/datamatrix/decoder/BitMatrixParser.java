...
final class BitMatrixParser {
    ...
    public byte[] readCodewords() throws FormatException {
        ...
        while (true) {
            if (i6 == height && i4 == 0 && !z4) {
                ...
                int i7 = height - 2;
                if (i6 == i7 && i4 == 0 && (width & 3) != 0 && !z5) {
                    bArr[i5] = (byte) readCorner2(height, width);
                    i6 -= 2;
                    i4 += 2;
                    i5++;
                    z5 = true;
                } else if (i6 == height + 4 && i4 == 2 && (width & 7) == 0 && !z6) {
                    bArr[i5] = (byte) readCorner3(height, width);
                    i6 -= 2;
                    i4 += 2;
                    i5++;
                    z6 = true;
                } else if (i6 == i7 && i4 == 0 && (width & 7) == 4 && !z7) {
    ...
    boolean readModule(int i4, int i5, int i6, int i7) {
        if (i4 < 0) {
            i4 += i6;
            i5 += 4 - ((i6 + 4) & 7);
        }
    ...
    int readUtah(int i4, int i5, int i6, int i7) {
        int i8 = i4 - 2;
        int i9 = i5 - 2;
