...
public abstract class GridSampler {
    ...
    */
    ...
    public abstract BitMatrix sampleGrid(BitMatrix bitMatrix, int i4, int i5, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17, float f18, float f19, float f20) throws NotFoundException;
