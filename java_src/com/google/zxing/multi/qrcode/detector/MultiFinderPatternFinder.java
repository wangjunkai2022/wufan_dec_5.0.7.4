...
final class MultiFinderPatternFinder extends FinderPatternFinder {
                ...
                if (finderPattern != null) {
                    ...
                    while (i6 < size - 1) {
                        ...
                        if (finderPattern2 != null) {
                            ...
                            float f5 = DIFF_MODSIZE_CUTOFF_PERCENT;
                            float f6 = 0.5f;
                            ...
                            while (i7 < size) {
                                ...
                                if (finderPattern3 != null) {
                                    ...
                                    if (Math.abs(finderPattern2.getEstimatedModuleSize() - finderPattern3.getEstimatedModuleSize()) > f6 && estimatedModuleSize2 >= f5) {
                                        break;
                                    }
                                ...
                                i4 = 3;
                                c5 = 0;
                                f5 = DIFF_MODSIZE_CUTOFF_PERCENT;
                                f6 = 0.5f;
                            }
                        }
                        i6++;
    ...
    public FinderPatternInfo[] findMulti(Map<DecodeHintType, ?> map) throws NotFoundException {
        ...
        int i4 = (((int) ((((float) height) / 228.0f) * 3.0f)) < 3 || z4) ? 3 : 3;
        int[] iArr = new int[5];
