...
final class AlignmentPatternFinder {
    ...
    public AlignmentPatternFinder(BitMatrix bitMatrix, int i4, int i5, int i6, int i7, float f5, ResultPointCallback resultPointCallback) {
    ...
    */
    ...
    private AlignmentPattern handlePossibleCenter(int[] iArr, int i4, int i5) {
        ...
        for (AlignmentPattern alignmentPattern : this.possibleCenters) {
            if (alignmentPattern.aboutEquals(f5, crossCheckVertical, centerFromEnd)) {
                return alignmentPattern.combineEstimate(crossCheckVertical, centerFromEnd, f5);
            }
        }
        AlignmentPattern alignmentPattern2 = new AlignmentPattern(centerFromEnd, crossCheckVertical, f5);
