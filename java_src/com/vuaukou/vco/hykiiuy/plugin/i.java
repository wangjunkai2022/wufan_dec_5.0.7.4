...
final class i {
    ...
    public static /* synthetic */ void a(ClassLoader classLoader, File file) {
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            new StringBuilder(a.auu.a.c("IgwWRQUaFxU=")).append(i4).append(a.auu.a.c("E18=")).append(((File) list.get(i4)).getAbsolutePath());
        }
        ...
        e.a(obj, a.auu.a.c("IAQADBcWKScHBgQTCjUvERwgDRYIKwsAFg==")).set(obj, (Object[]) e.a(obj, a.auu.a.c("IwQfADESESYgGAAMFgs6Fg=="), List.class).invoke(obj, arrayList2));
    }
