...
public class b {
    ...
    private static boolean f2730a;

    /* renamed from: b  reason: collision with root package name */
    private static boolean f2731b;

    /* renamed from: c  reason: collision with root package name */
    private static final LinkedBlockingDeque<Object[]> f2732c = new LinkedBlockingDeque<>();

    /* renamed from: d  reason: collision with root package name */
    public static Object[] f2733d = {null, null, null, null, null, null, Collections.synchronizedMap(new HashMap()), Collections.synchronizedMap(new WeakHashMap())};

    /* loaded from: classes2.dex */
    public static class a {
        /* JADX INFO: Access modifiers changed from: private */
        public static native Object b(int i4, Object obj);
    }
    ...
    public static Object a(int i4, int i5) {
        return a.b(1, new int[]{i4, i5});
    }
        ...
        synchronized (b.class) {
            if (!f2730a) {
                try {
                    ...
                    f2730a = ((Boolean) a.b(0, Boolean.TRUE)).booleanValue();
    ...
    public static boolean a(Context context, boolean z4) {
        ...
        synchronized (b.class) {
            ...
            boolean z5 = ((boolean[]) a.b(11, new Object[]{context, f2732c, new int[]{2, 0, 1, 3, 4, 5, 7, 6, 9, 8}, f2733d, new boolean[]{z4}}))[0];
            f2731b = z5;
            return z5;
        }
    }
