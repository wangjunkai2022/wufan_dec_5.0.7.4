...
public class b extends h implements KsLoadManager.FeedAdListener {
    ...
    private static String f3181j = "AMEPTAGKS";
    ...
    public void l() {
        ...
        try {
            ...
            com.aggmoread.sdk.z.c.a.a.e.e.b(f3181j, "load ad");
    ...
    public void onError(int i4, String str) {
        com.aggmoread.sdk.z.c.a.a.e.e.a(f3181j, "onAdError %s,%s", Integer.valueOf(i4), str);
        b(new i(i4, str));
    }

    @Override // com.kwad.sdk.api.KsLoadManager.FeedAdListener
    public void onFeedAdLoad(@Nullable List<KsFeedAd> list) {
        com.aggmoread.sdk.z.c.a.a.e.e.b(f3181j, "ad loaded");
        List<com.aggmoread.sdk.z.c.a.a.c.o.c> arrayList = new ArrayList<>();
        if (list != null && list.size() > 0) {
            int i4 = -1;
            for (KsFeedAd ksFeedAd : list) {
                int a5 = com.aggmoread.sdk.z.c.a.a.d.a.d.u.b.a((Object) ksFeedAd);
                if (q() && com.aggmoread.sdk.z.c.a.a.d.a.d.u.b.a(this.f3245d, a5)) {
                    a(ksFeedAd, 0);
                } else {
                    b(ksFeedAd, com.aggmoread.sdk.z.c.a.a.d.a.d.u.b.a((Object) ksFeedAd));
                    arrayList.add(new c(ksFeedAd, this.f3244c, this.f3245d, this.f3243b));
                }
                i4 = a5;
            }
