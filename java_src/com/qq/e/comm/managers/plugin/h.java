...
public class h {
    ...
    private static String f59874a = b.a("e_qq_com_plugin");

    /* renamed from: b  reason: collision with root package name */
    private static String f59875b = b.a("e_qq_com_dex");

    /* JADX INFO: Access modifiers changed from: package-private */
    public static File a(Context context) {
        return context.getDir(f59875b, 0);
    }
    ...
    public static boolean a(File file, File file2, Context context, boolean z4) {
        if (file == null || !file.exists()) {
            return false;
        }
        if (file.renameTo(file2)) {
            if (z4) {
                return d(file2, context);
            }
            return true;
        }
        try {
            boolean a5 = a(new FileInputStream(file), file2);
            if (z4) {
                if (a5) {
                    return d(file2, context);
                }
    ...
    public static File e(Context context) {
        return new File(context.getDir(f59874a, 0), "update_lc");
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static File f(Context context) {
        return new File(context.getDir(f59874a, 0), "gdt_plugin.next");
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static File g(Context context) {
        return new File(context.getDir(f59874a, 0), "gdt_plugin.next.sig");
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static File h(Context context) {
        return new File(context.getDir(f59874a, 0), "gdt_plugin.jar");
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static File i(Context context) {
        return new File(context.getDir(f59874a, 0), "gdt_plugin.jar.sig");
    }
}
