...
public class PullToRequestView extends RelativeLayout {
    ...
    */
    ...
    public void performPullingDown(boolean z4) {
    ...
    public void performPullingUp(boolean z4) {
    ...
    public PullToRequestView(Context context, AttributeSet attributeSet, int i4) {
