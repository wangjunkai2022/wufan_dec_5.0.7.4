...
public final class DexMerger {
    ...
    public abstract class IdMerger<T extends Comparable<T>> {
        ...
        public class UnsortedValue implements Comparable<IdMerger<T>.UnsortedValue> {
            ...
            UnsortedValue(Dex dex, IndexMap indexMap, T t4, int i4, int i5) {
                this.source = dex;
        ...
        public final void mergeSorted() {
            ...
            for (int i5 = 0; i5 < DexMerger.this.dexes.length; i5++) {
                sectionArr[i5] = getSection(DexMerger.this.dexes[i5].getTableOfContents());
                sectionArr2[i5] = sectionArr[i5].exists() ? DexMerger.this.dexes[i5].open(sectionArr[i5].off) : null;
                iArr[i5] = readIntoMap(sectionArr2[i5], sectionArr[i5], DexMerger.this.indexMaps[i5], iArr2[i5], treeMap, i5);
            }
            if (treeMap.isEmpty()) {
    ...
    private void mergeCallSiteIds() {
        new IdMerger<CallSiteId>(this.idsDefsOut) { // from class: com.android.dx.merge.DexMerger.5
            ...
            @Override // com.android.dx.merge.DexMerger.IdMerger
            void updateIndex(int i4, IndexMap indexMap, int i5, int i6) {
                indexMap.callSiteIds[i5] = i6;
            }

            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.android.dx.merge.DexMerger.IdMerger
            public CallSiteId read(Dex.Section section, IndexMap indexMap, int i4) {
    ...
    private void mergeMethodHandles() {
        new IdMerger<MethodHandle>(this.idsDefsOut) { // from class: com.android.dx.merge.DexMerger.6
            ...
            @Override // com.android.dx.merge.DexMerger.IdMerger
            void updateIndex(int i4, IndexMap indexMap, int i5, int i6) {
                indexMap.methodHandleIds.put(Integer.valueOf(i5), Integer.valueOf(indexMap.methodHandleIds.size()));
            }

            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.android.dx.merge.DexMerger.IdMerger
            public MethodHandle read(Dex.Section section, IndexMap indexMap, int i4) {
    ...
    public Dex merge() throws IOException {
        ...
        while (i4 < this.dexes.length) {
            int i5 = i4 + 1;
            this.context.out.printf("Merged dex #%d (%d defs/%.1fKiB)%n", Integer.valueOf(i5), Integer.valueOf(this.dexes[i4].getTableOfContents().classDefs.size), Float.valueOf(this.dexes[i4].getLength() / 1024.0f));
            i4 = i5;
        }
    ...
    public static class WriterSizes {
        ...
        private void plus(TableOfContents tableOfContents, boolean z4) {
            ...
            int i4 = this.code;
            double d5 = tableOfContents.codes.byteCount;
            Double.isNaN(d5);
            this.code = i4 + ((int) Math.ceil(d5 * 1.25d));
            int i5 = this.classData;
            double d6 = tableOfContents.classDatas.byteCount;
            Double.isNaN(d6);
            this.classData = i5 + ((int) Math.ceil(d6 * 1.67d));
