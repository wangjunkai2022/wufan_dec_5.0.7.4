...
public final class RegisterSpecSet extends MutabilityControl {
    ...
    public RegisterSpecSet(int i4) {
        super(i4 != 0);
        this.specs = new RegisterSpec[i4];
        this.size = 0;
    }
    ...
    public int hashCode() {
        ...
        for (int i5 = 0; i5 < length; i5++) {
            ...
            i4 = (i4 * 31) + (registerSpec == null ? 0 : registerSpec.hashCode());
        }
        return i4;
    }
    ...
    public void intersect(RegisterSpecSet registerSpecSet, boolean z4) {
        ...
        for (int i4 = 0; i4 < min; i4++) {
            RegisterSpec registerSpec = this.specs[i4];
            if (registerSpec != null && (intersect = registerSpec.intersect(registerSpecArr[i4], z4)) != registerSpec) {
