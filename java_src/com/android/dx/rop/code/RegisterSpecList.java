...
public final class RegisterSpecList extends FixedSizeList implements TypeList {
    ...
    private static class Expander {
        ...
        private Expander(RegisterSpecList registerSpecList, BitSet bitSet, int i4, boolean z4) {
    ...
    public RegisterSpecList withExpandedRegisters(int i4, boolean z4, BitSet bitSet) {
        int size = size();
        if (size == 0) {
            return this;
        }
        Expander expander = new Expander(bitSet, i4, z4);
        for (int i5 = 0; i5 < size; i5++) {
