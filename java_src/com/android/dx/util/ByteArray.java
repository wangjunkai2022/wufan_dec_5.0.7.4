...
public final class ByteArray {
    ...
    public long getLong(int i4) {
        ...
        return ((getUnsignedByte0(i4 + 7) | (getByte0(i4 + 4) << 24) | (getUnsignedByte0(i4 + 5) << 16) | (getUnsignedByte0(i4 + 6) << 8)) & 4294967295L) | (byte0 << 32);
    }
    ...
    public ByteArray slice(int i4, int i5) {
        checkOffsets(i4, i5);
        return new ByteArray(Arrays.copyOfRange(this.bytes, i4, i5));
    }

    public int underlyingOffset(int i4) {
