...
public final class Grep {
    ...
    public void encounterString(int i4) {
        if (this.stringIds.contains(Integer.valueOf(i4))) {
            ...
            printWriter.println(location() + " " + this.dex.strings().get(i4));
    ...
    private String location() {
        ...
        if (this.currentMethod != null) {
            return str + h0.f27805a + this.dex.strings().get(this.dex.methodIds().get(this.currentMethod.getMethodIndex()).getNameIndex());
        }
        return str;
    }
