...
public final class Dops {
    ...
    static {
        ...
        MUL_INT_LIT8 = dop211;
        Dop dop212 = new Dop(Opcodes.DIV_INT_LIT8, 147, 211, insnFormat18, true);
        DIV_INT_LIT8 = dop212;
        Dop dop213 = new Dop(220, 148, 212, insnFormat18, true);
        REM_INT_LIT8 = dop213;
        Dop dop214 = new Dop(Opcodes.AND_INT_LIT8, 149, 213, insnFormat18, true);
        AND_INT_LIT8 = dop214;
        Dop dop215 = new Dop(Opcodes.OR_INT_LIT8, 150, Opcodes.OR_INT_LIT16, insnFormat18, true);
        OR_INT_LIT8 = dop215;
        Dop dop216 = new Dop(Opcodes.XOR_INT_LIT8, 151, 215, insnFormat18, true);
        XOR_INT_LIT8 = dop216;
