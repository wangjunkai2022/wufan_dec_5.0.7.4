...
public enum ItemType implements ToHuman {
    ...
    TYPE_DEBUG_INFO_ITEM(q.a.f63907t, "debug_info_item"),
    TYPE_ANNOTATION_ITEM(q.a.f63908u, "annotation_item"),
    TYPE_ENCODED_ARRAY_ITEM(q.a.f63909v, "encoded_array_item"),
