...
public final class AnnotationsDirectoryItem extends OffsettedItem {
    ...
    public void debugPrint(PrintWriter printWriter) {
        ...
        if (this.fieldAnnotations != null) {
            ...
            Iterator<FieldAnnotationStruct> it2 = this.fieldAnnotations.iterator();
            while (it2.hasNext()) {
        ...
        if (this.methodAnnotations != null) {
            ...
            Iterator<MethodAnnotationStruct> it3 = this.methodAnnotations.iterator();
            while (it3.hasNext()) {
        ...
        if (this.parameterAnnotations != null) {
            ...
            Iterator<ParameterAnnotationStruct> it4 = this.parameterAnnotations.iterator();
            while (it4.hasNext()) {
