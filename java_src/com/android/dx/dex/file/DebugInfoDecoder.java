...
public class DebugInfoDecoder {
    ...
    public static class LocalEntry {
        ...
        public LocalEntry(int i4, boolean z4, int i5, int i6, int i7, int i8) {
            this.address = i4;
            this.isStart = z4;
            this.reg = i5;
            this.nameIndex = i6;
    ...
    DebugInfoDecoder(byte[] bArr, int i4, int i5, boolean z4, CstMethodRef cstMethodRef, DexFile dexFile) {
    ...
    private static void validateEncode0(byte[] bArr, int i4, int i5, boolean z4, CstMethodRef cstMethodRef, DexFile dexFile, PositionList positionList, LocalList localList) {
        boolean z5;
        LocalEntry localEntry;
        PositionEntry next;
        DebugInfoDecoder debugInfoDecoder = new DebugInfoDecoder(bArr, i4, i5, z4, cstMethodRef, dexFile);
