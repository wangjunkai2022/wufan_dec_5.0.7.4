...
public enum InstructionCodec {
    ...
    FORMAT_21H { // from class: com.android.dx.io.instructions.InstructionCodec.12
        ...
        public DecodedInstruction decode(int i4, CodeInput codeInput) throws EOFException {
            ...
            return new OneRegisterDecodedInstruction(this, byte0, 0, null, 0, ((short) codeInput.read()) << (byte0 == 21 ? (char) 16 : '0'), InstructionCodec.byte1(i4));
        }
    ...
    FORMAT_45CC { // from class: com.android.dx.io.instructions.InstructionCodec.32
        ...
        public DecodedInstruction decode(int i4, CodeInput codeInput) throws EOFException {
            int byte0 = InstructionCodec.byte0(i4);
            if (byte0 == 250) {
                int nibble2 = InstructionCodec.nibble2(i4);
                int nibble3 = InstructionCodec.nibble3(i4);
                int read = codeInput.read();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static int nibble0(int i4) {
        return i4 & 15;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static int nibble1(int i4) {
        return (i4 >> 4) & 15;
    }
