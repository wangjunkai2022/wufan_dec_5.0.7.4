...
public class StdAttributeFactory extends AttributeFactory {
    ...
    private Attribute bootstrapMethods(DirectClassFile directClassFile, int i4, int i5, ParseObserver parseObserver) {
        if (i5 < 2) {
        ...
        if (parseObserver != null) {
            parseObserver.parsed(bytes, i4, 2, "num_boostrap_methods: " + Hex.u2(unsignedShort));
        }
        return new AttBootstrapMethods(parseBootstrapMethods(bytes, directClassFile.getConstantPool(), directClassFile.getThisClass(), unsignedShort, i4 + 2, i5 - 2, parseObserver));
    }
    ...
    private Attribute lineNumberTable(DirectClassFile directClassFile, int i4, int i5, ParseObserver parseObserver) {
        ...
        for (int i8 = 0; i8 < unsignedShort; i8++) {
            ...
            if (parseObserver != null) {
                parseObserver.parsed(bytes, i6, 4, Hex.u2(unsignedShort2) + " " + unsignedShort3);
            }
            i6 += 4;
        }
    ...
    private BootstrapMethodsList parseBootstrapMethods(ByteArray byteArray, ConstantPool constantPool, CstType cstType, int i4, int i5, int i6, ParseObserver parseObserver) throws ParseException {
        BootstrapMethodsList bootstrapMethodsList = new BootstrapMethodsList(i4);
        int i7 = i5;
        int i8 = i6;
        for (int i9 = 0; i9 < i4; i9++) {
            ...
            int unsignedShort = byteArray.getUnsignedShort(i7);
            int i10 = i7 + 2;
            int unsignedShort2 = byteArray.getUnsignedShort(i10);
            if (parseObserver != null) {
                parseObserver.parsed(byteArray, i7, 2, "bootstrap_method_ref: " + Hex.u2(unsignedShort));
                parseObserver.parsed(byteArray, i10, 2, "num_bootstrap_arguments: " + Hex.u2(unsignedShort2));
            }
            i7 += 4;
            i8 -= 4;
            if (i8 < unsignedShort2 * 2) {
                throwTruncated();
            }
            BootstrapMethodArgumentsList bootstrapMethodArgumentsList = new BootstrapMethodArgumentsList(unsignedShort2);
            int i11 = 0;
            while (i11 < unsignedShort2) {
                int unsignedShort3 = byteArray.getUnsignedShort(i7);
                if (parseObserver != null) {
                    parseObserver.parsed(byteArray, i7, 2, "bootstrap_arguments[" + i11 + "]" + Hex.u2(unsignedShort3));
                }
                bootstrapMethodArgumentsList.set(i11, constantPool.get(unsignedShort3));
                i11++;
                i7 += 2;
                i8 -= 2;
            }
            bootstrapMethodArgumentsList.setImmutable();
            bootstrapMethodsList.set(i9, cstType, (CstMethodHandle) constantPool.get(unsignedShort), bootstrapMethodArgumentsList);
        }
    ...
    private LocalVariableList parseLocalVariables(ByteArray byteArray, ConstantPool constantPool, ParseObserver parseObserver, int i4, boolean z4) {
        CstString cstString;
        ...
        for (int i6 = 0; i6 < i4; i6++) {
            try {
                ...
                if (parseObserver != null) {
                    parseObserver.parsed(byteArray, i6 * 10, 10, Hex.u2(readUnsignedShort) + ".." + Hex.u2(readUnsignedShort + readUnsignedShort2) + " " + Hex.u2(readUnsignedShort5) + " " + cstString3.toHuman() + " " + cstString4.toHuman());
                }
    ...
    private Attribute sourceDebugExtension(DirectClassFile directClassFile, int i4, int i5, ParseObserver parseObserver) {
        ByteArray slice = directClassFile.getBytes().slice(i4, i4 + i5);
        ...
        if (parseObserver != null) {
            ...
            parseObserver.parsed(slice, i4, i5, "sourceDebugExtension: " + string);
        }
    ...
    public Attribute parse0(DirectClassFile directClassFile, int i4, String str, int i5, int i6, ParseObserver parseObserver) {
        if (i4 != 0) {
            ...
            return bootstrapMethods(directClassFile, i5, i6, parseObserver);
        } else {
            if (str == AttDeprecated.ATTRIBUTE_NAME) {
                return deprecated(directClassFile, i5, i6, parseObserver);
            }
            ...
            if (str == AttSourceDebugExtension.ATTRIBUTE_NAME) {
                return sourceDebugExtension(directClassFile, i5, i6, parseObserver);
            }
