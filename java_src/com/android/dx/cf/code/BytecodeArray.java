        ...
        try {
            ...
            switch (unsignedByte) {
                ...
                case 15:
                    ...
                    return 1;
                case 16:
                    int i5 = this.bytes.getByte(i4 + 1);
                    visitor2.visitConstant(18, i4, 2, CstInteger.make(i5), i5);
                    return 2;
                case 17:
                    int i6 = this.bytes.getShort(i4 + 1);
                    visitor2.visitConstant(18, i4, 3, CstInteger.make(i6), i6);
                    return 3;
                case 18:
                    Constant constant = this.pool.get(this.bytes.getUnsignedByte(i4 + 1));
                    visitor2.visitConstant(18, i4, 2, constant, constant instanceof CstInteger ? ((CstInteger) constant).getValue() : 0);
                    return 2;
                case 19:
                    Constant constant2 = this.pool.get(this.bytes.getUnsignedShort(i4 + 1));
                    visitor2.visitConstant(18, i4, 3, constant2, constant2 instanceof CstInteger ? ((CstInteger) constant2).getValue() : 0);
                    return 3;
                case 20:
                ...
                case 185:
                    ...
                    return 5;
                case 186:
                    visitor2.visitConstant(unsignedByte, i4, 5, (CstInvokeDynamic) this.pool.get(this.bytes.getUnsignedShort(i4 + 1)), 0);
                    return 5;
                case 188:
                ...
                case 197:
                    visitor2.visitConstant(unsignedByte, i4, 4, this.pool.get(this.bytes.getUnsignedShort(i4 + 1)), this.bytes.getUnsignedByte(i4 + 3));
                    return 4;
                case 200:
                case 201:
                    visitor2.visitBranch(unsignedByte == 200 ? 167 : 168, i4, 5, this.bytes.getInt(i4 + 1) + i4);
                    return 5;
                default:
            ...
            e5.addContext("...at bytecode offset " + Hex.u4(i4));
            throw e5;
