...
public class OneLocalsArray extends LocalsArray {
    ...
    public OneLocalsArray(int i4) {
        super(i4 != 0);
        this.locals = new TypeBearer[i4];
    }
    ...
    public TypeBearer get(int i4) {
        ...
        return typeBearer == null ? throwSimException(i4, "invalid") : typeBearer;
    }
    ...
    public TypeBearer getCategory1(int i4) {
        ...
        return type.isCategory2() ? throwSimException(i4, "category-2") : typeBearer;
    }

    @Override // com.android.dx.cf.code.LocalsArray
    public TypeBearer getCategory2(int i4) {
        TypeBearer typeBearer = get(i4);
        return typeBearer.getType().isCategory1() ? throwSimException(i4, "category-1") : typeBearer;
    }
