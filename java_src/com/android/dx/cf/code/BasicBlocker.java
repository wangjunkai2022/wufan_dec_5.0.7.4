...
public final class BasicBlocker implements BytecodeArray.Visitor {
    ...
    private void addWorkIfNecessary(int i4, boolean z4) {
        ...
        while (true) {
            ...
            if (Bits.get(this.liveSet, i4)) {
                ...
                if (intList == null) {
                    ...
                    byteCatchList = this.catchLists[i6];
    ...
    private void visitCommon(int i4, int i5, boolean z4) {
    ...
    private void visitThrowing(int i4, int i5, boolean z4) {
        int i6 = i5 + i4;
        if (z4) {
    ...
    public void visitNoArgs(int i4, int i5, int i6, Type type) {
        ...
        } else if (i4 != 172 && i4 != 177) {
            if (i4 != 190) {
                if (i4 == 191) {
                    visitCommon(i5, i6, false);
                    visitThrowing(i5, i6, false);
                    return;
                } else if (i4 != 194 && i4 != 195) {
                    switch (i4) {
                        case 46:
                        case 47:
                        case 48:
