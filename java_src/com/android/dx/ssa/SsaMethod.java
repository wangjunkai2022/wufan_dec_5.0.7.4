...
public final class SsaMethod {
    ...
    private SsaMethod(RopMethod ropMethod, int i4, boolean z4) {
        this.paramWidth = i4;
        this.isStatic = z4;
    ...
    public static SsaMethod newFromRopMethod(RopMethod ropMethod, int i4, boolean z4) {
        SsaMethod ssaMethod = new SsaMethod(ropMethod, i4, z4);
