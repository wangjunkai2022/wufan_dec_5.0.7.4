...
public final class PhiInsn extends SsaInsn {
    ...
    public boolean areAllOperandsEqual() {
        ...
        Iterator<Operand> it2 = this.operands.iterator();
        while (it2.hasNext()) {
            if (reg != it2.next().regSpec.getReg()) {
                return false;
            }
        }
        return true;
    ...
    protected final String toHumanWithInline(String str) {
        ...
        if (size == 0) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                sb.append(" ");
                sb.append(this.sources.get(i4).toHuman() + "[b=" + Hex.u2(this.operands.get(i4).ropLabel) + "]");
            }
        }
        return sb.toString();
    }
