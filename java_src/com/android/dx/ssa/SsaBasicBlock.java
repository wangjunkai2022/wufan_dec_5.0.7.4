    ...
    private void scheduleUseBeforeAssigned(List<SsaInsn> list) {
        ...
        while (i4 < size) {
            ...
            if (i4 == i7) {
                ...
                list.set(i4, new NormalSsaInsn(new PlainInsn(Rops.opMove(result.getType()), sourcePosition, result, RegisterSpecList.make(withReg)), this));
                size = list.size();
            } else {
                i4 = i7;
            }
