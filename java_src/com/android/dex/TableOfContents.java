...
public final class TableOfContents {
    ...
    public TableOfContents() {
        ...
        Section section17 = new Section(q.a.f63907t);
        this.debugInfos = section17;
        Section section18 = new Section(q.a.f63908u);
        this.annotations = section18;
        Section section19 = new Section(q.a.f63909v);
    ...
    private Section getSection(short s4) {
        Section[] sectionArr;
