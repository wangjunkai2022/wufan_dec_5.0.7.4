...
public final class Dex {
    ...
    private final class ClassDefIterator implements Iterator<ClassDef> {
        ...
        private final Section f5058in;

        private ClassDefIterator() {
            this.f5058in = Dex.this.open(Dex.this.tableOfContents.classDefs.off);
            this.count = 0;
        }
        ...
        public ClassDef next() {
            if (hasNext()) {
                this.count++;
                return this.f5058in.readClassDef();
            }
    ...
    public final class Section implements ByteInput, ByteOutput {
        ...
        private Code.CatchHandler readCatchHandler(int i4) {
            ...
            for (int i5 = 0; i5 < abs; i5++) {
                iArr[i5] = readUleb128();
                iArr2[i5] = readUleb128();
            }
            return new Code.CatchHandler(iArr, iArr2, readSleb128 <= 0 ? readUleb128() : -1, i4);
        }
