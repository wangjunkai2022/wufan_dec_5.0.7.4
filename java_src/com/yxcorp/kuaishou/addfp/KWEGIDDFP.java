...
public class KWEGIDDFP {
    ...
    private void getEGidImpl(boolean z4) {
        Object obj;
        try {
            Pair a5 = d.a(this.mParamContext).a();
            ...
            if (TextUtils.isEmpty(this.mEgid)) {
                String a6 = Build.VERSION.SDK_INT < 29 ? com.yxcorp.kuaishou.addfp.c.a.a.a(this.mParamContext, "k_w_o_d_out_dtt") : null;
                String a7 = (TextUtils.isEmpty(a6) && !d.a(this.mParamContext).b() && g.a(this.mParamContext, new String[]{com.kuaishou.weapon.p0.g.f55589i, com.kuaishou.weapon.p0.g.f55590j})) ? d.a(this.mParamContext).a("Lm91a2R0ZnQ=") : "";
                if (TextUtils.isEmpty(a6) && TextUtils.isEmpty(a7)) {
                    return;
                }
                LinkedHashMap b5 = d.a(this.mParamContext).b(a6);
                if (b5 == null || b5.size() == 0) {
                    b5 = d.a(this.mParamContext).b(a7);
                }
                if (b5 == null || b5.size() <= 0) {
                    return;
                }
                String str2 = (String) b5.get(c.c().a());
    ...
    public void getEGidByCallback(Context context, boolean z4, ResponseDfpCallback responseDfpCallback) {
        try {
            ...
            String a5 = g.a(th);
            if (responseDfpCallback != null) {
                responseDfpCallback.onFailed(-1, a5);
            }
        }
    }

    public String getEGidLocal(Context context, String str, boolean z4) {
        if (TextUtils.isEmpty(this.mEgid)) {
            return null;
        }
        return this.mEgid;
