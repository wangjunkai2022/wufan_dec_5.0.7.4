...
public final class ByteSourceJsonBootstrapper {
    ...
    private boolean checkUTF16(int i4) {
        if ((65280 & i4) == 0) {
            this._bigEndian = true;
        } else if ((i4 & 255) != 0) {
            return false;
    ...
    private boolean checkUTF32(int i4) throws IOException {
        if ((i4 >> 8) == 0) {
            this._bigEndian = true;
    ...
    private boolean handleBOM(int i4) throws IOException {
        if (i4 == -16842752) {
            reportWeirdUCS4("3412");
        } else if (i4 == -131072) {
            this._inputPtr += 4;
    ...
    public JsonParser constructParser(int i4, ObjectCodec objectCodec, ByteQuadsCanonicalizer byteQuadsCanonicalizer, CharsToNameCanonicalizer charsToNameCanonicalizer, int i5) throws IOException {
        ...
        if (detectEncoding == JsonEncoding.UTF8 && JsonFactory.Feature.CANONICALIZE_FIELD_NAMES.enabledIn(i5)) {
            return new UTF8StreamJsonParser(this._context, i4, this._in, objectCodec, byteQuadsCanonicalizer.makeChild(i5), this._inputBuffer, this._inputPtr, this._inputEnd, i7, this._bufferRecyclable);
        }
        return new ReaderBasedJsonParser(this._context, i4, constructReader(), objectCodec, charsToNameCanonicalizer.makeChild(i5));
    }
    ...
    */
    ...
    protected boolean ensureLoaded(int i4) throws IOException {
        int read;
