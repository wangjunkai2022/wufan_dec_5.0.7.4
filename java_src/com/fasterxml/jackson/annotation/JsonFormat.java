...
public @interface JsonFormat {
    ...
    public static class Features {
        ...
        private Features(int i4, int i5) {
            this._enabled = i4;
            this._disabled = i5;
        }
        ...
        public Features with(Feature... featureArr) {
            ...
            return i4 == this._enabled ? this : new Features(i4, this._disabled);
        }
        ...
        public Features withOverrides(Features features) {
            ...
            int i4 = features._disabled;
            int i5 = features._enabled;
            if (i4 == 0 && i5 == 0) {
                return this;
            }
            int i6 = this._enabled;
            if (i6 == 0 && this._disabled == 0) {
                return features;
            }
            int i7 = ((i4 ^ (-1)) & i6) | i5;
            int i8 = this._disabled;
            int i9 = i4 | ((i5 ^ (-1)) & i8);
            return (i7 == i6 && i9 == i8) ? this : new Features(i7, i9);
        }

        public Features without(Feature... featureArr) {
            int i4 = this._disabled;
            for (Feature feature : featureArr) {
                i4 |= 1 << feature.ordinal();
            }
            return i4 == this._disabled ? this : new Features(this._enabled, i4);
        }
    ...
    public static class Value implements JacksonAnnotationValue<JsonFormat>, Serializable {
        ...
        private static <T> boolean _equal(T t4, T t5) {
            if (t4 == null) {
                return t5 == null;
            } else if (t5 == null) {
                return false;
        ...
        public static Value forLeniency(boolean z4) {
            return new Value("", null, null, null, null, Features.empty(), Boolean.valueOf(z4));
        }
