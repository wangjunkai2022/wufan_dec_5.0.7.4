...
public abstract class DeserializationContext extends DatabindContext implements Serializable {
    ...
    public String extractScalarFromObject(JsonParser jsonParser, JsonDeserializer<?> jsonDeserializer, Class<?> cls) throws IOException {
        return (String) reportInputMismatch(cls, String.format("Cannot deserialize value of type %s from %s (token `JsonToken.START_OBJECT`)", ClassUtil.getClassDescription(cls), _shapeForToken(JsonToken.START_OBJECT)), new Object[0]);
    }
    ...
    public Date parseDate(String str) throws IllegalArgumentException {
        try {
            ...
            throw new IllegalArgumentException(String.format("Failed to parse Date value '%s': %s", str, ClassUtil.exceptionMessage(e5)));
        }
    }
