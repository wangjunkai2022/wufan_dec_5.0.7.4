...
public class PropertyMetadata implements Serializable {
    ...
    @Deprecated
    public static PropertyMetadata construct(boolean z4, String str, Integer num, String str2) {
        if (str == null && num == null && str2 == null) {
            return z4 ? STD_REQUIRED : STD_OPTIONAL;
        }
        return new PropertyMetadata(Boolean.valueOf(z4), str, num, str2, null, null, null);
    }
}
