...
public abstract class TypeDeserializerBase extends TypeDeserializer implements Serializable {
    ...
    public TypeDeserializerBase(JavaType javaType, TypeIdResolver typeIdResolver, String str, boolean z4, JavaType javaType2) {
            ...
            if (typeFromId == null) {
                ...
                if (javaType != null && javaType.getClass() == typeFromId.getClass() && !typeFromId.hasGenericTypes()) {
                    try {
                        ...
                        throw deserializationContext.invalidTypeIdException(this._baseType, str, e5.getMessage());
                    }
                }
