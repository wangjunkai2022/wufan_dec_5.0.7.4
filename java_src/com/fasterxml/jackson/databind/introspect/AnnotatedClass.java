...
public final class AnnotatedClass extends Annotated implements TypeResolutionContext {
    ...
    public AnnotatedClass(JavaType javaType, Class<?> cls, List<JavaType> list, Class<?> cls2, Annotations annotations, TypeBindings typeBindings, AnnotationIntrospector annotationIntrospector, ClassIntrospector.MixInResolver mixInResolver, TypeFactory typeFactory, boolean z4) {
        this._type = javaType;
        this._class = cls;
