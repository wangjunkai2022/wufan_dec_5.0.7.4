...
public class AnnotationIntrospectorPair extends AnnotationIntrospector implements Serializable {
    ...
    @Override // com.fasterxml.jackson.databind.AnnotationIntrospector
    @Deprecated
    public String[] findPropertiesToIgnore(Annotated annotated, boolean z4) {
        String[] findPropertiesToIgnore = this._primary.findPropertiesToIgnore(annotated, z4);
        return findPropertiesToIgnore == null ? this._secondary.findPropertiesToIgnore(annotated, z4) : findPropertiesToIgnore;
    }
