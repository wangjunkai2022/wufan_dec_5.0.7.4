...
public class ObjectIdInfo {
    ...
    public ObjectIdInfo withAlwaysAsId(boolean z4) {
        return this._alwaysAsId == z4 ? this : new ObjectIdInfo(this._propertyName, this._scope, this._generator, z4, this._resolver);
    }

    protected ObjectIdInfo(PropertyName propertyName, Class<?> cls, Class<? extends ObjectIdGenerator<?>> cls2, boolean z4) {
        this(propertyName, cls, cls2, z4, SimpleObjectIdResolver.class);
    }
