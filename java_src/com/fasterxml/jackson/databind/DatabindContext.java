...
public abstract class DatabindContext {
    ...
    private JavaType _resolveAndValidateGeneric(JavaType javaType, String str, PolymorphicTypeValidator polymorphicTypeValidator, int i4) throws JsonMappingException {
    ...
    public JavaType resolveAndValidateSubType(JavaType javaType, String str, PolymorphicTypeValidator polymorphicTypeValidator) throws JsonMappingException {
        ...
        try {
            ...
            throw invalidTypeIdException(javaType, str, String.format("problem: (%s) %s", e5.getClass().getName(), ClassUtil.exceptionMessage(e5)));
        }
    }
