...
public class PropertyBuilder {
    ...
    protected BeanPropertyWriter _constructPropertyWriter(BeanPropertyDefinition beanPropertyDefinition, AnnotatedMember annotatedMember, Annotations annotations, JavaType javaType, JsonSerializer<?> jsonSerializer, TypeSerializer typeSerializer, JavaType javaType2, boolean z4, Object obj, Class<?>[] clsArr) throws JsonMappingException {
        return new BeanPropertyWriter(beanPropertyDefinition, annotatedMember, annotations, javaType, jsonSerializer, typeSerializer, javaType2, z4, obj, clsArr);
    }
    ...
    */
    ...
    public BeanPropertyWriter buildWriter(SerializerProvider serializerProvider, BeanPropertyDefinition beanPropertyDefinition, JavaType javaType, JsonSerializer<?> jsonSerializer, TypeSerializer typeSerializer, TypeSerializer typeSerializer2, AnnotatedMember annotatedMember, boolean z4) throws JsonMappingException {
        JavaType javaType2;
        ...
        boolean z5;
        try {
            JavaType findSerializationType = findSerializationType(annotatedMember, z4, javaType);
            ...
            int i4 = AnonymousClass1.$SwitchMap$com$fasterxml$jackson$annotation$JsonInclude$Include[valueInclusion.ordinal()];
            if (i4 != 1) {
                if (i4 == 2) {
                ...
                if (this._useRealPropertyDefaults && (defaultBean = getDefaultBean()) != null) {
                    ...
                    try {
                        ...
                        _throwWrapped(e5, beanPropertyDefinition.getName(), defaultBean);
                    }
                } else {
            ...
            BeanPropertyWriter _constructPropertyWriter = _constructPropertyWriter(beanPropertyDefinition, annotatedMember, this._beanDesc.getClassAnnotations(), javaType, jsonSerializer, typeSerializer, javaType2, z5, obj, findViews);
            ...
            if (beanPropertyDefinition == null) {
                return (BeanPropertyWriter) serializerProvider.reportBadDefinition(javaType, ClassUtil.exceptionMessage(e6));
            }
            return (BeanPropertyWriter) serializerProvider.reportBadPropertyDefinition(this._beanDesc, beanPropertyDefinition, ClassUtil.exceptionMessage(e6), new Object[0]);
        }
    }

    protected JavaType findSerializationType(Annotated annotated, boolean z4, JavaType javaType) throws JsonMappingException {
        ...
        if (findSerializationTyping != null && findSerializationTyping != JsonSerialize.Typing.DEFAULT_TYPING) {
            z4 = findSerializationTyping == JsonSerialize.Typing.STATIC;
        }
        if (z4) {
    ...
    protected Object getPropertyDefaultValue(String str, AnnotatedMember annotatedMember, JavaType javaType) {
        ...
        try {
            ...
            return _throwWrapped(e5, str, defaultBean);
        }
    }
}
