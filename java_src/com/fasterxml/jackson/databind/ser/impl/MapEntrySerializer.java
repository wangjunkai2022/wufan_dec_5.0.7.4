...
public class MapEntrySerializer extends ContainerSerializer<Map.Entry<?, ?>> implements ContextualSerializer {
    ...
    public JsonSerializer<?> createContextual(SerializerProvider serializerProvider, BeanProperty beanProperty) throws JsonMappingException {
        ...
        if (beanProperty == null || (findPropertyInclusion = beanProperty.findPropertyInclusion(serializerProvider.getConfig(), null)) == null || (contentInclusion = findPropertyInclusion.getContentInclusion()) == JsonInclude.Include.USE_DEFAULTS) {
            ...
            if (i4 == 1) {
                ...
                if (i4 == 3) {
                    ...
                    if (obj2 != null) {
                        z4 = serializerProvider.includeFilterSuppressNulls(obj2);
                        obj = obj2;
                    }
                } else if (i4 != 5) {
                    obj = null;
        ...
        return withResolved(beanProperty, jsonSerializer4, jsonSerializer3, obj, z4);
    }
    ...
    public MapEntrySerializer withContentInclusion(Object obj, boolean z4) {
        return (this._suppressableValue == obj && this._suppressNulls == z4) ? this : new MapEntrySerializer(this, this._property, this._valueTypeSerializer, this._keySerializer, this._valueSerializer, obj, z4);
    }
    ...
    public MapEntrySerializer withResolved(BeanProperty beanProperty, JsonSerializer<?> jsonSerializer, JsonSerializer<?> jsonSerializer2, Object obj, boolean z4) {
        return new MapEntrySerializer(this, beanProperty, this._valueTypeSerializer, jsonSerializer, jsonSerializer2, obj, z4);
    }
