...
public final class IndexedStringListSerializer extends StaticListSerializerBase<List<String>> {
    ...
    private final void serializeContents(List<String> list, JsonGenerator jsonGenerator, SerializerProvider serializerProvider, int i4) throws IOException {
        for (int i5 = 0; i5 < i4; i5++) {
            try {
                ...
                wrapAndThrow(serializerProvider, e5, list, i5);
                return;
            }
        }
    }
