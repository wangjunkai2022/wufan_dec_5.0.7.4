...
public class BeanAsArraySerializer extends BeanSerializerBase {
    ...
    protected final void serializeAsArray(Object obj, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        ...
        try {
            ...
            JsonMappingException from = JsonMappingException.from(jsonGenerator, "Infinite recursion (StackOverflowError)", e6);
            from.prependPath(new JsonMappingException.Reference(obj, i4 != beanPropertyWriterArr.length ? beanPropertyWriterArr[i4].getName() : "[anySetter]"));
            throw from;
        }
    }
