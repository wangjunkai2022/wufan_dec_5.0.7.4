...
public class AtomicReferenceSerializer extends ReferenceTypeSerializer<AtomicReference<?>> {
    ...
    public AtomicReferenceSerializer(ReferenceType referenceType, boolean z4, TypeSerializer typeSerializer, JsonSerializer<Object> jsonSerializer) {
        super(referenceType, z4, typeSerializer, jsonSerializer);
    }
    ...
    protected AtomicReferenceSerializer(AtomicReferenceSerializer atomicReferenceSerializer, BeanProperty beanProperty, TypeSerializer typeSerializer, JsonSerializer<?> jsonSerializer, NameTransformer nameTransformer, Object obj, boolean z4) {
        super(atomicReferenceSerializer, beanProperty, typeSerializer, jsonSerializer, nameTransformer, obj, z4);
    }
