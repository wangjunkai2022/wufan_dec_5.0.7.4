...
public abstract class BeanSerializerBase extends StdSerializer<Object> implements ContextualSerializer, ResolvableSerializer, JsonFormatVisitable, SchemaAware {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public final void _serializeWithObjectId(Object obj, JsonGenerator jsonGenerator, SerializerProvider serializerProvider, boolean z4) throws IOException {
        ObjectIdWriter objectIdWriter = this._objectIdWriter;
    ...
    public void acceptJsonFormatVisitor(JsonFormatVisitorWrapper jsonFormatVisitorWrapper, JavaType javaType) throws JsonMappingException {
        ...
        if (this._propertyFilterId != null) {
            ...
            while (i4 < length) {
                findPropertyFilter.depositSchemaProperty(this._props[i4], expectObjectFormat, provider);
                i4++;
            }
            return;
        }
        ...
        if (findFormatOverrides == null || !findFormatOverrides.hasShape()) {
            ...
            if (shape != JsonFormat.Shape.ANY && shape != this._serializationShape) {
                if (this._beanType.isEnumType()) {
                    int i6 = AnonymousClass1.$SwitchMap$com$fasterxml$jackson$annotation$JsonFormat$Shape[shape.ordinal()];
                    if (i6 == 1 || i6 == 2 || i6 == 3) {
    ...
    public void serializeFields(Object obj, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        ...
        try {
            ...
            wrapAndThrow(serializerProvider, e5, obj, i4 != beanPropertyWriterArr.length ? beanPropertyWriterArr[i4].getName() : "[anySetter]");
            ...
            jsonMappingException.prependPath(new JsonMappingException.Reference(obj, i4 != beanPropertyWriterArr.length ? beanPropertyWriterArr[i4].getName() : "[anySetter]"));
