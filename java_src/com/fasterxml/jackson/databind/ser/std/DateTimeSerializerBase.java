...
public abstract class DateTimeSerializerBase<T> extends StdScalarSerializer<T> implements ContextualSerializer {
    ...
    protected void _acceptJsonFormatVisitor(JsonFormatVisitorWrapper jsonFormatVisitorWrapper, JavaType javaType, boolean z4) throws JsonMappingException {
        if (z4) {
    ...
    protected abstract long _timestamp(T t4);
