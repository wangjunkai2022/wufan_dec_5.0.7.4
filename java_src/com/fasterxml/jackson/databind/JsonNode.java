...
public abstract class JsonNode extends JsonSerializable.Base implements TreeNode, Iterable<JsonNode> {
    ...
    public final boolean isValueNode() {
        int i4 = AnonymousClass1.$SwitchMap$com$fasterxml$jackson$databind$node$JsonNodeType[getNodeType().ordinal()];
    ...
    @Override // com.fasterxml.jackson.core.TreeNode
    public abstract JsonNode path(int i4);
    ...
    public JsonNode required(int i4) throws IllegalArgumentException {
