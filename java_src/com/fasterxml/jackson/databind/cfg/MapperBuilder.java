...
public abstract class MapperBuilder<M extends ObjectMapper, B extends MapperBuilder<M, B>> {
    ...
    public B configure(MapperFeature mapperFeature, boolean z4) {
        this._mapper.configure(mapperFeature, z4);
        return _this();
    }
    ...
    public B configure(SerializationFeature serializationFeature, boolean z4) {
        this._mapper.configure(serializationFeature, z4);
        return _this();
    }
    ...
    public B configure(DeserializationFeature deserializationFeature, boolean z4) {
        this._mapper.configure(deserializationFeature, z4);
        return _this();
    }
    ...
    public B configure(JsonParser.Feature feature, boolean z4) {
        this._mapper.configure(feature, z4);
        return _this();
    }

    public B configure(JsonGenerator.Feature feature, boolean z4) {
        this._mapper.configure(feature, z4);
        return _this();
    }
    ...
    public B configure(StreamReadFeature streamReadFeature, boolean z4) {
        this._mapper.configure(streamReadFeature.mappedFeature(), z4);
        return _this();
    }
    ...
    public B configure(StreamWriteFeature streamWriteFeature, boolean z4) {
        this._mapper.configure(streamWriteFeature.mappedFeature(), z4);
        return _this();
    }
