...
public abstract class MapperConfigBase<CFG extends ConfigFeature, T extends MapperConfigBase<CFG, T>> extends MapperConfig<T> implements Serializable {
    ...
    protected abstract T _withMapperFeatures(int i4);
    ...
    public final VisibilityChecker<?> getDefaultVisibilityChecker() {
        ...
        int i4 = this._mapperFeatures;
        int i5 = AUTO_DETECT_MASK;
        if ((i4 & i5) != i5) {
    ...
    public final T without(MapperFeature... mapperFeatureArr) {
        ...
        for (MapperFeature mapperFeature : mapperFeatureArr) {
            i4 &= mapperFeature.getMask() ^ (-1);
        }
        return i4 == this._mapperFeatures ? this : _withMapperFeatures(i4);
    }
    ...
    public final T with(MapperFeature... mapperFeatureArr) {
        int i4 = this._mapperFeatures;
        for (MapperFeature mapperFeature : mapperFeatureArr) {
            i4 |= mapperFeature.getMask();
        }
        return i4 == this._mapperFeatures ? this : _withMapperFeatures(i4);
    }

    @Override // com.fasterxml.jackson.databind.cfg.MapperConfig
    public final T with(MapperFeature mapperFeature, boolean z4) {
        int mask;
        if (z4) {
            mask = mapperFeature.getMask() | this._mapperFeatures;
        } else {
            mask = (mapperFeature.getMask() ^ (-1)) & this._mapperFeatures;
        }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public MapperConfigBase(MapperConfigBase<CFG, T> mapperConfigBase, int i4) {
        super(mapperConfigBase, i4);
        this._mixIns = mapperConfigBase._mixIns;
        this._subtypeResolver = mapperConfigBase._subtypeResolver;
        this._rootNames = mapperConfigBase._rootNames;
        this._rootName = mapperConfigBase._rootName;
