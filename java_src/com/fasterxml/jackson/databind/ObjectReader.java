...
public class ObjectReader extends ObjectCodec implements Versioned, Serializable {
    ...
    protected JsonParser _considerFilter(JsonParser jsonParser, boolean z4) {
        return (this._filter == null || FilteringParserDelegate.class.isInstance(jsonParser)) ? jsonParser : new FilteringParserDelegate(jsonParser, this._filter, TokenFilter.Inclusion.ONLY_INCLUDE_ALL, z4);
    }

    protected Object _detectBindAndClose(byte[] bArr, int i4, int i5) throws IOException {
        DataFormatReaders.Match findFormat = this._dataFormatReaders.findFormat(bArr, i4, i5);
    ...
    protected <T> MappingIterator<T> _detectBindAndReadValues(DataFormatReaders.Match match, boolean z4) throws IOException {
        if (!match.hasMatch()) {
    ...
    protected <T> MappingIterator<T> _newIterator(JsonParser jsonParser, DeserializationContext deserializationContext, JsonDeserializer<?> jsonDeserializer, boolean z4) {
        return new MappingIterator<>(this._valueType, jsonParser, deserializationContext, jsonDeserializer, z4, this._valueToUpdate);
    }
    ...
    protected Object _detectBindAndClose(DataFormatReaders.Match match, boolean z4) throws IOException {
        if (!match.hasMatch()) {
            _reportUnkownFormat(this._dataFormatReaders, match);
        }
        JsonParser createParserWithMatch = match.createParserWithMatch();
    ...
    public JsonParser createParser(byte[] bArr, int i4, int i5) throws IOException {
        _assertNotNull("content", bArr);
        return this._config.initialize(this._parserFactory.createParser(bArr, i4, i5), this._schema);
    }
    ...
    public JsonParser createParser(char[] cArr, int i4, int i5) throws IOException {
        _assertNotNull("content", cArr);
        return this._config.initialize(this._parserFactory.createParser(cArr, i4, i5), this._schema);
    }
    ...
    public JsonNode readTree(byte[] bArr, int i4, int i5) throws IOException {
        ...
        return _bindAndCloseAsTree(_considerFilter(createParser(bArr, i4, i5), false));
    }
    ...
    public <T> T readValue(byte[] bArr, int i4, int i5) throws IOException {
        if (this._dataFormatReaders != null) {
            return (T) _detectBindAndClose(bArr, i4, i5);
        }
        return (T) _bindAndClose(_considerFilter(createParser(bArr, i4, i5), false));
    }

    public <T> MappingIterator<T> readValues(byte[] bArr, int i4, int i5) throws IOException {
        DataFormatReaders dataFormatReaders = this._dataFormatReaders;
        if (dataFormatReaders != null) {
            return _detectBindAndReadValues(dataFormatReaders.findFormat(bArr, i4, i5), false);
        }
        return _bindAndReadValues(_considerFilter(createParser(bArr, i4, i5), true));
    }

    public <T> T readValue(byte[] bArr, int i4, int i5, Class<T> cls) throws IOException {
        return (T) forType((Class<?>) cls).readValue(bArr, i4, i5);
    }
