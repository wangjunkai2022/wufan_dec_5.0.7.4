...
public abstract class BasicDeserializerFactory extends DeserializerFactory implements Serializable {
            ...
            if (visibilityChecker.isCreatorVisible(next)) {
                ...
                while (true) {
                    if (i5 < parameterCount) {
                        AnnotatedParameter parameter = next.getParameter(i5);
                        PropertyName _findParamName = _findParamName(parameter, annotationIntrospector);
                        if (_findParamName != null && !_findParamName.isEmpty()) {
                            settableBeanPropertyArr2[i5] = constructCreatorProperty(deserializationContext, beanDescription, _findParamName, parameter.getIndex(), parameter, null);
                            i5++;
                        }
    ...
    protected void _addExplicitConstructorCreators(DeserializationContext deserializationContext, CreatorCollectionState creatorCollectionState, boolean z4) throws JsonMappingException {
        ...
        for (AnnotatedConstructor annotatedConstructor : beanDescription.getConstructors()) {
            ...
            if (JsonCreator.Mode.DISABLED != findCreatorAnnotation) {
                if (findCreatorAnnotation == null) {
                    if (z4 && visibilityChecker.isCreatorVisible(annotatedConstructor)) {
                    ...
                    int i4 = AnonymousClass1.$SwitchMap$com$fasterxml$jackson$annotation$JsonCreator$Mode[findCreatorAnnotation.ordinal()];
                    if (i4 == 1) {
    ...
    protected void _addExplicitDelegatingCreator(DeserializationContext deserializationContext, BeanDescription beanDescription, CreatorCollector creatorCollector, CreatorCandidate creatorCandidate) throws JsonMappingException {
        ...
        for (int i5 = 0; i5 < paramCount; i5++) {
            ...
            if (injection != null) {
                settableBeanPropertyArr[i5] = constructCreatorProperty(deserializationContext, beanDescription, null, i5, parameter, injection);
            } else if (i4 < 0) {
                i4 = i5;
            } else {
                deserializationContext.reportBadTypeDefinition(beanDescription, "More than one argument (#%d and #%d) left as delegating for Creator %s: only one allowed", Integer.valueOf(i4), Integer.valueOf(i5), creatorCandidate);
            }
        }
        if (i4 < 0) {
        ...
        creatorCollector.addDelegatingCreator(creatorCandidate.creator(), true, settableBeanPropertyArr, i4);
    }

    protected void _addExplicitFactoryCreators(DeserializationContext deserializationContext, CreatorCollectionState creatorCollectionState, boolean z4) throws JsonMappingException {
        BeanDescription beanDescription = creatorCollectionState.beanDesc;
        CreatorCollector creatorCollector = creatorCollectionState.creators;
        AnnotationIntrospector annotationIntrospector = creatorCollectionState.annotationIntrospector();
        VisibilityChecker<?> visibilityChecker = creatorCollectionState.vchecker;
        ...
        for (AnnotatedMethod annotatedMethod : beanDescription.getFactoryMethods()) {
            ...
            if (findCreatorAnnotation == null) {
                if (z4 && parameterCount == 1 && visibilityChecker.isCreatorVisible(annotatedMethod)) {
    ...
    protected void _addExplicitPropertyCreator(DeserializationContext deserializationContext, BeanDescription beanDescription, CreatorCollector creatorCollector, CreatorCandidate creatorCandidate) throws JsonMappingException {
        ...
        for (int i4 = 0; i4 < paramCount; i4++) {
            JacksonInject.Value injection = creatorCandidate.injection(i4);
            AnnotatedParameter parameter = creatorCandidate.parameter(i4);
            PropertyName paramName = creatorCandidate.paramName(i4);
            if (paramName == null) {
                ...
                paramName = creatorCandidate.findImplicitParamName(i4);
                if (paramName == null && injection == null) {
                    deserializationContext.reportBadTypeDefinition(beanDescription, "Argument #%d has no property name, is not Injectable: can not use as Creator %s", Integer.valueOf(i4), creatorCandidate);
                }
            }
            settableBeanPropertyArr[i4] = constructCreatorProperty(deserializationContext, beanDescription, paramName, i4, parameter, injection);
        }
    ...
    protected void _addImplicitConstructorCreators(DeserializationContext deserializationContext, CreatorCollectionState creatorCollectionState, List<CreatorCandidate> list) throws JsonMappingException {
        ...
        while (it4.hasNext()) {
            ...
            if (paramCount == 1) {
                ...
                z4 = singleArgCreatorDefaultsToProperties;
                it2 = it4;
            } else {
                ...
                while (i7 < paramCount) {
                    ...
                    BeanPropertyDefinition propertyDef2 = next.propertyDef(i7);
                ...
                if (i9 > 0 || i10 > 0) {
                    if (i13 + i10 == i12) {
                        ...
                        PropertyName findImplicitParamName = creatorCandidate2.findImplicitParamName(i11);
                        if (findImplicitParamName == null || findImplicitParamName.isEmpty()) {
                            deserializationContext.reportBadTypeDefinition(beanDescription, "Argument #%d of constructor %s has no property name annotation; must have name when multiple-parameter constructor annotated as Creator", Integer.valueOf(i11), annotatedWithParams2);
                        }
                    }
                }
            ...
            singleArgCreatorDefaultsToProperties = z4;
            it4 = it2;
    ...
    protected void _addRecordConstructor(DeserializationContext deserializationContext, CreatorCollectionState creatorCollectionState, AnnotatedConstructor annotatedConstructor, List<String> list) throws JsonMappingException {
        ...
        for (int i4 = 0; i4 < parameterCount; i4++) {
            ...
            settableBeanPropertyArr[i4] = constructCreatorProperty(deserializationContext, creatorCollectionState.beanDesc, findNameForDeserialization, i4, parameter, findInjectableValue);
        }
    ...
    protected ValueInstantiator _constructDefaultValueInstantiator(DeserializationContext deserializationContext, BeanDescription beanDescription) throws JsonMappingException {
        ...
        if (beanDescription.getType().isConcrete()) {
            if (beanDescription.getType().isRecordType() && (findRecordConstructor = JDK14Util.findRecordConstructor(deserializationContext, beanDescription, (arrayList = new ArrayList()))) != null) {
                ...
                if (creatorCollectionState.hasImplicitConstructorCandidates() && !creatorCollectionState.hasExplicitFactories() && !creatorCollectionState.hasExplicitConstructors()) {
    ...
    protected boolean _handleSingleArgumentCreator(CreatorCollector creatorCollector, AnnotatedWithParams annotatedWithParams, boolean z4, boolean z5) {
        Class<?> rawParameterType = annotatedWithParams.getRawParameterType(0);
        if (rawParameterType == String.class || rawParameterType == CLASS_CHAR_SEQUENCE) {
            if (z4 || z5) {
                creatorCollector.addStringCreator(annotatedWithParams, z4);
            }
            return true;
        } else if (rawParameterType == Integer.TYPE || rawParameterType == Integer.class) {
            if (z4 || z5) {
                creatorCollector.addIntCreator(annotatedWithParams, z4);
            }
            return true;
        } else if (rawParameterType == Long.TYPE || rawParameterType == Long.class) {
            if (z4 || z5) {
                creatorCollector.addLongCreator(annotatedWithParams, z4);
            }
            return true;
        } else if (rawParameterType == Double.TYPE || rawParameterType == Double.class) {
            if (z4 || z5) {
                creatorCollector.addDoubleCreator(annotatedWithParams, z4);
            }
            return true;
        } else if (rawParameterType == Boolean.TYPE || rawParameterType == Boolean.class) {
            if (z4 || z5) {
                creatorCollector.addBooleanCreator(annotatedWithParams, z4);
            }
            return true;
        } else {
            if (rawParameterType == BigInteger.class && (z4 || z5)) {
                creatorCollector.addBigIntegerCreator(annotatedWithParams, z4);
            }
            if (rawParameterType == BigDecimal.class && (z4 || z5)) {
                creatorCollector.addBigDecimalCreator(annotatedWithParams, z4);
            }
            if (z4) {
                creatorCollector.addDelegatingCreator(annotatedWithParams, z4, null, 0);
                return true;
            }
            return false;
        }
    ...
    protected SettableBeanProperty constructCreatorProperty(DeserializationContext deserializationContext, BeanDescription beanDescription, PropertyName propertyName, int i4, AnnotatedParameter annotatedParameter, JacksonInject.Value value) throws JsonMappingException {
        ...
        CreatorProperty construct2 = CreatorProperty.construct(propertyName, resolveMemberAndTypeAnnotations, std.getWrapperName(), typeDeserializer, beanDescription.getClassAnnotations(), annotatedParameter, i4, value, _getSetterInfo(deserializationContext, std, propertyMetadata));
    ...
    public KeyDeserializer createKeyDeserializer(DeserializationContext deserializationContext, JavaType javaType) throws JsonMappingException {
        ...
        if (this._factoryConfig.hasKeyDeserializers()) {
            ...
            while (it2.hasNext() && (keyDeserializer = it2.next().findKeyDeserializer(javaType, config, beanDescription)) == null) {
            }
        } else {
    ...
    */
    ...
    protected void _addExplicitAnyCreator(DeserializationContext deserializationContext, BeanDescription beanDescription, CreatorCollector creatorCollector, CreatorCandidate creatorCandidate, ConstructorDetector constructorDetector) throws JsonMappingException {
        ...
        int i4 = AnonymousClass1.$SwitchMap$com$fasterxml$jackson$databind$cfg$ConstructorDetector$SingleArgConstructor[constructorDetector.singleArgMode().ordinal()];
        if (i4 == 1) {
            propertyName = null;
            z4 = false;
        } else if (i4 == 2) {
            ...
            z4 = (explicitParamName == null && injection == null) ? false : true;
            if (!z4 && propertyDef != null) {
                explicitParamName = creatorCandidate.paramName(0);
                z4 = explicitParamName != null && propertyDef.couldSerialize();
            }
