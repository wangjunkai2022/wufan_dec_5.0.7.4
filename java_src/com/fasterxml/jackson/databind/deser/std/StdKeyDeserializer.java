...
public class StdKeyDeserializer extends KeyDeserializer implements Serializable {
    ...
    static final class DelegatingKD extends KeyDeserializer implements Serializable {
        ...
        public final Object deserializeKey(String str, DeserializationContext deserializationContext) throws IOException {
            ...
            try {
                ...
                return deserializationContext.handleWeirdKey(this._keyClass, str, "not a valid representation: %s", e5.getMessage());
            }
        }
        ...
        public Object _parse(String str, DeserializationContext deserializationContext) throws IOException {
            ...
            if (annotatedMethod != null) {
                try {
                    ...
                    ClassUtil.unwrapAndThrowAsIAE(e5);
                }
            }
        ...
        switch (this._kind) {
            ...
            case 14:
                try {
                    ...
                    return _weirdKey(deserializationContext, str, e8);
                }
            case 15:
                try {
            ...
            case 16:
                try {
                    ...
                    return _weirdKey(deserializationContext, str, e9);
                }
            case 17:
                try {
    ...
    public Object deserializeKey(String str, DeserializationContext deserializationContext) throws IOException {
        ...
        try {
            ...
            return deserializationContext.handleWeirdKey(this._keyClass, str, "not a valid representation, problem: (%s) %s", e5.getClass().getName(), ClassUtil.exceptionMessage(e5));
        }
    }
