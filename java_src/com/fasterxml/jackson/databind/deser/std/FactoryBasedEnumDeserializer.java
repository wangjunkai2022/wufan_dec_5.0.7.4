...
class FactoryBasedEnumDeserializer extends StdDeserializer<Object> implements ContextualDeserializer {
    ...
    private Throwable throwOrReturnThrowable(Throwable th, DeserializationContext deserializationContext) throws IOException {
        ...
        if (rootCause instanceof IOException) {
            if (!z4 || !(rootCause instanceof JsonProcessingException)) {
    ...
    protected final Object _deserializeWithErrorWrapping(JsonParser jsonParser, DeserializationContext deserializationContext, SettableBeanProperty settableBeanProperty) throws IOException {
        try {
            ...
            return wrapAndThrow(e5, handledType(), settableBeanProperty.getName(), deserializationContext);
        }
    }
    ...
    public Object deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        if (jsonDeserializer != null) {
            ...
            try {
                ...
                return deserializationContext.handleInstantiationProblem(this._valueClass, null, ClassUtil.throwRootCauseIfIOE(e5));
            }
        }
        try {
            return this._factory.callOnWith(this._valueClass, text);
        } catch (Exception e6) {
            Throwable throwRootCauseIfIOE = ClassUtil.throwRootCauseIfIOE(e6);
