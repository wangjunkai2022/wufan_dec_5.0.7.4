...
public final class PropertyBasedCreator {
    ...
    protected PropertyBasedCreator(DeserializationContext deserializationContext, ValueInstantiator valueInstantiator, SettableBeanProperty[] settableBeanPropertyArr, boolean z4, boolean z5) {
        ...
        for (int i4 = 0; i4 < length; i4++) {
            ...
            this._allProperties[i4] = settableBeanProperty2;
    ...
    public SettableBeanProperty findCreatorProperty(int i4) {
    ...
    public static PropertyBasedCreator construct(DeserializationContext deserializationContext, ValueInstantiator valueInstantiator, SettableBeanProperty[] settableBeanPropertyArr, boolean z4) throws JsonMappingException {
        int length = settableBeanPropertyArr.length;
        SettableBeanProperty[] settableBeanPropertyArr2 = new SettableBeanProperty[length];
        for (int i4 = 0; i4 < length; i4++) {
            SettableBeanProperty settableBeanProperty = settableBeanPropertyArr[i4];
        ...
        return new PropertyBasedCreator(deserializationContext, valueInstantiator, settableBeanPropertyArr2, z4, false);
    }
