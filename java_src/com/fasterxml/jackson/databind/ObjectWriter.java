...
public class ObjectWriter implements Versioned, Serializable {
    ...
    private final void _writeCloseable(JsonGenerator jsonGenerator, Object obj) throws IOException {
        ...
        try {
            ...
            e5 = e7;
            ClassUtil.closeOnFailAndThrowAsIOE(jsonGenerator, closeable, e5);
        }
    }
    ...
    protected SequenceWriter _newSequenceWriter(boolean z4, JsonGenerator jsonGenerator, boolean z5) throws IOException {
        return new SequenceWriter(_serializerProvider(), _configureGenerator(jsonGenerator), z5, this._prefetch).init(z4);
    }
    ...
    protected final void _writeValueAndClose(JsonGenerator jsonGenerator, Object obj) throws IOException {
        ...
        try {
            ...
            ClassUtil.closeOnFailAndThrowAsIOE(jsonGenerator, e5);
        }
    }
    ...
    public void writeValue(JsonGenerator jsonGenerator, Object obj) throws IOException {
        ...
        if (this._config.isEnabled(SerializationFeature.CLOSE_CLOSEABLE) && (obj instanceof Closeable)) {
            ...
            try {
                ...
                ClassUtil.closeOnFailAndThrowAsIOE(null, closeable, e5);
                return;
            }
        }
        this._prefetch.serialize(jsonGenerator, obj, _serializerProvider());
