...
public abstract class TypeBase extends JavaType implements JsonSerializable {
    ...
    public TypeBase(Class<?> cls, TypeBindings typeBindings, JavaType javaType, JavaType[] javaTypeArr, int i4, Object obj, Object obj2, boolean z4) {
    ...
    public String containedTypeName(int i4) {
        return this._bindings.getBoundName(i4);
    }
    ...
    public final JavaType findSuperType(Class<?> cls) {
        ...
        if (cls.isInterface() && (javaTypeArr = this._superInterfaces) != null) {
            ...
            for (int i4 = 0; i4 < length; i4++) {
                JavaType findSuperType2 = this._superInterfaces[i4].findSuperType(cls);
    ...
    public JavaType containedType(int i4) {
        return this._bindings.getBoundType(i4);
    }
