...
public abstract class JsonDeserializer<T> implements NullValueProvider {
    ...
    public Object deserializeWithType(JsonParser jsonParser, DeserializationContext deserializationContext, TypeDeserializer typeDeserializer, T t4) throws IOException {
        deserializationContext.handleBadMerge(this);
