...
@DebugMetadata(c = "com.join.kotlin.quark.viewmodel.CreateSourceHopeViewModel$getWebDiskHome$1", f = "CreateSourceHopeViewModel.kt", i = {}, l = {48}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
final class CreateSourceHopeViewModel$getWebDiskHome$1 extends SuspendLambda implements Function1<Continuation<? super ResponseModel<SourceTabListBean>>, Object> {
    final /* synthetic */ String $uid;
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CreateSourceHopeViewModel$getWebDiskHome$1(String str, Continuation<? super CreateSourceHopeViewModel$getWebDiskHome$1> continuation) {
    ...
    public final Continuation<Unit> create(@NotNull Continuation<?> continuation) {
        return new CreateSourceHopeViewModel$getWebDiskHome$1(this.$uid, continuation);
    }

    @Override // kotlin.jvm.functions.Function1
    @Nullable
    public final Object invoke(@Nullable Continuation<? super ResponseModel<SourceTabListBean>> continuation) {
        return ((CreateSourceHopeViewModel$getWebDiskHome$1) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
