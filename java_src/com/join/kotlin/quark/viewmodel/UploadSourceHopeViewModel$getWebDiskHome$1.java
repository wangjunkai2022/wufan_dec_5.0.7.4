...
@DebugMetadata(c = "com.join.kotlin.quark.viewmodel.UploadSourceHopeViewModel$getWebDiskHome$1", f = "UploadSourceHopeViewModel.kt", i = {}, l = {44}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
final class UploadSourceHopeViewModel$getWebDiskHome$1 extends SuspendLambda implements Function1<Continuation<? super ResponseModel<SourceTabListBean>>, Object> {
    final /* synthetic */ String $uid;
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UploadSourceHopeViewModel$getWebDiskHome$1(String str, Continuation<? super UploadSourceHopeViewModel$getWebDiskHome$1> continuation) {
    ...
    public final Continuation<Unit> create(@NotNull Continuation<?> continuation) {
        return new UploadSourceHopeViewModel$getWebDiskHome$1(this.$uid, continuation);
    }

    @Override // kotlin.jvm.functions.Function1
    @Nullable
    public final Object invoke(@Nullable Continuation<? super ResponseModel<SourceTabListBean>> continuation) {
        return ((UploadSourceHopeViewModel$getWebDiskHome$1) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
