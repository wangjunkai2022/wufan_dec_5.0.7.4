...
@DebugMetadata(c = "com.join.kotlin.quark.viewmodel.SourceHopeListViewModel$wishPoolWant$2", f = "SourceHopeListViewModel.kt", i = {}, l = {77}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
final class SourceHopeListViewModel$wishPoolWant$2 extends SuspendLambda implements Function1<Continuation<? super ResponseModel<Boolean>>, Object> {
    ...
    public SourceHopeListViewModel$wishPoolWant$2(String str, Integer num, Continuation<? super SourceHopeListViewModel$wishPoolWant$2> continuation) {
    ...
    public final Continuation<Unit> create(@NotNull Continuation<?> continuation) {
        return new SourceHopeListViewModel$wishPoolWant$2(this.$uid, this.$wishPoolId, continuation);
    }

    @Override // kotlin.jvm.functions.Function1
    @Nullable
    public final Object invoke(@Nullable Continuation<? super ResponseModel<Boolean>> continuation) {
        return ((SourceHopeListViewModel$wishPoolWant$2) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
