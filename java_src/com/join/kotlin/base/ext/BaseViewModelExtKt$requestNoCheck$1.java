...
@DebugMetadata(c = "com.join.kotlin.base.ext.BaseViewModelExtKt$requestNoCheck$1", f = "BaseViewModelExt.kt", i = {}, l = {185}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class BaseViewModelExtKt$requestNoCheck$1 extends SuspendLambda implements Function2<q0, Continuation<? super Unit>, Object> {
    ...
    public BaseViewModelExtKt$requestNoCheck$1(boolean z4, MutableLiveData<ResultState<T>> mutableLiveData, String str, Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super BaseViewModelExtKt$requestNoCheck$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        BaseViewModelExtKt$requestNoCheck$1 baseViewModelExtKt$requestNoCheck$1 = new BaseViewModelExtKt$requestNoCheck$1(this.$isShowDialog, this.$resultState, this.$loadingMessage, this.$block, continuation);
    ...
    public final Object invoke(@NotNull q0 q0Var, @Nullable Continuation<? super Unit> continuation) {
        return ((BaseViewModelExtKt$requestNoCheck$1) create(q0Var, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (Result.m42isSuccessimpl(m35constructorimpl)) {
            ResultStateKt.paresResult(mutableLiveData, m35constructorimpl);
        }
