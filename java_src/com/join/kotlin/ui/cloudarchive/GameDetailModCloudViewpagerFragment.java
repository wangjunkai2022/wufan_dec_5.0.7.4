...
public class GameDetailModCloudViewpagerFragment extends Fragment {
    ...
    private void addTagList() {
        ...
        CloudArchiveTagAdapter cloudArchiveTagAdapter = new CloudArchiveTagAdapter(getActivity(), 1, this.tags);
        this.cloudArchiveTagAdapter = cloudArchiveTagAdapter;
        cloudArchiveTagAdapter.e(new CloudArchiveTagAdapter.a() { // from class: com.join.kotlin.ui.cloudarchive.g
            @Override // com.join.mgps.adapter.CloudArchiveTagAdapter.a
            public final void onSelected(int i4) {
                GameDetailModCloudViewpagerFragment.this.lambda$addTagList$0(i4);
            }
        });
    ...
    private void initViewPager() {
        ...
        while (it2.hasNext()) {
            ...
            this.fragments.add(new FragmentPagerAdapter.a(next.getName(), gameDetailModCloudListFragment));
        }
        ...
        this.viewpager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() { // from class: com.join.kotlin.ui.cloudarchive.GameDetailModCloudViewpagerFragment.1
            ...
            public void onPageSelected(int i4) {
                ...
                while (it3.hasNext()) {
                    ...
                    boolean z4 = false;
                    if (GameDetailModCloudViewpagerFragment.this.tags.indexOf(modGameArchiveTagBean) == i4) {
                ...
                if (linearLayoutManager != null && (linearLayoutManager.findLastCompletelyVisibleItemPosition() < i4 || linearLayoutManager.findFirstCompletelyVisibleItemPosition() > i4)) {
                    GameDetailModCloudViewpagerFragment.this.subTabList.smoothScrollToPosition(i4);
                }
                if (GameDetailModCloudViewpagerFragment.this.lastSelectedTagIndex != i4) {
                    com.papa.sim.statistic.p.l(GameDetailModCloudViewpagerFragment.this.getContext()).O1(Event.clickCloudLabelButton, new Ext().setFrom(String.valueOf(((ModGameArchiveTagBean) GameDetailModCloudViewpagerFragment.this.tags.get(i4)).getType())).setGameId(GameDetailModCloudViewpagerFragment.this.gameId).setPosition(((ModGameArchiveTagBean) GameDetailModCloudViewpagerFragment.this.tags.get(i4)).getTagId()));
                }
            }
        });
    }
