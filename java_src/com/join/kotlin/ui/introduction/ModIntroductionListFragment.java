...
public class ModIntroductionListFragment extends Fragment {
    ...
    static /* synthetic */ int access$008(ModIntroductionListFragment modIntroductionListFragment) {
        int i4 = modIntroductionListFragment.page;
        modIntroductionListFragment.page = i4 + 1;
        return i4;
    }
    ...
    public void aftervidew() {
        ...
        aVar.f46233f = 0;
        aVar.f46237d = (int) getResources().getDimension(R.dimen.wdp24);
        aVar.f46234a = (int) getResources().getDimension(R.dimen.wdp24);
        this.rv_list_data.addItemDecoration(new UniversalItemDecoration() { // from class: com.join.kotlin.ui.introduction.ModIntroductionListFragment.1
            @Override // com.join.mgps.base.decoration.UniversalItemDecoration
            public UniversalItemDecoration.b getItemOffsets(int i4) {
                return aVar;
            }
        });
        this.mItemAdapter.setOnItemClickListener(new BaseQuickAdapter.j() { // from class: com.join.kotlin.ui.introduction.c
            @Override // com.join.mgps.base.BaseQuickAdapter.j
            public final void onItemClick(BaseQuickAdapter baseQuickAdapter, View view, int i4) {
                ModIntroductionListFragment.this.lambda$aftervidew$0(baseQuickAdapter, view, i4);
            }
        });
        this.rv_list_data.setAdapter(this.mItemAdapter);
        this.mItemAdapter.setOnLoadMoreListener(new BaseQuickAdapter.l() { // from class: com.join.kotlin.ui.introduction.ModIntroductionListFragment.2
