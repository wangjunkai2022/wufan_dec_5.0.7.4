...
public class HandShankFCActivity extends HandShankBaseActivity implements View.OnClickListener {
    ...
    private boolean f33547z;
    final String A = "FC游戏手柄设置";
    KeyMap.EmuMap B = KeyMap.EmuMap.FC;
    ...
    private View A0(String str) {
        ...
        while (true) {
            ...
            if (aVar != null && !TextUtils.isEmpty(aVar.f33549b) && aVar.f33549b.equals(str)) {
                return this.C[i4];
            }
            i4++;
        }
    ...
    private void initView() {
        this.C = new View[]{this.f33525d, this.f33526e, this.f33535n, this.f33533l, this.f33534m, this.f33527f, this.f33528g, this.f33529h, this.f33530i, this.f33531j, this.f33532k, this.f33536o, this.f33537p, this.f33538q, this.f33539r, this.f33540s, this.f33541t, this.f33542u, this.f33543v, this.f33544w};
    ...
    public class a {
        ...
        public a(KeyCodes keyCodes) {
            ...
            this.f33548a = str;
            HashMap<String, String> hashMap = HandShankFCActivity.this.H;
            if (hashMap != null) {
                this.f33549b = hashMap.get(str);
            }
        }

        public boolean a() {
            return !TextUtils.isEmpty(this.f33549b);
        }

        public void b() {
            HashMap<String, String> hashMap = HandShankFCActivity.this.H;
            if (hashMap != null) {
                this.f33549b = hashMap.get(this.f33548a);
            }
        }
