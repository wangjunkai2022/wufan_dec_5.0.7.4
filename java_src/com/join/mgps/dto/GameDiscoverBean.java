...
public class GameDiscoverBean extends DownloadPointBase implements Serializable {
    ...
    private String last_week_down_count;
    private int lock_sp;
    ...
    public String getLast_week_down_count() {
    ...
    public void setLast_week_down_count(String str) {
        this.last_week_down_count = str;
    }
