...
public final class GameDetialItemStrategyItemimage3Binding implements ViewBinding {
    @NonNull

    /* renamed from: b  reason: collision with root package name */
    private final LinearLayout f20310b;
    @NonNull

    /* renamed from: c  reason: collision with root package name */
    public final RelativeLayout f20311c;
    @NonNull

    /* renamed from: d  reason: collision with root package name */
    public final LinearLayout f20312d;
    @NonNull

    /* renamed from: e  reason: collision with root package name */
    public final ImageView f20313e;
    @NonNull
    ...
    public final SimpleDraweeView f20316h;
    @NonNull

    /* renamed from: i  reason: collision with root package name */
    public final SimpleDraweeView f20317i;
    @NonNull

    /* renamed from: j  reason: collision with root package name */
    public final SimpleDraweeView f20318j;
    @NonNull
    ...
    public final TextView f20321m;
    @NonNull

    /* renamed from: n  reason: collision with root package name */
    public final TextView f20322n;
    @NonNull

    /* renamed from: o  reason: collision with root package name */
    public final LinearLayout f20323o;

    private GameDetialItemStrategyItemimage3Binding(@NonNull LinearLayout linearLayout, @NonNull RelativeLayout relativeLayout, @NonNull LinearLayout linearLayout2, @NonNull ImageView imageView, @NonNull ImageView imageView2, @NonNull TextView textView, @NonNull SimpleDraweeView simpleDraweeView, @NonNull SimpleDraweeView simpleDraweeView2, @NonNull SimpleDraweeView simpleDraweeView3, @NonNull View view, @NonNull TextView textView2, @NonNull TextView textView3, @NonNull TextView textView4, @NonNull LinearLayout linearLayout3) {
        this.f20310b = linearLayout;
        this.f20311c = relativeLayout;
        this.f20312d = linearLayout2;
        this.f20313e = imageView;
        this.f20314f = imageView2;
        this.f20315g = textView;
        this.f20316h = simpleDraweeView;
        this.f20317i = simpleDraweeView2;
        this.f20318j = simpleDraweeView3;
        this.f20319k = view;
        this.f20320l = textView2;
        this.f20321m = textView3;
        this.f20322n = textView4;
        this.f20323o = linearLayout3;
    }

    @NonNull
    public static GameDetialItemStrategyItemimage3Binding bind(@NonNull View view) {
                                                ...
                                                if (textView3 != null) {
                                                    ...
                                                    if (textView4 != null) {
                                                        ...
                                                        if (linearLayout2 != null) {
                                                            return new GameDetialItemStrategyItemimage3Binding((LinearLayout) view, relativeLayout, linearLayout, imageView, imageView2, textView, simpleDraweeView, simpleDraweeView2, simpleDraweeView3, findChildViewById, textView2, textView3, textView4, linearLayout2);
                                                        }
                                                    }
                                                }
                                            }
    ...
    @NonNull
    public static GameDetialItemStrategyItemimage3Binding inflate(@NonNull LayoutInflater layoutInflater) {
    ...
    @NonNull
    public static GameDetialItemStrategyItemimage3Binding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z4) {
