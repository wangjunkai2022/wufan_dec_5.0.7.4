...
public final class HomeRankLayoutBinding implements ViewBinding {
    ...
    public final SlidingTabLayout6 f21480d;
    @NonNull

    /* renamed from: e  reason: collision with root package name */
    public final ViewPager f21481e;

    private HomeRankLayoutBinding(@NonNull ConstraintLayout constraintLayout, @NonNull TextView textView, @NonNull SlidingTabLayout6 slidingTabLayout6, @NonNull ViewPager viewPager) {
        this.f21478b = constraintLayout;
        this.f21479c = textView;
        this.f21480d = slidingTabLayout6;
    ...
    public static HomeRankLayoutBinding bind(@NonNull View view) {
        ...
        if (textView != null) {
            ...
            if (slidingTabLayout6 != null) {
                ...
                if (viewPager != null) {
                    return new HomeRankLayoutBinding((ConstraintLayout) view, textView, slidingTabLayout6, viewPager);
                }
            }
        }
    ...
    @NonNull
    public static HomeRankLayoutBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z4) {
