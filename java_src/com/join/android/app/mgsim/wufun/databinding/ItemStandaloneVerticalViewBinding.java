...
public final class ItemStandaloneVerticalViewBinding implements ViewBinding {
    @NonNull

    /* renamed from: b  reason: collision with root package name */
    private final RelativeLayout f22867b;
    @NonNull
    ...
    public final ImageView f22869d;
    @NonNull

    /* renamed from: e  reason: collision with root package name */
    public final View f22870e;
    @NonNull

    /* renamed from: f  reason: collision with root package name */
    public final LinearLayout f22871f;
    @NonNull

    /* renamed from: g  reason: collision with root package name */
    public final LinearLayout f22872g;
    @NonNull

    /* renamed from: h  reason: collision with root package name */
    public final TextView f22873h;
    @NonNull

    /* renamed from: i  reason: collision with root package name */
    public final TextView f22874i;
    @NonNull

    /* renamed from: j  reason: collision with root package name */
    public final TextView f22875j;
    @NonNull

    /* renamed from: k  reason: collision with root package name */
    public final SimpleDraweeView f22876k;
    @NonNull

    /* renamed from: l  reason: collision with root package name */
    public final TextView f22877l;
    @NonNull
    ...
    public final ProgressBar f22879n;
    @NonNull

    /* renamed from: o  reason: collision with root package name */
    public final ProgressBar f22880o;
    @NonNull

    /* renamed from: p  reason: collision with root package name */
    public final RelativeLayout f22881p;
    @NonNull

    /* renamed from: q  reason: collision with root package name */
    public final RelativeLayout f22882q;
    @NonNull

    /* renamed from: r  reason: collision with root package name */
    public final LinearLayout f22883r;

    private ItemStandaloneVerticalViewBinding(@NonNull RelativeLayout relativeLayout, @NonNull TextView textView, @NonNull ImageView imageView, @NonNull View view, @NonNull LinearLayout linearLayout, @NonNull LinearLayout linearLayout2, @NonNull TextView textView2, @NonNull TextView textView3, @NonNull TextView textView4, @NonNull SimpleDraweeView simpleDraweeView, @NonNull TextView textView5, @NonNull TextView textView6, @NonNull ProgressBar progressBar, @NonNull ProgressBar progressBar2, @NonNull RelativeLayout relativeLayout2, @NonNull RelativeLayout relativeLayout3, @NonNull LinearLayout linearLayout3) {
        this.f22867b = relativeLayout;
        this.f22868c = textView;
        this.f22869d = imageView;
        this.f22870e = view;
        this.f22871f = linearLayout;
        this.f22872g = linearLayout2;
        this.f22873h = textView2;
        this.f22874i = textView3;
        this.f22875j = textView4;
        this.f22876k = simpleDraweeView;
        this.f22877l = textView5;
        this.f22878m = textView6;
        this.f22879n = progressBar;
        this.f22880o = progressBar2;
        this.f22881p = relativeLayout2;
        this.f22882q = relativeLayout3;
        this.f22883r = linearLayout3;
    }

    @NonNull
    public static ItemStandaloneVerticalViewBinding bind(@NonNull View view) {
        int i4 = R.id.appSize;
                                                        ...
                                                        if (progressBar2 != null) {
                                                            ...
                                                            if (relativeLayout != null) {
                                                                ...
                                                                if (linearLayout3 != null) {
                                                                    return new ItemStandaloneVerticalViewBinding(relativeLayout2, textView, imageView, findChildViewById, linearLayout, linearLayout2, textView2, textView3, textView4, simpleDraweeView, textView5, textView6, progressBar, progressBar2, relativeLayout, relativeLayout2, linearLayout3);
                                                                }
                                                            }
                                                        }
                                                    }
    ...
    @NonNull
    public static ItemStandaloneVerticalViewBinding inflate(@NonNull LayoutInflater layoutInflater) {
    ...
    @NonNull
    public static ItemStandaloneVerticalViewBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z4) {
