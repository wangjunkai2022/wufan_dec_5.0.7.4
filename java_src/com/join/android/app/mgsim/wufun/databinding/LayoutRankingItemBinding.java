...
public final class LayoutRankingItemBinding implements ViewBinding {
    @NonNull

    /* renamed from: b  reason: collision with root package name */
    private final RelativeLayout f23271b;
    @NonNull

    /* renamed from: c  reason: collision with root package name */
    public final TextView f23272c;
    @NonNull

    /* renamed from: d  reason: collision with root package name */
    public final ImageView f23273d;
    @NonNull

    /* renamed from: e  reason: collision with root package name */
    public final LinearLayout f23274e;
    @NonNull

    /* renamed from: f  reason: collision with root package name */
    public final LinearLayout f23275f;
    @NonNull

    /* renamed from: g  reason: collision with root package name */
    public final TextView f23276g;
    @NonNull

    /* renamed from: h  reason: collision with root package name */
    public final TextView f23277h;
    @NonNull

    /* renamed from: i  reason: collision with root package name */
    public final TextView f23278i;
    @NonNull

    /* renamed from: j  reason: collision with root package name */
    public final SimpleDraweeView f23279j;
    @NonNull

    /* renamed from: k  reason: collision with root package name */
    public final TextView f23280k;
    @NonNull

    /* renamed from: l  reason: collision with root package name */
    public final TextView f23281l;
    @NonNull

    /* renamed from: m  reason: collision with root package name */
    public final ProgressBar f23282m;
    @NonNull

    /* renamed from: n  reason: collision with root package name */
    public final ProgressBar f23283n;
    @NonNull

    /* renamed from: o  reason: collision with root package name */
    public final RelativeLayout f23284o;
    @NonNull

    /* renamed from: p  reason: collision with root package name */
    public final RelativeLayout f23285p;
    @NonNull

    /* renamed from: q  reason: collision with root package name */
    public final LinearLayout f23286q;
    @NonNull

    /* renamed from: r  reason: collision with root package name */
    public final TextView f23287r;

    private LayoutRankingItemBinding(@NonNull RelativeLayout relativeLayout, @NonNull TextView textView, @NonNull ImageView imageView, @NonNull LinearLayout linearLayout, @NonNull LinearLayout linearLayout2, @NonNull TextView textView2, @NonNull TextView textView3, @NonNull TextView textView4, @NonNull SimpleDraweeView simpleDraweeView, @NonNull TextView textView5, @NonNull TextView textView6, @NonNull ProgressBar progressBar, @NonNull ProgressBar progressBar2, @NonNull RelativeLayout relativeLayout2, @NonNull RelativeLayout relativeLayout3, @NonNull LinearLayout linearLayout3, @NonNull TextView textView7) {
        this.f23271b = relativeLayout;
        this.f23272c = textView;
        this.f23273d = imageView;
        this.f23274e = linearLayout;
        this.f23275f = linearLayout2;
        this.f23276g = textView2;
        this.f23277h = textView3;
        this.f23278i = textView4;
        this.f23279j = simpleDraweeView;
        this.f23280k = textView5;
        this.f23281l = textView6;
        this.f23282m = progressBar;
        this.f23283n = progressBar2;
        this.f23284o = relativeLayout2;
        this.f23285p = relativeLayout3;
        this.f23286q = linearLayout3;
        this.f23287r = textView7;
    }

    @NonNull
    public static LayoutRankingItemBinding bind(@NonNull View view) {
        int i4 = R.id.appSize;
                                                    ...
                                                    if (progressBar2 != null) {
                                                        ...
                                                        if (relativeLayout != null) {
                                                            ...
                                                            if (linearLayout3 != null) {
                                                                ...
                                                                if (textView7 != null) {
                                                                    return new LayoutRankingItemBinding(relativeLayout2, textView, imageView, linearLayout, linearLayout2, textView2, textView3, textView4, simpleDraweeView, textView5, textView6, progressBar, progressBar2, relativeLayout, relativeLayout2, linearLayout3, textView7);
                                                                }
                                                            }
                                                        }
                                                    }
    ...
    @NonNull
    public static LayoutRankingItemBinding inflate(@NonNull LayoutInflater layoutInflater) {
    ...
    @NonNull
    public static LayoutRankingItemBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z4) {
