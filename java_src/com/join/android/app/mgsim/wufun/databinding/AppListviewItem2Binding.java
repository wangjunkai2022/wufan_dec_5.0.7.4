...
public final class AppListviewItem2Binding implements ViewBinding {
    @NonNull

    /* renamed from: b  reason: collision with root package name */
    private final RelativeLayout f17391b;
    @NonNull
    ...
    public final LinearLayout f17396g;
    @NonNull

    /* renamed from: h  reason: collision with root package name */
    public final LinearLayout f17397h;
    @NonNull
    ...
    public final SimpleDraweeView f17401l;
    @NonNull
    ...
    public final ProgressBar f17405p;
    @NonNull

    /* renamed from: q  reason: collision with root package name */
    public final RelativeLayout f17406q;
    @NonNull

    /* renamed from: r  reason: collision with root package name */
    public final RelativeLayout f17407r;
    @NonNull

    /* renamed from: s  reason: collision with root package name */
    public final LinearLayout f17408s;

    private AppListviewItem2Binding(@NonNull RelativeLayout relativeLayout, @NonNull TextView textView, @NonNull TextView textView2, @NonNull ImageView imageView, @NonNull View view, @NonNull LinearLayout linearLayout, @NonNull LinearLayout linearLayout2, @NonNull TextView textView3, @NonNull TextView textView4, @NonNull TextView textView5, @NonNull SimpleDraweeView simpleDraweeView, @NonNull TextView textView6, @NonNull TextView textView7, @NonNull ProgressBar progressBar, @NonNull ProgressBar progressBar2, @NonNull RelativeLayout relativeLayout2, @NonNull RelativeLayout relativeLayout3, @NonNull LinearLayout linearLayout3) {
        this.f17391b = relativeLayout;
        this.f17392c = textView;
        this.f17393d = textView2;
        this.f17394e = imageView;
        this.f17395f = view;
        this.f17396g = linearLayout;
        this.f17397h = linearLayout2;
        this.f17398i = textView3;
        this.f17399j = textView4;
        this.f17400k = textView5;
        this.f17401l = simpleDraweeView;
        this.f17402m = textView6;
        this.f17403n = textView7;
        this.f17404o = progressBar;
        this.f17405p = progressBar2;
        this.f17406q = relativeLayout2;
        this.f17407r = relativeLayout3;
        this.f17408s = linearLayout3;
    }

    @NonNull
    public static AppListviewItem2Binding bind(@NonNull View view) {
        int i4 = R.id.adText;
                                                            ...
                                                            if (progressBar2 != null) {
                                                                ...
                                                                if (relativeLayout != null) {
                                                                    ...
                                                                    if (linearLayout3 != null) {
                                                                        return new AppListviewItem2Binding(relativeLayout2, textView, textView2, imageView, findChildViewById, linearLayout, linearLayout2, textView3, textView4, textView5, simpleDraweeView, textView6, textView7, progressBar, progressBar2, relativeLayout, relativeLayout2, linearLayout3);
                                                                    }
                                                                }
                                                            }
                                                        }
    ...
    @NonNull
    public static AppListviewItem2Binding inflate(@NonNull LayoutInflater layoutInflater) {
    ...
    @NonNull
    public static AppListviewItem2Binding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z4) {
