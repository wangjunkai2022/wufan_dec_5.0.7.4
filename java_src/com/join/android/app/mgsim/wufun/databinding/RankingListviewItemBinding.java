...
public final class RankingListviewItemBinding implements ViewBinding {
    @NonNull

    /* renamed from: b  reason: collision with root package name */
    private final LinearLayout f26184b;
    @NonNull
    ...
    public final LinearLayout f26190h;
    @NonNull

    /* renamed from: i  reason: collision with root package name */
    public final LinearLayout f26191i;
    @NonNull
    ...
    public final TextView f26193k;
    @NonNull

    /* renamed from: l  reason: collision with root package name */
    public final TextView f26194l;
    @NonNull

    /* renamed from: m  reason: collision with root package name */
    public final SimpleDraweeView f26195m;
    @NonNull

    /* renamed from: n  reason: collision with root package name */
    public final TextView f26196n;
    @NonNull

    /* renamed from: o  reason: collision with root package name */
    public final TextView f26197o;
    @NonNull

    /* renamed from: p  reason: collision with root package name */
    public final ProgressBar f26198p;
    @NonNull

    /* renamed from: q  reason: collision with root package name */
    public final ProgressBar f26199q;
    @NonNull

    /* renamed from: r  reason: collision with root package name */
    public final RelativeLayout f26200r;
    @NonNull

    /* renamed from: s  reason: collision with root package name */
    public final RelativeLayout f26201s;
    @NonNull

    /* renamed from: t  reason: collision with root package name */
    public final LinearLayout f26202t;
    @NonNull

    /* renamed from: u  reason: collision with root package name */
    public final TextView f26203u;
    @NonNull

    /* renamed from: v  reason: collision with root package name */
    public final RelativeLayout f26204v;

    private RankingListviewItemBinding(@NonNull LinearLayout linearLayout, @NonNull TextView textView, @NonNull ImageView imageView, @NonNull ImageView imageView2, @NonNull View view, @NonNull View view2, @NonNull LinearLayout linearLayout2, @NonNull LinearLayout linearLayout3, @NonNull TextView textView2, @NonNull TextView textView3, @NonNull TextView textView4, @NonNull SimpleDraweeView simpleDraweeView, @NonNull TextView textView5, @NonNull TextView textView6, @NonNull ProgressBar progressBar, @NonNull ProgressBar progressBar2, @NonNull RelativeLayout relativeLayout, @NonNull RelativeLayout relativeLayout2, @NonNull LinearLayout linearLayout4, @NonNull TextView textView7, @NonNull RelativeLayout relativeLayout3) {
        this.f26184b = linearLayout;
        this.f26185c = textView;
        this.f26186d = imageView;
        this.f26187e = imageView2;
        this.f26188f = view;
        this.f26189g = view2;
        this.f26190h = linearLayout2;
        this.f26191i = linearLayout3;
        this.f26192j = textView2;
        this.f26193k = textView3;
        this.f26194l = textView4;
        this.f26195m = simpleDraweeView;
        this.f26196n = textView5;
        this.f26197o = textView6;
        this.f26198p = progressBar;
        this.f26199q = progressBar2;
        this.f26200r = relativeLayout;
        this.f26201s = relativeLayout2;
        this.f26202t = linearLayout4;
        this.f26203u = textView7;
        this.f26204v = relativeLayout3;
    }

    @NonNull
    public static RankingListviewItemBinding bind(@NonNull View view) {
        int i4 = R.id.appSize;
    ...
    @NonNull
    public static RankingListviewItemBinding inflate(@NonNull LayoutInflater layoutInflater) {
    ...
    @NonNull
    public static RankingListviewItemBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z4) {
