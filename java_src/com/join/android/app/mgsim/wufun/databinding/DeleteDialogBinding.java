...
public final class DeleteDialogBinding implements ViewBinding {
    ...
    private final LinearLayout f18356b;
    @NonNull
    ...
    public final Button f18358d;
    @NonNull

    /* renamed from: e  reason: collision with root package name */
    public final TextView f18359e;
    @NonNull

    /* renamed from: f  reason: collision with root package name */
    public final TextView f18360f;

    private DeleteDialogBinding(@NonNull LinearLayout linearLayout, @NonNull Button button, @NonNull Button button2, @NonNull TextView textView, @NonNull TextView textView2) {
        this.f18356b = linearLayout;
        this.f18357c = button;
        this.f18358d = button2;
        this.f18359e = textView;
        this.f18360f = textView2;
    }
        ...
        if (button != null) {
            ...
            if (button2 != null) {
                ...
                if (textView != null) {
                    ...
                    if (textView2 != null) {
                        return new DeleteDialogBinding((LinearLayout) view, button, button2, textView, textView2);
                    }
                }
            }
        }
