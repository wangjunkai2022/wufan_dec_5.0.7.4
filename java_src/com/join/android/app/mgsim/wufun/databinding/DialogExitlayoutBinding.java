...
public final class DialogExitlayoutBinding implements ViewBinding {
    ...
    private final LinearLayout f18703b;
    @NonNull

    /* renamed from: c  reason: collision with root package name */
    public final Button f18704c;
    @NonNull

    /* renamed from: d  reason: collision with root package name */
    public final Button f18705d;
    @NonNull
    ...
    private DialogExitlayoutBinding(@NonNull LinearLayout linearLayout, @NonNull Button button, @NonNull Button button2, @NonNull TextView textView, @NonNull ImageView imageView) {
        this.f18703b = linearLayout;
        this.f18704c = button;
        this.f18705d = button2;
        this.f18706e = textView;
        this.f18707f = imageView;
    }

    @NonNull
    public static DialogExitlayoutBinding bind(@NonNull View view) {
        ...
        if (button != null) {
            ...
            if (button2 != null) {
                ...
                if (textView != null) {
                    ...
                    if (imageView != null) {
                        return new DialogExitlayoutBinding((LinearLayout) view, button, button2, textView, imageView);
                    }
                }
            }
        }
    ...
    @NonNull
    public static DialogExitlayoutBinding inflate(@NonNull LayoutInflater layoutInflater) {
    ...
    @NonNull
    public static DialogExitlayoutBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z4) {
