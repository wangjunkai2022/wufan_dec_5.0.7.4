...
public final class ItemPapaDownloadListBinding implements ViewBinding {
    @NonNull

    /* renamed from: b  reason: collision with root package name */
    private final RelativeLayout f22517b;
    @NonNull
    ...
    public final LinearLayout f22522g;
    @NonNull

    /* renamed from: h  reason: collision with root package name */
    public final TextView f22523h;
    @NonNull

    /* renamed from: i  reason: collision with root package name */
    public final TextView f22524i;
    @NonNull
    ...
    public final SimpleDraweeView f22526k;
    @NonNull

    /* renamed from: l  reason: collision with root package name */
    public final TextView f22527l;
    @NonNull

    /* renamed from: m  reason: collision with root package name */
    public final TextView f22528m;
    @NonNull

    /* renamed from: n  reason: collision with root package name */
    public final ProgressBar f22529n;
    @NonNull

    /* renamed from: o  reason: collision with root package name */
    public final ProgressBar f22530o;
    @NonNull

    /* renamed from: p  reason: collision with root package name */
    public final RelativeLayout f22531p;
    @NonNull

    /* renamed from: q  reason: collision with root package name */
    public final RelativeLayout f22532q;
    @NonNull

    /* renamed from: r  reason: collision with root package name */
    public final LinearLayout f22533r;

    private ItemPapaDownloadListBinding(@NonNull RelativeLayout relativeLayout, @NonNull TextView textView, @NonNull ImageView imageView, @NonNull View view, @NonNull LinearLayout linearLayout, @NonNull LinearLayout linearLayout2, @NonNull TextView textView2, @NonNull TextView textView3, @NonNull TextView textView4, @NonNull SimpleDraweeView simpleDraweeView, @NonNull TextView textView5, @NonNull TextView textView6, @NonNull ProgressBar progressBar, @NonNull ProgressBar progressBar2, @NonNull RelativeLayout relativeLayout2, @NonNull RelativeLayout relativeLayout3, @NonNull LinearLayout linearLayout3) {
        this.f22517b = relativeLayout;
        this.f22518c = textView;
        this.f22519d = imageView;
        this.f22520e = view;
        this.f22521f = linearLayout;
        this.f22522g = linearLayout2;
        this.f22523h = textView2;
        this.f22524i = textView3;
        this.f22525j = textView4;
        this.f22526k = simpleDraweeView;
        this.f22527l = textView5;
        this.f22528m = textView6;
        this.f22529n = progressBar;
        this.f22530o = progressBar2;
        this.f22531p = relativeLayout2;
        this.f22532q = relativeLayout3;
        this.f22533r = linearLayout3;
    }

    @NonNull
    public static ItemPapaDownloadListBinding bind(@NonNull View view) {
        int i4 = R.id.appSize;
                                                        ...
                                                        if (progressBar2 != null) {
                                                            ...
                                                            if (relativeLayout != null) {
                                                                ...
                                                                if (linearLayout3 != null) {
                                                                    return new ItemPapaDownloadListBinding(relativeLayout2, textView, imageView, findChildViewById, linearLayout, linearLayout2, textView2, textView3, textView4, simpleDraweeView, textView5, textView6, progressBar, progressBar2, relativeLayout, relativeLayout2, linearLayout3);
                                                                }
                                                            }
                                                        }
                                                    }
    ...
    @NonNull
    public static ItemPapaDownloadListBinding inflate(@NonNull LayoutInflater layoutInflater) {
    ...
    @NonNull
    public static ItemPapaDownloadListBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z4) {
