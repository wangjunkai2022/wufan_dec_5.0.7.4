...
public final class FragmentCloudListBinding implements ViewBinding {
    ...
    private final LinearLayout f19647b;
    @NonNull
    ...
    public final PtrClassicFrameLayout f19651f;
    @NonNull

    /* renamed from: g  reason: collision with root package name */
    public final XListView2 f19652g;
    @NonNull

    /* renamed from: h  reason: collision with root package name */
    public final RelativeLayout f19653h;
    @NonNull
    ...
    private FragmentCloudListBinding(@NonNull LinearLayout linearLayout, @NonNull ImageView imageView, @NonNull LinearLayout linearLayout2, @NonNull LinearLayout linearLayout3, @NonNull PtrClassicFrameLayout ptrClassicFrameLayout, @NonNull XListView2 xListView2, @NonNull RelativeLayout relativeLayout, @NonNull TextView textView, @NonNull TextView textView2) {
        this.f19647b = linearLayout;
        this.f19648c = imageView;
        this.f19649d = linearLayout2;
        this.f19650e = linearLayout3;
        this.f19651f = ptrClassicFrameLayout;
        this.f19652g = xListView2;
        this.f19653h = relativeLayout;
        this.f19654i = textView;
        this.f19655j = textView2;
    }
                        ...
                        if (xListView2 != null) {
                            ...
                            if (relativeLayout != null) {
                                ...
                                if (textView != null) {
                                    ...
                                    if (textView2 != null) {
                                        return new FragmentCloudListBinding((LinearLayout) view, imageView, linearLayout, linearLayout2, ptrClassicFrameLayout, xListView2, relativeLayout, textView, textView2);
                                    }
                                }
                            }
                        }
    ...
    @NonNull
    public static FragmentCloudListBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z4) {
