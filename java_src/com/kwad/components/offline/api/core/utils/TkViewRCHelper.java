...
public class TkViewRCHelper {
    ...
    public static class CornerConf {
        ...
        public CornerConf setBottomLeft(boolean z4) {
            this.bottomLeft = z4;
            return this;
        }

        public CornerConf setLeftTop(boolean z4) {
            this.leftTop = z4;
            return this;
        }

        public CornerConf setRightBottom(boolean z4) {
            this.rightBottom = z4;
            return this;
        }

        public CornerConf setTopRight(boolean z4) {
            this.topRight = z4;
            return this;
        }
    }
