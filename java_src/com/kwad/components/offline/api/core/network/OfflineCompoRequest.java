...
public abstract class OfflineCompoRequest implements IOfflineCompoRequest {
    ...
    public void putBody(String str, double d5) {
        JsonHelper.putValue(this.mBodyParams, str, d5);
    }
    ...
    public void putBody(String str, float f5) {
        JsonHelper.putValue(this.mBodyParams, str, f5);
    }

    public void putBody(String str, byte b5) {
        JsonHelper.putValue(this.mBodyParams, str, b5);
    }
    ...
    public void putBody(String str, boolean z4) {
        JsonHelper.putValue(this.mBodyParams, str, z4);
    }
