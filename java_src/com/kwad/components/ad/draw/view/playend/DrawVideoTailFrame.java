...
public class DrawVideoTailFrame extends FrameLayout implements View.OnClickListener {
    ...
    private KsAppDownloadListener getAppDownloadListener() {
        return new a() { // from class: com.kwad.components.ad.draw.view.playend.DrawVideoTailFrame.1
            ...
            public final void onPaused(int i4) {
                super.onPaused(i4);
                DrawVideoTailFrame.this.dJ.e(com.kwad.sdk.core.response.b.a.FQ(), i4);
            }
    ...
    public void onClick(View view) {
        com.kwad.components.core.e.d.a.a(new a.C0457a(getContext()).ar(this.mAdTemplate).b(this.mApkDownloadHelper).an(view == this.dJ ? 1 : 2).ao(view == this.dJ).a(new a.b() { // from class: com.kwad.components.ad.draw.view.playend.DrawVideoTailFrame.2
