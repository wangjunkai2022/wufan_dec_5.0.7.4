...
public class DrawCardApp extends FrameLayout implements View.OnClickListener {
        ...
        if (this.cx == null) {
            this.cx = new com.kwad.sdk.core.download.a.a() { // from class: com.kwad.components.ad.draw.view.playcard.DrawCardApp.1
                ...
                public final void onPaused(int i4) {
                    super.onPaused(i4);
                    DrawCardApp.this.dt.e(com.kwad.sdk.core.response.b.a.FQ(), i4);
                }
    ...
    public void onClick(View view) {
        ...
        com.kwad.components.core.e.d.a.a(new a.C0457a(getContext()).ar(this.mAdTemplate).b(this.mApkDownloadHelper).ao(view == this.dt).an(view == this.dt ? 1 : 2).a(new a.b() { // from class: com.kwad.components.ad.draw.view.playcard.DrawCardApp.2
    ...
    private void d(int i4, int i5) {
        aG();
        ValueAnimator b5 = n.b(this, i4, i5);
        this.du = b5;
    ...
    public final void a(@NonNull AdTemplate adTemplate, a aVar) {
        ...
        boolean z5 = !TextUtils.isEmpty(ay);
        if (z5) {
            this.dq.setText(ay);
