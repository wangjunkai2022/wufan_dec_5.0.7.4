...
public final class c extends com.kwad.components.ad.draw.a.a implements View.OnClickListener {
    ...
    private KsAppDownloadListener cx = new com.kwad.sdk.core.download.a.a() { // from class: com.kwad.components.ad.draw.b.c.2
        ...
        public final void onPaused(int i4) {
            ...
            c.this.cs.e(com.kwad.sdk.core.response.b.a.FQ(), i4);
        }
    ...
    public void al() {
        ...
        ValueAnimator b5 = n.b(textView, 0, com.kwad.sdk.c.a.a.a(textView.getContext(), 44.0f));
        this.ct = b5;
    ...
    private void a(boolean z4, int i4) {
        com.kwad.components.core.e.d.a.a(new a.C0457a(this.co.getContext()).ar(this.mAdTemplate).b(this.mApkDownloadHelper).an(i4).ao(z4).a(new a.b() { // from class: com.kwad.components.ad.draw.b.c.3
