...
public final class f extends com.kwad.components.ad.reward.presenter.b implements o, com.kwad.sdk.core.g.b, com.kwad.sdk.widget.c {
    ...
    private g mPlayEndPageListener = new com.kwad.components.ad.reward.e.a() { // from class: com.kwad.components.ad.fullscreen.c.a.f.1
        ...
        public final void bL() {
            ...
            if (f.this.eg != null) {
                f.this.eg.bw(f.this.getContext());
            }
            if (f.this.hG != null) {
                f.this.hG.cancel();
                f.this.hG = null;
    ...
    private void cg() {
        ...
        this.hy.post(new az() { // from class: com.kwad.components.ad.fullscreen.c.a.f.6
    ...
    public final void aj() {
        ...
        if (com.kwad.components.ad.fullscreen.b.a.a(getContext(), this.qp.mAdTemplate)) {
            this.qp.a(this);
            this.qp.b(this.mPlayEndPageListener);
            cg();
            initView();
            a(dS);
            float dP = com.kwad.sdk.core.response.b.b.dP(dS);
            com.kwad.sdk.core.g.d dVar = this.eg;
            if (dVar == null) {
                com.kwad.sdk.core.g.d dVar2 = new com.kwad.sdk.core.g.d(dP);
                this.eg = dVar2;
                dVar2.a(this);
            } else {
                dVar.g(dP);
            ...
            com.kwad.components.ad.fullscreen.b.a.E(getContext());
        }
    }
    ...
    private void a(AdInfo adInfo) {
        String dR = com.kwad.sdk.core.response.b.b.dR(adInfo);
        ...
        String a5 = a(this.qp, adInfo);
        TextView textView3 = this.hA;
        if (textView3 != null) {
            textView3.setText("或点击" + a5);
        }
    }

    private static String a(com.kwad.components.ad.reward.g gVar, AdInfo adInfo) {
        String dT = com.kwad.sdk.core.response.b.b.dT(adInfo);
        com.kwad.components.core.e.d.c cVar = gVar.mApkDownloadHelper;
        if (!com.kwad.sdk.core.response.b.a.aE(adInfo) || cVar == null) {
            return dT;
        }
        int ov = cVar.ov();
        AdMatrixInfo.DownloadTexts dV = com.kwad.sdk.core.response.b.b.dV(adInfo);
        if (ov != 8) {
            if (ov != 12) {
                return dV.adActionDescription;
            }
            return dV.openAppLabel;
        }
        return dV.installAppLabel;
    }

    /* JADX INFO: Access modifiers changed from: private */
    @Nullable
    public Animator a(float f5, float f6) {
        if (this.hy == null) {
            return null;
        }
        AnimatorSet animatorSet = new AnimatorSet();
        Resources resources = this.hy.getResources();
        Animator a5 = n.a((View) this.hB, (Interpolator) null, 100L, 16.0f);
        a5.addListener(new AnimatorListenerAdapter() { // from class: com.kwad.components.ad.fullscreen.c.a.f.7
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this.hy, "translationX", f5 - (this.hy.getLeft() + (this.hy.getWidth() / 2.0f)));
        ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(this.hy, "translationY", f6 - (this.hy.getTop() + (this.hy.getHeight() / 2.0f)));
        ...
        animatorSet.playSequentially(a5, a5.clone(), a5.clone(), ofFloat5, animatorSet2, animatorSet3);
        return animatorSet;
    }
    ...
    public final void a(double d5) {
        ...
        boolean z4 = activity != null && activity.equals(currentActivity);
        if (!com.kwad.components.core.e.c.b.nQ() && z4) {
            if (this.qp != null) {
                com.kwad.sdk.core.adlog.c.b bVar = new com.kwad.sdk.core.adlog.c.b();
                bVar.l(d5);
                this.qp.a(1, getContext(), 157, 1, 0L, false, bVar);
            }
            bo.a(new az() { // from class: com.kwad.components.ad.fullscreen.c.a.f.5
                @Override // com.kwad.sdk.utils.az
                public final void doTask() {
        ...
        bo.a(new Runnable() { // from class: com.kwad.components.ad.fullscreen.c.a.f.4
