...
public final class a {
    ...
    public static Map<String, AppPackageInfo> K(Context context) {
        ...
        if (av.Ne()) {
            try {
                List<String> Nf = av.Nf();
                if (Nf != null && !Nf.isEmpty()) {
                    for (String str : new ArrayList(Nf)) {
                        try {
                            PackageInfo packageInfo = packageManager.getPackageInfo(str, 0);
                            if (packageInfo != null) {
                                AppPackageInfo a5 = a(packageInfo, packageManager);
                                a5.reportMethod = 3;
                ...
                for (ResolveInfo resolveInfo : context.getPackageManager().queryIntentActivities(intent, 32)) {
                    if (resolveInfo != null && (activityInfo = resolveInfo.activityInfo) != null && !TextUtils.isEmpty(activityInfo.packageName)) {
                        ...
                        if (packageInfo2 != null) {
                            AppPackageInfo a6 = a(packageInfo2, packageManager);
                            a6.reportMethod = 1;
                    ...
                    for (String str3 : dv) {
                        try {
                            ...
                            if (packageInfo3 != null) {
                                AppPackageInfo a7 = a(packageInfo3, packageManager);
                                a7.reportMethod = 2;
                                hashMap.put(a7.packageName, a7);
                            }
    ...
    public static JSONObject a(AppPackageInfo appPackageInfo) {
        ...
        t.putValue(jSONObject, TTDownloadField.TT_APP_NAME, appPackageInfo.appName);
        return jSONObject;
    }
