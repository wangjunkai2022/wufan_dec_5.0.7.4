...
public final class c extends AbstractKsFeedAd implements com.kwad.components.core.internal.api.a {
    ...
    private com.kwad.components.core.widget.b<?, ?> B(Context context) {
        ...
        double a6 = com.kwad.sdk.core.config.d.a(com.kwad.sdk.core.config.c.atW);
        double screenWidth = k.getScreenWidth(context);
        Double.isNaN(screenWidth);
        if (width < a6 * screenWidth) {
        ...
        if (com.kwad.sdk.core.response.b.b.cQ(this.mAdTemplate)) {
            ...
            a5 = b.a(context, FeedType.fromInt(this.mAdTemplate.type), com.kwad.sdk.core.response.b.a.bd(this.mAdInfo));
        }
        if (a5 != null) {
            if (!(a5 instanceof n)) {
                a5.setMargin(com.kwad.sdk.c.a.a.a(context, 16.0f));
            }
            a5.setPageExitListener(this.bT);
        }
        return a5;
    }
    ...
    private void aS() {
        if (this.mAdTemplate != null) {
            com.kwad.sdk.core.diskcache.b.a DM = com.kwad.sdk.core.diskcache.b.a.DM();
            DM.remove("feed_ad_cache_" + this.mAdTemplate.posId);
        }
    }
    ...
    public final void render(final KsFeedAd.AdRenderListener adRenderListener) {
        if (this.dW.get()) {
            ...
            final int i4 = com.kwad.sdk.core.response.b.b.cQ(this.mAdTemplate) ? 3 : 2;
            this.dV.set(true);
    ...
    public final void setVideoSoundEnable(boolean z4) {
        this.dU.setVideoSoundEnable(z4);
    ...
    public void a(final com.kwad.components.core.widget.b bVar, final boolean z4) {
        ...
        bVar.setInnerAdInteractionListener(new b.a() { // from class: com.kwad.components.ad.feed.c.6
            ...
            public final void onAdClicked() {
                ...
                com.kwad.components.ad.feed.monitor.b.a(4, c.this.mAdTemplate, com.kwad.sdk.core.response.b.a.ba(c.this.mAdInfo), z4 ? 1 : 2);
            }
            ...
            public final void onAdShow() {
                ...
                com.kwad.components.ad.feed.monitor.b.a(3, c.this.mAdTemplate, com.kwad.sdk.core.response.b.a.ba(c.this.mAdInfo), z4 ? 1 : 2);
                if (z4) {
            ...
            public final void onDislikeClicked() {
                ...
                com.kwad.components.ad.feed.monitor.b.a(5, c.this.mAdTemplate, com.kwad.sdk.core.response.b.a.ba(c.this.mAdInfo), z4 ? 1 : 2);
            }
