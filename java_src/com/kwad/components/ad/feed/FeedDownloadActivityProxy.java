...
public class FeedDownloadActivityProxy extends com.kwad.components.core.proxy.c implements View.OnClickListener {
    ...
    public void onClick(View view) {
        com.kwad.components.core.e.d.a.a(new a.C0457a(view.getContext()).ar(this.mAdTemplate).b(this.mApkDownloadHelper).an(view == this.mProgressBarTv ? 1 : 2).ao(view == this.mProgressBarTv).a(new a.b() { // from class: com.kwad.components.ad.feed.FeedDownloadActivityProxy.2
