...
public abstract class c extends a implements View.OnClickListener, com.kwad.sdk.widget.c {
    ...
    public c(@NonNull Context context) {
        ...
        this.eS = new a.InterfaceC0476a() { // from class: com.kwad.components.ad.feed.b.c.3
            ...
            public final void a(int i4, ac.a aVar) {
                ...
                c.this.ba();
                com.kwad.components.core.e.d.a.a(new a.C0457a(c.this.getContext()).ar(c.this.mAdTemplate).b(c.this.mApkDownloadHelper).an(i6).ao(z4).aq(true).al(5).am(i5).d(aVar).as(true).a(new a.b() { // from class: com.kwad.components.ad.feed.b.c.3.1
    ...
    */
    public void onClick(android.view.View r5) {
        ...
        L8:
            ...
            com.kwad.sdk.utils.l.em(r5)
            R extends com.kwad.sdk.core.response.model.AdTemplate r5 = r4.mAdTemplate
            com.kwad.sdk.contentalliance.a.a.a r5 = com.kwad.sdk.contentalliance.a.a.a.bF(r5)
            com.kwad.sdk.core.video.videoview.a r0 = r4.eN
    ...
    static /* synthetic */ boolean b(c cVar, boolean z4) {
        cVar.eQ = false;
        return false;
    }
    ...
    */
    ...
    private void a(com.kwad.sdk.core.video.videoview.a aVar, boolean z4, final int i4) {
        if (aVar != null || this.eW) {
            ...
            ba();
            a.C0457a ao = new a.C0457a(getContext()).ar(this.mAdTemplate).b(this.mApkDownloadHelper).ao(z4);
            IAdLivePlayModule iAdLivePlayModule = this.eV;
