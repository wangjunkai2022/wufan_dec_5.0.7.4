...
public final class d extends FrameLayout {
    ...
    private void bp() {
        ...
        this.f55889fm = a(this.fh, 0.5f, com.kwad.sdk.c.a.a.a(getContext(), 50.0f));
        this.fj.addListener(new AnimatorListenerAdapter() { // from class: com.kwad.components.ad.feed.b.d.1
            ...
            public final void onAnimationEnd(Animator animator) {
                ...
                d.this.fh.startAnimation(d.this.f55889fm);
                d.this.fk.start();
            }
        });
    ...
    public final void bo() {
        ...
        Animation animation2 = this.f55889fm;
        if (animation2 != null) {
            animation2.cancel();
        }
    }
    ...
    private Animation a(final View view, float f5, int i4) {
        AlphaAnimation alphaAnimation = new AlphaAnimation(f5, 0.0f);
        float a5 = i4 / com.kwad.sdk.c.a.a.a(getContext(), 10.0f);
        ScaleAnimation scaleAnimation = new ScaleAnimation(1.0f, a5, 1.0f, a5, 1, 0.5f, 1, 0.5f);
