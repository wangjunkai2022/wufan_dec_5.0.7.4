...
public final class e extends FrameLayout {
    ...
    public Animator bq() {
        ...
        animatorSet.playSequentially(br, a5, bs);
        return animatorSet;
    }

    private Animator br() {
        Animator b5 = b(this.fp, com.kwad.sdk.c.a.a.a(getContext(), 128.0f));
        Animator b6 = b(this.fq, com.kwad.sdk.c.a.a.a(getContext(), 71.11f));
        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.setDuration(500L);
        animatorSet.playTogether(b5, b6);
        return animatorSet;
    }

    private Animator bs() {
        Animator f5 = f(this.fp);
        Animator f6 = f(this.fq);
        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.setDuration(500L);
    ...
    public final void a(final AnimatorListenerAdapter animatorListenerAdapter) {
        ...
        this.fq.post(new az() { // from class: com.kwad.components.ad.feed.b.e.1
    ...
    private Animator a(View view, long j4, float f5) {
        ...
        Animator a7 = com.kwad.components.core.s.n.a(view, create, 100L, 16.0f);
        AnimatorSet animatorSet = new AnimatorSet();
