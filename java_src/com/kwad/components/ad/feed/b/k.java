...
public final class k extends a implements View.OnClickListener, com.kwad.sdk.widget.c {
    ...
    private void be() {
        ...
        com.kwad.sdk.c.a.a.a(this, this.eB, this.fv, this.eI);
    ...
    private void c(View view, final int i4) {
        if (view == this.eD) {
            ...
            com.kwad.components.core.e.d.a.a(new a.C0457a(getContext()).al(5).am(i4).ar(this.mAdTemplate).b(this.mApkDownloadHelper).an(view == this.eI ? 1 : 2).ao(view == this.eI).a(new a.b() { // from class: com.kwad.components.ad.feed.b.k.1
