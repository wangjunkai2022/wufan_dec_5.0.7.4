...
public final class l extends a implements View.OnClickListener, com.kwad.sdk.widget.c {
    ...
    private void c(View view, final int i4) {
        if (view == this.eD) {
            ...
            com.kwad.components.core.e.d.a.a(new a.C0457a(getContext()).ar(this.mAdTemplate).al(5).am(i4).b(this.mApkDownloadHelper).an(view == this.eI ? 1 : 2).ao(view == this.eI).a(new a.b() { // from class: com.kwad.components.ad.feed.b.l.1
    ...
    public final void b(@NonNull AdResultData adResultData) {
        ...
        if (aZ.size() > 0) {
            ...
            KSImageLoader.loadFeeImage(this.fv, aZ.get(0), this.mAdTemplate, this.ez);
        } else {
            com.kwad.sdk.core.e.c.e("FeedTextRightImageView", "getImageUrlList size less than one");
        }
        be();
        com.kwad.sdk.c.a.a.a(this, this.eB, this.fv, this.eI, this.eD);
