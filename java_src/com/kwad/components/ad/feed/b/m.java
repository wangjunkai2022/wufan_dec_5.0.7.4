...
public final class m extends com.kwad.components.core.widget.b<AdResultData, AdTemplate> implements View.OnClickListener, com.kwad.sdk.widget.c {
    ...
    private d eP;
    private boolean eQ;
    private final a.InterfaceC0476a eS;
    ...
    public m(@NonNull Context context) {
        ...
        this.eS = new a.InterfaceC0476a() { // from class: com.kwad.components.ad.feed.b.m.10
            ...
            public final void a(int i4, ac.a aVar) {
                ...
                m.this.bw();
                com.kwad.components.core.e.d.a.a(new a.C0457a(m.this.getContext()).ar(m.this.mAdTemplate).b(m.this.mApkDownloadHelper).an(i6).ao(z4).aq(true).am(i5).d(aVar).as(true).a(new a.b() { // from class: com.kwad.components.ad.feed.b.m.10.1
    ...
    public IAdLivePlayModule bi() {
        bj();
        IAdLiveOfflineView a5 = com.kwad.components.ad.j.b.a(this.eU, this.mContext, 3);
        this.eT = a5;
        if (a5 == null) {
            return null;
        }
        IAdLivePlayModule adLivePlayModule = this.eU.getAdLivePlayModule(a5, ServiceProvider.Lx().appId, String.valueOf(com.kwad.sdk.core.response.b.a.ch(this.mAdInfo)), com.kwad.sdk.core.response.b.a.ci(this.mAdInfo), com.kwad.sdk.core.response.b.a.cj(this.mAdInfo));
    ...
    public void bu() {
        d.b bVar = new d.b() { // from class: com.kwad.components.ad.feed.b.m.17
            ...
            public final boolean b(final double d5) {
                if (br.o(m.this.fy, (int) (com.kwad.sdk.core.config.d.CV() * 100.0f))) {
                    com.kwad.components.core.e.d.a.a(new a.C0457a(m.this.getContext()).ar(m.this.mAdTemplate).b(m.this.mApkDownloadHelper).an(2).ao(false).aq(false).am(157).al(5).as(true).a(new a.b() { // from class: com.kwad.components.ad.feed.b.m.17.1
                        @Override // com.kwad.components.core.e.d.a.b
                        public final void onAdClicked() {
        ...
        this.ek = bVar;
        com.kwad.components.ad.feed.d.a(com.kwad.sdk.core.response.b.b.cN(this.mAdTemplate), this.mContext, bVar);
    }
    ...
    public ao.a getOpenNewPageListener() {
        return new ao.a() { // from class: com.kwad.components.ad.feed.b.m.18
            ...
            public final void a(com.kwad.components.core.webview.a.b bVar) {
                AdWebViewActivityProxy.launch(m.this.mContext, new AdWebViewActivityProxy.a.C0468a().at(bVar.title).au(bVar.url).aC(true).at(m.this.mAdTemplate).pK());
            }
        };
    }
    ...
    */
    ...
    public final void setVideoPlayConfig(KsAdVideoPlayConfig ksAdVideoPlayConfig) {
        ...
        if (ksAdVideoPlayConfig instanceof KSAdVideoPlayConfigImpl) {
            ...
            if (kSAdVideoPlayConfigImpl.getVideoSoundValue() != 0) {
                ...
                R r4 = this.mAdTemplate;
                if (r4 != 0) {
                    r4.mIsAudioEnable = isVideoSoundEnable;
                }
                IAdLiveOfflineView iAdLiveOfflineView = this.eT;
                if (iAdLiveOfflineView != null && iAdLiveOfflineView.getView() != null && (iAdLivePlayModule = this.eV) != null) {
    ...
    private void ay() {
        ...
        R r4 = this.mAdTemplate;
        com.kwad.components.ad.feed.monitor.b.a(r4, com.kwad.sdk.core.response.b.b.cI(r4));
        bt();
    }
    ...
    private void i(AdTemplate adTemplate) {
        ...
        Double d5 = fG.get(Long.valueOf(this.mAdTemplate.posId));
        if (d5 != null) {
            this.fy.setRatio(d5.floatValue());
        } else if (com.kwad.sdk.core.response.b.b.cO(this.mAdTemplate) > 0.0d) {
    ...
    public void v(final int i4) {
        bw();
        com.kwad.components.core.e.d.a.a(new a.C0457a(getContext()).ar(this.mAdTemplate).b(this.mApkDownloadHelper).an(1).ao(true).am(i4).al(5).aq(false).as(true).a(new a.b() { // from class: com.kwad.components.ad.feed.b.m.8
            @Override // com.kwad.components.core.e.d.a.b
            public final void onAdClicked() {
                m.this.aL(i4);
            }
    ...
    static /* synthetic */ boolean d(m mVar, boolean z4) {
        mVar.fV = true;
        return true;
    }
    ...
    public final void b(@NonNull AdResultData adResultData) {
        ...
        } else if (!com.kwad.sdk.core.response.b.b.cP(this.mAdTemplate)) {
            a("0", 0, 1);
        } else {
            if (!bx()) {
                i(this.mAdTemplate);
    ...
    final class AnonymousClass11 extends com.kwad.components.core.webview.c {
                ...
                public final void a(WebCardVideoPositionHandler.VideoPosition videoPosition) {
                    if (m.this.mAdInfo != null) {
                        if (com.kwad.sdk.core.response.b.a.bb(m.this.mAdInfo) || m.this.eW) {
                            ...
                            double d7 = videoPosition.leftMarginRation;
                            double d8 = i4;
                            Double.isNaN(d8);
                            marginLayoutParams2.leftMargin = (int) (d7 * d8);
                            ViewGroup.MarginLayoutParams marginLayoutParams3 = m.this.fR;
                            double d9 = videoPosition.widthRation;
                            Double.isNaN(d8);
                            marginLayoutParams3.width = (int) (d8 * d9);
                            ViewGroup.MarginLayoutParams marginLayoutParams4 = m.this.fR;
                            double d10 = m.this.fR.width;
                            double d11 = videoPosition.heightWidthRation;
                            Double.isNaN(d10);
                            marginLayoutParams4.height = (int) (d10 * d11);
        ...
        public final void a(com.kwad.sdk.core.webview.d.b.a aVar) {
            ...
            com.kwad.components.core.e.d.a.a(new a.C0457a(m.this.getContext()).ar(m.this.mAdTemplate).b(m.this.mApkDownloadHelper).ao(m.a(m.this, aVar)).an(i4).am(aVar.kl).ah((cVar == null || TextUtils.isEmpty(cVar.Lh)) ? "" : aVar.Yo.Lh).al(5).au(aVar.KS).as(bb).v(m.this.eV == null ? 0L : m.this.eV.getPlayDuration()).aq(true).a(new a.b() { // from class: com.kwad.components.ad.feed.b.m.11.5
                @Override // com.kwad.components.core.e.d.a.b
                public final void onAdClicked() {
                    if (m.this.abY != null) {
                        m.this.abY.onAdClicked();
    ...
    static /* synthetic */ boolean a(m mVar, boolean z4) {
        mVar.eQ = false;
        return false;
    }
    ...
    public void a(String str, int i4, int i5) {
        ...
        if (this.mAdWebView != null) {
            R r4 = this.mAdTemplate;
            com.kwad.components.ad.feed.monitor.b.a(r4, com.kwad.sdk.core.response.b.b.cI(r4), System.currentTimeMillis() - this.mAdWebView.getLoadTime(), i4);
        }
        ...
        com.kwad.components.ad.feed.monitor.b.a(i6, com.kwad.sdk.core.response.b.a.bd(this.mAdInfo), this.mAdTemplate, i5);
        a aVar = this.fQ;
        if (aVar != null) {
            aVar.c(1, str);
        }
        ...
        if (this.fM == null) {
            ...
            com.kwad.components.core.widget.b a5 = com.kwad.components.ad.feed.b.a(this.mContext, FeedType.fromInt(this.mAdTemplate.type), bd);
            this.fM = a5;
            if (a5 != null) {
    ...
    */
    ...
    private void a(com.kwad.sdk.core.video.videoview.a aVar, final int i4) {
        if (aVar != null) {
            ...
            bw();
            com.kwad.components.core.e.d.a.a(new a.C0457a(getContext()).ar(this.mAdTemplate).b(this.mApkDownloadHelper).an(2).as(com.kwad.sdk.core.response.b.a.bb(this.mAdInfo)).a(new a.b() { // from class: com.kwad.components.ad.feed.b.m.9
                @Override // com.kwad.components.core.e.d.a.b
                public final void onAdClicked() {
                    m.this.aL(i4);
                }
