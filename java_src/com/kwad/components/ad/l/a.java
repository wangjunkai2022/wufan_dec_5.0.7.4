...
public final class a {
    ...
    private void fk() {
        ...
        c.a b5 = this.HZ.getClientConfig().bu(false).bw(true).bv(false).bt(true).ek(this.mAdTemplate).a(mH()).b(ik());
        this.Ih = b5;
        this.HZ.setClientConfig(b5);
    ...
    static /* synthetic */ boolean d(a aVar, boolean z4) {
        aVar.Ia = true;
        return true;
    }
