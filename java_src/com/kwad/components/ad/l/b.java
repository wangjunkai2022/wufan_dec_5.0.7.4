...
public class b {
    ...
    public void fk() {
        ...
        if (ksAdWebView != null) {
            ...
            b.a f5 = new b.a().aA(this.mAdTemplate).aH(B(this.mAdTemplate)).d(this.cL).e(this.mReportExtData).k(this.dB).f(this.Il.get(0));
            if (this.Il.size() > 1 && this.Ik.size() > 1) {
                z4 = true;
            }
            this.fX.a(f5.aS(z4).a(this.fY));
    ...
    public final void a(@Nullable InterfaceC0420b interfaceC0420b) {
        this.Iq = interfaceC0420b;
        this.da.setVisibility(4);
        this.cP = -1;
