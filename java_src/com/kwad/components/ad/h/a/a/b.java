...
public final class b implements com.kwad.sdk.core.webview.c.a {
    ...
    public void I(int i4) {
        ...
        if (i4 >= 0 && this.nt != null) {
            InterfaceC0406b interfaceC0406b = this.nz;
            if (interfaceC0406b != null && i4 == 0) {
                interfaceC0406b.E(this.nw);
            }
            a aVar = new a();
            aVar.nD = i4;
            aVar.nC = this.nw;
    ...
    private static int f(AdInfo adInfo) {
        int b5 = com.kwad.components.ad.interstitial.b.b.b(adInfo);
        if (b5 <= 0) {
            b5 = 60;
        }
        int i4 = adInfo.adInsertScreenInfo.autoCloseTime;
        return i4 > 0 ? Math.min(b5, i4) : b5;
    }
