...
public class ActionBarAppPortrait extends LinearLayout implements c {
        ...
        if (this.cx == null) {
            this.cx = new com.kwad.sdk.core.download.a.a() { // from class: com.kwad.components.ad.reward.widget.actionbar.ActionBarAppPortrait.1
                ...
                public final void onPaused(int i4) {
                    ActionBarAppPortrait.this.Bt.e(com.kwad.sdk.core.response.b.a.dn(i4), i4);
                    ActionBarAppPortrait.this.Bu.setVisibility(8);
                }

                @Override // com.kwad.sdk.api.KsAppDownloadListener
                public final void onProgressUpdate(int i4) {
                    ActionBarAppPortrait.this.Bt.e(com.kwad.sdk.core.response.b.a.dm(i4), i4);
                    ActionBarAppPortrait.this.Bu.setVisibility(8);
                }
            };
        }
    ...
    private void ki() {
        ...
        boolean z4 = !TextUtils.isEmpty(ay);
    ...
    private void b(View view, final boolean z4) {
        int i4 = view == this.Bu ? 1 : 2;
        com.kwad.components.core.e.d.a.a(new a.C0457a(view.getContext()).ar(this.mAdTemplate).b(this.mApkDownloadHelper).al(1).am(i4).ao(view == this.Bt).an(i4).a(new a.b() { // from class: com.kwad.components.ad.reward.widget.actionbar.ActionBarAppPortrait.2
            @Override // com.kwad.components.core.e.d.a.b
            public final void onAdClicked() {
                if (ActionBarAppPortrait.this.Bx != null) {
                    ActionBarAppPortrait.this.Bx.N(z4);
                }
            }
        }));
    }
