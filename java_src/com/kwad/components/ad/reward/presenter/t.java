...
public final class t extends b implements View.OnClickListener, com.kwad.components.ad.reward.e.o, com.kwad.sdk.core.g.b {
    ...
    public Animator a(float f5, float f6) {
        ...
        Resources resources = this.hy.getResources();
        Animator a5 = com.kwad.components.core.s.n.a((View) this.hB, (Interpolator) null, 100L, 16.0f);
        a5.addListener(new AnimatorListenerAdapter() { // from class: com.kwad.components.ad.reward.presenter.t.7
