...
public class AdRewardPreviewActivityProxy extends c implements HandSlideView.a {
    ...
    private KsAdWebView.e getWebErrorListener() {
        return new KsAdWebView.e() { // from class: com.kwad.components.ad.reward.page.AdRewardPreviewActivityProxy.4
            ...
            public final void onPageStart() {
                ...
                c0514a.aqi = "award_view";
                b.a(true, AdRewardPreviewActivityProxy.this.mAdTemplate, null, new com.kwad.sdk.core.adlog.c.b().b(c0514a));
            }
    ...
    public void handleAdClick() {
        ...
        a.C0514a c0514a = new a.C0514a();
        c0514a.aqi = "award_view";
        b.a(this.mAdTemplate, (String) null, "nativePreview", new com.kwad.sdk.core.adlog.c.b().cK(72).b(c0514a).f(this.mWebContainer.getTouchCoords()), (JSONObject) null);
        closeHandSlideMask();
    ...
    public static void launch(Activity activity, AdResultData adResultData, AdTemplate adTemplate, String str, KsRewardVideoAd.RewardAdInteractionListener rewardAdInteractionListener) {
        ...
        try {
            ...
            com.kwad.components.ad.reward.monitor.c.a(true, adTemplate, PageCreateStage.ERROR_START_ACTIVITY.getStage(), e5.getMessage());
        }
    ...
    public void checkExposure() {
        long j4 = com.kwad.sdk.core.response.b.e.dS(this.mAdTemplate).adRewardInfo.callBackStrategyInfo.impressionCheckMs;
        if (j4 <= 0 || com.kwad.sdk.core.response.b.a.af(com.kwad.sdk.core.response.b.e.dS(this.mAdTemplate)) <= 5000) {
            return;
        }
    ...
    */
    public boolean checkIntentData(@androidx.annotation.Nullable android.content.Intent r5) {
        /*
            ...
            com.kwad.components.core.c.f r0 = com.kwad.components.core.c.f.ne()     // Catch: java.lang.Throwable -> L39
    ...
    public void initData() {
        ...
        int i4 = dS.adStyleInfo.adBrowseInfo.adBrowseDuration;
        int ad = com.kwad.sdk.core.response.b.a.ad(dS);
        this.mCount = i4;
        this.mSkipCount = Math.min(ad, i4);
    ...
    public void initView() {
        ...
        if (this.mUrl != null) {
            ...
            if (com.kwad.sdk.core.response.b.a.aE(dS) && d.CA() && ah.isWifiConnected(getActivity())) {
                cVar.r(new a.C0457a(getActivity()).ao(false).ap(false).ar(this.mAdTemplate).ar(false));
            }
        }
        this.mAdWebView.loadUrl(!TextUtils.isEmpty(this.mUrl) ? this.mUrl : com.kwad.sdk.core.response.b.a.aR(com.kwad.sdk.core.response.b.e.dS(this.mAdTemplate)));
        ...
        hVar.a(new h.a() { // from class: com.kwad.components.ad.reward.page.AdRewardPreviewActivityProxy.2
            ...
            public final void onProgress(long j4, long j5) {
                com.kwad.sdk.core.e.c.d(AdRewardPreviewActivityProxy.TAG, "onProgress currentDuration: " + j4 + " , totalDuration: " + j5);
