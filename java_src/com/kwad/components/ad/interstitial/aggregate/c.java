...
public final class c {
    ...
    public final void a(int i4, int i5, @NonNull SceneImpl sceneImpl, b bVar) {
        ...
        m23clone.setAdStyle(16);
        m23clone.setAdNum(i5);
        a(new ImpInfo(m23clone), new AnonymousClass1(sceneImpl, bVar, elapsedRealtime));
    }
        ...
        aVar.request(new o<com.kwad.components.core.request.a, AdResultData>() { // from class: com.kwad.components.ad.interstitial.aggregate.c.2
            private void c(@NonNull AdResultData adResultData) {
                ...
                if (adResultData.isAdResultDataEmpty()) {
                    jVar.onError(e.awK.errorCode, TextUtils.isEmpty(adResultData.testErrorMsg) ? e.awK.msg : adResultData.testErrorMsg);
                } else {
                    jVar.a(adResultData);
                }
            }
