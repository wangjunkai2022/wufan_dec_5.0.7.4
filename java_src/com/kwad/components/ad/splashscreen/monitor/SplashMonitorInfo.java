...
public class SplashMonitorInfo extends com.kwad.sdk.commercial.c.a implements Serializable {
    ...
    public SplashMonitorInfo setRotateComposeTimeout(boolean z4) {
        this.isRotateComposeTimeout = z4;
        return this;
    }
    ...
    public SplashMonitorInfo setWebTimeout(boolean z4) {
        this.isWebTimeout = z4;
        return this;
    }
