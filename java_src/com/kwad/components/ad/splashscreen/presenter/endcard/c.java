    ...
    private CloseCountDownView.a EL = new CloseCountDownView.a() { // from class: com.kwad.components.ad.splashscreen.presenter.endcard.c.1
        ...
        public final void dg() {
            ...
            if (c.this.Di.mTimerHelper != null) {
                c0514a.duration = c.this.Di.mTimerHelper.getTime();
            }
            com.kwad.sdk.core.adlog.c.b(c.this.Di.mAdTemplate, new com.kwad.sdk.core.adlog.c.b().cL(1).b(c0514a).cT(6), (JSONObject) null);
            c.this.Di.kP();
        }
        ...
        public final void lc() {
            ...
            com.kwad.sdk.core.adlog.c.b(c.this.Di.mAdTemplate, new com.kwad.sdk.core.adlog.c.b().cL(14).b(c0514a).cT(6), (JSONObject) null);
            c.this.Di.kT();
        }
    };
