...
public class SplashEndLandView extends FrameLayout {
    ...
    private void b(AdTemplate adTemplate, AdInfo adInfo, com.kwad.components.core.e.d.c cVar) {
        ...
        String a5 = com.kwad.components.ad.splashscreen.d.a(adTemplate, adInfo, cVar.ov(), 0);
    ...
    public final void a(AdTemplate adTemplate, com.kwad.components.core.e.d.c cVar, float f5) {
        a(new g(getContext(), f5));
