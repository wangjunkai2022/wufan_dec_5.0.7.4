...
public final class p extends e implements com.kwad.components.ad.splashscreen.e, com.kwad.components.ad.splashscreen.g, com.kwad.sdk.core.h.c {
    ...
    public void lx() {
        ...
        final Presenter y2 = y(this.mAdInfo);
        if (y2 != null) {
    ...
    private void ly() {
        lw();
        boolean dH = com.kwad.sdk.core.response.b.d.dH(this.mAdTemplate);
    ...
    public final void lw() {
        ...
        c0514a.aqh = com.kwad.components.ad.splashscreen.local.b.s(this.mAdInfo);
        com.kwad.sdk.core.adlog.c.d(this.Di.mAdTemplate, (JSONObject) null, new com.kwad.sdk.core.adlog.c.b().cM(123).b(c0514a));
    ...
    public final void h(boolean z4, boolean z5) {
        com.kwad.sdk.core.e.c.d("SplashWebViewPresenter", "isClick: " + z4 + ", isActionBar: " + z5);
        a(!z4, z5 ? 1 : 2, 132, null);
    }

    static /* synthetic */ boolean a(p pVar, boolean z4) {
        pVar.Ef = true;
        return true;
    }
