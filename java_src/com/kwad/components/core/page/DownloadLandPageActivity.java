...
public class DownloadLandPageActivity extends com.kwad.components.core.l.b<com.kwad.components.core.page.c.d> {
    ...
    public void initNativeLandPage() {
        ...
        setAdTitle((TextView) findViewById(R.id.ksad_ad_title), dS);
        ((TextView) findViewById(R.id.ksad_ad_info)).setText(dS.adBaseInfo.adDescription);
    ...
    public static void launch(@NonNull Context context, @NonNull AdTemplate adTemplate, boolean z4) {
        Class cls = aj.ML() ? AdWebViewActivity.class : KsFullScreenLandScapeVideoActivity.class;
        com.kwad.sdk.service.b.a(cls, DownloadLandPageActivity.class);
        Intent intent = new Intent(context, cls);
        intent.addFlags(268435456);
        intent.putExtra("key_template_json", adTemplate.toJson().toString());
        intent.putExtra(KEY_NEED_CLOSE_REWARD, z4);
        ...
        if (com.kwad.sdk.core.response.b.a.aE(adInfo)) {
            ...
            downloadProgressBar.setOnClickListener(new View.OnClickListener() { // from class: com.kwad.components.core.page.DownloadLandPageActivity.5
                ...
                public final void onClick(View view) {
                    ...
                    DownloadLandPageActivity.this.mApkDownloadHelper.r(new a.C0457a(DownloadLandPageActivity.this.getActivity()).ao(true).ap(false).ar(DownloadLandPageActivity.this.mAdTemplate).ar(false));
