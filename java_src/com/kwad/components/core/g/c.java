...
public final class c implements ImageLoadingListener {
    ...
    public c() {
        ...
        this.Mi = aVar;
        aVar.a(new a.InterfaceC0458a() { // from class: com.kwad.components.core.g.c.1
            ...
            @Override // com.kwad.components.core.g.a.InterfaceC0458a
            public final void y(final long j4) {
                ...
                c.this.b(new com.kwad.sdk.f.a<h>() { // from class: com.kwad.components.core.g.c.1.1
                    ...
                    public void accept(h hVar) {
                        hVar.onMediaPlayProgress(c.this.Ml, j4);
                    }
                });
    ...
    public final void setHorizontalGravity(int i4) {
        this.Mk = com.kwad.components.core.b.c.aj(i4);
        pb();
    }
    ...
    public final void setVerticalGravity(int i4) {
        this.Mk = com.kwad.components.core.b.c.ai(i4);
        pb();
    }
