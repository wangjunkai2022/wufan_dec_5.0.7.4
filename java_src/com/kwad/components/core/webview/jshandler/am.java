...
public final class am implements com.kwad.sdk.core.webview.c.a {
    ...
    public static class a extends com.kwad.sdk.core.download.a.a {
        ...
        public final void onPaused(int i4) {
            am.a(this.Yp, 3, (i4 * 1.0f) / 100.0f);
        }

        @Override // com.kwad.sdk.api.KsAppDownloadListener
        public final void onProgressUpdate(int i4) {
            am.a(this.Yp, 2, (i4 * 1.0f) / 100.0f);
        }
    }
    ...
    public static void a(c cVar, int i4, float f5) {
        if (cVar == null || cVar.nt == null) {
            return;
        }
        com.kwad.sdk.core.e.c.d("MultiProgressListener", "notifyDownloadProgress: " + cVar.nt + f5);
