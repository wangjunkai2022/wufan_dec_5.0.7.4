...
public final class n {
    public static Animator a(View view, @Nullable Interpolator interpolator, long j4, float f5) {
    ...
    public static ValueAnimator h(final View view, final boolean z4) {
    ...
    public static Animator a(View view, @Nullable Interpolator interpolator, float f5, float f6) {
        if (view == null) {
            return null;
        }
