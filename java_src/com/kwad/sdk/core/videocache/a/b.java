...
public final class b implements com.kwad.sdk.core.videocache.a {
    ...
    public b(File file, a aVar) {
        ...
        try {
            if (aVar != null) {
                ...
                this.file = file2;
                this.aDM = new RandomAccessFile(this.file, exists ? "r" : net.lingala.zip4j.util.e.f71861e0);
                return;
            }
    ...
    public final synchronized long GY() {
        try {
            ...
            throw new ProxyCacheException("Error reading length of file " + this.file, e5);
        }
    ...
    public final synchronized int a(byte[] bArr, long j4, int i4) {
        try {
            ...
            throw new ProxyCacheException(String.format("Error reading %d bytes with offset %d from file[%d bytes] to buffer[%d bytes]", Integer.valueOf(i4), Long.valueOf(j4), Long.valueOf(GY()), Integer.valueOf(bArr.length)), e5);
        }
        return this.aDM.read(bArr, 0, i4);
    }
    ...
    public final synchronized void close() {
        try {
            ...
            throw new ProxyCacheException("Error closing file " + this.file, e5);
        }
    }
    ...
    public final synchronized void complete() {
        ...
        if (this.file.renameTo(file)) {
            ...
            try {
                ...
                throw new ProxyCacheException("Error opening " + this.file + " as disc cache", e5);
            }
        }
    ...
    public final synchronized void d(byte[] bArr, int i4) {
        try {
            if (!isCompleted()) {
                this.aDM.seek(GY());
                this.aDM.write(bArr, 0, i4);
            } else {
                throw new ProxyCacheException("Error append cache: cache file " + this.file + " is completed!");
            }
        } catch (IOException e5) {
            throw new ProxyCacheException(String.format("Error writing %d bytes to %s from buffer with size %d", Integer.valueOf(i4), this.aDM, 1024), e5);
        }
    }
