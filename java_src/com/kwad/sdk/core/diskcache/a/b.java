...
public final class b implements Closeable {
    ...
    private final InputStream f55898in;
    private int pos;
    ...
    private void DL() {
        InputStream inputStream = this.f55898in;
        byte[] bArr = this.buf;
    ...
    public final void close() {
        synchronized (this.f55898in) {
            if (this.buf != null) {
                this.buf = null;
                com.kwad.sdk.crash.utils.b.closeQuietly(this.f55898in);
            }
        }
    }
            ...
            if (this.buf != null) {
                ...
                for (int i6 = this.pos; i6 != this.end; i6++) {
                    ...
                    if (bArr2[i6] == 10) {
                        ...
                        if (i6 != i7) {
                            i5 = i6 - 1;
                            if (bArr2[i5] == 13) {
                                String str = new String(bArr2, i7, i5 - i7, this.avr.name());
                                this.pos = i6 + 1;
                                return str;
                            }
                        }
                        i5 = i6;
                        String str2 = new String(bArr2, i7, i5 - i7, this.avr.name());
                        this.pos = i6 + 1;
                        return str2;
                    }
                }
                ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream((this.end - this.pos) + 80) { // from class: com.kwad.sdk.core.diskcache.a.b.1
                    ...
                    public final String toString() {
                        ...
                        try {
                            return new String(((ByteArrayOutputStream) this).buf, 0, i8, b.this.avr.name());
