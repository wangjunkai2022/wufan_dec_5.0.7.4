...
public class AdTemplate extends com.kwad.sdk.core.response.a.a implements Serializable {
    ...
    public <T> T getLocalParams(String str) {
        T t4;
        if (TextUtils.isEmpty(str) || (t4 = (T) this.mLocalParams.get(str)) == null) {
            return null;
        }
        return t4;
    }
    ...
    public void setCheatingFlow(boolean z4) {
        if (this.mCheatingFlow) {
            return;
        }
        this.mCheatingFlow = z4;
    }
    ...
    public void setLoadFromCache(boolean z4) {
        this.mAdStatusInfo.setLoadFromCache(z4);
    }
