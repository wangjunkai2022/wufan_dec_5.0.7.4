...
public final class a {
    private static List<String> a(AdTemplate adTemplate, int i4, @NonNull com.kwad.sdk.core.adlog.c.a aVar) {
        ...
        List<AdInfo.AdTrackInfo> list2 = dS.adTrackInfoList;
        if (ai.I(list2)) {
            return arrayList;
        }
        List<String> a5 = a(i4, aVar, arrayList, dS, list2);
        if (a5 != null) {
            return a5;
        }
    ...
    public static void d(@NonNull com.kwad.sdk.core.adlog.c.a aVar) {
        ...
        int i4 = aVar.apT;
        List<String> a5 = a(adTemplate, i4, aVar);
        if (ai.I(a5)) {
            return;
        }
        for (String str : a5) {
            ...
            if (adTemplate.isCheatingFlow()) {
                ...
                String a6 = ab.a(ServiceProvider.getContext(), str, i4 == 2 ? aVar.kn : null, com.kwad.sdk.core.response.b.a.aA(e.dS(adTemplate)));
                ab.f(adTemplate, str, a6);
                AdHttpProxy yy = g.yy();
                int i5 = yy instanceof com.kwad.sdk.core.network.c.a ? 2 : 1;
                c doGetWithoutResponse = yy.doGetWithoutResponse(a6, null);
                if (dp(doGetWithoutResponse.code)) {
                    ...
                    com.kwad.sdk.commercial.j.a.a(adTemplate, i4, str, a6, d.cb(doGetWithoutResponse.code), doGetWithoutResponse.awE, i5);
                }
            }
        }
    }
    ...
    */
    private static java.util.List<java.lang.String> a(int r2, com.kwad.sdk.core.adlog.c.a r3, java.util.List<java.lang.String> r4, com.kwad.sdk.core.response.model.AdInfo r5, java.util.List<com.kwad.sdk.core.response.model.AdInfo.AdTrackInfo> r6) {
        /*
            ...
            if (r2 != r0) goto L4f
            boolean r2 = com.kwad.sdk.core.response.b.a.bm(r5)
            if (r2 == 0) goto L4f
            java.lang.String r2 = r3.Lh     // Catch: java.lang.Throwable -> L4e
            ...
            java.lang.String r3 = r3.Lh     // Catch: java.lang.Throwable -> L4e
            ...
            goto L22
        L20:
            int r2 = r3.aqO     // Catch: java.lang.Throwable -> L4e
        L22:
