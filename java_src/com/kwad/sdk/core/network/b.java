...
public abstract class b implements f {
    ...
    public JSONObject getBody() {
        ...
        if (!TextUtils.isEmpty(bk.getAppId())) {
            t.putValue(jSONObject, "appId", bk.getAppId());
        } else {
    ...
    public void putBody(String str, double d5) {
        t.putValue(this.mBodyParams, str, d5);
    }
    ...
    public void putBody(String str, float f5) {
        t.putValue(this.mBodyParams, str, f5);
    }

    public void putBody(String str, byte b5) {
        t.putValue(this.mBodyParams, str, b5);
    }
    ...
    public void putBody(String str, boolean z4) {
        t.putValue(this.mBodyParams, str, z4);
    }
