...
public class ImageLoader {
    ...
    public void denyNetworkDownloads(boolean z4) {
        this.engine.denyNetworkDownloads(z4);
    }
    ...
    public void handleSlowNetwork(boolean z4) {
        this.engine.handleSlowNetwork(z4);
    }
