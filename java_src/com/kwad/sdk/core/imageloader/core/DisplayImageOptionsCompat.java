...
public final class DisplayImageOptionsCompat {
    ...
    public static class Builder {
        ...
        public Builder considerExifParams(boolean z4) {
        ...
        public Builder setCircle(boolean z4) {
            this.isCircle = z4;
            return this;
        }
        ...
        public Builder setFrameSequence(boolean z4) {
            this.isFrameSequence = z4;
            return this;
        }
        ...
        public Builder setStrokeWidth(float f5) {
            if (f5 > 0.0f) {
                this.strokeWidth = f5;
                this.isCircle = true;
            }
        ...
        @Deprecated
        public Builder cacheOnDisc(boolean z4) {
            return cacheOnDisk(z4);
        }
