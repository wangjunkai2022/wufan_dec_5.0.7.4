...
public class CircleBitmapDisplayer implements BitmapDisplayer {
    ...
    public static class CircleDrawable extends Drawable {
        ...
        public CircleDrawable(Bitmap bitmap, Integer num, float f5) {
            ...
            this.strokeWidth = f5;
            this.strokeRadius = this.radius - (f5 / 2.0f);
        }
        ...
        public void draw(Canvas canvas) {
            ...
            if (paint != null) {
                ...
                canvas.drawCircle(f6, f6, this.strokeRadius, paint);
            }
        }
    ...
    public CircleBitmapDisplayer(Integer num, float f5) {
