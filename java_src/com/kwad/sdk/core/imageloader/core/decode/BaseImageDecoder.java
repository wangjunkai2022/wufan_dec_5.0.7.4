...
public class BaseImageDecoder implements ImageDecoder {
    ...
    public BaseImageDecoder(boolean z4) {
    ...
    protected Bitmap considerExactScaleAndOrientatiton(Bitmap bitmap, ImageDecodingInfo imageDecodingInfo, int i4, boolean z4) {
        ...
        if (i4 != 0) {
            ...
            if (this.loggingEnabled) {
                L.d(LOG_ROTATE_IMAGE, Integer.valueOf(i4), imageDecodingInfo.getImageKey());
            }
        }
    ...
    public static class ExifInfo {
        ...
        protected ExifInfo(int i4, boolean z4) {
            this.rotation = i4;
