...
public class LinkedBlockingDeque<E> extends AbstractQueue<E> implements BlockingDeque<E>, Serializable {
    ...
    public boolean offer(E e5, long j4, TimeUnit timeUnit) {
        return offerLast(e5, j4, timeUnit);
    }
    ...
    @Override // com.kwad.sdk.core.imageloader.core.assist.deque.BlockingDeque
    public boolean offerFirst(E e5, long j4, TimeUnit timeUnit) {
        Objects.requireNonNull(e5);
        Node<E> node = new Node<>(e5);
        long nanos = timeUnit.toNanos(j4);
        ReentrantLock reentrantLock = this.lock;
    ...
    @Override // com.kwad.sdk.core.imageloader.core.assist.deque.BlockingDeque
    public boolean offerLast(E e5, long j4, TimeUnit timeUnit) {
        Objects.requireNonNull(e5);
        Node<E> node = new Node<>(e5);
        long nanos = timeUnit.toNanos(j4);
        ReentrantLock reentrantLock = this.lock;
