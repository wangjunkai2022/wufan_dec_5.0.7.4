...
public class LruDiskCache implements DiskCache {
    ...
    public void clear() {
        ...
        try {
            initCache(this.cache.getDirectory(), this.reserveCacheDir, this.cache.getMaxSize(), this.cache.DG());
    ...
    public boolean save(String str, InputStream inputStream, IoUtils.CopyListener copyListener) {
        a.C0517a dz = this.cache.dz(getKey(str));
        if (dz == null) {
            return false;
        }
        BufferedOutputStream bufferedOutputStream = new BufferedOutputStream(dz.cZ(0), this.bufferSize);
        try {
