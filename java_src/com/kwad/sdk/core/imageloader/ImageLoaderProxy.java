...
public enum ImageLoaderProxy implements IImageLoader {
    ...
    @Override // com.kwad.sdk.core.imageloader.IImageLoader
    public final void setCacheSize(int i4) {
        this.mDelegate.setCacheSize(i4);
    }
    ...
    @Override // com.kwad.sdk.service.a.i
    public final void load(@NonNull KsFragment ksFragment, @NonNull String str, @NonNull ImageView imageView, @NonNull Drawable drawable, @NonNull Drawable drawable2, float f5) {
        this.mDelegate.load(ksFragment, str, imageView, drawable, drawable2, f5);
    }
