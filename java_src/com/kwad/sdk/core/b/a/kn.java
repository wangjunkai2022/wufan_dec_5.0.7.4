...
public final class kn implements com.kwad.sdk.core.d<PhotoInfo.VideoInfo> {
    ...
    private static JSONObject b2(PhotoInfo.VideoInfo videoInfo, JSONObject jSONObject) {
        ...
        double d5 = videoInfo.leftRatio;
        if (d5 != 0.0d) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "leftRatio", d5);
        }
        double d6 = videoInfo.topRatio;
        if (d6 != 0.0d) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "topRatio", d6);
        }
