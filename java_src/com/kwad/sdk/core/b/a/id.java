...
public final class id implements com.kwad.sdk.core.d<RewardMonitorInfo> {
    ...
    private static JSONObject b2(RewardMonitorInfo rewardMonitorInfo, JSONObject jSONObject) {
        ...
        boolean z4 = rewardMonitorInfo.enableRewardLayoutOptimise;
        if (z4) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "enable_reward_layout_optimise", z4);
        }
        boolean z5 = rewardMonitorInfo.enableFullscreenLayoutOptimise;
        if (z5) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "enable_fullscreen_layout_optimise", z5);
        }
