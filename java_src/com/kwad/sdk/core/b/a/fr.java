...
public final class fr {
    ...
    static {
        ...
        awm = hashMap;
        hashMap.put(AdMatrixInfo.SplashEndCardTKInfo.class, new iz());
        ...
        awm.put(AdMatrixInfo.SplashSlideInfo.class, new ji());
        ...
        awm.put(k.a.C0541a.class, new jl());
