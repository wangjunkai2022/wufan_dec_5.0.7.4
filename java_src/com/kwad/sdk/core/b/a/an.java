...
public final class an implements com.kwad.sdk.core.d<AdInfo.AdSplashInfo> {
    ...
    private static JSONObject b2(AdInfo.AdSplashInfo adSplashInfo, JSONObject jSONObject) {
        ...
        boolean z4 = adSplashInfo.impressionStatisticalChangeSwitch;
        if (z4) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "impressionStatisticalChangeSwitch", z4);
        }
        double d5 = adSplashInfo.impressionLimitSize;
        if (d5 != 0.0d) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "impressionLimitSize", d5);
        }
