...
public final class l implements com.kwad.sdk.core.d<AdInfo.AdConversionInfo> {
    ...
    private static JSONObject b2(AdInfo.AdConversionInfo adConversionInfo, JSONObject jSONObject) {
        ...
        boolean z4 = adConversionInfo.appSecondConfirmationSwitch;
        if (z4) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "appSecondConfirmationSwitch", z4);
        }
        boolean z5 = adConversionInfo.h5SecondConfirmationSwitch;
        if (z5) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "h5SecondConfirmationSwitch", z5);
        }
        ...
        boolean z6 = adConversionInfo.blockCallbackIfSpam;
        if (z6) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "blockCallbackIfSpam", z6);
        }
        boolean z7 = adConversionInfo.needDeeplinkReplaceAdapta;
        if (z7) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "needDeeplinkReplaceAdapta", z7);
        }
        boolean z8 = adConversionInfo.interceptH5JumpAppMkt;
        if (z8) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "interceptH5JumpAppMkt", z8);
        }
        com.kwad.sdk.utils.t.putValue(jSONObject, "interceptH5JumpTimeOut", adConversionInfo.interceptH5JumpTimeOut);
        ...
        boolean z9 = adConversionInfo.isSupportKeepPlaying;
        if (z9) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "isSupportKeepPlaying", z9);
        }
