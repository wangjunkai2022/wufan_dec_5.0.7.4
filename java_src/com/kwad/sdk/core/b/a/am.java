...
public final class am implements com.kwad.sdk.core.d<AdInfo.AdShowVideoH5Info> {
    ...
    private static JSONObject b2(AdInfo.AdShowVideoH5Info adShowVideoH5Info, JSONObject jSONObject) {
        ...
        boolean z4 = adShowVideoH5Info.videoAutoLoopAtH5;
        if (z4) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "videoAutoLoopAtH5", z4);
        }
        boolean z5 = adShowVideoH5Info.videoMutedAtH5;
        if (z5) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "videoMutedAtH5", z5);
        }
        boolean z6 = adShowVideoH5Info.videoClickAtH5;
        if (z6) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "videoClickAtH5", z6);
        }
        return jSONObject;
    }
}
