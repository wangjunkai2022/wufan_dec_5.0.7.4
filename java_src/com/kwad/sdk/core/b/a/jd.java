...
public final class jd implements com.kwad.sdk.core.d<SplashMonitorInfo> {
    ...
    private static void a2(SplashMonitorInfo splashMonitorInfo, JSONObject jSONObject) {
        ...
        splashMonitorInfo.count = jSONObject.optInt(QuarkInstallAppActivity_.f36990i);
    ...
    private static JSONObject b2(SplashMonitorInfo splashMonitorInfo, JSONObject jSONObject) {
        ...
        if (i7 != 0) {
            com.kwad.sdk.utils.t.putValue(jSONObject, QuarkInstallAppActivity_.f36990i, i7);
        }
        ...
        if (j11 != 0) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "creative_id", j11);
        }
        ...
        boolean z4 = splashMonitorInfo.isRotateComposeTimeout;
        if (z4) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "is_rotate_compose_timeout", z4);
        }
        ...
        boolean z5 = splashMonitorInfo.isWebTimeout;
        if (z5) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "is_web_timeout", z5);
        }
