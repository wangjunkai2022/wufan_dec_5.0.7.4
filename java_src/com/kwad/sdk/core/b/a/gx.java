...
public final class gx implements com.kwad.sdk.core.d<com.kwad.sdk.core.network.i> {
    ...
    private static void a2(com.kwad.sdk.core.network.i iVar, JSONObject jSONObject) {
        ...
        iVar.host = jSONObject.optString(com.alipay.sdk.cons.c.f4843f);
        ...
        if (JSONObject.NULL.toString().equals(iVar.axb)) {
            iVar.axb = "";
        }
    ...
    private static JSONObject b2(com.kwad.sdk.core.network.i iVar, JSONObject jSONObject) {
        ...
        if (str2 != null && !str2.equals("")) {
            com.kwad.sdk.utils.t.putValue(jSONObject, com.alipay.sdk.cons.c.f4843f, iVar.host);
        }
        int i4 = iVar.httpCode;
        if (i4 != 0) {
            com.kwad.sdk.utils.t.putValue(jSONObject, IjkMediaPlayer.OnNativeInvokeListener.ARG_HTTP_CODE, i4);
        }
