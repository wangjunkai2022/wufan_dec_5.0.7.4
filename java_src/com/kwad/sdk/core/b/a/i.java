...
public final class i implements com.kwad.sdk.core.d<AdInfo.AdBaseInfo> {
    ...
    private static void a2(AdInfo.AdBaseInfo adBaseInfo, JSONObject jSONObject) {
        ...
        adBaseInfo.appName = jSONObject.optString(TTDownloadField.TT_APP_NAME);
    ...
    private static JSONObject b2(AdInfo.AdBaseInfo adBaseInfo, JSONObject jSONObject) {
        ...
        if (str11 != null && !str11.equals("")) {
            com.kwad.sdk.utils.t.putValue(jSONObject, TTDownloadField.TT_APP_NAME, adBaseInfo.appName);
        }
        ...
        if (i11 != 0) {
            com.kwad.sdk.utils.t.putValue(jSONObject, MediationConstant.KEY_ECPM, i11);
        }
        ...
        boolean z4 = adBaseInfo.extraClickReward;
        if (z4) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "extraClickReward", z4);
        }
        boolean z5 = adBaseInfo.enableClientProofreadTime;
        if (z5) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "enableClientProofreadTime", z5);
        }
        return jSONObject;
    }
}
