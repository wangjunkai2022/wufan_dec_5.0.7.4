...
public final class al implements com.kwad.sdk.core.d<AdInfo.AdRewardInfo> {
    ...
    private static JSONObject b2(AdInfo.AdRewardInfo adRewardInfo, JSONObject jSONObject) {
        ...
        boolean z4 = adRewardInfo.rewardVideoEndCardSwitch;
        if (z4) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "rewardVideoEndCardSwitch", z4);
        }
        boolean z5 = adRewardInfo.recommendAggregateSwitch;
        if (z5) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "recommendAggregateSwitch", z5);
        }
