...
public final class dc implements com.kwad.sdk.core.d<DownloadParams> {
    ...
    private static JSONObject b2(DownloadParams downloadParams, JSONObject jSONObject) {
        ...
        if (str10 != null && !str10.equals("")) {
            com.kwad.sdk.utils.t.putValue(jSONObject, TTDownloadField.TT_FILE_PATH, downloadParams.filePath);
        }
        boolean z4 = downloadParams.requestInstallPermission;
        if (z4) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "requestInstallPermission", z4);
        }
        boolean z5 = downloadParams.downloadEnablePause;
        if (z5) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "downloadEnablePause", z5);
        }
