...
public final class ap implements com.kwad.sdk.core.d<AdInfo.AdStyleConfInfo> {
    ...
    private static JSONObject b2(AdInfo.AdStyleConfInfo adStyleConfInfo, JSONObject jSONObject) {
        ...
        boolean z4 = adStyleConfInfo.rewardVideoInteractSwitch;
        if (z4) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "rewardVideoInteractSwitch", z4);
        }
        com.kwad.sdk.utils.t.a(jSONObject, "adShowVideoH5Info", adStyleConfInfo.adShowVideoH5Info);
        boolean z5 = adStyleConfInfo.adPushSwitch;
        if (z5) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "adPushSwitch", z5);
        }
        ...
        boolean z6 = adStyleConfInfo.useNativeForOuterLiveAd;
        if (z6) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "useNativeForOuterLiveAd", z6);
        }
