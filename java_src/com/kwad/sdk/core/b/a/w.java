...
public final class w implements com.kwad.sdk.core.d<AdInfo.AdInsertScreenInfo> {
    ...
    private static void a2(AdInfo.AdInsertScreenInfo adInsertScreenInfo, JSONObject jSONObject) {
        ...
        adInsertScreenInfo.cycleAggregateDailyShowCount = jSONObject.optInt("cycleAggregateDailyShowCount", new Integer(com.join.mgps.Util.v.f28122v).intValue());
        adInsertScreenInfo.cycleAggregateStyle = jSONObject.optInt("cycleAggregateStyle");
        adInsertScreenInfo.cycleAggregateInterval = jSONObject.optInt("cycleAggregateInterval", new Integer(com.join.mgps.Util.v.f28122v).intValue());
    ...
    private static JSONObject b2(AdInfo.AdInsertScreenInfo adInsertScreenInfo, JSONObject jSONObject) {
        ...
        boolean z4 = adInsertScreenInfo.cycleAggregateSwitch;
        if (z4) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "cycleAggregateSwitch", z4);
        }
