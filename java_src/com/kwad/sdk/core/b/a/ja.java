...
public final class ja implements com.kwad.sdk.core.d<SplashExtraDataImpl> {
    ...
    private static JSONObject b2(SplashExtraDataImpl splashExtraDataImpl, JSONObject jSONObject) {
        ...
        boolean z4 = splashExtraDataImpl.disableShake;
        if (z4) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "disableShake", z4);
        }
        boolean z5 = splashExtraDataImpl.disableRotate;
        if (z5) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "disableRotate", z5);
        }
        boolean z6 = splashExtraDataImpl.disableSlide;
        if (z6) {
