...
public final class ft implements com.kwad.sdk.core.d<WebCardVideoPositionHandler.VideoPosition.KSAdJSCornerModel> {
    ...
    private static JSONObject b2(WebCardVideoPositionHandler.VideoPosition.KSAdJSCornerModel kSAdJSCornerModel, JSONObject jSONObject) {
        ...
        double d5 = kSAdJSCornerModel.topLeft;
        if (d5 != 0.0d) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "topLeft", d5);
        }
        double d6 = kSAdJSCornerModel.topRight;
        if (d6 != 0.0d) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "topRight", d6);
        }
        double d7 = kSAdJSCornerModel.bottomRight;
        if (d7 != 0.0d) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "bottomRight", d7);
        }
        double d8 = kSAdJSCornerModel.bottomLeft;
        if (d8 != 0.0d) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "bottomLeft", d8);
        }
        return jSONObject;
    }
}
