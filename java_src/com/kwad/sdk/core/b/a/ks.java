...
public final class ks implements com.kwad.sdk.core.d<WebCardVideoPositionHandler.VideoPosition> {
    ...
    private static JSONObject b2(WebCardVideoPositionHandler.VideoPosition videoPosition, JSONObject jSONObject) {
        ...
        double d5 = videoPosition.leftMarginRation;
        if (d5 != 0.0d) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "leftMarginRation", d5);
        }
        double d6 = videoPosition.topMarginRation;
        if (d6 != 0.0d) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "topMarginRation", d6);
        }
        double d7 = videoPosition.widthRation;
        if (d7 != 0.0d) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "widthRation", d7);
        }
        double d8 = videoPosition.heightWidthRation;
        if (d8 != 0.0d) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "heightWidthRation", d8);
        }
