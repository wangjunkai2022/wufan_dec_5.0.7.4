...
public final class ar implements com.kwad.sdk.core.d<AdTemplate> {
    private static void k(AdTemplate adTemplate, JSONObject jSONObject) {
        ...
        adTemplate.mIsForceJumpLandingPage = jSONObject.optBoolean("mIsForceJumpLandingPage", new Boolean(Bugly.SDK_IS_DEV).booleanValue());
    ...
    private static JSONObject l(AdTemplate adTemplate, JSONObject jSONObject) {
        ...
        boolean z4 = adTemplate.mIsFromContent;
        if (z4) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "mIsFromContent", z4);
        }
        ...
        boolean z5 = adTemplate.mIsAudioEnable;
        if (z5) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "mIsAudioEnable", z5);
        }
        boolean z6 = adTemplate.mRewardVerifyCalled;
        if (z6) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "mRewardVerifyCalled", z6);
        }
        boolean z7 = adTemplate.isWebViewDownload;
        if (z7) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "isWebViewDownload", z7);
        }
        boolean z8 = adTemplate.watched;
        if (z8) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "watched", z8);
        }
        boolean z9 = adTemplate.converted;
        if (z9) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "converted", z9);
        }
        ...
        if (z10) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "notNetworkRequest", z10);
        }
        ...
        boolean z11 = adTemplate.isNativeRewardPreview;
        if (z11) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "isNativeRewardPreview", z11);
        }
        boolean z12 = adTemplate.mInstallApkFromSDK;
        if (z12) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "mInstallApkFromSDK", z12);
        }
        boolean z13 = adTemplate.mInstallApkFormUser;
        if (z13) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "mInstallApkFormUser", z13);
        }
        boolean z14 = adTemplate.mClickOpenAppStore;
        if (z14) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "mClickOpenAppStore", z14);
        }
