...
public final class ao implements com.kwad.sdk.core.d<AdStatusInfo> {
    ...
    private static void a2(AdStatusInfo adStatusInfo, JSONObject jSONObject) {
        ...
        adStatusInfo.downloadType = jSONObject.optInt(PlugDownDialogAcitivity_.DOWNLOAD_TYPE_EXTRA);
    ...
    private static JSONObject b2(AdStatusInfo adStatusInfo, JSONObject jSONObject) {
        ...
        boolean z4 = adStatusInfo.loadFromCache;
        if (z4) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "loadFromCache", z4);
        }
        ...
        if (i4 != 0) {
            com.kwad.sdk.utils.t.putValue(jSONObject, PlugDownDialogAcitivity_.DOWNLOAD_TYPE_EXTRA, i4);
        }
