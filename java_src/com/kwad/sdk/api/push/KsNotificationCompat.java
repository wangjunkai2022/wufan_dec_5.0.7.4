...
public class KsNotificationCompat {
    ...
    public static final class Builder {
        ...
        public final Builder setAutoCancel(boolean z4) {
            this.mBuilder.setAutoCancel(z4);
            return this;
        }
        ...
        public final Builder setFullScreenIntent(PendingIntent pendingIntent, boolean z4) {
            this.mBuilder.setFullScreenIntent(pendingIntent, z4);
            return this;
        }
        ...
        public final Builder setGroupSummary(boolean z4) {
            this.mBuilder.setGroupSummary(z4);
            return this;
        }
        ...
        public final Builder setOnlyAlertOnce(boolean z4) {
            this.mBuilder.setOnlyAlertOnce(z4);
            return this;
        }
        ...
        @KsAdSdkApi
        @Keep
        public final Builder setProgress(int i4, int i5, boolean z4) {
            this.mBuilder.setProgress(i4, i5, z4);
            return this;
        }
        ...
        public final Builder setUsesChronometer(boolean z4) {
            this.mBuilder.setUsesChronometer(z4);
            return this;
        }
