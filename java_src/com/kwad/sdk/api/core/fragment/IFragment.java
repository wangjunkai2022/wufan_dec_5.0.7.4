...
interface IFragment {
    ...
    @KsAdSdkDynamicApi
    @Keep
    void setAllowEnterTransitionOverlap(boolean z4);

    @KsAdSdkDynamicApi
    @Keep
    void setAllowReturnTransitionOverlap(boolean z4);
    ...
    @KsAdSdkDynamicApi
    @Keep
    void setHasOptionsMenu(boolean z4);

    void setInitialSavedState(@Nullable KsSavedState ksSavedState);

    @KsAdSdkDynamicApi
    @Keep
    void setMenuVisibility(boolean z4);
    ...
    @KsAdSdkDynamicApi
    @Keep
    void setUserVisibleHint(boolean z4);
