...
public abstract class DelegateFragment extends Fragment implements IDelegateFragment {
    ...
    public Animation onCreateAnimation(int i4, boolean z4, int i5) {
        return this.mBase.onCreateAnimation(i4, z4, i5);
    }

    @Override // androidx.fragment.app.Fragment
    public Animator onCreateAnimator(int i4, boolean z4, int i5) {
        return this.mBase.onCreateAnimator(i4, z4, i5);
    }
    ...
    public void onMultiWindowModeChanged(boolean z4) {
        ...
        this.mBase.onMultiWindowModeChanged(z4);
    }
    ...
    public void onPictureInPictureModeChanged(boolean z4) {
        ...
        this.mBase.onPictureInPictureModeChanged(z4);
    }
