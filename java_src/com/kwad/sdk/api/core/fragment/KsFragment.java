...
public class KsFragment extends AbstractIFragmentLifecycle implements IFragment, IFragmentLifecycle {
    ...
    @Override // com.kwad.sdk.api.core.fragment.AbstractIFragmentLifecycle, com.kwad.sdk.api.core.fragment.IFragmentLifecycle
    public /* bridge */ /* synthetic */ Animation onCreateAnimation(int i4, boolean z4, int i5) {
        return super.onCreateAnimation(i4, z4, i5);
    }

    @Override // com.kwad.sdk.api.core.fragment.AbstractIFragmentLifecycle, com.kwad.sdk.api.core.fragment.IFragmentLifecycle
    public /* bridge */ /* synthetic */ Animator onCreateAnimator(int i4, boolean z4, int i5) {
    ...
    @Override // com.kwad.sdk.api.core.fragment.AbstractIFragmentLifecycle, com.kwad.sdk.api.core.fragment.IFragmentLifecycle
    public /* bridge */ /* synthetic */ void onHiddenChanged(boolean z4) {
    ...
    @Override // com.kwad.sdk.api.core.fragment.AbstractIFragmentLifecycle, com.kwad.sdk.api.core.fragment.IFragmentLifecycle
    public /* bridge */ /* synthetic */ void onMultiWindowModeChanged(boolean z4) {
    ...
    @Override // com.kwad.sdk.api.core.fragment.AbstractIFragmentLifecycle, com.kwad.sdk.api.core.fragment.IFragmentLifecycle
    public /* bridge */ /* synthetic */ void onPictureInPictureModeChanged(boolean z4) {
    ...
    @KsAdSdkDynamicApi
    @Keep
    public final void setAllowEnterTransitionOverlap(boolean z4) {
        this.mBase.setAllowEnterTransitionOverlap(z4);
    }

    @Override // com.kwad.sdk.api.core.fragment.IFragment
    @KsAdSdkDynamicApi
    @Keep
    public final void setAllowReturnTransitionOverlap(boolean z4) {
        this.mBase.setAllowReturnTransitionOverlap(z4);
    }
    ...
    public final void setHasOptionsMenu(boolean z4) {
        this.mBase.setHasOptionsMenu(z4);
    }
    ...
    public final void setMenuVisibility(boolean z4) {
        this.mBase.setMenuVisibility(z4);
    }
    ...
    public final void setRetainInstance(boolean z4) {
        this.mBase.setRetainInstance(z4);
    }
    ...
    public void setUserVisibleHint(boolean z4) {
        this.mBase.setUserVisibleHint(z4);
    }
