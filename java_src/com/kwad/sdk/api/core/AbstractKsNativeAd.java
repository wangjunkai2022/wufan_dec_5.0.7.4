...
public abstract class AbstractKsNativeAd implements KsNativeAd {
    ...
    @KsAdSdkDynamicApi
    @Keep
    public final View getVideoView(Context context, boolean z4) {
        return getVideoView2(Wrapper.wrapContextIfNeed(context), z4);
    }
    ...
    @KsAdSdkDynamicApi
    @Keep
    protected abstract View getVideoView2(Context context, boolean z4);
