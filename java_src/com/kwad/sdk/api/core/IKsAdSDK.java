...
public interface IKsAdSDK {
    ...
    @KsAdSdkDynamicApi
    @Keep
    void setInitStartTime(long j4);

    @KsAdSdkDynamicApi
    @Keep
    void setIsExternal(boolean z4);
    ...
    @KsAdSdkDynamicApi
    @Keep
    void setLoadingLottieAnimation(boolean z4, @RawRes int i4);

    @KsAdSdkDynamicApi
    @Keep
    void setLoadingLottieAnimationColor(boolean z4, @ColorInt int i4);

    @KsAdSdkDynamicApi
    @Keep
    void setPersonalRecommend(boolean z4);

    @KsAdSdkDynamicApi
    @Keep
    void setProgrammaticRecommend(boolean z4);
