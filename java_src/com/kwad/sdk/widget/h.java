...
public final class h {
    ...
    public static class a {
        ...
        public final a cf(boolean z4) {
            this.leftTop = z4;
            return this;
        }

        public final a cg(boolean z4) {
            this.topRight = z4;
            return this;
        }

        public final a ch(boolean z4) {
            this.rightBottom = z4;
            return this;
        }

        public final a ci(boolean z4) {
            this.bottomLeft = z4;
            return this;
        }
        ...
        public final void setAllCorner(boolean z4) {
            this.leftTop = z4;
            this.topRight = z4;
            this.rightBottom = z4;
            this.bottomLeft = z4;
