...
public final class NativeCrashHandler extends b {
    ...
    public static class a {
        private static final NativeCrashHandler aHo = new NativeCrashHandler();
    }
    ...
    public static native void install(@NonNull String str, boolean z4, @NonNull String str2, int i4);
    ...
    public static void onCallFromNative() {
        ...
        try {
            ...
            g.b(null, mMessage, com.kwad.sdk.crash.e.If().getContext());
    ...
    public final void init(@NonNull File file, boolean z4, @NonNull String str, com.kwad.sdk.crash.report.c cVar) {
        ...
        if (com.kwad.sdk.crash.b.HO()) {
            ...
            try {
                ...
                install(this.mDumpFile.getPath(), z4, str, Build.VERSION.SDK_INT);
