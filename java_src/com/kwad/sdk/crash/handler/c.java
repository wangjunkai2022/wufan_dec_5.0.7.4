...
public final class c extends b {
    ...
    public static class a {
        private static final c aHn = new c((byte) 0);
    }
    ...
    private void a(@NonNull Throwable th, @NonNull ExceptionMessage exceptionMessage, @Nullable Context context, boolean z4) {
        boolean z5;
        ...
        try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (z5) {
                                ...
                                com.kwad.sdk.core.e.c.d("AdExceptionCollector", "uploader.uploadEvent(message);");
                                CountDownLatch countDownLatch4 = z4 ? new CountDownLatch(1) : null;
            ...
            try {
                ...
                if (!z5) {
                    if (uploader != null) {
                        com.kwad.sdk.core.e.c.d("AdExceptionCollector", "uploader.uploadEvent(message);");
                        CountDownLatch countDownLatch5 = z4 ? new CountDownLatch(1) : null;
