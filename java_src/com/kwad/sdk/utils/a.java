...
public final class a {
    ...
    public static String getFileMD5(File file) {
        try {
            ...
            if (fileMD5Digest != null && fileMD5Digest.length != 0) {
                return ae.toHexString(fileMD5Digest, 0, fileMD5Digest.length);
            }
            return null;
        } catch (IOException e5) {
            com.kwad.sdk.core.e.c.e("FileMD5Utils", "cannot calculate md5 of file", e5);
            return null;
        }
    }
    ...
    public static byte[] getFileMD5Digest(File file) {
        ...
        try {
            ...
            com.kwad.sdk.core.e.c.e("FileMD5Utils", "getting file md5 digest error.", e5);
            return null;
        } finally {
