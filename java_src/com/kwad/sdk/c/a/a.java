...
public final class a {
    ...
    private static int a(int i4, float f5, Context context) {
        float applyDimension = TypedValue.applyDimension(2, f5, context.getResources().getDisplayMetrics());
    ...
    public static View a(ViewGroup viewGroup, int i4, boolean z4) {
    ...
    public static void a(View view, float f5, float f6) {
        View view2;
        if (view == null || f5 == 0.0f || f6 == 0.0f || (view2 = (View) view.getParent()) == null) {
            return;
        }
    ...
    public static void a(TextView textView, String str, Bitmap bitmap) {
            ...
            while (true) {
                ...
                if (measureText < width) {
                    if (i6 == textView.getMaxLines()) {
                        float f5 = measureText + intrinsicWidth;
                        if (paint.measureText(" ") + f5 < width && f5 + paint.measureText("...") + paint.measureText(" ") < width) {
                            if (z4) {
        ...
        String str3 = str2 + WebSocketServerHandshaker.SUB_PROTOCOL_WILDCARD;
