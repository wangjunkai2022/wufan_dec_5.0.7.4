...
public class DownloadTask implements Serializable {
    ...
    public static class DownloadRequest implements Serializable {
        ...
        public void setDownloadEnablePause(boolean z4) {
            this.downloadEnablePause = z4;
        }

        public DownloadRequest setInstallAfterDownload(boolean z4) {
            this.mInstallAfterDownload = z4;
            return this;
        }
    ...
    private void notifyDownloadProgress(com.kwad.framework.filedownloader.a aVar, final boolean z4) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void onConnected(com.kwad.framework.filedownloader.a aVar, String str, boolean z4, int i4, int i5) {
        long j4;
        long j5 = i5;
        try {
    ...
    void instantiateDownloadTask() {
        ...
        this.mBaseDownloadTask = aX.c(path, TextUtils.isEmpty(this.mDestinationFileName)).a(new com.kwad.framework.filedownloader.i() { // from class: com.kwad.sdk.DownloadTask.1
            ...
            public final void a(com.kwad.framework.filedownloader.a aVar, String str, boolean z4, int i4, int i5) {
                DownloadTask.this.onConnected(aVar, str, z4, i4, i5);
            }
    ...
    public boolean isCompleted() {
        return this.mBaseDownloadTask.uz() == -3;
    }

    public boolean isError() {
        return this.mBaseDownloadTask.uz() == -1;
    }

    public boolean isErrorBecauseWifiRequired() {
        return this.mBaseDownloadTask.uG() && isError() && (this.mBaseDownloadTask.uB() instanceof FileDownloadNetworkPolicyException);
    }

    public boolean isInvalid() {
        return this.mBaseDownloadTask.uz() == 0;
    }
    ...
    public boolean isPaused() {
        return this.mBaseDownloadTask.uz() == -2;
    }
    ...
    public void setNotificationRemoved(boolean z4) {
        this.notificationRemoved = z4;
    }
