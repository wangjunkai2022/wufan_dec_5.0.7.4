...
public interface b extends IInterface {
    ...
    void b(String str, String str2, boolean z4, int i4, int i5, int i6, boolean z5, com.kwad.framework.filedownloader.d.b bVar, boolean z6);
            ...
            if (i4 != 1598968902) {
                switch (i4) {
                    case 1:
                        ...
                        a(a.AbstractBinderC0495a.c(parcel.readStrongBinder()));
                        return true;
                    case 2:
                        parcel.enforceInterface("com.kwad.framework.filedownloader.i.IFileDownloadIPCService");
                        b(a.AbstractBinderC0495a.c(parcel.readStrongBinder()));
                        return true;
                    case 3:
                        parcel.enforceInterface("com.kwad.framework.filedownloader.i.IFileDownloadIPCService");
                        boolean u4 = u(parcel.readString(), parcel.readString());
        ...
        public static class C0497a implements b {
            ...
            public final void a(com.kwad.framework.filedownloader.c.a aVar) {
                ...
                try {
                    ...
                    if (this.mRemote.transact(1, obtain, null, 1) || a.wA() == null) {
                        return;
                    }
                    a.wA().a(aVar);
                } finally {
            ...
            public final void b(com.kwad.framework.filedownloader.c.a aVar) {
                ...
                try {
                    obtain.writeInterfaceToken("com.kwad.framework.filedownloader.i.IFileDownloadIPCService");
                    obtain.writeStrongBinder(aVar != null ? aVar.asBinder() : null);
                    if (this.mRemote.transact(2, obtain, null, 1) || a.wA() == null) {
                        return;
                    }
                    a.wA().b(aVar);
                } finally {
            ...
            public final boolean bd(int i4) {
                ...
                try {
                    obtain.writeInterfaceToken("com.kwad.framework.filedownloader.i.IFileDownloadIPCService");
                    obtain.writeInt(i4);
                    if (!this.mRemote.transact(5, obtain, obtain2, 0) && a.wA() != null) {
                        return a.wA().bd(i4);
                    }
            ...
            public final byte be(int i4) {
                ...
                try {
                    obtain.writeInterfaceToken("com.kwad.framework.filedownloader.i.IFileDownloadIPCService");
                    obtain.writeInt(i4);
                    if (!this.mRemote.transact(10, obtain, obtain2, 0) && a.wA() != null) {
                        return a.wA().be(i4);
                    }
                    obtain2.readException();
            ...
            public final boolean bf(int i4) {
                ...
                try {
                    obtain.writeInterfaceToken("com.kwad.framework.filedownloader.i.IFileDownloadIPCService");
                    obtain.writeInt(i4);
                    if (!this.mRemote.transact(14, obtain, obtain2, 0) && a.wA() != null) {
                        return a.wA().bf(i4);
                    }
                    obtain2.readException();
                    return obtain2.readInt() != 0;
            ...
            public final boolean bx(int i4) {
                ...
                try {
                    obtain.writeInterfaceToken("com.kwad.framework.filedownloader.i.IFileDownloadIPCService");
                    obtain.writeInt(i4);
                    if (!this.mRemote.transact(7, obtain, obtain2, 0) && a.wA() != null) {
                        return a.wA().bx(i4);
                    }
                    obtain2.readException();
                    return obtain2.readInt() != 0;
            ...
            public final long by(int i4) {
                ...
                try {
                    obtain.writeInterfaceToken("com.kwad.framework.filedownloader.i.IFileDownloadIPCService");
                    obtain.writeInt(i4);
                    if (!this.mRemote.transact(8, obtain, obtain2, 0) && a.wA() != null) {
                        return a.wA().by(i4);
                    }
                    obtain2.readException();
            ...
            public final long bz(int i4) {
                ...
                try {
                    obtain.writeInterfaceToken("com.kwad.framework.filedownloader.i.IFileDownloadIPCService");
                    obtain.writeInt(i4);
                    if (!this.mRemote.transact(9, obtain, obtain2, 0) && a.wA() != null) {
                        return a.wA().bz(i4);
                    }
                    obtain2.readException();
                    return obtain2.readLong();
            ...
            public final boolean isIdle() {
                ...
                try {
                    obtain.writeInterfaceToken("com.kwad.framework.filedownloader.i.IFileDownloadIPCService");
                    if (!this.mRemote.transact(11, obtain, obtain2, 0) && a.wA() != null) {
                        return a.wA().isIdle();
                    }
                    obtain2.readException();
                    return obtain2.readInt() != 0;
            ...
            public final void pauseAllTasks() {
                ...
                try {
                    obtain.writeInterfaceToken("com.kwad.framework.filedownloader.i.IFileDownloadIPCService");
                    if (!this.mRemote.transact(6, obtain, obtain2, 0) && a.wA() != null) {
                        a.wA().pauseAllTasks();
                    } else {
                        obtain2.readException();
                    }
            ...
            public final void startForeground(int i4, Notification notification) {
                ...
                try {
                    ...
                    if (this.mRemote.transact(12, obtain, null, 1) || a.wA() == null) {
                        return;
                    }
                    a.wA().startForeground(i4, notification);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public final void stopForeground(boolean z4) {
                ...
                try {
                    ...
                    if (this.mRemote.transact(13, obtain, null, 1) || a.wA() == null) {
                        return;
                    }
                    a.wA().stopForeground(z4);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public final boolean u(String str, String str2) {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(3, obtain, obtain2, 0) && a.wA() != null) {
                        return a.wA().u(str, str2);
                    }
                    obtain2.readException();
                    return obtain2.readInt() != 0;
                } finally {
            ...
            public final void wz() {
                ...
                try {
                    obtain.writeInterfaceToken("com.kwad.framework.filedownloader.i.IFileDownloadIPCService");
                    if (!this.mRemote.transact(15, obtain, obtain2, 0) && a.wA() != null) {
                        a.wA().wz();
                    } else {
                        obtain2.readException();
                    }
            ...
            public final void b(String str, String str2, boolean z4, int i4, int i5, int i6, boolean z5, com.kwad.framework.filedownloader.d.b bVar, boolean z6) {
                ...
                try {
                    if (!this.mRemote.transact(4, obtain, obtain2, 0) && a.wA() != null) {
                        a.wA().b(str, str2, z4, i4, i5, i6, z5, bVar, z6);
                    } else {
                        obtain2.readException();
                    }
                    obtain2.recycle();
