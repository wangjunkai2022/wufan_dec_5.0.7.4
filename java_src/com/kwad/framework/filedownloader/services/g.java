...
public final class g implements y {
    ...
    */
    ...
    public final long bJ(int i4) {
        ...
        com.kwad.framework.filedownloader.d.c bk = xh.bk(i4);
        if (bk == null) {
            return 0L;
        }
        int wS = bk.wS();
        ...
        List<com.kwad.framework.filedownloader.d.a> bl = xh.bl(i4);
    ...
    public final boolean isIdle() {
        return this.aiQ.xk() <= 0;
    }

    @Override // com.kwad.framework.filedownloader.y
    public final int o(String str, int i4) {
        return this.aiQ.o(str, i4);
    }
