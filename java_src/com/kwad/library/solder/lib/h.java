...
public class h extends g {
    ...
    private Set<File> a(Context context, File file, File file2) {
        ...
        for (String str2 : com.kwad.library.solder.lib.d.c.b(file, file3)) {
            File a5 = com.kwad.library.solder.lib.d.c.a(file3, str2, file2);
            if (a5 != null) {
                hashSet.add(a5);
            }
        }
    ...
    */
    private void c(java.util.Set<java.io.File> r9) {
        /*
            r8 = this;
            com.kwad.library.solder.lib.c.b r0 = r8.ako
            if (r0 == 0) goto Lb0
            java.util.HashMap<java.lang.String, java.lang.String> r0 = r0.alb
            int r0 = r0.size()
            if (r0 <= 0) goto Lb0
            if (r9 == 0) goto Lb0
            com.kwad.library.solder.lib.c.b r0 = r8.ako
        ...
        L3d:
            ...
            java.lang.String r6 = com.kwad.sdk.utils.ae.ab(r5)
    ...
    public void h(Context context, String str) {
        ...
        try {
            ...
            try {
                ...
                throw new PluginError.LoadError(e6, 4004);
            }
        } catch (IOException e7) {
            throw new PluginError.LoadError(e7, 4003);
        }
    }
}
