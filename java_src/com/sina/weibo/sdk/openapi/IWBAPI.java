...
public interface IWBAPI {
    ...
    void authorizeCallback(Activity activity, int i4, int i5, Intent intent);
    ...
    void setLoggerEnable(boolean z4);

    void shareMessage(Activity activity, WeiboMultiMessage weiboMultiMessage, boolean z4);
}
