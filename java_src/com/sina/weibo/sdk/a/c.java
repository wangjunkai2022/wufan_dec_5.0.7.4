...
public abstract class c<Params, Progress, Result> {
    ...
    Handler f60125x = new Handler(Looper.getMainLooper()) { // from class: com.sina.weibo.sdk.a.c.1
    ...
    /* loaded from: classes5.dex */
    abstract class AbstractC0604c extends FutureTask<Result> implements Comparable<Object> {
        int priority;

        public AbstractC0604c(d dVar) {
            super(dVar);
    ...
    public c() {
        ...
        this.M = dVar;
        this.N = new c<Params, Progress, Result>.AbstractC0604c(dVar) { // from class: com.sina.weibo.sdk.a.c.3
            ...
            protected final void done() {
                try {
                    Result result = get();
                    c cVar = c.this;
                    cVar.f60125x.obtainMessage(1, new a(cVar, result)).sendToTarget();
                } catch (InterruptedException unused) {
                    throw new RuntimeException("An error occur while execute doInBackground().");
                } catch (CancellationException unused2) {
                    c.this.f60125x.obtainMessage(3, new a(c.this, null)).sendToTarget();
