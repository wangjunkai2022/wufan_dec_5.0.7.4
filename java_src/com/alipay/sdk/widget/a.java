...
public final class a {
    ...
    /* loaded from: classes2.dex */
    public class AlertDialogC0159a extends AlertDialog {
        /* JADX INFO: Access modifiers changed from: protected */
        public AlertDialogC0159a(Context context) {
            super(context);
        }

        private static int a(Context context, float f5) {
            return (int) (f5 * (context == null ? Resources.getSystem() : context.getResources()).getDisplayMetrics().density);
        }

        private static Drawable b(Context context, String str) {
            ByteArrayInputStream byteArrayInputStream;
            try {
                byteArrayInputStream = new ByteArrayInputStream(com.alipay.sdk.encrypt.a.d(str));
                try {
        ...
        private View c(Context context) {
            ...
            layoutParams2.setMargins(a(a.this.f4974b, 17.0f), a(a.this.f4974b, 10.0f), a(a.this.f4974b, 8.0f), a(a.this.f4974b, 10.0f));
            imageView.setLayoutParams(layoutParams2);
            imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
            imageView.setImageDrawable(b(context, a.f4972g));
            ...
            textView.setText(TextUtils.isEmpty(a.this.f4975c) ? a.f4969d : a.this.f4975c);
