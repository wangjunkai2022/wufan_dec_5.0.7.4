...
.method public run()V
    ...
    const-string v1, "The user is using the privacy version without a popup newThreadJob 001"
    ...
    .line 6
    :try_start_2
    iget-object v1, p0, Lcn/sharesdk/framework/f$5;->a:Lcn/sharesdk/framework/f;

    invoke-static {v1}, Lcn/sharesdk/framework/f;->c(Lcn/sharesdk/framework/f;)Z
    ...
    const-string v3, "The user is using the version before going to the second pop-up box newThreadJob 001 "
