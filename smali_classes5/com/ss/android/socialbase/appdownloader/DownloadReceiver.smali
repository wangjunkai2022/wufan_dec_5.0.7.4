...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/ss/android/socialbase/appdownloader/DownloadReceiver;->vv:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/ss/android/socialbase/appdownloader/DownloadReceiver;->m:Landroid/os/Handler;

    return-void
.end method

.method static synthetic vv(Lcom/ss/android/socialbase/appdownloader/DownloadReceiver;)Landroid/os/Handler;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/ss/android/socialbase/appdownloader/DownloadReceiver;->m:Landroid/os/Handler;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-virtual {v1}, Lcom/ss/android/socialbase/appdownloader/i;->vv()Lcom/ss/android/socialbase/appdownloader/p/p;
    ...
    invoke-interface {v1}, Lcom/ss/android/socialbase/appdownloader/p/p;->vv()Z
    ...
    .line 6
    sget-object p2, Lcom/ss/android/socialbase/appdownloader/DownloadReceiver;->vv:Ljava/lang/String;

    const-string v1, "Received broadcast intent for android.intent.action.BOOT_COMPLETED"

    invoke-static {p2, v1}, Lcom/ss/android/socialbase/downloader/p/vv;->vv(Ljava/lang/String;Ljava/lang/String;)V

    .line 7
    :cond_3
    invoke-direct {p0, p1, v0}, Lcom/ss/android/socialbase/appdownloader/DownloadReceiver;->vv(Landroid/content/Context;Ljava/lang/String;)V
