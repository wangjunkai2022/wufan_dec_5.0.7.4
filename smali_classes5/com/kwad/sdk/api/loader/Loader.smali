...
.field private aoa:Lcom/kwad/sdk/api/core/IKsAdSDK;

.field private aob:Lcom/kwad/sdk/api/loader/l;
...
.method private constructor <init>()V
    ...
    .line 3
    iput-object v0, p0, Lcom/kwad/sdk/api/loader/Loader;->aob:Lcom/kwad/sdk/api/loader/l;
    ...
    iput-object v0, p0, Lcom/kwad/sdk/api/loader/Loader;->Kc:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private static AQ()V
    ...
    .line 1
    :try_start_0
    invoke-static {}, Lcom/kwad/sdk/api/c;->AF()I
    ...
    invoke-static {v1}, Lcom/kwad/sdk/api/loader/e;->aL(Landroid/content/Context;)Lcom/kwad/sdk/api/loader/e;
    ...
    invoke-virtual {v1, v2}, Lcom/kwad/sdk/api/loader/e;->setDefaultUncaughtExceptionHandler(Ljava/lang/Thread$UncaughtExceptionHandler;)V
    ...
    invoke-virtual {v1, v0}, Lcom/kwad/sdk/api/loader/e;->bW(I)V
    :try_end_1
...
.method private aQ(Landroid/content/Context;)Z
    ...
    .line 1
    :try_start_0
    invoke-static {p1}, Lcom/kwad/sdk/api/loader/h;->aM(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v1

    .line 2
    invoke-static {p1}, Lcom/kwad/sdk/api/loader/h;->aN(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v2, v1}, Lcom/kwad/sdk/api/loader/h;->K(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 5
    invoke-static {p1, v2}, Lcom/kwad/sdk/api/loader/h;->o(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 7
    invoke-static {p1, v1}, Lcom/kwad/sdk/api/loader/h;->p(Landroid/content/Context;Ljava/lang/String;)V
...
.method private static aR(Landroid/content/Context;)V
    ...
    .line 1
    :try_start_0
    invoke-static {p0}, Lcom/kwad/sdk/api/loader/h;->aO(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 2
    sget-object v3, Lcom/kwad/sdk/api/loader/h;->anF:Ljava/lang/String;
    ...
    .line 4
    :cond_0
    invoke-static {p0}, Lcom/kwad/sdk/api/loader/h;->aM(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v1

    .line 5
    invoke-static {p0, v0}, Lcom/kwad/sdk/api/loader/h;->o(Landroid/content/Context;Ljava/lang/String;)V

    .line 6
    invoke-static {p0, v0}, Lcom/kwad/sdk/api/loader/h;->p(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 8
    invoke-static {p0, v1}, Lcom/kwad/sdk/api/loader/i;->t(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    ...
    .line 9
    invoke-static {p0, v2}, Lcom/kwad/sdk/api/loader/h;->q(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static get()Lcom/kwad/sdk/api/loader/Loader;
    ...
    .line 1
    invoke-static {}, Lcom/kwad/sdk/api/loader/Loader$a;->AR()Lcom/kwad/sdk/api/loader/Loader;
...
.method private static y(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/kwad/sdk/api/loader/i;->x(Landroid/content/Context;Ljava/lang/String;)V
...
.method public getExternalClassLoader()Ljava/lang/ClassLoader;
    ...
    .line 1
    iget-object v0, p0, Lcom/kwad/sdk/api/loader/Loader;->aob:Lcom/kwad/sdk/api/loader/l;

    if-eqz v0, :cond_0

    .line 2
    invoke-virtual {v0}, Lcom/kwad/sdk/api/loader/l;->getClassLoader()Ljava/lang/ClassLoader;
...
.method public getExternalResource()Landroid/content/res/Resources;
    ...
    .line 2
    invoke-virtual {v0}, Lcom/kwad/sdk/api/loader/l;->AN()Landroid/content/res/Resources;
...
.method public init(Landroid/content/Context;Ljava/lang/ClassLoader;)Lcom/kwad/sdk/api/core/IKsAdSDK;
    ...
    .line 1
    iget-object v0, p0, Lcom/kwad/sdk/api/loader/Loader;->Kc:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 2
    iget-object p1, p0, Lcom/kwad/sdk/api/loader/Loader;->aoa:Lcom/kwad/sdk/api/core/IKsAdSDK;
    ...
    .line 4
    invoke-static {p1}, Lcom/kwad/sdk/api/loader/Loader;->aR(Landroid/content/Context;)V

    .line 5
    invoke-direct {p0, p1}, Lcom/kwad/sdk/api/loader/Loader;->aQ(Landroid/content/Context;)Z
    ...
    .line 7
    invoke-static {p1, p2, v0}, Lcom/kwad/sdk/api/loader/l;->a(Landroid/content/Context;Ljava/lang/ClassLoader;Ljava/lang/String;)Lcom/kwad/sdk/api/loader/l;

    move-result-object p1

    iput-object p1, p0, Lcom/kwad/sdk/api/loader/Loader;->aob:Lcom/kwad/sdk/api/loader/l;

    .line 8
    :cond_1
    iget-object p1, p0, Lcom/kwad/sdk/api/loader/Loader;->aob:Lcom/kwad/sdk/api/loader/l;
    ...
    iput-object p1, p0, Lcom/kwad/sdk/api/loader/Loader;->aoa:Lcom/kwad/sdk/api/core/IKsAdSDK;
    ...
    .line 11
    :cond_2
    invoke-virtual {p1}, Lcom/kwad/sdk/api/loader/l;->AO()Lcom/kwad/sdk/api/core/IKsAdSDK;
    ...
    .line 15
    invoke-static {}, Lcom/kwad/sdk/api/loader/Loader;->AQ()V

    .line 16
    :cond_3
    iget-object p1, p0, Lcom/kwad/sdk/api/loader/Loader;->Kc:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public newInstance(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    .line 2
    iget-object v0, p0, Lcom/kwad/sdk/api/loader/Loader;->aoa:Lcom/kwad/sdk/api/core/IKsAdSDK;
...
.method public rest()V
    ...
    .line 3
    iput-object v0, p0, Lcom/kwad/sdk/api/loader/Loader;->aoa:Lcom/kwad/sdk/api/core/IKsAdSDK;
