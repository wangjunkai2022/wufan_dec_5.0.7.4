...
.method public toJson(Lcom/kwad/components/offline/api/tk/model/report/TKDownloadMsg;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    .line 5
    iget v0, p1, Lcom/kwad/components/offline/api/tk/model/report/TKDownloadMsg;->threadPoolCoreSize:I

    const-string v1, "thread_pool_core_size"

    invoke-static {p2, v1, v0}, Lcom/kwad/components/offline/api/core/utils/JsonHelper;->putValue(Lorg/json/JSONObject;Ljava/lang/String;I)V

    .line 6
    iget-wide v0, p1, Lcom/kwad/components/offline/api/tk/model/report/TKDownloadMsg;->availableTime:J

    const-string v2, "available_time"
