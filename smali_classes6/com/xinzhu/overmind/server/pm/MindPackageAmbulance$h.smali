.class public final Lcom/xinzhu/overmind/server/pm/MindPackageAmbulance$h;
...
# instance fields
.field public f:Landroid/content/pm/ServiceInfo;
...
.method public constructor <init>(Landroid/content/pm/PackageParser$Service;)V
    ...
    iput-object v0, p0, Lcom/xinzhu/overmind/server/pm/MindPackageAmbulance$h;->f:Landroid/content/pm/ServiceInfo;
    ...
    new-instance v2, Lcom/xinzhu/overmind/server/pm/MindPackageAmbulance$ServiceIntentInfo;

    invoke-direct {v2, v0}, Lcom/xinzhu/overmind/server/pm/MindPackageAmbulance$ServiceIntentInfo;-><init>(Landroid/content/pm/PackageParser$IntentInfo;)V
...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v1, p0, Lcom/xinzhu/overmind/server/pm/MindPackageAmbulance$h;->f:Landroid/content/pm/ServiceInfo;
    :try_end_0
    ...
    .line 12
    invoke-static {p1}, Lcom/xinzhu/overmind/utils/helpers/j;->a(Landroid/os/Parcel;)Landroid/content/pm/ServiceInfo;
    ...
    const-string v2, "trying to restore serviceInfo corrupt "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v2, p0, Lcom/xinzhu/overmind/server/pm/MindPackageAmbulance$h;->f:Landroid/content/pm/ServiceInfo;
    ...
    new-instance v3, Lcom/xinzhu/overmind/server/pm/MindPackageAmbulance$ServiceIntentInfo;

    invoke-direct {v3, v0}, Lcom/xinzhu/overmind/server/pm/MindPackageAmbulance$ServiceIntentInfo;-><init>(Lcom/xinzhu/overmind/server/pm/MindPackageAmbulance$IntentInfo;)V
