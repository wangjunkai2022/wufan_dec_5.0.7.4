...
.method static constructor <clinit>()V
    ...
    .line 2
    invoke-static {v1, v3, v2}, Lio/netty/handler/codec/http2/Http2Exception;->newStatic(Lio/netty/handler/codec/http2/Http2Error;Ljava/lang/String;Lio/netty/handler/codec/http2/Http2Exception$ShutdownHint;)Lio/netty/handler/codec/http2/Http2Exception;
    ...
    .line 3
    invoke-static {v3, v0, v4}, Lio/netty/util/internal/ThrowableUtil;->unknownStackTrace(Ljava/lang/Throwable;Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Throwable;

    move-result-object v3

    check-cast v3, Lio/netty/handler/codec/http2/Http2Exception;
    ...
    .line 9
    invoke-static {v4, v0, v5}, Lio/netty/util/internal/ThrowableUtil;->unknownStackTrace(Ljava/lang/Throwable;Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Throwable;

    move-result-object v4

    check-cast v4, Lio/netty/handler/codec/http2/Http2Exception;

    sput-object v4, Lio/netty/handler/codec/http2/HpackDecoder;->DECODE_ILLEGAL_INDEX_VALUE:Lio/netty/handler/codec/http2/Http2Exception;
    ...
    const-string v6, "indexHeader(..)"

    .line 11
    invoke-static {v4, v0, v6}, Lio/netty/util/internal/ThrowableUtil;->unknownStackTrace(Ljava/lang/Throwable;Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Throwable;

    move-result-object v4

    check-cast v4, Lio/netty/handler/codec/http2/Http2Exception;

    sput-object v4, Lio/netty/handler/codec/http2/HpackDecoder;->INDEX_HEADER_ILLEGAL_INDEX_VALUE:Lio/netty/handler/codec/http2/Http2Exception;
