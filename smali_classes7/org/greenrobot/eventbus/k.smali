...
.field private static final i:[Lorg/greenrobot/eventbus/k$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/greenrobot/eventbus/k;->g:Ljava/util/Map;
    ...
    .line 2
    sput-object v0, Lorg/greenrobot/eventbus/k;->i:[Lorg/greenrobot/eventbus/k$a;
...
.method constructor <init>(Ljava/util/List;ZZ)V
    ...
    .line 2
    iput-object p1, p0, Lorg/greenrobot/eventbus/k;->a:Ljava/util/List;

    .line 3
    iput-boolean p2, p0, Lorg/greenrobot/eventbus/k;->b:Z

    .line 4
    iput-boolean p3, p0, Lorg/greenrobot/eventbus/k;->c:Z
...
.method static a()V
    ...
    .line 1
    sget-object v0, Lorg/greenrobot/eventbus/k;->g:Ljava/util/Map;
...
.method private c(Ljava/lang/Class;)Ljava/util/List;
    ...
    .line 1
    invoke-direct {p0}, Lorg/greenrobot/eventbus/k;->h()Lorg/greenrobot/eventbus/k$a;

    move-result-object v0

    .line 2
    invoke-virtual {v0, p1}, Lorg/greenrobot/eventbus/k$a;->c(Ljava/lang/Class;)V
    ...
    .line 4
    invoke-direct {p0, v0}, Lorg/greenrobot/eventbus/k;->g(Lorg/greenrobot/eventbus/k$a;)Lorg/greenrobot/eventbus/meta/c;

    move-result-object p1

    iput-object p1, v0, Lorg/greenrobot/eventbus/k$a;->h:Lorg/greenrobot/eventbus/meta/c;

    if-eqz p1, :cond_1

    .line 5
    invoke-interface {p1}, Lorg/greenrobot/eventbus/meta/c;->a()[Lorg/greenrobot/eventbus/j;
    ...
    .line 9
    :cond_1
    invoke-direct {p0, v0}, Lorg/greenrobot/eventbus/k;->e(Lorg/greenrobot/eventbus/k$a;)V

    .line 10
    :cond_2
    invoke-virtual {v0}, Lorg/greenrobot/eventbus/k$a;->d()V

    goto :goto_0

    .line 11
    :cond_3
    invoke-direct {p0, v0}, Lorg/greenrobot/eventbus/k;->f(Lorg/greenrobot/eventbus/k$a;)Ljava/util/List;
...
.method private e(Lorg/greenrobot/eventbus/k$a;)V
    .locals 14
    ...
    .line 15
    :cond_0
    iget-boolean v7, p0, Lorg/greenrobot/eventbus/k;->b:Z
    ...
    .line 18
    :cond_2
    iget-boolean v5, p0, Lorg/greenrobot/eventbus/k;->b:Z
...
.method private f(Lorg/greenrobot/eventbus/k$a;)Ljava/util/List;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-virtual {p1}, Lorg/greenrobot/eventbus/k$a;->e()V

    .line 3
    sget-object v1, Lorg/greenrobot/eventbus/k;->i:[Lorg/greenrobot/eventbus/k$a;
    ...
    .line 4
    :try_start_0
    sget-object v3, Lorg/greenrobot/eventbus/k;->i:[Lorg/greenrobot/eventbus/k$a;
...
.method private g(Lorg/greenrobot/eventbus/k$a;)Lorg/greenrobot/eventbus/meta/c;
    .locals 3

    .line 1
    iget-object v0, p1, Lorg/greenrobot/eventbus/k$a;->h:Lorg/greenrobot/eventbus/meta/c;

    if-eqz v0, :cond_0

    invoke-interface {v0}, Lorg/greenrobot/eventbus/meta/c;->c()Lorg/greenrobot/eventbus/meta/c;
    ...
    .line 4
    :cond_0
    iget-object v0, p0, Lorg/greenrobot/eventbus/k;->a:Ljava/util/List;
...
.method private h()Lorg/greenrobot/eventbus/k$a;
    .locals 5

    .line 1
    sget-object v0, Lorg/greenrobot/eventbus/k;->i:[Lorg/greenrobot/eventbus/k$a;
    ...
    .line 2
    :try_start_0
    sget-object v2, Lorg/greenrobot/eventbus/k;->i:[Lorg/greenrobot/eventbus/k$a;
...
.method b(Ljava/lang/Class;)Ljava/util/List;
    ...
    .line 2
    :cond_0
    iget-boolean v1, p0, Lorg/greenrobot/eventbus/k;->c:Z

    if-eqz v1, :cond_1

    .line 3
    invoke-direct {p0, p1}, Lorg/greenrobot/eventbus/k;->d(Ljava/lang/Class;)Ljava/util/List;
