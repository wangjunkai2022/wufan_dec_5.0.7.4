...
.method public static final synthetic d(Lkotlinx/coroutines/sync/SemaphoreImpl;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 0
...
.method public static final synthetic e(Lkotlinx/coroutines/sync/SemaphoreImpl;Lkotlinx/coroutines/p;)Z
    ...
    .line 1
    invoke-direct {p0, p1}, Lkotlinx/coroutines/sync/SemaphoreImpl;->h(Lkotlinx/coroutines/p;)Z
...
.method public static final synthetic f(Lkotlinx/coroutines/sync/SemaphoreImpl;)Lkotlin/jvm/functions/Function1;
    .locals 0
...
.method private final g(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 2
    :cond_0
    invoke-static {p0, v0}, Lkotlinx/coroutines/sync/SemaphoreImpl;->e(Lkotlinx/coroutines/sync/SemaphoreImpl;Lkotlinx/coroutines/p;)Z
    ...
    invoke-static {p0}, Lkotlinx/coroutines/sync/SemaphoreImpl;->f(Lkotlinx/coroutines/sync/SemaphoreImpl;)Lkotlin/jvm/functions/Function1;
...
.method private final h(Lkotlinx/coroutines/p;)Z
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_1
    :goto_0
    invoke-virtual {v7}, Lkotlinx/coroutines/internal/l0;->o()J
    ...
    invoke-virtual {v7}, Lkotlinx/coroutines/internal/l0;->g()Z
    ...
    .line 5
    :cond_2
    invoke-static {v7}, Lkotlinx/coroutines/internal/m0;->b(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 9
    :goto_2
    invoke-static {v7}, Lkotlinx/coroutines/internal/m0;->h(Ljava/lang/Object;)Z
    ...
    invoke-static {v7}, Lkotlinx/coroutines/internal/m0;->f(Ljava/lang/Object;)Lkotlinx/coroutines/internal/l0;
    ...
    check-cast v11, Lkotlinx/coroutines/internal/l0;

    .line 11
    invoke-virtual {v11}, Lkotlinx/coroutines/internal/l0;->o()J

    move-result-wide v12

    invoke-virtual {v8}, Lkotlinx/coroutines/internal/l0;->o()J
    ...
    .line 12
    :cond_6
    invoke-virtual {v8}, Lkotlinx/coroutines/internal/l0;->r()Z
    ...
    .line 14
    invoke-virtual {v11}, Lkotlinx/coroutines/internal/l0;->n()Z
    ...
    .line 15
    :cond_8
    invoke-virtual {v8}, Lkotlinx/coroutines/internal/l0;->n()Z
    ...
    .line 18
    iget-object v5, v2, Lkotlinx/coroutines/sync/e;->e:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    invoke-direct {v3, v2, v4}, Lkotlinx/coroutines/sync/a;-><init>(Lkotlinx/coroutines/sync/e;I)V

    invoke-interface {v1, v3}, Lkotlinx/coroutines/p;->k(Lkotlin/jvm/functions/Function1;)V

    return v10

    .line 20
    :cond_a
    invoke-static {}, Lkotlinx/coroutines/sync/SemaphoreKt;->g()Lkotlinx/coroutines/internal/o0;

    move-result-object v3

    invoke-static {}, Lkotlinx/coroutines/sync/SemaphoreKt;->i()Lkotlinx/coroutines/internal/o0;

    move-result-object v5

    .line 21
    iget-object v6, v2, Lkotlinx/coroutines/sync/e;->e:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    invoke-interface {v1, v2, v3}, Lkotlinx/coroutines/p;->s(Ljava/lang/Object;Lkotlin/jvm/functions/Function1;)V
    ...
    .line 24
    iget-object v1, v2, Lkotlinx/coroutines/sync/e;->e:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    .line 25
    invoke-static {}, Lkotlinx/coroutines/sync/SemaphoreKt;->d()Lkotlinx/coroutines/internal/o0;
    ...
    .line 27
    check-cast v8, Lkotlinx/coroutines/internal/l0;
    ...
    .line 29
    invoke-static {v8, v9, v10}, Lkotlinx/coroutines/sync/SemaphoreKt;->c(JLkotlinx/coroutines/sync/e;)Lkotlinx/coroutines/sync/e;
...
.method private final i(Lkotlinx/coroutines/p;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v2, v1}, Lkotlinx/coroutines/p;->N(Ljava/lang/Object;Ljava/lang/Object;Lkotlin/jvm/functions/Function1;)Ljava/lang/Object;
...
.method private final j()Z
    ...
    :cond_1
    :goto_0
    invoke-virtual {v5}, Lkotlinx/coroutines/internal/l0;->o()J
    ...
    invoke-virtual {v5}, Lkotlinx/coroutines/internal/l0;->g()Z
    ...
    .line 5
    :cond_2
    invoke-static {v5}, Lkotlinx/coroutines/internal/m0;->b(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 9
    :goto_2
    invoke-static {v5}, Lkotlinx/coroutines/internal/m0;->h(Ljava/lang/Object;)Z
    ...
    invoke-static {v5}, Lkotlinx/coroutines/internal/m0;->f(Ljava/lang/Object;)Lkotlinx/coroutines/internal/l0;
    ...
    check-cast v9, Lkotlinx/coroutines/internal/l0;

    .line 11
    invoke-virtual {v9}, Lkotlinx/coroutines/internal/l0;->o()J

    move-result-wide v10

    invoke-virtual {v6}, Lkotlinx/coroutines/internal/l0;->o()J
    ...
    .line 12
    :cond_6
    invoke-virtual {v6}, Lkotlinx/coroutines/internal/l0;->r()Z
    ...
    .line 14
    invoke-virtual {v9}, Lkotlinx/coroutines/internal/l0;->n()Z
    ...
    .line 15
    :cond_8
    invoke-virtual {v6}, Lkotlinx/coroutines/internal/l0;->n()Z
    ...
    .line 18
    invoke-virtual {v0}, Lkotlinx/coroutines/internal/l0;->o()J
    ...
    .line 27
    :cond_d
    invoke-static {}, Lkotlinx/coroutines/sync/SemaphoreKt;->e()Lkotlinx/coroutines/internal/o0;
    ...
    invoke-direct {p0, v1}, Lkotlinx/coroutines/sync/SemaphoreImpl;->i(Lkotlinx/coroutines/p;)Z
    ...
    .line 30
    check-cast v6, Lkotlinx/coroutines/internal/l0;
...
.method public release()V
    ...
    .line 4
    :cond_2
    invoke-direct {p0}, Lkotlinx/coroutines/sync/SemaphoreImpl;->j()Z
